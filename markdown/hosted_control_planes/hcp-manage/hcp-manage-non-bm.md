...
# Managing {{ hcp }} on non-bare-metal agent machines {id="hcp-manage-non-bm"}
{%- set context = "hcp-manage-non-bm" %}

After you deploy {{ hcp }} on non-bare-metal agent machines, you can manage a hosted cluster. {._abstract}
