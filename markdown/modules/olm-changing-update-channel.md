...
# Changing the update channel for an Operator {id="olm-changing-update-channel_{{ context }}"}

To change the update channel for an installed Operator, you can use the {{ product_title }} web console. The update channel determines which Operator versions your subscription tracks and receives. {._abstract}
