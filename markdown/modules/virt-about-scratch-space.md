...
# About scratch space {id="virt-about-scratch-space_{{ context }}"}
...
During this process, CDI provisions a scratch space PVC equal to the size of the PVC backing the destination data volume (DV). {._abstract}
...
## Manual provisioning {id="_manual_provisioning"}
