...
# Examples: IP management {id="virt-example-nmstate-IP-management_{{ context }}"}

The following example configuration snippets show different methods of IP management. {._abstract}
...
## Static {id="virt-example-nmstate-IP-management-static_{{ context }}"}
...
## No IP address {id="virt-example-nmstate-IP-management-no-ip_{{ context }}"}
...
## Dynamic host configuration {id="virt-example-nmstate-IP-management-dhcp_{{ context }}"}
...
## Media Access Control (MAC) address {id="virt-example-nmstate-IP-management-mac_{{ context }}"}
...
## PCI address {id="virt-example-nmstate-IP-management-pci_{{ context }}"}
...
## DNS {id="virt-example-nmstate-IP-management-dns_{{ context }}"}
