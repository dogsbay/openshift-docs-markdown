...
# Fine grained access for Loki logs {id="logging-loki-log-access_{{ context }}"}
...
## Cluster wide access {id="_cluster_wide_access"}
...
## Namespaced access {id="_namespaced_access"}
...
## Custom admin group access {id="_custom_admin_group_access"}
