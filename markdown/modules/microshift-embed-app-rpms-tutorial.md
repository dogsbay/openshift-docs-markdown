...
1.  You added the blueprint for the installation ISO to image builder to create an `rpm-ostree` image (ISO) to boot from. This build contained both {{ op_system_ostree }} and {{ microshift_short }}.
