...
# Gathering ClusterVersion history using the {{ oc_first }} {id="gathering-clusterversion-history-cli_{{ context }}"}

Use the {{ oc_first }} to view ClusterVersion history. You can use the history to troubleshoot update issues or to verify completed updates. {._abstract}
