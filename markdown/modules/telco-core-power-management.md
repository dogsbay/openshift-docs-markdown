...
# Power Management {id="telco-core-power-management_{{ context }}"}

Use the performance profile to configure clusters with high power mode, low power mode, or mixed mode depending on workload latency sensitivity. {._abstract}
