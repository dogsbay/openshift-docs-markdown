...
# Overview of the cluster-compare plugin {id="cluster-compare-overview_{{ context }}"}

Clusters deployed at scale typically use a validated set of baseline custom resources (CRs) to configure clusters to meet use-case requirements and ensure consistency when deploying across different environments.  {._abstract}
