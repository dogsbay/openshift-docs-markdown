...
# Limitations of NUMA for {{ VirtProductName }} {id="virt-NUMA-limitations_{{ context }}"}

When you use NUMA topology with {{ VirtProductName }} VMs, certain limitations can impact performance and VM management. {._abstract}
