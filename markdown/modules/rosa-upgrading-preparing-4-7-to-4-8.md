...
# Requirements for upgrading to OpenShift 4.8 {id="rosa-upgrading-requirements-48_{{ context }}"}

You must meet the following requirements before upgrading a {{ product_title }} (ROSA) cluster that uses the AWS Security Token Service (STS) from version 4.7 to 4.8:
