...
# Dynamic plugin extension types {id="dynamic-plugin-sdk-extensions_{{ context }}"}

## `console.action/filter` {id="_consoleactionfilter"}

`ActionFilter` can be used to filter an action. {._abstract}
...
## `console.action/group` {id="_consoleactiongroup"}
...
## `console.action/provider` {id="_consoleactionprovider"}
...
## `console.action/resource-provider` {id="_consoleactionresource-provider"}
...
## `console.alert-action` {id="_consolealert-action"}
...
## `console.catalog/item-filter` {id="_consolecatalogitem-filter"}
...
## `console.catalog/item-metadata` {id="_consolecatalogitem-metadata"}
...
## `console.catalog/item-provider` {id="_consolecatalogitem-provider"}
...
## `console.catalog/item-type` {id="_consolecatalogitem-type"}
...
## `console.catalog/item-type-metadata` {id="_consolecatalogitem-type-metadata"}
...
## `console.cluster-overview/inventory-item` {id="_consolecluster-overviewinventory-item"}
...
## `console.cluster-overview/multiline-utilization-item` {id="_consolecluster-overviewmultiline-utilization-item"}
...
## `console.cluster-overview/utilization-item` {id="_consolecluster-overviewutilization-item"}
...
## `console.context-provider` {id="_consolecontext-provider"}
...
## `console.create-project-modal` {id="_consolecreate-project-modal"}
...
## `console.dashboards/card` {id="_consoledashboardscard"}
...
## `console.dashboards/custom/overview/detail/item` {id="_consoledashboardscustomoverviewdetailitem"}
...
## `console.dashboards/overview/activity/resource` {id="_consoledashboardsoverviewactivityresource"}
...
## `console.dashboards/overview/health/operator` {id="_consoledashboardsoverviewhealthoperator"}
...
## `console.dashboards/overview/health/prometheus` {id="_consoledashboardsoverviewhealthprometheus"}
...
## `console.dashboards/overview/health/resource` {id="_consoledashboardsoverviewhealthresource"}
...
## `console.dashboards/overview/health/url` {id="_consoledashboardsoverviewhealthurl"}
...
## `console.dashboards/overview/inventory/item` {id="_consoledashboardsoverviewinventoryitem"}
...
## `console.dashboards/overview/inventory/item/group` {id="_consoledashboardsoverviewinventoryitemgroup"}
...
## `console.dashboards/overview/inventory/item/replacement` {id="_consoledashboardsoverviewinventoryitemreplacement"}
...
## `console.dashboards/overview/prometheus/activity/resource` {id="_consoledashboardsoverviewprometheusactivityresource"}
...
## `console.dashboards/project/overview/item` {id="_consoledashboardsprojectoverviewitem"}
...
## `console.dashboards/tab` {id="_consoledashboardstab"}
...
## `console.file-upload` {id="_consolefile-upload"}
...
## `console.flag/hookProvider` {id="_consoleflaghookprovider"}
...
## `console.flag/model` {id="_consoleflagmodel"}
...
## `console.global-config` {id="_consoleglobal-config"}
...
## `console.model-metadata` {id="_consolemodel-metadata"}
...
## `console.navigation/href` {id="_consolenavigationhref"}
...
## `console.navigation/resource-cluster` {id="_consolenavigationresource-cluster"}
...
## `console.navigation/resource-ns` {id="_consolenavigationresource-ns"}
...
## `console.navigation/section` {id="_consolenavigationsection"}
...
## `console.navigation/separator` {id="_consolenavigationseparator"}
...
## `console.page/resource/details` {id="_consolepageresourcedetails"}
...
## `console.page/resource/list` {id="_consolepageresourcelist"}
...
## `console.page/route` {id="_consolepageroute"}
...
## `console.page/route/standalone` {id="_consolepageroutestandalone"}
...
## `console.perspective` {id="_consoleperspective"}
...
## `console.project-overview/inventory-item` {id="_consoleproject-overviewinventory-item"}
...
## `console.project-overview/utilization-item` {id="_consoleproject-overviewutilization-item"}
...
## `console.pvc/alert` {id="_consolepvcalert"}
...
## `console.pvc/create-prop` {id="_consolepvccreate-prop"}
...
## `console.pvc/delete` {id="_consolepvcdelete"}
...
## `console.pvc/status` {id="_consolepvcstatus"}
...
## `console.redux-reducer` {id="_consoleredux-reducer"}
...
## `console.resource/create` {id="_consoleresourcecreate"}
...
## `console.resource/details-item` {id="_consoleresourcedetails-item"}
...
<tr>
  ...
  <td>`CodeRef<React.ComponentType<DetailsItem ComponentProps<K8sResourceCommon, any>>>` |yes</td>
...
## `console.storage-class/provisioner` {id="_consolestorage-classprovisioner"}
...
## `console.storage-provider` {id="_consolestorage-provider"}
...
## `console.tab/horizontalNav` {id="_consoletabhorizontalnav"}
...
## `console.telemetry/listener` {id="_consoletelemetrylistener"}
...
## `console.topology/adapter/build` {id="_consoletopologyadapterbuild"}
...
## `console.topology/adapter/network` {id="_consoletopologyadapternetwork"}
...
## `console.topology/adapter/pod` {id="_consoletopologyadapterpod"}
...
## `console.topology/component/factory` {id="_consoletopologycomponentfactory"}
...
## `console.topology/create/connector` {id="_consoletopologycreateconnector"}
...
## `console.topology/data/factory` {id="_consoletopologydatafactory"}
...
## `console.topology/decorator/provider` {id="_consoletopologydecoratorprovider"}
...
## `console.topology/details/resource-alert` {id="_consoletopologydetailsresource-alert"}
...
## `console.topology/details/resource-link` {id="_consoletopologydetailsresource-link"}
...
## `console.topology/details/tab` {id="_consoletopologydetailstab"}
...
## `console.topology/details/tab-section` {id="_consoletopologydetailstab-section"}
...
## `console.topology/display/filters` {id="_consoletopologydisplayfilters"}
...
## `console.topology/relationship/provider` {id="_consoletopologyrelationshipprovider"}
...
## `console.user-preference/group` {id="_consoleuser-preferencegroup"}
...
## `console.user-preference/item` {id="_consoleuser-preferenceitem"}
...
## `console.yaml-template` {id="_consoleyaml-template"}
...
## `dev-console.add/action` {id="_dev-consoleaddaction"}
...
## `dev-console.add/action-group` {id="_dev-consoleaddaction-group"}
...
## `dev-console.import/environment` {id="_dev-consoleimportenvironment"}
...
## `console.dashboards/overview/detail/item` {id="_consoledashboardsoverviewdetailitem"}
...
## `console.page/resource/tab` {id="_consolepageresourcetab"}
