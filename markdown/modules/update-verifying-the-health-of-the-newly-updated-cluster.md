...
# Verifying the health of the newly updated cluster {id="update-verifying-the-health-of-the-newly-updated-cluster_{{ context }}"}

After updating the cluster, verify that the cluster is back up and running. {._abstract}
