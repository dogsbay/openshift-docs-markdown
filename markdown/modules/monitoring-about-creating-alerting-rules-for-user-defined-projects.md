...
# Creating alerting rules for user-defined projects {id="about-creating-alerting-rules-for-user-defined-projects_{{ context }}"}

In {{ product_title }}, you can create alerting rules for user-defined projects. Those alerting rules will trigger alerts based on the values of the chosen metrics.
