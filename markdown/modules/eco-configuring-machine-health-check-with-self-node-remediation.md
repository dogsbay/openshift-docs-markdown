...
# Configuring machine health checks to use the Self Node Remediation Operator {id="configuring-machine-health-check-with-self-node-remediation-operator_{{ context }}"}
