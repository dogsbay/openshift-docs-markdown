...
# Deploying a database in interactive mode {id="deploying-a-database-in-interactive-mode_{{ context }}"}

{{ odo_title }} provides a command-line interactive mode which simplifies deployment.
