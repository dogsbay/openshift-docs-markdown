...
# About invoking Quarkus functions {id="serverless-invoking-quarkus-functions_{{ context }}"}
...
```java title="Example Quarkus function"
...
## Invocation examples {id="serverless-invoking-quarkus-functions-examples_{{ context }}"}
