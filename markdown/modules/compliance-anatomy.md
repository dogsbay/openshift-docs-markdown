...
# Anatomy of a scan {id="compliance-anatomy_{{ context }}"}

Before troubleshooting Compliance Operator scans, familiarize yourself with the components and stages of Compliance Operator scans. {._abstract}

## Compliance sources {id="compliance-anatomy-compliance-sources_{{ context }}"}
...
## The ScanSetting and ScanSettingBinding objects lifecycle and debugging {id="compliance-anatomy-scan-setting-scan-binding-lifecycle_{{ context }}"}
...
## ComplianceSuite custom resource lifecycle and debugging {id="compliance-suite-lifecycle-debugging_{{ context }}"}
...
## ComplianceScan custom resource lifecycle and debugging {id="compliance-scan-lifecycle-debugging_{{ context }}"}
...
## Pending phase {id="compliance-scan-pending-phase_{{ context }}"}
...
## Launching phase {id="compliance-scan-launching-phase_{{ context }}"}
...
## Running phase {id="compliance-scan-running-phase_{{ context }}"}
...
## Aggregating phase {id="compliance-scan-aggregating-phase_{{ context }}"}
...
## Done phase {id="compliance-scan-done-phase_{{ context }}"}
...
## Useful labels {id="compliance-operator-useful-labels_{{ context }}"}
