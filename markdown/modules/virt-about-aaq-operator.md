...
# About the AAQ Operator {id="virt-about-aaq-operator_{{ context }}"}

The Application-Aware Quota (AAQ) Operator provides more flexible and extensible quota management compared to the native `ResourceQuota` object in the {{ product_title }} platform. {._abstract}
...
## AAQ Operator controller and custom resources {id="aaq-controller-and-crds_{{ context }}"}
