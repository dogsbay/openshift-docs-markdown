...
# Getting debug information from the installation program {id="installing-getting-debug-information_{{ context }}"}

You can choose between two methods to get debug information from the installation program. {._abstract}
