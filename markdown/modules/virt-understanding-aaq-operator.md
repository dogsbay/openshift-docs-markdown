...
# Understanding the Application Aware Quota Operator {id="virt-understanding-aaq-operator_{{ context }}"}

The Application Aware Quota (AAQ) operator extends Kubernetes native `ResourceQuota` to measure virtual machine (VM) resource consumption in mixed pod and VM environments. {._abstract}
