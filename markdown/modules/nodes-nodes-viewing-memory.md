...
# Viewing memory and CPU usage statistics on your nodes {id="nodes-nodes-viewing-memory_{{ context }}"}

You can display usage statistics about nodes, including CPU, memory, and storage consumption. These statistics can help you ensure your cluster is running efficiently. {._abstract}
