...
# Viewing service mesh data in the Kiali console {id="ossm-observability-visual_{{ context }}"}
...
## Changing graph layouts in Kiali {id="ossm-observability-topology_{{ context }}"}
...
1.  In Kiali console, click **Graph** to view a namespace graph.
1.  From the **Namespace** menu, select your application namespace, for example, `bookinfo`.
1.  To choose a different graph layout, do either or both of the following:
