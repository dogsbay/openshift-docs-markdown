...
# Configuration for a VLAN secondary network {id="nw-multus-vlan-object_{{ context }}"}

The VLAN CNI plugin JSON configuration object describes the configuration parameters for the VLAN, `vlan`, CNI plugin. The following table details these parameters: {._abstract}
...
## VLAN configuration example {id="nw-multus-vlan-config-example_{{ context }}"}
