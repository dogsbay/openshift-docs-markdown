...
# Node configuration reference CRs {id="node-configuration-crs_{{ context }}"}

Use the following custom resources (CRs) to configure node settings for the telco core profile. {._abstract}
