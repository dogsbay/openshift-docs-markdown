...
# Supported log forwarding outputs {id="supported-log-outputs_{{ context }}"}
...
| Elasticsearch v8 | HTTP 1.1 | 8.4.3, 8.6.1 | 5.6+ | Fluentd <sup>[1]</sup>, Vector |
| Fluent Forward | Fluentd forward v1 | Fluentd 1.14.6, Logstash 7.10.1, Fluentd 1.14.5 | 5.4+ | Fluentd |
| {{ gcp_full }} Logging | REST over HTTPS | Latest | 5.7+ | Vector |
...
| Syslog | RFC3164, RFC5424 | Rsyslog 8.37.0-9.el7, rsyslog-8.39.0 | 5.4+ | Fluentd, Vector <sup>[2]</sup> |
...
1.  Vector supports Syslog in the {{ logging }} version 5.7 and higher.