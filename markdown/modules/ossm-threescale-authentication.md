# Authenticating requests {id="ossm-threescale-authentication_{{ context }}"}
...
## Applying authentication patterns {id="ossm-threescale-authentication-patterns_{{ context }}"}
...
### API key authentication method {id="ossm-threescale-apikey-authentication_{{ context }}"}
...
### Application ID and application key pair authentication method {id="ossm-threescale-appidapikey-authentication_{{ context }}"}
...
### OpenID authentication method {id="ossm-threescale-openid-authentication_{{ context }}"}
...
### Hybrid authentication method {id="ossm-threescale-hybrid-authentication_{{ context }}"}
