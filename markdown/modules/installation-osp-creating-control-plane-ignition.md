...
# Creating control plane Ignition config files on {{ rh_openstack }} {id="installation-osp-creating-control-plane-ignition_{{ context }}"}

Installing {{ product_title }} on {{ rh_openstack_first }} on your own infrastructure requires control plane Ignition config files. You must create multiple config files. {._abstract}
