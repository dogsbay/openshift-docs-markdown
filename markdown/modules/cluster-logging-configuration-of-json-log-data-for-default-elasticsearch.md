# Configuring JSON log data for Elasticsearch {id="cluster-logging-configuration-of-json-log-data-for-default-elasticsearch_{{ context }}"}
...
1.  The `myLabel` element gives its string value, `myValue`, to the structured log record.
