...
# Reviewing configured cluster MachineConfigPool roles {id="update-reviewing-configured-cluster-mcp-roles_{{ context }}"}

Review the currently configured `MachineConfigPool` roles in the cluster. {._abstract}
