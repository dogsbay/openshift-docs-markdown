...
# About additional storage locations for CRI-O {id="nodes-nodes-additional-crio-storage-about_{{ context }}"}

To reduce application startup time and make your applications run more efficiently, you can configure additional storage locations for the CRI-O container engine.  {._abstract}
