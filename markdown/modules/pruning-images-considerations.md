...
# Image pruning considerations {id="pruning-images-considerations_{{ context }}"}

Review soft-delete conditions and registry caching behaviors before pruning images to prevent metadata corruption and protect active container deployment layers. {._abstract}
