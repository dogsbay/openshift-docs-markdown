...
# Network Observability CLI {id="network-observability-cli_{{ context }}"}

The Network Observability CLI (`oc netobserv`) is a lightweight tool that streams flow and packet data for quick, live insight into networking issues without requiring the full Network Observability Operator installation. {._abstract}
