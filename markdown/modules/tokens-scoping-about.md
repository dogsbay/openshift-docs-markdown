...
# About scoping tokens {id="tokens-scoping-about_{{ context }}"}
...
power to create pods. {._abstract}
...
## User scopes {id="scoping-tokens-user-scopes_{{ context }}"}
...
## Role scope {id="scoping-tokens-role-scope_{{ context }}"}
