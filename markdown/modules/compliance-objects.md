...
# Using the ComplianceSuite and ComplianceScan objects directly {id="compliance-objects_{{ context }}"}

You can define a `ComplianceSuite` object directly rather than using the `ScanSetting` and `ScanSettingBinding` objects to define the suites and scans. {._abstract}
