# Bookinfo example application {id="ossm-tutorial-bookinfo-overview_{{ context }}"}

The Bookinfo example application allows you to test your {{ SMProductName }} {{ SMProductVersion }} installation on {{ product_title }}.
