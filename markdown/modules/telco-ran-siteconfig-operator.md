...
# SiteConfig Operator {id="telco-ran-siteconfig-operator_{{ context }}"}

The SiteConfig Operator is a template-driven solution designed to provision clusters through various installation methods. {._abstract}
...
Description
    ...
    *   ***Assisted Installer*** automates the deployment of {{ product_title }} clusters by leveraging predefined configurations and validated host setups.
    It ensures that the target infrastructure meets {{ product_title }} requirements.
    ...
    *   ***Image-based Installer*** expedites the deployment of {{ sno }} clusters by utilizing preconfigured and validated {{ product_title }} seed images.
