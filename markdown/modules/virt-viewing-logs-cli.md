...
# Viewing {{ VirtProductName }} pod logs with the CLI {id="virt-viewing-logs-cli_{{ context }}"}

To diagnose issues and monitor {{ VirtProductName }} pods, you can view logs by using the {{ oc_first }}.  {._abstract}
