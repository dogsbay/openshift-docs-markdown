...
# Evaluation of update availability {id="update-evaluate-availability_{{ context }}"}

The Cluster Version Operator (CVO) periodically queries the OpenShift Update Service (OSUS) for the most recent data about update possibilities. {._abstract}
