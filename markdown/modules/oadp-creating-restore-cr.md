...
# Creating a Restore CR {id="oadp-creating-restore-cr_{{ context }}"}

Restore a `Backup` custom resource (CR) by creating a `Restore` CR. {._abstract}
...
*   You must install the {{ oadp_first }} Operator.
