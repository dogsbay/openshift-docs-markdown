...
# Prepare your AWS account {id="cloud-experts-deploy-api-data-protection-prepare-aws-account_{{ context }}"}

Create the AWS Identity and Access Management (IAM) policy, trust policy, and role to grant {{ oadp_full }} access to Amazon S3 and Amazon EC2 resources required for backup and restore operations. {._abstract}
