...
# AWS Arm-based Graviton instance types {id="rosa-sdpolicy-aws-instance-types-graviton_{{ context }}"}

In addition to x86-based architecture, {{ hcp_title }} offers the following Arm-based Graviton worker node instance types and sizes:
...
*   m8gb.xlarge (4 vCPU, 16 GiB)
*   m8gb.2xlarge (8 vCPU, 32 GiB)
*   m8gb.4xlarge (16 vCPU, 64 GiB)
*   m8gb.8xlarge (32 vCPU, 128 GiB)
*   m8gb.12xlarge (48 vCPU, 192 GiB)
*   m8gb.16xlarge (64 vCPU, 256 GiB)
*   m8gb.24xlarge (96 vCPU, 384 GiB)
*   m8gb.48xlarge (192 vCPU, 768 GiB)
*   m8gb.metal-24xl (96 vCPU, 384 GiB)
*   m8gb.metal-48xl (192 vCPU, 768 GiB)
*   m8gd.xlarge (4 vCPU, 16 GiB)
*   m8gd.2xlarge (8 vCPU, 32 GiB)
*   m8gd.4xlarge (16 vCPU, 64 GiB)
*   m8gd.8xlarge (32 vCPU, 128 GiB)
*   m8gd.12xlarge (48 vCPU, 192 GiB)
*   m8gd.16xlarge (64 vCPU, 256 GiB)
*   m8gd.24xlarge (96 vCPU, 384 GiB)
*   m8gd.48xlarge (192 vCPU, 768 GiB)
*   m8gd.metal-24xl (96 vCPU, 384 GiB)
*   m8gd.metal-48xl (192 vCPU, 768 GiB)
*   m8gn.xlarge (4 vCPU, 16 GiB)
*   m8gn.2xlarge (8 vCPU, 32 GiB)
*   m8gn.4xlarge (16 vCPU, 64 GiB)
*   m8gn.8xlarge (32 vCPU, 128 GiB)
*   m8gn.12xlarge (48 vCPU, 192 GiB)
*   m8gn.16xlarge (64 vCPU, 256 GiB)
*   m8gn.24xlarge (96 vCPU, 384 GiB)
