...
# Machine configuration reference CRs {id="machine-configuration-crs_{{ context }}"}

Use the following custom resources (CRs) to configure machine settings for the telco RAN DU reference design. {._abstract}
