# Release notes for {{ pipelines_title }} Technology Preview 1.3 {id="op-release-notes-1-3_{{ context }}"}

## New features {id="new-features-1-3_{{ context }}"}
{{ pipelines_title }} Technology Preview (TP) 1.3 is now available on {{ product_title }} 4.7. {{ pipelines_title }} TP 1.3 is updated to support:

*   Tekton Pipelines 0.19.0
*   Tekton `tkn` CLI 0.15.0
*   Tekton Triggers 0.10.2
*   cluster tasks based on Tekton Catalog 0.19.0
*   {{ ibm_power_name }} Systems on {{ product_title }} 4.7
*   {{ ibm_z_name }} and {{ ibm_linuxone_name }} on {{ product_title }} 4.7

In addition to the fixes and stability improvements, the following sections highlight what is new in {{ pipelines_title }} 1.3.

### Pipelines {id="pipeline-new-features-1-3_{{ context }}"}
...
### Pipelines CLI {id="cli-new-features-1-3_{{ context }}"}
...
### Triggers {id="triggers-new-features-1-3_{{ context }}"}
...
## Deprecated features {id="deprecated-features-1-3_{{ context }}"}
