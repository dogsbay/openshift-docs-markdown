...
# Adding resource claims to pods {id="nodes-pods-allocate-dra-configure_{{ context }}"}

You can use resource claims and resource claim templates with {{ attribute_based_full }} to allow you to request your workloads to be scheduled on nodes with specific graphics processing units (GPU).  {._abstract}
