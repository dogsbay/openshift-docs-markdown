...
# Understanding overcommitment and quality of service classes {id="nodes-cluster-overcommit-qos-about_{{ context }}"}

You can use Quality of Service (QoS) classes in an overcommitted environment to help you ensure that your cluster is properly configured. {._abstract}
...
## Understanding how to reserve memory across quality of service tiers {id="qos-about-reserve_{{ context }}"}
...
{{ product_title }} uses the `qos-reserved` parameter as follows:
