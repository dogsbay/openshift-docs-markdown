...
# Default Operator install modes and behavior {id="olm-default-install-modes-behavior_{{ context }}"}

When you install Operators in {{ product_title }} by using the web console as an administrator, you can choose between single namespace and all namespaces install modes. {._abstract}
