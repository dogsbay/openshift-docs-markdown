...
# Default permissions for IAM instance profiles {id="installation-aws-permissions-iam-roles_{{ context }}"}

To ensure your cluster operates with the correct security permissions in {{ product_title }}, review the default IAM instance profiles created by the installation program. {._abstract}
