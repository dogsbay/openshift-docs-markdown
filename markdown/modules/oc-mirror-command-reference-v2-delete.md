...
# Command reference for deleting images {id="oc-mirror-command-reference-delete-v2_{{ context }}"}

You can use the `oc mirror` subcommands and flags to modify how the oc-mirror plugin v2 deletes mirrored images. {._abstract}
