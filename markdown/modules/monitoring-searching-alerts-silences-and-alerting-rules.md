...
# Searching and filtering alerts, silences, and alerting rules {id="searching-alerts-silences-and-alerting-rules_{{ context }}"}
...
## Understanding alert filters {id="understanding-alert-filters_{{ context }}"}

The **Alerts** page in the Alerting UI provides details about alerts relating to default {{ product_title }} and user-defined projects. The page includes a summary of severity, state, and source for each alert. The time at which an alert went into its current state is also shown.
...
*   **Source** filters:
    *   **Platform**. Platform-level alerts relate only to default {{ product_title }} projects. These projects provide core {{ product_title }} functionality.
...
## Understanding silence filters {id="understanding-silence-filters_{{ context }}"}

The **Silences** page in the Alerting UI provides details about silences applied to alerts in default {{ product_title }} and user-defined projects. The page includes a summary of the state of each silence and the time at which a silence ends.
...
## Understanding alerting rule filters {id="understanding-alerting-rule-filters_{{ context }}"}

The **Alerting rules** page in the Alerting UI provides details about alerting rules relating to default {{ product_title }} and user-defined projects. The page includes a summary of the state, severity, and source for each alerting rule.
...
*   **Source** filters:
    *   **Platform**. Platform-level alerting rules relate only to default {{ product_title }} projects. These projects provide core {{ product_title }} functionality.
