...
# Example configurations for pod topology spread constraints {id="nodes-scheduler-pod-topology-spread-constraints-examples_{{ context }}"}

When configuring topology spread constraints, you can specify which pods to group together, which topology domains they are spread among, and the acceptable skew. {._abstract}
