...
# Managing alerting rules for core platform monitoring {id="managing-core-platform-alerting-rules_{{ context }}"}
...
*   New alerting rules must be based on the default {{ product_title }} monitoring metrics.
...
Therefore, any dropped alerts still appear in the {{ product_title }} web console even though they are no longer forwarded to Alertmanager.
