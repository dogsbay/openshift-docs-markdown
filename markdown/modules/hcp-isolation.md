...
# Control plane isolation {id="hcp-isolation_{{ context }}"}

You can configure {{ hcp }} to isolate network traffic or control plane pods. {._abstract}
...
## Control plane pod isolation {id="hcp-cp-pod-isolation_{{ context }}"}
