...
# Getting information about alerts, silences, and alerting rules {id="getting-information-about-alerts-silences-and-alerting-rules_{{ context }}"}
...
1.  Click the name of an alert to view its **Alert details** page. The page includes a graph that illustrates alert time series data. It also provides the following information about the alert:
...
1.  Select the name of a silence to view its **Silence details** page. The page includes the following details:
    *   Alert specification
    *   Start time
    *   End time
    *   Silence state
