...
# Supported bundle formats and dependencies {id="olmv1-about-supported-bundle-formats_{{ context }}"}

To install an Operator as a cluster extension, the Operator must be packaged using the `registry+v1` bundle format. {{ olmv1 }} does not support Operators that declare dependencies by using file-based catalog properties. {._abstract}
...
{% include "./snippets/olmv1-operator-conditions-support.md" %}