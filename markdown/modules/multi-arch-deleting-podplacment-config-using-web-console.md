...
# Deleting the ClusterPodPlacementConfig object by using the web console {id="multi-architecture-deleting-podplacement-config-using-web-console_{{ context }}"}

You can create only one instance of the `ClusterPodPlacementConfig` object. If you want to recreate this object, you must first delete the existing instance. {._abstract}

You can delete this object by using the {{ product_title }} web console.
