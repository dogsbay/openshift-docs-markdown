...
# Understanding how to copy files {id="nodes-containers-copying-files-about_{{ context }}"}
...
You can also use `oc rsync` to copy source code changes into a running pod for development debugging, when the running pod supports hot reload of source files. {._abstract}
