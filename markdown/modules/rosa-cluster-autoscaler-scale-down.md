...
# Automatic node removal {id="rosa-cluster-autoscaler-scale-down_{{ context }}"}

Every 10 seconds, the cluster autoscaler checks which nodes are unnecessary in the cluster and removes them. {._abstract}
