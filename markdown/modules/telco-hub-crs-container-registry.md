...
| Registry | `idms-release.yaml` | Defines an image digest `MirrorSet` CR for {{ product_title }} release images. | No |
...
| Registry | `itms-release.yaml` | Defines an image tag `MirrorSet` CR for {{ product_title }} release images. | No |
