...
# Configuring the metadata.yaml file to exclude template fields {id="cluster-compare-exclude-metadata_{{ context }}"}

You can configure the `metadata.yaml` file to exclude fields from a comparison. Exclude fields that are irrelevant to a comparison, for example annotations or labels that are inconsequential to a cluster configuration.  {._abstract}
...
## Excluding all fields not specified in a template {id="cluster-compare-ignore-all-fields_{{ context }}"}
...
## Excluding specific fields by setting default exclusion fields {id="cluster-compare-ignore-default-fields_{{ context }}"}
...
## Excluding specific fields {id="cluster-compare-ignore-specified-fields_{{ context }}"}
...
## Excluding specific fields by setting default exclusion groups {id="cluster-compare-ignore-default-groups_{{ context }}"}
