...
# Listing parameters {id="templates-cli-parameters_{{ context }}"}

You can list template parameters on your {{ product_title }} cluster to see which values you can override before processing a template. Use the `oc process --parameters` command with a template file or uploaded template name. {._abstract}
