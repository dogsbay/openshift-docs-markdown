...
# Cluster notification severity levels {id="managed-cluster-notification-severity_{{ context }}"}

Each cluster notification has an associated severity level to help you identify notifications with the greatest impact to your business. {._abstract}
