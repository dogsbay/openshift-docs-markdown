...
# Tag your AWS VPC and subnets {id="cloud-experts-using-alb-and-waf-aws-vpc-and-subnets_{{ context }}"}

You need to tag your subnets and Virtual Private Cloud (VPC) before using these resources. {._abstract}
...
1.  Set the following variables to the proper values for your {{ product_title }} deployment:
    ```terminal
...
1.  Add a tag to your cluster’s VPC with the cluster identifier:
    ```terminal
