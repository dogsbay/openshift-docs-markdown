...
# Interacting with pipelines using the Developer perspective {id="op-interacting-with-pipelines-using-the-developer-perspective_{{ context }}"}

The **Pipelines** view in the **Developer** perspective lists all the pipelines in a project, along with the following details: {._abstract}
...
1.  Click the required pipeline to see the **Pipeline details** page.
...
1.  Optional: Click the **YAML** tab to edit the YAML file for the pipeline.
1.  Optional: Click the **Pipeline Runs** tab to see the completed, running, or failed runs for the pipeline.
...
1.  Click the **Parameters** tab to see the parameters defined in the pipeline. You can also add or edit additional parameters, as required.
1.  Click the **Resources** tab to see the resources defined in the pipeline. You can also add or edit additional resources, as required.