...
# Creating a machine pool with Capacity Reservations using the {{ rosa_cli }} {id="creating_machine_pools_cli_capres_{{ context }}"}

You can create a new machine pool with Capacity Reservations by using the {{ rosa_cli_first }}. Both On-Demand Capacity Reservations and Capacity Blocks for ML are supported. {._abstract}
