...
Create three separate self-signed Transport Layer Security (TLS) certificate key pairs and add them to your local trust store to verify that you can access the new component routes in a web browser. {._abstract}
