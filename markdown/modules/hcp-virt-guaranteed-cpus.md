...
# Requesting guaranteed CPU resources {id="hcp-virt-guaranteed-cpus_{{ context }}"}

By default, KubeVirt VMs might share their CPUs with other workloads on a node. This might impact performance of a VM. To avoid the performance impact, you can request a guaranteed CPU access for VMs. {._abstract}
