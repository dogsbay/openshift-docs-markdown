...
# Release notes for Red Hat {{ ServerlessProductName }} 1.20.0 {id="serverless-rn-1-20-0_{{ context }}"}

{{ ServerlessProductName }} 1.20.0 is now available. New features, changes, and known issues that pertain to {{ ServerlessProductName }} on {{ product_title }} are included in this topic.

## New features {id="new-features-1-20-0_{{ context }}"}
...
## Known issues {id="known-issues-1-20-0_{{ context }}"}
