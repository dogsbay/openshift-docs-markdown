...
# Release notes for Red Hat Windows Machine Config Operator 10.22.1 {id="windows-containers-release-notes-10-22-1_{{ context }}"}

Issued: 28 July 2026

You can review the release notes to learn about the bug fixes and Common Vulnerabilities and Exposures (CVEs) fixes in the Windows Machine Config Operator (WMCO) version 10.22.1. {._abstract}
...
## Bug fixes {id="windows-containers-release-notes-10-22-1-bugs_{{ context }}"}
