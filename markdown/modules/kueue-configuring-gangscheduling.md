...
# Configuring gang scheduling {id="configuring-gangscheduling_{{ context }}"}

As a cluster administrator, you can configure gang scheduling by modifying the `gangScheduling` spec in the `Kueue` custom resource (CR). {._abstract}
