...
# Private clusters in AWS {id="private-clusters-about-aws_{{ context }}"}

To create a private cluster on Amazon Web Services (AWS), you must provide an existing private VPC and subnets to host the cluster. {._abstract}
...
## Limitations {id="private-clusters-limitations-aws_{{ context }}"}
