...
# Networking reference CRs {id="networking-crs_{{ context }}"}

Use the following custom resources (CRs) to configure networking components for the telco core profile. {._abstract}
