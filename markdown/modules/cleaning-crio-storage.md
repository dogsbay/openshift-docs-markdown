...
# Cleaning CRI-O storage {id="cleaning-crio-storage_{{ context }}"}

You can manually clear the CRI-O ephemeral storage if you experience the following issues: {._abstract}
