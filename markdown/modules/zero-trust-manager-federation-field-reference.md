...
# Federation configuration field reference {id="zero-trust-manager-federation-field-reference_{{ context }}"}

This reference provides detailed information about all configuration fields available for SPIRE federation in the `SpireServer` custom resource. Use this reference when customizing your federation setup. {._abstract}
