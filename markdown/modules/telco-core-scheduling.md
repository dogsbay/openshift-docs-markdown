...
# Scheduling {id="telco-core-scheduling_{{ context }}"}

The scheduler is a cluster-wide component responsible for selecting the right node for a given workload. {._abstract}
