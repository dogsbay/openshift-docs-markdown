...
# Managing proxy certificates {id="troubleshooting-certs-manual-proxy_{{ context }}"}

Proxy certificates allow users to specify one or more custom certificate authority (CA) certificates that are used by platform components when making egress connections. {._abstract}
