...
# FlowCollector API specifications {id="network-observability-flowcollector-api-specifications_{{ context }}"}
...
## .spec.agent.ebpf.advanced.scheduling.tolerations {id="_specagentebpfadvancedschedulingtolerations"}
...
## .spec.agent.ebpf.flowFilter {id="_specagentebpfflowfilter"}
...
Description
:   `consolePlugin` defines the settings related to the {{ product_title }} Console plugin, when available.
...
## .spec.consolePlugin.advanced.scheduling.tolerations {id="_specconsolepluginadvancedschedulingtolerations"}
...
## .spec.consolePlugin.autoscaler {id="_specconsolepluginautoscaler"}
...
## .spec.consolePlugin.portNaming {id="_specconsolepluginportnaming"}
...
| `clusterName` | `string` | `clusterName` is the name of the cluster to appear in the flows data. This is useful in a multi-cluster context. When using {{ product_title }}, leave empty to make it automatically determined. |
...
## .spec.processor.advanced.scheduling.tolerations {id="_specprocessoradvancedschedulingtolerations"}
...
## .spec.processor.advanced.secondaryNetworks {id="_specprocessoradvancedsecondarynetworks"}
...
## .spec.processor.metrics {id="_specprocessormetrics"}
...
Description
:   `subnetLabels` allows to define custom labels on subnets and IPs or to enable automatic labeling of recognized subnets in {{ product_title }}, which is used to identify cluster external traffic.
...
:   `customLabels` allows you to customize subnets and IPs labeling, such as to identify cluster external workloads or web services.
    ...
    If `openShiftAutoDetect` is disabled or you are not using {{ product_title }}, it is recommended to manually configure labels for the cluster subnets, to distinguish internal traffic from external traffic. +
...
| Property | Type | Description |
| --- | --- | --- |
| `alertManager` | `object` | AlertManager configuration. This is used in the console to query silenced alerts, for displaying health information. When used in {{ product_title }} it can be left empty to use the Console API instead. [Unsupported (*)]. |
...
:   AlertManager configuration. This is used in the console to query silenced alerts, for displaying health information.
    When used in {{ product_title }} it can be left empty to use the Console API instead.
    [Unsupported (*)].
