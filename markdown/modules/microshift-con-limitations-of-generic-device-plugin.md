...
# Limitations and considerations for the Generic Device Plugin {id="microshift-limitations-of-generic-device-plugin_{{ context }}"}

The Generic Device Plugin in {{ product_title }} has limitations and considerations for exposing host devices. You can use this information to choose suitable devices, configure stable identifiers, and plan for performance. {._abstract}

## Devices not suited for the Generic Device Plugin {id="microshift-devices-not-suited-generic-device-plugin_{{ context }}"}
...
## Device identification and logging {id="microshift-device-id-logging-generic-device-plugin_{{ context }}"}
...
## Performance considerations {id="microshift-performance-considerations-generic-device-plugin_{{ context }}"}
