...
# Before updating the {{ product_title }} cluster {id="before-updating-ocp_{{ context }}"}

Before updating your cluster, you must consider several factors in order to improve the chances of performing a successful update. {._abstract}
