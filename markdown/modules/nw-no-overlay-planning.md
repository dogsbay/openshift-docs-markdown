...
# Plan underlay routing and BGP for your cluster {id="nw-no-overlay-planning_{{ context }}"}

Plan routing mode, BGP topology, and SNAT behavior so pod subnets are routable and the design scales for your cluster size. {._abstract}
