...
# Elements of a PTP domain {id="ptp-elements_{{ context }}"}

PTP uses a leader-follower hierarchy of grandmaster, boundary, and ordinary clocks to synchronize time with high precision across network nodes. {._abstract}
...
## Advantages of PTP over NTP {id="ptp-advantages-over-ntp_{{ context }}"}
