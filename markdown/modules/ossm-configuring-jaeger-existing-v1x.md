# Connecting to an existing Jaeger instance {id="ossm-configuring-jaeger-existing-v1x_{{ context }}"}
...
```yaml title="Example ServiceMeshControlPlane with external Jaeger"
