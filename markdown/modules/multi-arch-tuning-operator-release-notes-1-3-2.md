...
# Release notes for the Multiarch Tuning Operator 1.3.2 {id="multi-arch-tuning-operator-release-notes-1-3-2_{{ context }}"}

The release notes for the Multiarch Tuning Operator 1.3.2 summarize all new features and enhancements, notable technical changes, major corrections from the previous version, and any known bugs upon general availability. {._abstract}

Issued: 13 July 2026

## Bug fixes {id="multi-arch-tuning-operator-1-3-2-bug-fixes_{{ context }}"}
...
## Enhancements {id="multi-arch-tuning-operator-1-3-2-enhancements_{{ context }}"}
