...
# Ethernet device configuration object {id="nw-sriov-network-object_{{ context }}"}

You can configure an Ethernet network device by defining an `SriovNetwork` object. {._abstract}
