...
# Changes from oc-mirror plugin v1 to v2 {id="oc-mirror-migration-differences_{{ context }}"}

Before migrating from oc-mirror plugin v1 to v2, you must review the updated mirroring workflow commands, which have changed to align with the new v2 workflow. {._abstract}
