...
# Load and merge rules {id="load-and-merge-rules_{{ context }}"}

Review the rules that {{ oc_first }} uses for the loading and merging order for the CLI configuration. {._abstract}
