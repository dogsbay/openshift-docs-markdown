...
# Update recommendations and Conditional Updates {id="conditional-updates-overview_{{ context }}"}

Red&#160;Hat monitors newly released versions and update paths associated with those versions before and after they are added to supported channels. {._abstract}
