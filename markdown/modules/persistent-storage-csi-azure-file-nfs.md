...
# NFS support {id="persistent-storage-csi-azure-file-nfs_{{ context }}"}

{{ product_title }} supports the Azure File Container Storage Interface (CSI) Driver Operator with Network File System (NFS). {._abstract}
