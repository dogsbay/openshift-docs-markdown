...
# User-defined networks {id="network-observability-user-defined-networks_{{ context }}"}

Understand how you can use user-defined networks (UDN) for flexible network segmentation and leverage the Network Observability Operator to monitor these segments through dedicated labels and name filters in the traffic flow table. {._abstract}
