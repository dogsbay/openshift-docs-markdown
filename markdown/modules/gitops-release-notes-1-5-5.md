...
# Release notes for {{ gitops_title }} 1.5.5 {id="gitops-release-notes-1-5-5_{{ context }}"}

{{ gitops_title }} 1.5.5 is now available on {{ product_title }} 4.8, 4.9, 4.10, and 4.11.

## New features {id="new-features-1-5-5_{{ context }}"}

The current release adds the following improvements:

*   With this update, the bundled Argo CD has been updated to version 2.3.7.

## Fixed issues {id="fixed-issues-1-5-5_{{ context }}"}
...
## Known issues {id="known-issues-1-5-5_{{ context }}"}
