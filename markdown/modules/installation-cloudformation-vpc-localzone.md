...
# CloudFormation template for the VPC {id="installation-cloudformation-vpc-localzone_{{ context }}"}

You can use a CloudFormation template to deploy the VPC that you need for your {{ product_title }} cluster. {._abstract}
