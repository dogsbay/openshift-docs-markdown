...
# Projects and namespaces {id="rbac-projects-namespaces_{{ context }}"}

You can use projects and namespaces to organize and isolate cluster resources. These resources provide boundaries for access control, policies, quotas, and service accounts. {._abstract}
