...
# About metrics collection profiles {id="configuring-metrics-collection-profiles_{{ context }}"}

By default, Prometheus collects metrics exposed by all default metrics targets in {{ product_title }} components.
