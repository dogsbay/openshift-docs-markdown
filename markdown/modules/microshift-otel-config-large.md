...
# Select a large configuration {id="microshift-otel-config-large_{{ context }}"}

You can configure {{ microshift_short }} Observability to collect the maximum amount of performance and resource information, from the maximum number of sources, by updating the YAML file. {._abstract}
