...
# Understanding OpenJDK settings for {{ product_title }} {id="nodes-cluster-resource-configure-jdk_{{ context }}"}

You can review the following concepts to learn about how to deploy OpenJDK applications in your cluster effectively. {._abstract}
