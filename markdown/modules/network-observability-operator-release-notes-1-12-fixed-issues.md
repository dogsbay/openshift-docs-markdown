...
# Network Observability Operator 1.12 fixed issues {id="network-observability-operator-release-notes-1-12-fixed-issues_{{ context }}"}

The Network Observability Operator 1.12 release contains several fixed issues that improve performance, system status reporting, and user experience. {._abstract}
