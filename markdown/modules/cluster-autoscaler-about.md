...
# The cluster autoscaler {id="cluster-autoscaler-about_{{ context }}"}
...
## Automatic node removal {id="cluster-autoscaler-scale-down_{{ context }}"}
...
## Limitations {id="cluster-autoscaler-limitations_{{ context }}"}
...
## Interaction with other scheduling features {id="cluster-autoscaler-interaction_{{ context }}"}
