...
# Nodes with System Reserved CPU Utilization > 80% {id="nodes-dashboard-using-identify-critical-cpu"}

You can identify any nodes where the system-reserved CPU utilization is more than 80% by using the **Nodes with system reserved CPU utilization > 80%** query in the node metrics dashboard.  {._abstract}
