...
# DPDK library for use with container applications {id="nw-sriov-app-netutil_{{ context }}"}

An [optional library](https://github.com/openshift/app-netutil), `app-netutil`, provides several API methods for gathering network information about a pod from within a container running within that pod. {._abstract}
