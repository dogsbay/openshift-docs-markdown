...
# Creating subnets in Local Zones {id="installation-creating-aws-vpc-subnets-lz_{{ context }}"}

Before you configure a machine set for edge compute nodes in your {{ product_title }} cluster, you must create the subnets in {{ zone_type }}. {._abstract}
