...
# Filtering application logs at input by including or excluding the namespace or container name {id="logging-input-spec-filter-namespace-container_{{ context }}"}
