...
# Configuring the Open vSwitch log level permanently {id="configuring-ovs-log-level-permanently_{{ context }}"}

For long-term changes to the Open vSwitch (OVS) log level, you can change the log level permanently. {._abstract}
