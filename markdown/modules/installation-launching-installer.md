...
{% endif %}
{% if ibm_cloud_restricted %}
1.  Export the `OPENSHIFT_INSTALL_OS_IMAGE_OVERRIDE` variable to specify the location of the {{ op_system_first }} image by running the following command:
    ```terminal
