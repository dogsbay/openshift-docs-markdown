...
# Rule object {id="rule-object_{{ context }}"}

You can use the `Rule` object, which represents an individual compliance check, to view check details and understand why a scan result passed or failed. {._abstract}
