...
1.  Add the following telemetry URLs to an allowlist:
    | Domain | Port | Function |
    | --- | --- | --- |
    ...
    | `console.redhat.com` | 443 | Required for telemetry and {{ red_hat_lightspeed }}. |
...
1.  Add the following site reliability engineering (SRE) and management URLs to an allowlist:
    | Domain | Port | Function |
    | --- | --- | --- |
...
1.  Add the following URLs for the {{ GCP }} API endpoints to an allowlist:
    | Domain | Port | Function |
    | --- | --- | --- |
    ...
    Required Google APIs can be exposed using the [Private Google Access restricted virtual IP (VIP)](https://cloud.google.com/vpc-service-controls/docs/restricted-vip-services), with the exception of the Service Usage API (serviceusage.googleapis.com). To circumvent this, you must expose the Service Usage API using the [Private Google Access private VIP](https://cloud.google.com/vpc/docs/configure-private-google-access#domain-options).
