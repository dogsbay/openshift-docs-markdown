...
## Importance of network health monitoring {id="importance-of-network-health-monitoring_{{ context }}"}
...
## Automated health monitoring {id="detection-of-network-issues_{{ context }}"}
...
*   Automated alerting: Integrates with the {{ product_title }} monitoring stack.
...
## Network health monitoring workflow {id="network-health-monitoring-workflow_{{ context }}"}
...
*   Monitoring alerts in the {{ product_title }} web console in the **Observe** → **Alerting** and **Observe** → **Network Health** views.
