...
# EgressIP object {id="nw-egress-ips-object_{{ context }}"}

You can view YAML files to better understand how you can effectively configure an `EgressIP` object to better meet your needs. {._abstract}
