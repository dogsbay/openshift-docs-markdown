...
# Sink binding reference {id="serverless-sinkbinding-reference_{{ context }}"}
...
## Subject parameter {id="serverless-sinkbinding-reference-subject-parameters_{{ context }}"}
...
## CloudEvent overrides {id="serverless-sinkbinding-reference-cloudevent-overrides_{{ context }}"}
...
## The include label {id="serverless-sinkbinding-reference-include-label_{{ context }}"}
