...
# DNS tracking {id="network-observability-dns-overview_{{ context }}"}

Monitor DNS activity by using eBPF-based DNS tracking to gain insights into query patterns, detect security threats, and troubleshoot latency issues through dedicated graphical panels in the **Overview** view. {._abstract}
