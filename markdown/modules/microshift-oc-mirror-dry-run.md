...
# Perform a dry run {id="microshift-oc-mirror-dry-run_{{ context }}"}

You can use oc-mirror to perform a dry run so that you can review the list of images to be mirrored. By using a dry run, you can catch any errors with your image set configuration early or use the generated list of images with other tools to conduct mirroring. {._abstract}
...
1.  Review the `mapping.txt` file that was generated by running the following command:
    ```terminal
