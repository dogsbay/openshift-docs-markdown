...
# About integrating Service Mesh with cert-manager and istio-csr {id="ossm-cert-manager-integration-istio_{{ context }}"}

The cert-manager tool is a solution for X.509 certificate management on Kubernetes. It delivers a unified API to integrate applications with private or public key infrastructure (PKI), such as Vault, {{ gcp_full }} Certificate Authority Service, Let’s Encrypt, and other providers.
...
*   One of these versions of cert-manager:
    *   {{ cert_manager_operator }} 1.10 or later
