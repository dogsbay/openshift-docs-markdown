...
# Federation configuration examples {id="zero-trust-manager-config-example_{{ context }}"}

The following examples demonstrate different SPIRE federation configurations. Use these as templates when setting up federation between your clusters. {._abstract}
