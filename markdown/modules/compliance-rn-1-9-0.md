...
# Release notes for OpenShift Compliance Operator 1.9.0 {id="compliance-operator-release-notes-1-9-0_{{ context }}"}

Release notes for OpenShift Compliance Operator 1.9.0. {._abstract}
...
## New features and enhancements {id="compliance-operator-1-9-0-new-features-and-enhancements_{{ context }}"}
...
## Bug fixes {id="compliance-operator-1-9-0-bug-fixes_{{ context }}"}
