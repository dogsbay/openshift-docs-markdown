...
# Outputting the data to the streams and logs {id="cloud-experts-deploying-application-logging-output-data_{{ context }}"}

Output your data to the streams and logs in the OSToy application. {._abstract}
