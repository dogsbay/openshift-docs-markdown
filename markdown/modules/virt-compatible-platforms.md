...
# Compatible platforms {id="compatible-platforms_{{ context }}"}

{{ VirtProductName }} supports bare-metal servers, ARM64-based systems, and {{ ibm_z_name }} or {{ ibm_linuxone_name }} systems in logical partitions. {._abstract}
