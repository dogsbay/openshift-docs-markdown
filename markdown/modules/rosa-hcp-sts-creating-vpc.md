...
# Creating a Virtual Private Cloud for your {{ product_title }} clusters {id="rosa-hcp-creating-vpc_{{ context }}"}

You must have a Virtual Private Cloud (VPC) to create a {{ product_title }} cluster. {._abstract}
