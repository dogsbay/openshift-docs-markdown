...
# Lab resources {id="learning-lab-overview-lab-resources_{{ context }}"}

To successfully complete the lab tutorial, review the provided reference materials. These supporting materials guide you through the required configurations and core concepts. {._abstract}

*   [OSToy application source code](https://github.com/openshift-cs/ostoy)
