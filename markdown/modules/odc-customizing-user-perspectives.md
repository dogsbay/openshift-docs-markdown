...
As a cluster administrator, you can show or hide {{ product_title }} web console perspectives, such as **Administrator** and **Developer**, for all users or for a specific user role. This lets you limit each user’s view to only the perspectives and cluster resources that are relevant to their role. {._abstract}
