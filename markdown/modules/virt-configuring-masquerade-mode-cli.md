...
# Configuring masquerade mode from the CLI {id="virt-configuring-masquerade-mode-cli_{{ context }}"}
...
connect virtual machines to the pod network backend through a Linux bridge. {._abstract}
