...
# Network observability metrics {id="network-observability-metrics_{{ context }}"}

Review the comprehensive list of network observability metrics, prefixed by `netobserv_`, which you can configure in the `FlowCollector` resource and use to monitor traffic and create Prometheus alerts. {._abstract}
