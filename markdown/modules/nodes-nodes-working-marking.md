...
# Understanding how to mark nodes as unschedulable or schedulable {id="nodes-nodes-working-marking_{{ context }}"}

You can mark a node as unschedulable in order to block any new pods from being scheduled on the node.  {._abstract}
