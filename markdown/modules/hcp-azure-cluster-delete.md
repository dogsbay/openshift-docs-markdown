...
# Deleting a hosted cluster on {{ azure_short }} {id="hcp-azure-cluster-delete_{{ context }}"}

If you are no longer using a hosted cluster on {{ azure_short }}, you can delete it. {._abstract}
