...
# Image validation stage {id="kmm-image-validation-stage_{{ context }}"}

Image validation checks whether kernel module images exist and are accessible before attempting to build or sign new images. {._abstract}
