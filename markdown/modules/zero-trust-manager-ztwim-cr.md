...
# About the ZeroTrustWorkloadIdentityManager custom resource {id="zero-trust-manager-ztwim-cr_{{ context }}"}

The `ZeroTrustWorkloadIdentityManager` is the primary custom resource that initializes the SPIRE deployments. This primary resource defines the trust domain and cluster name to help ensure secure workload identity management. {._abstract}
