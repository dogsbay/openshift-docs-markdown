...
# Enabling Advanced Audit Logging {id="spo-log-enabling_{{ context }}"}

To enable Advanced Audit Logging, configure the Audit JSON log enricher and specify a set of filters to only log user activity. {._abstract}
...
1.  Check the pods for application of the change with the following command:
    ```terminal
