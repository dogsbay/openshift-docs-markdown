...
# Performing a canary rollout update {id="update-using-custom-machine-config-pools-canary_{{ context }}"}

In some specific use cases, you might want a more controlled update process where you do not want specific nodes updated concurrently with the rest of the cluster. {._abstract}
