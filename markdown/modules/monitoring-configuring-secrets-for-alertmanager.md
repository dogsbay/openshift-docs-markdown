...
# Configuring secrets for Alertmanager {id="monitoring-configuring-secrets-for-alertmanager_{{ context }}"}

The {{ product_title }} monitoring stack includes Alertmanager, which routes alerts from Prometheus to endpoint receivers.
