# Enabling mutual Transport Layer Security (mTLS) {id="ossm-security-mtls_{{ context }}"}
...
## Enabling strict mTLS across the mesh {id="ossm-security-enabling-strict-mtls_{{ context }}"}
