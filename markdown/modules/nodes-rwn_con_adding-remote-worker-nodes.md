...
# Adding remote worker nodes {id="nodes-rwn_con_adding-remote-worker-nodes_{{ context }}"}

You can review the following information to understand some additional considerations when adding remote worker nodes to a cluster. {._abstract}
