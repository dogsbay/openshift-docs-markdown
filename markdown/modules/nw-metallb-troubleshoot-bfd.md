...
1.  Display the names of the FRR-K8s pods by running the following command:
    ...
    ```
1.  Run the following command against the `frr` container in the FRR-K8s pod to display the BFD peers:
    ```terminal
...
1.  Optional: To display detailed BFD peer information, run the following command:
    ```terminal
