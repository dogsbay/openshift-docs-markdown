# Cluster Management pods {id="cnf-du-management-pods_{{ context }}"}
...
## Core Operators {id="_core_operators"}
...
| openshift-operator-lifecycle-manager | packageserver |
| openshift-ovn-kubernetes | ovnkube-control-plane |
...
## Day 2 Operators {id="_day_2_operators"}
