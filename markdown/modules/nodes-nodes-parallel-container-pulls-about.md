...
# About configuring parallel container image pulls {id="nodes-nodes-parallel-container-pulls-about_{{ context }}"}

To help control bandwidth issues, you can configure the number of workload images that can be pulled at the same time.  {._abstract}
