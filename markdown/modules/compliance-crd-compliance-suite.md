...
# ComplianceSuite object {id="compliance-suite-object_{{ context }}"}

You can review a `ComplianceSuite` object to keep track of the state of the scans. The object has the raw settings to create scans and an overall result. {._abstract}
