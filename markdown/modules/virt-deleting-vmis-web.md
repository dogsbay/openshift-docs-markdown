...
# Deleting a standalone virtual machine instance using the web console {id="virt-deleting-vmis-web_{{ context }}"}

You can delete a standalone virtual machine instance (VMI) from the web console. {._abstract}
