...
# ComplianceRemediation object {id="compliance-remediation-object_{{ context }}"}

If a Kubernetes fix is available, the Compliance Operator creates a `ComplianceRemediation` object, which you can use to determine a way to fix a problem described in a `ComplianceCheckResult` object. {._abstract}
