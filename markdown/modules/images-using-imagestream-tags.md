...
# Image stream tags {id="images-using-imagestream-tags_{{ context }}"}

To maintain human-readable references to immutable images, utilize image stream tags within {{ product_title }}. These tags are essential because they enable your builds and deployments to accurately target specific, stable image content. {._abstract}
