...
# OpenShift CLI (oc) administrator commands {id="openshift-cli-admin_{{ context }}"}

Review the commands that cluster administrators can use to configure, maintain, and troubleshoot OpenShift Container Platform clusters. {._abstract}

## oc adm build-chain {id="_oc_adm_build-chain"}
...
## oc adm catalog mirror {id="_oc_adm_catalog_mirror"}
...
## oc adm certificate approve {id="_oc_adm_certificate_approve"}
...
## oc adm certificate deny {id="_oc_adm_certificate_deny"}
...
## oc adm copy-to-node {id="_oc_adm_copy-to-node"}
...
## oc adm cordon {id="_oc_adm_cordon"}
...
## oc adm create-bootstrap-project-template {id="_oc_adm_create-bootstrap-project-template"}
...
## oc adm create-error-template {id="_oc_adm_create-error-template"}
...
## oc adm create-login-template {id="_oc_adm_create-login-template"}
...
## oc adm create-provider-selection-template {id="_oc_adm_create-provider-selection-template"}
...
## oc adm groups add-users {id="_oc_adm_groups_add-users"}
...
## oc adm groups new {id="_oc_adm_groups_new"}
Create a new group
...
## oc adm groups prune {id="_oc_adm_groups_prune"}
...
## oc adm groups remove-users {id="_oc_adm_groups_remove-users"}
...
## oc adm groups sync {id="_oc_adm_groups_sync"}
...
## oc adm inspect {id="_oc_adm_inspect"}
...
## oc adm migrate icsp {id="_oc_adm_migrate_icsp"}
...
## oc adm migrate template-instances {id="_oc_adm_migrate_template-instances"}
...
## oc adm must-gather {id="_oc_adm_must-gather"}
...
## oc adm new-project {id="_oc_adm_new-project"}
...
## oc adm node-image create {id="_oc_adm_node-image_create"}
...
## oc adm node-image monitor {id="_oc_adm_node-image_monitor"}
...
## oc adm node-logs {id="_oc_adm_node-logs"}
...
## oc adm ocp-certificates monitor-certificates {id="_oc_adm_ocp-certificates_monitor-certificates"}
...
## oc adm ocp-certificates regenerate-leaf {id="_oc_adm_ocp-certificates_regenerate-leaf"}
...
## oc adm ocp-certificates regenerate-machine-config-server-serving-cert {id="_oc_adm_ocp-certificates_regenerate-machine-config-server-serving-cert"}
...
## oc adm ocp-certificates regenerate-top-level {id="_oc_adm_ocp-certificates_regenerate-top-level"}
...
## oc adm ocp-certificates remove-old-trust {id="_oc_adm_ocp-certificates_remove-old-trust"}
...
## oc adm ocp-certificates update-ignition-ca-bundle-for-machine-config-server {id="_oc_adm_ocp-certificates_update-ignition-ca-bundle-for-machine-config-server"}
...
## oc adm policy add-cluster-role-to-group {id="_oc_adm_policy_add-cluster-role-to-group"}
...
## oc adm policy add-cluster-role-to-user {id="_oc_adm_policy_add-cluster-role-to-user"}
...
## oc adm policy add-role-to-user {id="_oc_adm_policy_add-role-to-user"}
...
## oc adm policy add-scc-to-group {id="_oc_adm_policy_add-scc-to-group"}
...
## oc adm policy add-scc-to-user {id="_oc_adm_policy_add-scc-to-user"}
...
## oc adm policy remove-cluster-role-from-group {id="_oc_adm_policy_remove-cluster-role-from-group"}
...
## oc adm policy remove-cluster-role-from-user {id="_oc_adm_policy_remove-cluster-role-from-user"}
...
## oc adm policy scc-review {id="_oc_adm_policy_scc-review"}
...
## oc adm policy scc-subject-review {id="_oc_adm_policy_scc-subject-review"}
...
## oc adm prune builds {id="_oc_adm_prune_builds"}
...
## oc adm prune deployments {id="_oc_adm_prune_deployments"}
...
## oc adm prune groups {id="_oc_adm_prune_groups"}
Remove old OpenShift groups referencing missing records from an external provider
...
## oc adm prune images {id="_oc_adm_prune_images"}
...
## oc adm prune renderedmachineconfigs {id="_oc_adm_prune_renderedmachineconfigs"}
...
## oc adm prune renderedmachineconfigs list {id="_oc_adm_prune_renderedmachineconfigs_list"}
...
## oc adm reboot-machine-config-pool {id="_oc_adm_reboot-machine-config-pool"}
...
## oc adm release extract {id="_oc_adm_release_extract"}
...
## oc adm release info {id="_oc_adm_release_info"}
...
## oc adm release new {id="_oc_adm_release_new"}
...
## oc adm restart-kubelet {id="_oc_adm_restart-kubelet"}
...
## oc adm top images {id="_oc_adm_top_images"}
...
## oc adm top imagestreams {id="_oc_adm_top_imagestreams"}
...
## oc adm top node {id="_oc_adm_top_node"}
...
## oc adm top persistentvolumeclaims {id="_oc_adm_top_persistentvolumeclaims"}
...
## oc adm top pod {id="_oc_adm_top_pod"}
...
## oc adm uncordon {id="_oc_adm_uncordon"}
...
## oc adm upgrade {id="_oc_adm_upgrade"}
...
## oc adm verify-image-signature {id="_oc_adm_verify-image-signature"}
...
## oc adm wait-for-node-reboot {id="_oc_adm_wait-for-node-reboot"}
...
## oc adm wait-for-stable-cluster {id="_oc_adm_wait-for-stable-cluster"}
