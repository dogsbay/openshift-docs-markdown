...
The Managed Upgrade Operator (MUO) handles the scheduling, monitoring, and notifications of {{ product_title }} cluster upgrades. The MUO orchestrates the automated in-place cluster upgrades by ensuring the operating conditions are met before and after the upgrade of a managed cluster.
