...
# Example dependency resolution scenarios {id="olm-dependency-resolution-examples_{{ context }}"}

Reference example scenarios to understand how OLM prevents dependency conflicts and update deadlocks between Operators that provide or depend on the same API. {._abstract}

## Example: Deprecating dependent APIs {id="olm-dependency-resolution-examples-deprecating-dependent-APIs_{{ context }}"}
...
## Example: Version deadlock {id="olm-dependency-resolution-examples-version-deadlock_{{ context }}"}
