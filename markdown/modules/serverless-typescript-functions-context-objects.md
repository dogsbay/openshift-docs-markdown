...
# TypeScript context objects {id="serverless-typescript-functions-context-objects_{{ context }}"}
...
```javascript title="Example context object"
...
## Context object methods {id="serverless-typescript-functions-context-objects-methods_{{ context }}"}
...
```javascript title="Example context object method"
...
## Context types {id="serverless-typescript-functions-context-types_{{ context }}"}

The TypeScript type definition files export the following types for use in your functions.

```javascript title="Exported type definitions"
...
## CloudEvent data {id="serverless-typescript-functions-context-objects-cloudevent-data_{{ context }}"}
...
```javascript title="Example signature"
