...
# Workload partitioning {id="telco-ran-workload-partitioning_{{ context }}"}

Workload partitioning pins {{ product_title }} and Day 2 Operator pods that are part of the DU profile to the reserved CPU set and removes the reserved CPU from node accounting. {._abstract}
...
Description
:   Workload partitioning pins {{ product_title }} and Day 2 Operator pods that are part of the DU profile to the reserved CPU set and removes the reserved CPU from node accounting.
