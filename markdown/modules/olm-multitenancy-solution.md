...
# Recommended solution for multitenant clusters {id="olm-multitenancy-solution_{{ context }}"}

While a **Multinamespace** install mode does exist, it is supported by very few Operators. As a middle ground solution between the standard **All namespaces** and **Single namespace** install modes, you can install multiple instances of the same Operator, one for each tenant. {._abstract}
...
## Limitations and considerations {id="_limitations_and_considerations"}
