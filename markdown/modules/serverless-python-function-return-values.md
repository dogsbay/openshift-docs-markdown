...
# Python function return values {id="serverless-python-function-return-values_{{ context }}"}

Functions can return any value supported by [Flask](https://flask.palletsprojects.com/en/1.1.x/quickstart/#about-responses). This is because the invocation framework proxies these values directly to the Flask server.
...
## Returning CloudEvents {id="serverless-python-function-return-values-returning-events_{{ context }}"}
