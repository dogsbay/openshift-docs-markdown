...
# Kubernetes API audit log output {id="spo-log-kube-api-out_{{ context }}"}

The Kubernetes API audit log output is YAML. It includes the `SPO_EXEC_REQUEST_UID` field that provides the correlation key for searching the Advanced Audit Logging output. {._abstract}
