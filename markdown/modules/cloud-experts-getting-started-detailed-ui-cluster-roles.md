...
# Creating account wide roles {id="cloud-experts-getting-started-detailed-ui-cluster-roles_{{ context }}"}

You create your account wide roles to create your cluster by using the {{ rosa_cli_first }} tool. {._abstract}
...
If this is the _first time_ you are deploying {{ product_title }} in this account and you have _not_ yet created the account roles, create the account-wide roles and policies, including the Operator policies.
