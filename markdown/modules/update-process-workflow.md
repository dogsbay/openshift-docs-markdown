...
# Update process workflow {id="update-process-workflow_{{ context }}"}

When you initiate a cluster update, the Cluster Version Operator (CVO) begins a specific sequence of events to orchestrate the update. {._abstract}

The following steps represent a detailed workflow of the {{ product_title }} update process:
