...
# Configuring the Open vSwitch log level temporarily {id="configuring-ovs-log-level-temp_{{ context }}"}
...
In addition, the configuration change does not persist whenever you reboot the node. {._abstract}
