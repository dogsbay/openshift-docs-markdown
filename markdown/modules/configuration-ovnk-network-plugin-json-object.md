...
# OVN-Kubernetes network plugin JSON configuration table {id="configuration-ovnk-network-plugin-json-object_{{ context }}"}

The OVN-Kubernetes network plugin JSON configuration object describes the configuration parameters for the OVN-Kubernetes CNI network plugin. {._abstract}
