...
# About the --cache-dir and --workspace flags {id="oc-mirror-about-cache-and-workspace-dirs_{{ context }}"}

You can use the `--cache-dir` flag to specify a directory where the oc-mirror plugin stores a persistent cache of image blobs and manifests for use during mirroring operations. {._abstract}
