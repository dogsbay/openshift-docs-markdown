...
# Workloads on schedulable control planes {id="telco-core-workloads-on-schedulable-control-planes_{{ context }}"}

You can enable schedulable control planes to run workloads on control plane nodes, utilizing idle CPU capacity on bare-metal machines. {._abstract}
