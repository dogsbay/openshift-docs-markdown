...
1.  Navigate to **Ecosystem** -> **Software Catalog**.
    ...
    1.  Select an **Update Channel** and **Approval Strategy**.
    1.  Click **Install**.
1.  On the **Installed Operators** page, click **ClusterResourceOverride**.
    ...
    1.  On the **Create ClusterResourceOverride** page, click **YAML view** and edit the YAML template to set the overcommit values as needed:
        ```yaml
...
1.  Check the current state of the admission webhook by checking the status of the cluster custom resource:
    ...
    1.  On the **ClusterResourceOverride Details** page, click **YAML**. The `mutatingWebhookConfigurationRef` section displays when the webhook is called.
        ```yaml
        apiVersion: operator.autoscaling.openshift.io/v1
        kind: ClusterResourceOverride
        metadata:
