...
# Ingress Controller sharding {id="nw-ingress-sharding_{{ context }}"}

You can use Ingress sharding, also known as _router sharding_, to distribute a set of routes across multiple routers by adding labels to routes, namespaces, or both.  {._abstract}
