...
# Network topology {id="microshift-network-topology_{{ context }}"}

OVN-Kubernetes provides an overlay-based networking implementation. This overlay includes an OVS-based implementation of `Service` and `NetworkPolicy` resources. {._abstract}
...
## Description of the connections in the network topology figure {id="microshift-description-connections-network-topology_{{ context }}"}
