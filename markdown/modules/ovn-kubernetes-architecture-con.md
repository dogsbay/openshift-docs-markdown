...
# Introduction to OVN-Kubernetes architecture {id="ovn-kubernetes-architecture-con"}

The OVN-Kubernetes architecture comprises specialized databases and daemons that process network state requests. Use this mapping to evaluate data paths and troubleshoot multi-node communication routing. {._abstract}
