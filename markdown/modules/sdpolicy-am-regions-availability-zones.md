...
# Regions and availability zones {id="regions-availability-zones_{{ context }}"}

The following regions are supported by {{ OCP }} 4 and are supported for {{ product_title }}. {._abstract}

## AWS regions and availability zones {id="aws-regions-availability-zones_{{ context }}"}
The following AWS regions are supported by {{ OCP }} 4 and are supported for {{ product_title }}:
...
## {{ gcp_full }} regions and availability zones {id="gcp-regions-availability-zones_{{ context }}"}
The following {{ gcp_full }} regions are currently supported:
