...
In the {{ logging }} 5.8 and later versions, the {{ loki_op }} supports setting pod anti-affinity rules to request that pods of the same component are scheduled on different available nodes in the cluster.
