...
# Creating a Data Protection Application for bare metal {id="hcp-dr-oadp-dpa-bm_{{ context }}"}

Automate parts of the backup and restore process on bare metal by creating a Data Protection Application (DPA). A DPA defines information including backup locations and Velero pod configurations. {._abstract}
...
1.  Create the DPA object by running the following command:
    ```terminal
