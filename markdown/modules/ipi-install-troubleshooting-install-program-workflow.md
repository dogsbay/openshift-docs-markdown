...
![Troubleshooting workflow when the `install-config.yaml` file has errors or the {{ op_system_first }} images are inaccessible](/_assets/images/flow1.png)
...
![Troubleshooting workflow for bootstrap VM issues](/_assets/images/flow2.png)
...
![Troubleshooting workflow for cluster nodes that will not PXE boot](/_assets/images/flow3.png)
...
![Troubleshooting workflow from a non-accessible API to a validated installation](/_assets/images/flow4.png)
