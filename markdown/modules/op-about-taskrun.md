# TaskRun {id="about-taskrun_{{ context }}"}
...
1.  Specifies the type of Kubernetes object. In this example, `TaskRun`.
1.  Unique name to identify this task run.
1.  Definition of the task run. For this task run, the task and the required workspace are specified.
1.  Name of the task reference used for this task run. This task run executes the `apply-manifests` task.
1.  Workspace used by the task run.