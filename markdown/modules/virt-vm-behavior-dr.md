...
# VM behavior during disaster recovery scenarios {id="virt-vm-behavior-dr_{{ context }}"}

VMs typically act similarly to pod-based workloads during both relocate and failover disaster recovery flows. {._abstract}

## Relocate {id="dr-relocate_{{ context }}"}
...
## Failover {id="dr-failover_{{ context }}"}
