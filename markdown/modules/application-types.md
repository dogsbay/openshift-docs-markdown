...
# Application types {id="application-types_{{ context }}"}

Consider how your application type influences how to run the application. 
Kubernetes defines different types of workloads that are appropriate for different kinds of applications. {._abstract}
...
Suitable {{ product_title }} objects for these types of applications include `Job` and `CronJob` objects.
