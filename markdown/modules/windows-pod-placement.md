...
# Windows pod placement {id="windows-pod-placement_{{ context }}"}

Before deploying your Windows workloads to the cluster, you must configure your Windows node scheduling so pods are assigned correctly.  {._abstract}
