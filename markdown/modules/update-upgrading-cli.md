...
# Updating a cluster by using the CLI {id="update-upgrading-cli_{{ context }}"}

You can use the {{ oc_first }} to review and request cluster updates. {._abstract}
...
*   You installed the {{ oc_first }} that matches the version for your updated version.
