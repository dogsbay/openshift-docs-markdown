...
1.  Download the Knative (`kn`) CLI from the **Command Line Tools** page. You can access the **Command Line Tools** page by clicking the ![question-circle](/images/question-circle.png "Help") icon in the top right corner of the web console and selecting **Command Line Tools** in the list.
