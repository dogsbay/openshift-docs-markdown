...
# Resource management and performance considerations {id="network-observability-resource-recommendations_{{ context }}"}

Review the key configuration settings, including eBPF sampling, feature enablement, and resource limits, necessary to manage performance criteria and optimize resource consumption for network observability. {._abstract}
