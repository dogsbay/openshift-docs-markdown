...
# The risk of conditional updates {id="update-preparing-conditional_{{ context }}"}

Conditional updates are update targets flagged by the OpenShift Update Service (OSUS) as available but not recommended due to known risks that apply to your cluster. {._abstract}
