...
# Kubernetes components {id="kubernetes-components_{{ context }}"}

To effectively manage and maintain a Kubernetes cluster, you must understand its core infrastructure and control plane components. This reference details the function of each component and how they interact to run your workloads. {._abstract}
