...
You can create catalogs for your custom Operators or filter catalogs of widely available Operators. You can combine both methods to create the catalogs needed for your specific use case. To run {{ microshift_short }} with your own Operators and OLM, make a catalog by using the file-based catalog structure.
...
*   [Operator Framework packaging format](https://docs.redhat.com/en/documentation/openshift_container_platform/{{ ocp_version }}/html/operators/understanding-operators#olm-packaging-format)
