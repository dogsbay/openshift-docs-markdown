...
# Understanding how to reboot nodes running routers {id="nodes-nodes-rebooting-router_{{ context }}"}

Review the following information to learn how to reboot a node that hosts a router pod.  {._abstract}

In most cases, a pod running an {{ product_title }} router exposes a host port.
