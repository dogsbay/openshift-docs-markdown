...
# Log forwarding implementations {id="log-forwarding-implementations_{{ context }}"}
...
## Legacy implementation {id="log-forwarding-implementations-legacy_{{ context }}"}
...
## Multi log forwarder feature {id="log-forwarding-implementations-multi-clf_{{ context }}"}
