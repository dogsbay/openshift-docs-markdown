...
# Vector collector alerts {id="logging-vector-collector-alerts_{{ context }}"}

In logging 5.7 and later versions, the following alerts are generated by the Vector collector. You can view these alerts in the {{ product_title }} web console.
