...
## Considerations for using BaselineAdminNetworkPolicy {id="considerations-using-banp_{{ context }}"}
...
## Differences to consider between AdminNetworkPolicy and NetworkPolicy {id="differences-with-netpol_{{ context }}"}
