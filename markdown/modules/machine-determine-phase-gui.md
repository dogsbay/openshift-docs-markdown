...
# Determining the phase of a machine by using the web console {id="machine-determine-phase-gui_{{ context }}"}

To troubleshoot issues with a machine, you can find the phase of a machine by using the {{ product_title }} web console. {._abstract}
