...
# Network Observability Operator 1.12.2 fixed issues {id="network-observability-operator-release-notes-1-12-2-fixed-issues_{{ context }}"}

The Network Observability Operator 1.12.2 release contains several fixed issues that improve system status reporting and user experience. {._abstract}
