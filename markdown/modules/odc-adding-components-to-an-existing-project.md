...
# Adding components to an existing project {id="odc-adding-components-to-an-existing-project_{{ context }}"}
...
1.  Click **Add to Project** (![odc_add_to_project](/images/odc_add_to_project.png "Add to Project")) next to left navigation pane or press <kbd>Ctrl+Space</kbd>
