...
# {{ DTProductName }} architecture {id="distr-tracing-tempo-architecture_{{ context }}"}

{{ DTProductName }} is made up of several components that work together to collect, store, and display tracing data.

*   **{{ TempoName }}** - This component is based on the open source [Grafana Tempo project](https://grafana.com/oss/tempo/).
...
*   **{{ OTELName }}** - This component is based on the open source [OpenTelemetry project](https://opentelemetry.io/).
