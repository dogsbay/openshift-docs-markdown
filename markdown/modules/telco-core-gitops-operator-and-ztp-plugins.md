...
# GitOps Operator and {{ ztp }} plugins {id="telco-core-gitops-operator-and-ztp-plugins_{{ context }}"}

The GitOps Operator provides a GitOps-driven infrastructure for managing cluster deployment and configuration. {._abstract}
