...
# Networking {id="telco-core-networking_{{ context }}"}

The following diagram describes the telco core reference design networking configuration. {._abstract}
