...
# About performing a canary rollout update {id="update-using-custom-machine-config-pools-about_{{ context }}"}

The process of a canary update can be understood as several high-level steps. {._abstract}
