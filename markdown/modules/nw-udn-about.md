...
# About the UserDefinedNetwork CR {id="about-udn_{{ context }}"}

To create advanced network segmentation and isolation, users and administrators create `UserDefinedNetwork` (UDN) custom resource (CR)s. UDNs provide granular control over network traffic within specific namespaces. {._abstract}
