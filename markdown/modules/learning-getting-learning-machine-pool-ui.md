...
# Creating a machine pool with the UI {id="learning-getting-started-learning-machine-pool-ui_{{ context }}"}

You can create your machine pools by using {{ cluster_manager }}. {._abstract}
