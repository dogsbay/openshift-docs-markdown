...
# Configuring a secret for the Image Registry Operator {id="registry-operator-config-resources-secret-azure_{{ context }}"}
...
*   Create an {{ product_title }} secret that contains the required key.
    ```terminal
