...
# Monitoring {id="telco-core-monitoring_{{ context }}"}

The Cluster Monitoring Operator (CMO) is included by default in {{ product_title }} and provides monitoring for the platform components and optionally user projects. {._abstract}
