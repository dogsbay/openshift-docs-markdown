...
# `deploymentConfig` field reference {id="olmv1-deployment-config-reference_{{ context }}"}

Field reference for the `deploymentConfig` API including {{ olmv0 }} to {{ olmv1 }} field mappings and merge behavior for each configuration option. {._abstract}

{%- set FeatureName = "{{ olmv1 }} `deploymentConfig` API" %}
{% include "./snippets/technology-preview.md" %}

## Field mapping from {{ olmv0 }} to {{ olmv1 }} {id="olmv1-deployment-config-field-mapping_{{ context }}"}

Field conversion from {{ olmv0 }} to {{ olmv1 }}:

**{{ olmv0 }} to {{ olmv1 }} configuration field mapping**

| {{ olmv0 }} field path | {{ olmv1 }} field path | Notes |
| --- | --- | --- |
| `spec.config.env` | `spec.config.inline.deploymentConfig.env` | Environment variables are merged. {{ olmv1 }} values take precedence over bundle values. |
...
| `spec.config.selector` | Not supported | The `selector` field from {{ olmv0 }} is not supported in {{ olmv1 }}. This field was never used in {{ olmv0 }}. |

## Merge and override behavior {id="olmv1-deployment-config-merge-behavior_{{ context }}"}
...
## Environment variable fields {id="olmv1-deployment-config-env-reference_{{ context }}"}
...
## Resource requirements fields {id="olmv1-deployment-config-resources-reference_{{ context }}"}
...
## Node placement fields {id="olmv1-deployment-config-node-placement-reference_{{ context }}"}
...
## Storage fields {id="olmv1-deployment-config-storage-reference_{{ context }}"}
...
## Metadata fields {id="olmv1-deployment-config-metadata-reference_{{ context }}"}
