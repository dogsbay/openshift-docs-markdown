...
# Lab resources {id="cloud-experts-deploying-application-lab-overview_{{ context }}"}

The following section lists all of the various resources that are used in this lab. {._abstract}

*   [Source code for the OSToy application](https://github.com/openshift-cs/ostoy)
