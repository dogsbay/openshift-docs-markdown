...
# Using the Repository custom resource definition (CRD) with {{ pac }} {id="using-repository-crd-with-pipelines-as-code_{{ context }}"}

The `Repository` custom resource (CR) has the following primary functions: {._abstract}
