...
# About machine health checks {id="machine-health-checks-about_{{ context }}"}

You can use machine health checks to detect and remediate unhealthy machines automatically, limiting disruption to the targeted machine pool. {._abstract}
...
## Limitations when deploying machine health checks {id="machine-health-checks-limitations_{{ context }}"}
