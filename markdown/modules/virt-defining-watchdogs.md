...
# About watchdogs {id="virt-defining-watchdogs_{{ context }}"}

Watchdog devices monitor guest operating system responsiveness and trigger recovery actions when a virtual machine becomes unresponsive. {._abstract}
