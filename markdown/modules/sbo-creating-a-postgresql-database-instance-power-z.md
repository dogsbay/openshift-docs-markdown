...
# Creating a PostgreSQL database instance {id="sbo-creating-a-postgresql-database-instance-power-z_{{ context }}"}

To create a PostgreSQL database instance, you must create a `Database` custom resource (CR) and configure the database. {._abstract}
