...
# About VM boot sources {id="virt-about-vms-and-boot-sources_{{ context }}"}

Virtual machines (VMs) consist of a VM definition and one or more disks that are backed by data volumes. VM templates enable you to create VMs using predefined specifications. {._abstract}
