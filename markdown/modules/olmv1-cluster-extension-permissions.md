...
# Cluster extension permissions {id="olmv1-cluster-extension-permissions_{{ context }}"}

In {{ olmv0_first }}, a single service account with cluster administrator privileges manages all cluster extensions. {._abstract}
...
{% include "./snippets/olmv1-manual-rbac-scoping-admonition.md" %}
