...
# Creating restore hooks {id="oadp-creating-restore-hooks_{{ context }}"}

Create restore hooks to run commands in a container in a pod by editing the `Restore` custom resource (CR). {._abstract}
