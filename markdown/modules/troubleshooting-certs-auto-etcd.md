...
# Certificates managed by etcd {id="troubleshooting-certs-auto-etcd_{{ context }}"}
...
For example, communication can be lost during an upgrade due to nodes rebooting at different times. {._abstract}
