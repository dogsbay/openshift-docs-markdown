...
# Connectivity considerations when populating a mirror registry {id="microshift-connectivity-considerations_{{ context }}"}

When you populate your mirror registry, you can use connected or disconnected mirroring depending on your use case. {._abstract}
