...
# Creating the configuration inputs {id="installing-ocp-agent-basic-inputs_{{ context }}"}

Create the configuration files that are used by the installation program to generate the agent image. {._abstract}
