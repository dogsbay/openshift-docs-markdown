...
# Using advanced Rsync features {id="nodes-containers-copying-files-rsync_{{ context }}"}

You can use the additional command-line options that are available with the standard `rsync` command if needed.  {._abstract}
