...
# Nodes with CRI-O system reserved CPU utilization > 50% {id="nodes-dashboard-using-identify-critical-cpu-crio"}

You can identify any nodes where the CRI-O system-reserved CPU utilization has exceeded 50% in the last 5 minutes by using the **Nodes with CRI-O system reserved CPU utilization > 50%** query in the node metrics dashboard. {._abstract}
