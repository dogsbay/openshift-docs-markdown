...
# About using the Vertical Pod Autoscaler Operator {id="nodes-pods-vertical-autoscaler-using-about_{{ context }}"}

To use the {{ product_title }} Vertical Pod Autoscaler Operator (VPA) to help you maintain the optimal CPU and memory usage for your pods, you create a VPA custom resource (CR) for a workload object in your cluster.  {._abstract}
...
## Changing the VPA minimum value {id="nodes-pods-vertical-autoscaler-using-one-pod_{{ context }}"}
...
## Automatically applying VPA recommendations {id="nodes-pods-vertical-autoscaler-using-auto_{{ context }}"}
...
## Automatically applying VPA recommendations on pod creation {id="nodes-pods-vertical-autoscaler-using-pod_{{ context }}"}
...
## Manually applying VPA recommendations {id="nodes-pods-vertical-autoscaler-using-manual_{{ context }}"}
...
## Exempting containers from applying VPA recommendations {id="nodes-pods-vertical-autoscaler-using-exempt_{{ context }}"}
