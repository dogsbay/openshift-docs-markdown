...
# Hosted cluster and node pool version skew policy {id="hcp-np-version-skew_{{ context }}"}

In {{ hcp }}, ensure that you use a node pool version that is supported with your hosted cluster version. {._abstract}
