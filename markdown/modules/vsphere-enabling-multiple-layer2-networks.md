...
# Enabling a multiple layer 2 network for your cluster {id="vsphere-enabling-multiple-layer2-network_{{ context }}"}

You can configure your cluster to use a multiple layer 2 network configuration so that data transfer among nodes can span across multiple networks. {._abstract}
