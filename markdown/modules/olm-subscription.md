...
# Subscription {id="olm-subscription_{{ context }}"}

A _subscription_, defined by a `Subscription` object, represents an intention to install an Operator. It is the custom resource that relates an Operator to a catalog source. {._abstract}
