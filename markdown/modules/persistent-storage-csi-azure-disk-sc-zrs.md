...
# Creating a storage class with storage account type {id="persistent-storage-csi-azure-disk-sc-zrs_{{ context }}"}

To provision persistent volumes with specific performance and redundancy characteristics, create a storage class that designates an Azure storage account type corresponding to your SKU tier. {._abstract}
