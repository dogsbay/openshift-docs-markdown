...
# About assuming AWS IAM roles in your own pods {id="assuming-an-aws-iam-role-in-your-own-pods_{{ context }}"}

You can enable a service account to assume an AWS Identity and Access Management (IAM) role in a pod deployed in a user-defined project. {._abstract}
