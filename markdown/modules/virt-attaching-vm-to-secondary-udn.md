...
# Attaching a virtual machine to secondary user-defined networks by using the CLI {id="virt-attaching-vm-to-secondary-udn_{{ context }}"}

You can connect a virtual machine (VM) to multiple secondary cluster-scoped user-defined networks (CUDNs) by configuring the interface binding. {._abstract}
