...
# Verifying the queue status {id="verifying-queue-status_{{ context }}"}

To ensure that your performance profile changes are active, verify the queue status.  {._abstract}
