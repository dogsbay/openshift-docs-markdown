...
# Annotations for automatically pruning task runs and pipeline runs {id="annotations-for-automatic-pruning-taskruns-pipelineruns_{{ context }}"}
...
```yaml title="Example of auto-pruning annotations"
kind: Namespace
apiVersion: v1
# ...
spec:
