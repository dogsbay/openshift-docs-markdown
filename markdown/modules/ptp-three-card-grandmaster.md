...
# 3-card Intel E810 PTP grandmaster clock {id="ptp-three-card-grandmaster_{{ context }}"}

{{ product_title }} supports cluster hosts with 3 Intel E810 NICs as PTP grandmaster clocks (T-GM). {._abstract}
