...
# About the API audit log {id="nodes-pods-audit-log-basic_{{ context }}"}

Audit works at the API server level, logging all requests coming to the server. Each audit log contains the following information: {._abstract}
