...
# Updating security content {id="compliance-update_{{ context }}"}

Track `ProfileBundle` updates accurately and ensure predictable compliance profile versions across cluster deployments, by using container image digests instead of tags. {._abstract}
