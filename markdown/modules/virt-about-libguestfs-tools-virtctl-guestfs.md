...
# Libguestfs and virtctl guestfs commands {id="virt-about-libguestfs-tools-virtctl-guestfs_{{ context }}"}

`Libguestfs` tools help you access and modify virtual machine (VM) disk images. You can use `libguestfs` tools to view and edit files in a guest, clone and build virtual machines, and format and resize disks. {._abstract}
