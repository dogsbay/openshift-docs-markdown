...
Use the {{ op_system_base }} documentation in "Using image mode for RHEL to build, deploy, and manage operating systems" to understand the full details of using {{ op_system_image }}.
