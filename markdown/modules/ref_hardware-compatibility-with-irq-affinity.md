...
# Hardware compatibility with IRQ affinity {id="ref_hardware-compatibility-with-irq-affinity_{{ context }}"}
...
{{ product_title }} supports the following hardware devices for dynamic load balancing:
