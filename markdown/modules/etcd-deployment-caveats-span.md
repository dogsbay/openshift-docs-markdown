...
# Deployment caveats for spanned clusters {id="deployment-caveats-span_{{ context }}"}

Review the guidance about the general aspects of a cluster deployment that spans data centers.  {._abstract}
