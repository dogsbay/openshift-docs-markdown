...
# Sample YAML for a Cluster API compute machine set resource on {{ gcp_full }} {id="capi-yaml-machine-set-gcp_{{ context }}"}
...
:   Specifies the failure domain within the {{ gcp_short }} region.