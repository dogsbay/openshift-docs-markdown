...
# FRR configurations {id="nw-metallb-configuring-frr-k8s-configurations_{{ context }}"}

You can create multiple `FRRConfiguration` CRs to use `FRR` services in `MetalLB`. {._abstract}
