...
# Release notes for OpenShift Compliance Operator 0.1.44 {id="compliance-operator-release-notes-0-1-44_{{ context }}"}

Release notes for OpenShift Compliance Operator 0.1.44. {._abstract}
...
## New features and enhancements {id="compliance-operator-0-1-44-new-features-and-enhancements_{{ context }}"}
...
## Templating and variable use {id="openshift-compliance-operator-0-1-44-templating_{{ context }}"}
...
## Bug fixes {id="openshift-compliance-operator-0-1-44-bug-fixes_{{ context }}"}
