...
# Kafka compression codec reference {id="network-observability-kafka-compression-codec-reference_{{ context }}"}

Compare Kafka compression codecs to choose the optimal algorithm for your environment. {._abstract}
