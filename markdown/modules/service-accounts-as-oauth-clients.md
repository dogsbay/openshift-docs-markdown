...
# About service accounts as OAuth clients {id="service-accounts-as-oauth-clients_{{ context }}"}

You can configure a service account to function as a constrained OAuth client that can request a limited subset of scopes. {._abstract}
