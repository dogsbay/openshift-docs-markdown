...
# Creating a cluster with automatic mode {id="cloud-experts-getting-start-detailed-cli-deployment-automatic_{{ context }}"}

Use this method if you want the {{ rosa_cli }} to automate the creation of the roles and policies to create your cluster quickly. If this is the _first time_ you are deploying {{ product_title }} in this account and you have _not_ yet created the account roles, then create the account-wide roles and policies, including Operator policies. {._abstract}
