...
# Kubernetes API log compared to Advanced Audit Logging output {id="spo-log-kube-api-compare_{{ context }}"}

To understand the value of Advanced Audit Logging, compare the Kubernetes API Server Audit Log to the Advanced Audit Logging output: {._abstract}
