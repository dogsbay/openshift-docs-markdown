...
# 3scale backend cache {id="threescale-backend-cache_{{ context }}"}
...
## Advantages of enabling backend cache {id="_advantages_of_enabling_backend_cache"}
...
## Trade-offs for having lower latencies {id="_trade-offs_for_having_lower_latencies"}
...
## Backend cache configuration settings {id="_backend_cache_configuration_settings"}
