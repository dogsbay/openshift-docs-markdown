...
# Example: Bonds and SR-IOV dual-NIC node network configuration {id="agent-install-sample-config-bond-sriov_{{ context }}"}

See example manifest files to better understand configuration options for deploying your cluster. {._abstract}
