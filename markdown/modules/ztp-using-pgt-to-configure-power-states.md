...
# Configuring power states using {{ policy_gen_cr }} CRs {id="ztp-using-pgt-to-configure-power-saving-states_{{ context }}"}

For low latency and high-performance edge deployments, it is necessary to disable or limit C-states and P-states. {._abstract}
