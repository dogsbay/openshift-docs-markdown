# About the custom installation {id="installation-about-custom_{{ context }}"}

You can use the {{ product_title }} installation program to customize four levels
of the program:

*   {{ product_title }} itself
*   The cluster platform
*   Kubernetes
*   The cluster operating system

Changes to {{ product_title }} and its platform are managed and supported, but
...
you customize {{ product_title }}. You can further modify the cluster platform
