...
The image streams are the {{ op_system_first }}-based {{ product_title }} image streams pointing to images on `registry.redhat.io`. Similarly, the templates are those categorized as {{ product_title }} templates.
