...
*   You are logged into an {{ product_title }} cluster as a project administrator.
...
1.  Create a route definition and save it in a file called `app-example-route.yaml`:
    ...
    `response.name`
    :   Specifies the name of the header you want to change. For a list of available headers you can set or delete, see _HTTP header configuration_.
