...
# Performing the second y-stream update {id="update-performing-the-second-y-stream-update_{{ context }}"}

After completing the first y-stream update, you must update the y-stream control plane version to the new EUS version. {._abstract}
