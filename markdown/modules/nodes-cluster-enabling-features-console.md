...
# Enabling feature sets using the web console {id="nodes-cluster-enabling-features-console_{{ context }}"}

You can use the {{ product_title }} web console to enable feature sets for all of the nodes in a cluster by editing the `FeatureGate` custom resource (CR). Completing this task enables non-default features in your cluster. {._abstract}
