...
# 2-card E810 NIC configuration reference {id="ptp-dual-nics_{{ context }}"}

{{ product_title }} supports single and dual-NIC Intel E810 hardware for PTP timing in grandmaster clocks (T-GM) and boundary clocks (T-BC). {._abstract}
