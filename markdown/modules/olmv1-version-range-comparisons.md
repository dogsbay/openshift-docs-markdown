...
# Version comparison strings {id="olmv1-version-range-comparisons_{{ context }}"}

To define a version range for a cluster extension, add a comparison string to the custom resource (CR) of the extension. {._abstract}
