...
<tr>
  ...
  {% if not (openshift_dedicated or openshift_rosa or openshift_rosa_hcp) %}<td>✅^[3]^</td>{% endif %}
</tr>
<tr>
  {% if not (openshift_dedicated or openshift_rosa or openshift_rosa_hcp) %}<td>✅^[3]^</td>{% endif %}
  {% if not (openshift_dedicated or openshift_rosa or openshift_rosa_hcp) %}<td>✅</td>{% endif %}
...
<tr>
  {% if not (openshift_dedicated or openshift_rosa or openshift_rosa_hcp) %}<td>✅ ^[4]^</td>{% endif %}
  ...
  {% if not (openshift_dedicated or openshift_rosa or openshift_rosa_hcp) %}<td>✅^[5]^</td>{% endif %}
</tr>
<tr>
  {% if not (openshift_dedicated or openshift_rosa or openshift_rosa_hcp) %}<td>✅^[6]^</td>{% endif %}
  {% if not (openshift_dedicated or openshift_rosa or openshift_rosa_hcp) %}<td>✅^[7]^</td>{% endif %}
</tr>
</tbody>
</table>
