...
# About CNI chaining {id="cnf-about-cni-chaining_{{ context }}"}

CNI plugin chaining allows pods to use multiple network interfaces. This enables advanced configurations such as traffic isolation and prioritized routing through granular traffic policies. {._abstract}
