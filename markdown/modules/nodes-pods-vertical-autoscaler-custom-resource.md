...
# Example custom resources for the Vertical Pod Autoscaler {id="nodes-pods-vertical-autoscaler-custom-resource_{{ context }}"}

You can use the Vertical Pod Autoscaler Operator (VPA) to update custom resources that manage pods, not just built-in resources such as deployments or stateful sets. {._abstract}
