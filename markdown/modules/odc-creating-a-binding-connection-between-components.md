...
# Creating a binding connection between components {id="odc-creating-a-binding-connection-between-components_{{ context }}"}
...
*   You installed {{ servicebinding_title }} from the software catalog.
