...
# Quota enforcement {id="quota-enforcement_{{ context }}"}

Track project resource usage, such as compute and storage, and automatically deny modifications that exceed defined limits to prevent quota violations. {._abstract}
