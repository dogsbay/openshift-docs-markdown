...
# Docker strategy {id="builds-docker-strategy_{{ context }}"}
...
To prevent the contents of input secrets and config maps from appearing in the build output container images and avoid this removal process altogether, [use build volumes](/cicd/builds/build-strategies#builds-using-build-volumes_build-strategies-docker) in your Docker build strategy instead.
