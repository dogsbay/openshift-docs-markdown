...
# About the Elasticsearch log store {id="cluster-logging-about-es-logstore_{{ context }}"}
...
See the [Elasticsearch documentation](https://www.elastic.co/guide/en/elasticsearch/guide/current/hardware.html) for considerations involved in configuring storage.
