...
# Example: Bond interface node network configuration policy {id="virt-example-bond-nncp_{{ context }}"}

You can create a bond interface on nodes in the cluster by applying a `NodeNetworkConfigurationPolicy` manifest to the cluster. {._abstract}
