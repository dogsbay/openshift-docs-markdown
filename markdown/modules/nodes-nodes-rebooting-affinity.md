...
# Rebooting a node using pod anti-affinity {id="nodes-nodes-rebooting-affinity_{{ context }}"}

You can use pod anti-affinity to spread the workloads on a node to other nodes before performing a graceful node restart. {._abstract}
