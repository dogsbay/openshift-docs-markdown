...
# Monitoring the cluster update {id="update-monitoring-the-cluster-update_{{ context }}"}

You should check the cluster health often during the update.
Check for the node status, cluster Operators status and failed pods. {._abstract}
