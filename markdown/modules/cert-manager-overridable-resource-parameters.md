...
# Overridable resource parameters for the cert-manager components {id="cert-manager-overridable-resource-parameters_{{ context }}"}

You can configure the CPU and memory request and limits for the cert-manager components in the `CertManager` CR to control resource consumption for the controller, webhook, and cainjector pods. {._abstract}
