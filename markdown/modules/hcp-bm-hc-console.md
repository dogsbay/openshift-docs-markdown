...
# Creating a hosted cluster on bare metal by using the console {id="hcp-bm-hc-console_{{ context }}"}

Instead of using the command-line interface to create a hosted cluster on bare metal, you can also use the {{ product_title }} web console. {._abstract}
