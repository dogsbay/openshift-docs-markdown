...
# Uninstalling the {{ pipelines_title }} Operator {id="op-uninstalling-the-pipelines-operator_{{ context }}"}

You can uninstall the {{ pipelines_title }} Operator by using the **Administrator** perspective in the web console.
