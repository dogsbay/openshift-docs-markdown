...
# Overview of CSI volume cloning {id="persistent-storage-csi-cloning-overview_{{ context }}"}

You can use Container Storage Interface (CSI) volume clones to create point-in-time duplicates of existing persistent volumes.  {._abstract}
...
## Support limitations {id="_support_limitations"}

By default, {{ product_title }} supports CSI volume cloning with these limitations:
