...
# Creating the namespace-scoped PodPlacementConfig object {id="multi-arch-creating-namespace-podplacement-config_{{ context }}"}

After creating the `ClusterPodPlacementConfig` object, you can configure pod placement at the namespace level by creating namespace-scoped `PodPlacementConfig` objects. {._abstract}
