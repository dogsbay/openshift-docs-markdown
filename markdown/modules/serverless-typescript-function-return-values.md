...
# TypeScript function return values {id="serverless-typescript-function-return-values_{{ context }}"}
...
## Returning headers {id="serverless-typescript-function-return-values-headers_{{ context }}"}
...
## Returning status codes {id="serverless-typescript-function-return-values-status-codes_{{ context }}"}
