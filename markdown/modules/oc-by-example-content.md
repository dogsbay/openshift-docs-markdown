...
# OpenShift CLI (oc) developer commands {id="openshift-cli-developer_{{ context }}"}

Review the commands that developers can use to create, deploy, and manage applications on OpenShift Container Platform clusters. {._abstract}

## oc annotate {id="_oc_annotate"}
...
## oc api-resources {id="_oc_api-resources"}
...
## oc api-versions {id="_oc_api-versions"}
...
## oc apply edit-last-applied {id="_oc_apply_edit-last-applied"}
...
## oc apply set-last-applied {id="_oc_apply_set-last-applied"}
...
## oc apply view-last-applied {id="_oc_apply_view-last-applied"}
...
## oc auth can-i {id="_oc_auth_can-i"}
...
## oc auth reconcile {id="_oc_auth_reconcile"}
...
## oc auth whoami {id="_oc_auth_whoami"}
...
## oc cancel-build {id="_oc_cancel-build"}
...
## oc cluster-info {id="_oc_cluster-info"}
...
## oc cluster-info dump {id="_oc_cluster-info_dump"}
...
## oc completion {id="_oc_completion"}
...
## oc config current-context {id="_oc_config_current-context"}
...
## oc config delete-cluster {id="_oc_config_delete-cluster"}
...
## oc config delete-context {id="_oc_config_delete-context"}
...
## oc config delete-user {id="_oc_config_delete-user"}
...
## oc config get-clusters {id="_oc_config_get-clusters"}
...
## oc config get-contexts {id="_oc_config_get-contexts"}
...
## oc config get-users {id="_oc_config_get-users"}
...
## oc config new-admin-kubeconfig {id="_oc_config_new-admin-kubeconfig"}
...
## oc config new-kubelet-bootstrap-kubeconfig {id="_oc_config_new-kubelet-bootstrap-kubeconfig"}
...
## oc config refresh-ca-bundle {id="_oc_config_refresh-ca-bundle"}
...
## oc config rename-context {id="_oc_config_rename-context"}
...
## oc config set {id="_oc_config_set"}
...
## oc config set-cluster {id="_oc_config_set-cluster"}
...
## oc config set-context {id="_oc_config_set-context"}
...
## oc config set-credentials {id="_oc_config_set-credentials"}
...
## oc config unset {id="_oc_config_unset"}
...
## oc config use-context {id="_oc_config_use-context"}
...
## oc config view {id="_oc_config_view"}
...
## oc create build {id="_oc_create_build"}
Create a new build
...
## oc create clusterresourcequota {id="_oc_create_clusterresourcequota"}
...
## oc create clusterrole {id="_oc_create_clusterrole"}
...
## oc create clusterrolebinding {id="_oc_create_clusterrolebinding"}
...
## oc create configmap {id="_oc_create_configmap"}
...
## oc create cronjob {id="_oc_create_cronjob"}
...
## oc create deployment {id="_oc_create_deployment"}
...
## oc create deploymentconfig {id="_oc_create_deploymentconfig"}
...
## oc create identity {id="_oc_create_identity"}
...
## oc create imagestream {id="_oc_create_imagestream"}
...
## oc create imagestreamtag {id="_oc_create_imagestreamtag"}
...
## oc create ingress {id="_oc_create_ingress"}
...
## oc create job {id="_oc_create_job"}
...
## oc create namespace {id="_oc_create_namespace"}
...
## oc create poddisruptionbudget {id="_oc_create_poddisruptionbudget"}
...
## oc create priorityclass {id="_oc_create_priorityclass"}
...
## oc create quota {id="_oc_create_quota"}
...
## oc create role {id="_oc_create_role"}
...
## oc create rolebinding {id="_oc_create_rolebinding"}
...
## oc create route edge {id="_oc_create_route_edge"}
...
## oc create route passthrough {id="_oc_create_route_passthrough"}
...
## oc create route reencrypt {id="_oc_create_route_reencrypt"}
...
## oc create secret docker-registry {id="_oc_create_secret_docker-registry"}
...
## oc create secret generic {id="_oc_create_secret_generic"}
...
## oc create secret tls {id="_oc_create_secret_tls"}
Create a TLS secret
...
## oc create service clusterip {id="_oc_create_service_clusterip"}
...
## oc create service externalname {id="_oc_create_service_externalname"}
...
## oc create service loadbalancer {id="_oc_create_service_loadbalancer"}
...
## oc create service nodeport {id="_oc_create_service_nodeport"}
...
## oc create serviceaccount {id="_oc_create_serviceaccount"}
...
## oc create token {id="_oc_create_token"}
...
## oc create user {id="_oc_create_user"}
...
## oc create useridentitymapping {id="_oc_create_useridentitymapping"}
...
## oc image append {id="_oc_image_append"}
...
## oc image extract {id="_oc_image_extract"}
...
## oc image info {id="_oc_image_info"}
...
## oc image mirror {id="_oc_image_mirror"}
...
## oc import-image {id="_oc_import-image"}
...
## oc new-project {id="_oc_new-project"}
...
## oc plugin list {id="_oc_plugin_list"}
...
## oc policy add-role-to-user {id="_oc_policy_add-role-to-user"}
...
## oc policy scc-review {id="_oc_policy_scc-review"}
...
## oc policy scc-subject-review {id="_oc_policy_scc-subject-review"}
...
## oc port-forward {id="_oc_port-forward"}
...
## oc registry login {id="_oc_registry_login"}
...
## oc rollout cancel {id="_oc_rollout_cancel"}
...
## oc rollout history {id="_oc_rollout_history"}
...
## oc rollout latest {id="_oc_rollout_latest"}
...
## oc rollout pause {id="_oc_rollout_pause"}
...
## oc rollout restart {id="_oc_rollout_restart"}
Restart a resource
...
## oc rollout resume {id="_oc_rollout_resume"}
...
## oc rollout retry {id="_oc_rollout_retry"}
...
## oc rollout status {id="_oc_rollout_status"}
...
## oc rollout undo {id="_oc_rollout_undo"}
...
## oc secrets link {id="_oc_secrets_link"}
...
## oc secrets unlink {id="_oc_secrets_unlink"}
...
## oc set build-hook {id="_oc_set_build-hook"}
...
## oc set build-secret {id="_oc_set_build-secret"}
...
## oc set deployment-hook {id="_oc_set_deployment-hook"}
...
## oc set image-lookup {id="_oc_set_image-lookup"}
...
## oc set resources {id="_oc_set_resources"}
...
## oc set route-backends {id="_oc_set_route-backends"}
...
## oc set selector {id="_oc_set_selector"}
...
## oc set serviceaccount {id="_oc_set_serviceaccount"}
...
## oc set subject {id="_oc_set_subject"}
...
## oc set triggers {id="_oc_set_triggers"}
...
## oc set volumes {id="_oc_set_volumes"}
...
## oc start-build {id="_oc_start-build"}
Start a new build
