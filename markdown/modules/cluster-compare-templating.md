...
# Configuring expected variation in a template {id="cluster-compare-templating_{{ context }}"}

You can handle variable content within a template by using Golang templating syntax. Using this syntax, you can configure validation logic that handles optional, required, and conditional content within the template.   {._abstract}
