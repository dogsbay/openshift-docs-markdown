...
# Preparing to deploy {{ hcp }} on bare metal {id="hcp-bm-prepare_{{ context }}"}

Before you deploy {{ hcp }} on bare metal, ensure that you understand the requirements for the deployment. {._abstract}
