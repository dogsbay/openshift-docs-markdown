...
# Quick start content guidelines {id="quick-start-content-guidelines_{{ context }}"}

Follow these content guidelines when writing quick starts for the {{ product_title }} web console. {._abstract}

## Card copy {id="quick-start-content-guidelines-card-copy_{{ context }}"}
...
## Introduction {id="quick-start-content-guidelines-introduction_{{ context }}"}
...
## Task steps {id="quick-start-content-guidelines-task-steps_{{ context }}"}
...
## Check your work module {id="quick-start-content-guidelines-check-your-work-module_{{ context }}"}
...
## Formatting UI elements {id="quick-start-content-guidelines-formatting-UI-elements_{{ context }}"}
