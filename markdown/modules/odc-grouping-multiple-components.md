...
# Grouping multiple components within an application {id="odc-grouping-multiple-components_{{ context }}"}
...
*   You have created and deployed minimum two or more components on {{ product_title }} using the **Developer** perspective.
