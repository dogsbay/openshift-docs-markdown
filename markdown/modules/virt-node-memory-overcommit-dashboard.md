...
# Node Memory Overcommit dashboard {id="virt-node-memory-overcommit-dashboard_{{ context }}"}

The Node Memory Overcommit dashboard displays physical and virtual memory utilization across the cluster, focusing on how virtual machines (VMs) affect node memory. {._abstract}
...
## Summary section {id="_summary_section"}
...
## Cluster section {id="_cluster_section"}
...
## Nodes section {id="_nodes_section"}
...
## System Reserved section {id="_system_reserved_section"}
...
## Workloads section {id="_workloads_section"}
...
## Interpreting the dashboard {id="_interpreting_the_dashboard"}
