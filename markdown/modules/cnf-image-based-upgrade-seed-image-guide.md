...
# Seed image guidelines {id="cnf-image-based-upgrade-seed-image-guide_{{ context }}"}

The seed image targets {{ sno }} clusters with matching hardware and configuration, requiring the seed cluster to match specific aspects of the target clusters. {._abstract}
...
*   Set of Day 2 Operators, including the {{ lcao }} and the {{ oadp_short }} Operator
