...
# Supported tags for quick starts {id="supported-tags-for-quick-starts_{{ context }}"}

Write your quick start content in markdown using these tags. The markdown is converted to HTML. {._abstract}
