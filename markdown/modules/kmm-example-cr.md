...
# Example PreflightValidationOCP resource {id="kmm-example-cr_{{ context }}"}

The example `PreflightValidationOCP` resource validates kernel modules and pushes built images to repositories. {._abstract}
