...
# HTTPRoute timeout configuration {id="httproute-timeout-configuration_{{ context }}"}
...
## Example: Request and backendRequest timeouts {id="_example_request_and_backendrequest_timeouts"}
