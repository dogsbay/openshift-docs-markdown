...
# Expose pod information to Containers using the Downward API {id="nodes-containers-projected-volumes-about_{{ context }}"}
...
information by using environment variables or a volume plugin. {._abstract}
