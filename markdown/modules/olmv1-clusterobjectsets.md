...
# ClusterObjectSets {id="olmv1-clusterobjectsets_{{ context }}"}

{%- set FeatureName = "ClusterObjectSets" %}
{% include "./snippets/technology-preview.md" %}

As part of {{ olmv1_first }}, the operator-controller creates `ClusterObjectSet` resources when you install or upgrade content with a `ClusterExtension` object. `ClusterObjectSet` objects enable safe, phased rollouts of Kubernetes resources.  {._abstract}
