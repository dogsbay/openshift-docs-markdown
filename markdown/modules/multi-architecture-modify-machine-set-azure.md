...
# Adding a multi-architecture compute machine set to your Azure cluster {id="multi-architecture-modify-machine-set-azure_{{ context }}"}
...
1.  Create a YAML file and add the configuration to create a compute machine set to control the 64-bit ARM or 64-bit x86 compute nodes in your cluster.
    ```yaml title="Example MachineSet object for an {{ azure_short }} 64-bit ARM or x86 compute node"
