...
# Supported identity providers {id="supported-identity-providers_{{ context }}"}
...
<tr>
  ...
  <td>Configure the <code>keystone</code> identity provider to integrateyour {{ product_title }} cluster with Keystone to enable shared authentication withan OpenStack Keystone v3 server configured to store users in an internaldatabase.</td>
</tr>
<tr>
