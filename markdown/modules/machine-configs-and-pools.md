# Machine Configs and Machine Config Pools {id="machine-configs-and-pools_{{ context }}"}
...
1.  The user defined configuration.
1.  The Machine Config Pool selector to apply the KubeletConfig to.