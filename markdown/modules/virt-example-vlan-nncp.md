...
# Example: VLAN interface node network configuration policy {id="virt-example-vlan-nncp_{{ context }}"}

You can create a VLAN interface on nodes in the cluster by applying a `NodeNetworkConfigurationPolicy` manifest to the cluster. {._abstract}
