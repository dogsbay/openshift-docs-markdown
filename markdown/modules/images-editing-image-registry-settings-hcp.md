...
# Editing image registry settings for {{ product_title }} {id="images-editing-image-registry-settings-hcp_{{ context }}"}

You can change the image registry config with the `rosa edit` command. {._abstract}
