...
# Creating the ImageContentSourcePolicy object {id="olm-mirror-catalog-icsp_{{ context }}"}

To make mirrored Operator images available to a disconnected cluster, you can create an `ImageContentSourcePolicy` object that redirects image references to your mirror registry. {._abstract}
