...
You must meet several prerequisites before updating a cluster in a disconnected environment. {._abstract}

The following prerequisites must be met:

*   You must have the `oc` command-line interface (CLI) tool installed.
*   You must provision a local container image registry with the container images for your update, as described in "Mirroring {{ product_title }} images".
