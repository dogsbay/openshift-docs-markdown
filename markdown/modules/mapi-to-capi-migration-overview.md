...
# Machine API to Cluster API resource migration {id="mapi-to-capi-migration-overview_{{ context }}"}

On clusters that support migrating Machine API resources to Cluster API resources, a two-way synchronization controller creates the Cluster API resources in the `openshift-cluster-api` namespace. {._abstract}
