...
# kn func invoke optional parameters {id="serverless-kn-func-invoke-reference_{{ context }}"}
...
## Main parameters {id="serverless-kn-func-invoke-main-parameters_{{ context }}"}
...
## Example commands {id="serverless-kn-func-invoke-example-commands_{{ context }}"}
...
### Specifying the file with data {id="serverless-kn-func-invoke-example-commands-specifying-file-with-data_{{ context }}"}
...
### Specifying the function project {id="serverless-kn-func-invoke-example-commands-specifying-function-project_{{ context }}"}
...
### Specifying where the target function is deployed {id="serverless-kn-func-invoke-example-commands-specifying-where-function-is-deployed_{{ context }}"}
