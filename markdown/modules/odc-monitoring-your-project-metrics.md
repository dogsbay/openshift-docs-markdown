...
# Monitoring your project metrics {id="odc-monitoring-your-project-metrics_{{ context }}"}
...
1.  Optional: Use the **Metrics** tab to query for the required project metric.
    ...
    **Figure 1. Monitoring metrics**
    ...
    1.  Use the drop-down list to set a time range for the data being displayed. You can click **Reset Zoom** to reset it to the default time range.
    1.  Optional: In the **Select Query** list, select **Custom Query** to create a custom Prometheus query and filter relevant metrics.
