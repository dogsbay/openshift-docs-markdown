...
# NFD core configuration parameters {id="nfd-configuring-core_{{ context }}"}

The following core configuration parameters control Node Feature Discovery (NFD) feature detection intervals, label filtering, and publishing behavior across all feature sources. {._abstract}
