...
# Creating a new project using the web console {id="learning-deploying-application-deployment-new-project-ui_{{ context }}"}

You can use {{ cluster_manager }} to create a new project. {._abstract}
