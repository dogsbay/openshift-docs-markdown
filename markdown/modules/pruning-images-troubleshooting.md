...
# Image pruning issues {id="pruning-images-troubleshooting_{{ context }}"}

Identify the image pruning issues in your cluster to diagnose unpruned images, manage tag revision thresholds, and fix connection or certificate authority errors between the CLI client and registry. {._abstract}
