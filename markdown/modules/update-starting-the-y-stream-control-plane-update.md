...
# Starting the y-stream control plane update {id="update-starting-the-y-stream-control-plane-update_{{ context }}"}

After you have determined the full new release that you are moving to, you can run the `oc adm upgrade –to=x.y.z` command. {._abstract}
