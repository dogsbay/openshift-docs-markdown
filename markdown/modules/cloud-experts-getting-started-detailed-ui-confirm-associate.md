...
# Confirming successful account association {id="cloud-experts-getting-started-detailed-ui-confirm-assocation_{{ context }}"}

You should now see your AWS account in the **Associated AWS infrastructure account** dropdown menu.  {._abstract}
