...
# Recovery of failed control plane machines {id="cpmso-control-plane-recovery_{{ context }}"}

The Control Plane Machine Set Operator automates the recovery of control plane machines to maintain cluster availability without manual intervention.  {._abstract}
