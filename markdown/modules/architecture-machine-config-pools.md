...
# Node configuration management with machine config pools {id="architecture-machine-config-pools_{{ context }}"}

When making changes to nodes, you can modify groups of nodes by applying the changes to all of the nodes in the same machine config pool (MCP).  {._abstract}
