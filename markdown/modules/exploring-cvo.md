...
# Exploring the CVO {id="exploring-cvo_{{ context }}"}
...
While most of the Cluster Operators listed provide services to the {{ product_title }} cluster, the machine-config Operator in particular is tasked with managing the {{ op_system }} operating systems in the nodes.