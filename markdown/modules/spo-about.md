...
# About security profiles {id="spo-about_{{ context }}"}

Security profiles limit what containers can do on a node, so you can reduce the attack surface of workloads in your cluster. {._abstract}
