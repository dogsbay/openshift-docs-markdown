...
# Differences between non-versioned and versioned cluster tasks {id="differences-between-non-versioned-and-versioned-cluster-tasks_{{ context }}"}

Non-versioned and versioned cluster tasks have different naming conventions. And, the {{ pipelines_title }} Operator upgrades them differently.
