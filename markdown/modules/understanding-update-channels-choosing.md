...
# What to consider when choosing an update channel {id="fast-stable-channel-strategies_{{ context }}"}

Choosing the appropriate update channel for your cluster involves two decisions. {._abstract}
