...
# Enabling Instance Metadata Service in CLI {id="rosa-imds-cli_{{ context }}"}
...
*   After your cluster has been created, navigate to the cluster **Overview** tab in {{ cluster_manager_url }} to see the **Instance Metadata Service (IMDS)** field that notes your IMDS version support.