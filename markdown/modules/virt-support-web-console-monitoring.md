...
# Web console monitoring {id="virt-support-web-console-monitoring_{{ context }}"}

Monitor cluster and virtual machine (VM) health with the {{ product_title }} web console. {._abstract}

The {{ product_title }} web console displays resource usage, alerts, events, and trends for your cluster and for {{ VirtProductName }} components and resources.
