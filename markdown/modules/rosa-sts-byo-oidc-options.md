...
# Parameter options for creating your own OpenID Connect configuration {id="rosa-sts-byo-oidc-options_{{ context }}"}
...
## raw-files {id="rosa-sts-byo-oidc-raw-files_{{ context }}"}
...
## mode {id="rosa-sts-byo-oidc-mode_{{ context }}"}
...
## managed {id="rosa-sts-byo-oidc-managed_{{ context }}"}
