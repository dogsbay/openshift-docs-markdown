...
# Installing the Dynamic Accelerator Slicer Operator using the web console {id="das-operator-installing-web-console_{{ context }}"}

As a cluster administrator, you can install the Dynamic Accelerator Slicer (DAS) Operator using the {{ product_title }} web console.
...
1.  In the YAML editor, paste the following example:
