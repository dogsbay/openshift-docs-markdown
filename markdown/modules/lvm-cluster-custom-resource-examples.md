...
# LVMCluster custom resource examples {id="lvm-cluster-custom-resource-examples_{{ context }}"}

You can configure the `deviceDiscoveryPolicy` field in your `LVMCluster` custom resource (CR) by using these examples to meet your specific storage requirements. {._abstract}
