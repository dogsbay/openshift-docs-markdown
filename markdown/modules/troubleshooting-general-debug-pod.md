...
# Debugging a pod {id="troubleshooting-general-debug-pod_{{ context }}"}

In certain cases, you do not want to directly interact with your pod that is in production. {._abstract}
