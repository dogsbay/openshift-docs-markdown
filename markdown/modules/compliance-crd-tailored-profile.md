...
# TailoredProfile object {id="tailored-profile-object_{{ context }}"}
...
After validation, the `TailoredProfile` object creates a `ConfigMap`, which can be referenced by a `ComplianceScan` object. {._abstract}
