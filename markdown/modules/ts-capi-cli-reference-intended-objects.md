...
# Referencing the intended objects when using the CLI {id="ts-capi-cli-reference-intended-objects_{{ context }}"}

For clusters that use the Cluster API, {{ oc_first }} commands prioritize Cluster API objects over Machine API objects. {._abstract}
