...
# Downloading the {{ product_title }} images {id="ztp-downloading-ocp-images_{{ context }}"}

The {{ factory_prestaging_tool }} allows you to pre-cache all the container images required to provision a specific {{ product_title }} release. {._abstract}
