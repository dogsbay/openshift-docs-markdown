...
# Failure rate for image pulls in the last hour {id="nodes-dashboard-using-identify-critical-pulls_{{ context }}"}

You can review the ratio of failed image pulls by using the **Failure rate for image pulls in the last hour** query in the node metrics dashboard.  {._abstract}
