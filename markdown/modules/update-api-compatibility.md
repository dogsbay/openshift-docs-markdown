...
# {{ product_title }} API compatibility {id="update-openshift-container-platform-api-compatibility_{{ context }}"}
...
If the version you update to does not have all the required patches, the built-in compatibility of Kubernetes is broken. {._abstract}
