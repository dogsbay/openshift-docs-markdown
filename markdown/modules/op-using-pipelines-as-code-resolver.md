...
# Using the {{ pac }} resolver {id="using-pipelines-as-code-resolver_{{ context }}"}

The {{ pac }} resolver ensures that a running pipeline run does not conflict with others. {._abstract}
