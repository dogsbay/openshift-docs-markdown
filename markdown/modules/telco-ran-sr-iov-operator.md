...
# SR-IOV Operator {id="telco-ran-sr-iov-operator_{{ context }}"}

The SR-IOV Operator provisions and configures the SR-IOV CNI and device plugins. {._abstract}
...
:   *   Use devices that are supported for {{ product_title }}.
