## Dead man’s switch {id="dead-mans-switch_{{ context }}"}

{{ product_title }} Monitoring ships with a "Dead man’s switch" to ensure the availability of the monitoring infrastructure.
