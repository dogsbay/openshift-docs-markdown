# Restoring the default Security Context Constraints {id="security-context-constraints-restore-defaults_{{ context }}"}
...
1.  Delete any SCC you want to reset and restart the master.
1.  Use the `oc adm policy reconcile-sccs` command.
