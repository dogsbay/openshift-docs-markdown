...
# FlowMetric [flows.netobserv.io/v1alpha1] {id="flowmetric-flows-netobserv-io-v1alpha1"}
...
Description
:   Charts configuration, for the {{ product_title }} Console in the administrator view, Dashboards menu.
