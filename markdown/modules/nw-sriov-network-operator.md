...
# Example SR-IOV Network Operator for virtual functions {id="nw-sriov-network-operator_{{ context }}"}

You can use the Single Root I/O Virtualization (SR-IOV) Network Operator to allocate and configure Virtual Functions (VFs) from SR-IOV-supporting Physical Function NICs on the nodes. {._abstract}
