...
# About scheduler profiles {id="nodes-scheduler-profiles-about_{{ context }}"}

You can use scheduler profiles to determine how the cluster distributes pods across nodes based on node resource utilization. {._abstract}
