...
# About label propagation from Ingress to Route resources {id="networking-ingress-label-propagation-about_{{ context }}"}

You can opt-in to a feature that enables the Ingress Operator to automatically propagate labels. This allows you to add metadata that helps track or manage resources, or to control specific behaviors that depend on labels. {._abstract}
