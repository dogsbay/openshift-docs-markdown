...
# About the Vertical Pod Autoscaler Operator {id="nodes-pods-vertical-autoscaler-about_{{ context }}"}

To help you maintain the optimal CPU and memory usage for your pods, you can use the {{ product_title }} Vertical Pod Autoscaler Operator (VPA). {._abstract}
...
## About the Vertical Pod Autoscaler Operator modes {id="nodes-pods-vertical-autoscaler-modes_{{ context }}"}
...
{%- set FeatureName = "The `Auto` VPA mode" %}
{% leveloffset +1 %}{% include "./snippets/deprecated-feature.md" %}{% endleveloffset %}
