...
# Running ovnkube-trace {id="nw-ovn-kubernetes-running-ovnkube-trace_{{ context }}"}

To simulate packet forwarding in an OVN logical network, you can run `ovnkube-trace` with source and destination pods, ports, and log levels. {._abstract}
