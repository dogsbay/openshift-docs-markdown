...
# Monitoring the second part of a <y+1> cluster update {id="update-monitoring-second-part-y-update_{{ context }}"}

Monitor the second part of the cluster update to the &lt;y+1> version. {._abstract}
