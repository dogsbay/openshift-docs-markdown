...
# Lifecycle and persistent volume claims {id="generic-ephemeral-vols-lifecycle_{{ context }}"}

Generic ephemeral volumes follow pod lifecycle through automatically managed persistent volume claims created at pod startup and deleted at termination. Choose volume binding mode and reclaim policy based on this lifecycle behavior. {._abstract}
