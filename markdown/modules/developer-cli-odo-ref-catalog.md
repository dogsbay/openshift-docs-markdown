...
### Listing components {id="_listing_components"}
...
### Getting information about a component {id="_getting_information_about_a_component"}
...
1.  _Starter projects_ are sample projects in the same language and framework of the devfile, that can help you start a new project.

See `odo create` for more information on creating a project from a starter project.

## Services {id="_services"}

`odo` can deploy _services_ with the help of _Operators_.

Only Operators deployed with the help of the [_Operator Lifecycle Manager_](https://olm.operatorframework.io/) are supported by odo.
...
### Searching services {id="_searching_services"}
