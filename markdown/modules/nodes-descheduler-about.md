...
# About the descheduler {id="nodes-descheduler-about_{{ context }}"}

You can use the descheduler to evict pods based on specific strategies so that the pods are rescheduled onto more appropriate nodes. {._abstract}
