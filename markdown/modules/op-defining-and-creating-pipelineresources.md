...
# Defining and creating PipelineResources {id="defining-and-creating-pipelineresources_{{ context }}"}
...
1.  Create a PipelineResource that defines the Git repository for the front-end application:
    ...
    ```
1.  Create a PipelineResource that defines the {{ product_title }} {{ product_registry }} to where you want to push the front-end image:
    ```
    $ tkn resource create
    ...
    ```
1.  Create a PipelineResource that defines the Git repository for the back-end application:
    ```
    $ tkn resource create
    ...
    ```
1.  Create a PipelineResource that defines the {{ product_title }} {{ product_registry }} to where you want to push the back-end image:
    ```
    $ tkn resource create
    ...
    ```
1.  View the list of `resources` created:
    ```
    $ tkn resource list
    ```
