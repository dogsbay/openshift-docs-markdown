...
# Release notes for OpenShift Compliance Operator 0.1.48 {id="compliance-operator-release-notes-0-1-48_{{ context }}"}

Release notes for OpenShift Compliance Operator 0.1.48. {._abstract}
...
## Bug fixes {id="openshift-compliance-operator-0-1-48-bug-fixes_{{ context }}"}
