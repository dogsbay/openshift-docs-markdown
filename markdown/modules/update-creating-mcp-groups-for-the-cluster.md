...
# Creating MachineConfigPool groups for the cluster {id="update-creating-mcp-groups-for-the-cluster_{{ context }}"}

Creating `mcp` groups is a 2-step process: {._abstract}
