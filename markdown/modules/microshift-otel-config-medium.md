...
# Select a medium configuration {id="microshift-otel-config-medium_{{ context }}"}

You can configure {{ microshift_short }} Observability to collect performance and resource information from various sources by updating the YAML file. {._abstract}
