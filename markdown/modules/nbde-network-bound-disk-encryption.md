...
# Network-Bound Disk Encryption (NBDE) {id="nbde-network-bound-disk-encryption_{{ context }}"}
...
Clevis and Tang are generic client and server components that provide network-bound encryption. {{ op_system_first }}
