...
# Deploying a Java application by uploading a JAR file {id="odc-deploying-java-applications_{{ context }}"}
...
{%- endif %}
*   You have access to the {{ product_title }} web console and are in the **Developer** perspective.
