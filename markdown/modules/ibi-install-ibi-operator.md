...
# Installing the Image Based Install Operator {id="ibi-install-ibi-operator_{{ context }}"}

The Image Based Install (IBI) Operator is part of the image-based deployment workflow for preinstalled {{ sno }} on bare-metal hosts. {._abstract}
...
*   You deployed a {{ rh_rhacm_first }} hub cluster or you deployed the {{ mce }}.
