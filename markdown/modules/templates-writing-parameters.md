...
# Writing template parameters {id="templates-writing-parameters_{{ context }}"}

To customize a template when you process it, define parameters with default or generated values and reference them in template fields. Use string or JSON substitution syntax to pass user-specific values into created objects. {._abstract}
