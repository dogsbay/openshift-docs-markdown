...
# Load balancer {id="telco-core-load-balancer_{{ context }}"}

MetalLB is a load-balancer implementation for bare metal Kubernetes clusters that uses standard routing protocols. {._abstract}
