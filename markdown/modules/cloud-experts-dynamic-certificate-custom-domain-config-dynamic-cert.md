...
1.  Ensure that the new `cert-manager-openshift-routes` pod is running successfully:
    ```terminal
    $ oc -n cert-manager get pods
    ```
    ```terminal title="Example result"
