...
# Verifying the status of your service binding from the Topology view {id="odc-verifying-the-status-of-your-service-binding-from-the-topology-view_{{ context }}"}
