...
# Sample resource quota definitions {id="quotas-sample-resource-quota-definitions_{{ context }}"}

View sample YAML definitions for resource quotas, including specifications for object counts, compute resources, QoS scopes, and storage classes, to configure custom quota manifests for your project. {._abstract}
