...
1.  Inspect the `ClusterVersion` object by running the following command:
    ...
    ```
1.  View the conditions by running the following command:
    ```terminal
    ...
    ```
1.  Inspect the `ClusterOperator` object by running the following command:
    ```terminal
    ...
    ```
1.  Inspect individual cluster Operators by running the following command:
    ```terminal
