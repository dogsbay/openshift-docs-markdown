...
# Configuring JSON Web Token authentication for {{ SMProductShortName }} 1.x and {{ ServerlessProductName }} {id="serverless-ossm-v1x-jwt_{{ context }}"}
