...
# Recommended firmware configuration for vDU cluster hosts {id="ztp-du-firmware-config-reference_{{ context }}"}

Use the following table as the basis to configure the cluster host firmware for vDU applications running on {{ product_title }} {{ product_version }}. {._abstract}
