...
# Setting a quota to consume a resource {id="setting-quota-to-consume-resource_{{ context }}"}

To restrict the amount of a resource that a user can consume, set a quota. By doing this task, you can prevent unbounded usage of resources, such as storage classes, ensuring that project consumption remains within defined limits. {._abstract}
