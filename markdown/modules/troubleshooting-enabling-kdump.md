...
# Enabling kdump {id="enabling-kdump"}

{{ op_system }} ships with the `kexec-tools` package, but manual configuration is required to enable the `kdump` service. {._abstract}
