...
# Example: Network interface with a predictable route table ID {id="virt-example-predictable-route-table-id_{{ context }}"}

To simplify network administration and reduce configuration errors in {{ product_title }}, configure routes by using names instead of Virtual Routing and Forwarding (VRF) routing table ID numbers.  {._abstract}
