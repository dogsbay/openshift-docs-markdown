...
# IPConfig reference specifications {id="cnf-ipconfig-cr-reference_{{ context }}"}

The `IPConfig` custom resource (CR) is a cluster-scoped CR that controls the IP configuration workflow for {{ sno }} clusters using the {{ lcao }}.  {._abstract}
