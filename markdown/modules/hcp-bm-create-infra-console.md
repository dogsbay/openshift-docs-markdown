...
# Creating an InfraEnv resource by using the console {id="hcp-bm-create-infra-console_{{ context }}"}

If you prefer to use the {{ product_title }} web console, you can use it to create an `InfraEnv` resource for a hosted cluster on bare metal. {._abstract}
