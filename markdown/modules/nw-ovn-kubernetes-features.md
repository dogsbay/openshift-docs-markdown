...
*   IPv4-primary dual-stack networking on bare-metal, {{ vmw_full }}, {{ ibm_power_name }}, {{ ibm_z_name }}, and {{ rh_openstack_first }} platforms.
*   IPv6 single-stack networking on {{ rh_openstack }} and bare metal platforms.
*   IPv6-primary dual-stack networking for a cluster running on a bare-metal, a {{ vmw_full }}, or an {{ rh_openstack }} platform.
