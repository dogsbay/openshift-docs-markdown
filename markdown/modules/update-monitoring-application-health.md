...
# Application liveness, readiness, and startup probes {id="update-monitoring-application-health_{{ context }}"}
...
These are very useful tools to use with pods that are dependent upon keeping state for their application containers. {._abstract}
