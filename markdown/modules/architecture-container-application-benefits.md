...
# The benefits of containerized applications {id="architecture-container-application-benefits_{{ context }}"}

Use containerized applications as they offer many advantages over using traditional deployment methods. Where applications were once expected to be installed on operating systems that included all their dependencies, containers let an application carry their dependencies with them.  {._abstract}
