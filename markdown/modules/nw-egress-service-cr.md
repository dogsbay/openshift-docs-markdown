...
# Egress service custom resource {id="nw-egress-service-ovn-cr_{{ context }}"}

You can define the configuration for an egress service in an `EgressService` custom resource. {._abstract}
