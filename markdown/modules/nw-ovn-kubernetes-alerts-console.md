...
# Viewing OVN-Kubernetes alerts in the console {id="nw-ovn-kubernetes-alerts-console_{{ context }}"}

To view OVN-Kubernetes alerts in the {{ product_title }} web console, you can open **Observe** → **Alerting** to inspect rules, alerts, and silences. {._abstract}
