...
# AI safety {id="ai-app-mcp-server-ai-safety_{{ context }}"}

Because MCP server for Red Hat OpenShift grants AI agents access to cluster resources, you must follow safety practices to protect your cluster from unauthorized actions, data exposure, and prompt injection risks. {._abstract}
...
## Data ownership {id="ai-app-mcp-server-ai-safety-data-ownership_{{ context }}"}
...
## Required verification workflow: Human in the loop (HITL) enforcement {id="ai-app-mcp-server-ai-safety-hitl_{{ context }}"}
...
## Data privacy and redaction {id="ai-app-mcp-server-ai-safety-privacy-redaction_{{ context }}"}
...
## Audit trail recommendation {id="ai-app-mcp-server-ai-safety-audit-trail_{{ context }}"}
...
## Recommendations regarding 3rd-party MCP servers {id="ai-app-mcp-server-ai-safety-mcp-servers-hitl_{{ context }}"}
...
## AI governance and guardrails {id="ai-app-mcp-server-ai-safety-governance-guardrails_{{ context }}"}
...
## Emergency removal of AI agent access {id="ai-app-mcp-server-ai-safety-governance-removal_{{ context }}"}
