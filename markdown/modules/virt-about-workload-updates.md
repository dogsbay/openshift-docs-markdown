...
# VM workload updates {id="virt-about-workload-updates_{{ context }}"}

When you update {{ VirtProductName }}, virtual machine workloads, including `libvirt`, `virt-launcher`, and `qemu`, update automatically if they support live migration. {._abstract}
...
## Migration attempts and timeouts {id="migration-attempts-timeouts_{{ context }}"}
