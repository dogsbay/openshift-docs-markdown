...
In {{ product_title }}, because overcommitment of project-level resources is enabled by default, if required by your use case, you can disable overcommitment on projects that are not managed by Red Hat.
{% endif %} {._abstract}
