...
# Nodes with Kubelet system reserved CPU utilization > 50% {id="nodes-dashboard-using-identify-critical-cpu-kubelet_{{ context }}"}

You can review the percentage of CPU that the Kubelet system is currently using from system reserved by using the **Nodes with Kubelet system reserved CPU utilization > 50%** query in the node metrics dashboard. {._abstract}
