...
# Updating the worker nodes {id="update-updating-the-worker-nodes_{{ context }}"}
...
Each of the worker nodes in the cluster reboot to upgrade to the new EUS, y-stream or z-stream version as required. {._abstract}
