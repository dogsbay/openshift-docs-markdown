...
# Sample YAML for a compute machine set custom resource on bare metal {id="machineset-yaml-baremetal_{{ context }}"}

You can define and apply a compute machine set on bare-metal infrastructure to automate node provisioning. {._abstract}
