...
# Request-based resource limit {id="hcp-resource-limit_{{ context }}"}

The maximum number of hosted control planes that the cluster can host is calculated based on the hosted control plane CPU and memory requests from the pods. {._abstract}
