...
# Manually upgrading your cluster using the CLI {id="cloud-experts-getting-started-upgrading-manual-cli_{{ context }}"}

You can upgrade your cluster by using the {{ rosa_cli_first }}. {._abstract}
