...
# About cluster hibernation {id="hibernating-cluster-about_{{ context }}"}

Review cluster hibernation limits and supported behavior before you pause a cluster. Understanding timing, node, and resume requirements helps you hibernate and resume successfully within 90 days. {._abstract}
