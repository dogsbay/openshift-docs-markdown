...
# Configuring image streams {id="images-imagestream-configure_{{ context }}"}

To customize image retrieval and security policies for your applications, configure image streams within {{ product_title }}. This process lets you define image pull specifications, manage tags, and control access permissions necessary for reliable application deployment. {._abstract}

An `ImageStream` object file contains the following elements.

<a name="image-stream-object-definition_{{ context }}"></a>
