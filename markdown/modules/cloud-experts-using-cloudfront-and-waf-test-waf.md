...
# Test the WAF {id="cloud-experts-using-cloudfront-and-waf-test-waf_{{ context }}"}

Verify that your AWS Web Application Firewall (WAF) configuration is working by sending valid and malicious requests to the sample application. {._abstract}
