...
# Hot swap limitations {id="virt-vm-nw-hot-swap-limitations_{{ context }}"}

{{ VirtProductName }} supports hot swapping for VMs that are connected to an OVN-Kubernetes localnet and a Linux bridge secondary network. {._abstract}
