...
# AWS Elastic Block Store (EBS) StorageObject object definition {id="aws-definition_{{ context }}"}

This AWS EBS storage class example shows how to configure volume type, IOPS performance, encryption settings, and filesystem type for dynamically provisioned persistent volumes. {._abstract}
