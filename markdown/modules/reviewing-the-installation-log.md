...
# Reviewing the installation log {id="reviewing-the-installation-log_{{ context }}"}

The {{ product_title }} installation log contains a summary of the installation, including the information required to access the cluster after installation. {._abstract}
