...
# Querying your cluster {id="troubleshooting-general-query-cluster_{{ context }}"}

Get information about your cluster so that you can more accurately find potential problems. {._abstract}
