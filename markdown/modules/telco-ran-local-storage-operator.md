...
# Local Storage Operator {id="telco-ran-local-storage-operator_{{ context }}"}

You can create persistent volumes that can be used as `PVC` resources by applications with the Local Storage Operator. {._abstract}
