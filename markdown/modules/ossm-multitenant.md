# Multitenant installations {id="ossm-multitenant-install_{{ context }}"}
...
## Multitenancy versus cluster-wide installations {id="ossm-mt-vs-clusterwide_{{ context }}"}
...
## Cluster scoped resources {id="ossm-cluster-scoped-resources_{{ context }}"}
