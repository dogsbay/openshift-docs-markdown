...
# Sample YAML for a Cluster API machine template resource on {{ vmw_full }} {id="capi-yaml-machine-template-vsphere_{{ context }}"}
...
:   Specifies the {{ vmw_short }} VM network to deploy the compute machine set to.
