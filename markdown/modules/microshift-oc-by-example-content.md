...
# OpenShift CLI (oc) developer commands {id="microshift-cli-developer_{{ context }}"}

You can use the `oc` command-line tool to manage your applications and interact with your MicroShift cluster. Use the following commands, along with their descriptions and example usage, to work with your cluster resources. {._abstract}

## oc annotate {id="microshift-oc-annotate_{{ context }}"}
...
## oc api-resources {id="microshift-oc-api-resources_{{ context }}"}
...
## oc api-versions {id="microshift-oc-api-versions_{{ context }}"}
...
## oc apply {id="microshift-oc-apply_{{ context }}"}
...
## oc apply edit-last-applied {id="microshift-oc-apply-edit-last-applied_{{ context }}"}
...
## oc apply set-last-applied {id="microshift-oc-apply-set-last-applied_{{ context }}"}
...
## oc apply view-last-applied {id="microshift-oc-apply-view-last-applied_{{ context }}"}
...
## oc attach {id="microshift-oc-attach_{{ context }}"}
...
## oc auth can-i {id="microshift-oc-auth-can-i_{{ context }}"}
...
## oc auth reconcile {id="microshift-oc-auth-reconcile_{{ context }}"}
...
## oc auth whoami {id="microshift-oc-auth-whoami_{{ context }}"}
...
## oc cluster-info {id="microshift-oc-cluster-info_{{ context }}"}
...
## oc cluster-info dump {id="microshift-oc-cluster-info-dump_{{ context }}"}
...
## oc completion {id="microshift-oc-completion_{{ context }}"}
...
## oc config current-context {id="microshift-oc-config-current-context_{{ context }}"}
...
## oc config delete-cluster {id="microshift-oc-config-delete-cluster_{{ context }}"}
...
## oc config delete-context {id="microshift-oc-config-delete-context_{{ context }}"}
...
## oc config delete-user {id="microshift-oc-config-delete-user_{{ context }}"}
...
## oc config get-clusters {id="microshift-oc-config-get-clusters_{{ context }}"}
...
## oc config get-contexts {id="microshift-oc-config-get-contexts_{{ context }}"}
...
## oc config get-users {id="microshift-oc-config-get-users_{{ context }}"}
...
## oc config new-admin-kubeconfig {id="microshift-oc-config-new-admin-kubeconfig_{{ context }}"}
...
## oc config new-kubelet-bootstrap-kubeconfig {id="microshift-oc-config-new-kubelet-bootstrap-kubeconfig_{{ context }}"}
...
## oc config refresh-ca-bundle {id="microshift-oc-config-refresh-ca-bundle_{{ context }}"}
...
## oc config rename-context {id="microshift-oc-config-rename-context_{{ context }}"}
...
## oc config set {id="microshift-oc-config-set_{{ context }}"}
...
## oc config set-cluster {id="microshift-oc-config-set-cluster_{{ context }}"}
...
## oc config set-context {id="microshift-oc-config-set-context_{{ context }}"}
...
## oc config set-credentials {id="microshift-oc-config-set-credentials_{{ context }}"}
...
## oc config unset {id="microshift-oc-config-unset_{{ context }}"}
...
## oc config use-context {id="microshift-oc-config-use-context_{{ context }}"}
...
## oc config view {id="microshift-oc-config-view_{{ context }}"}
...
## oc cp {id="microshift-oc-cp_{{ context }}"}
...
## oc create {id="microshift-oc-create_{{ context }}"}
...
## oc create clusterrole {id="microshift-oc-create-cluster-role_{{ context }}"}
...
## oc create clusterrolebinding {id="microshift-oc-create-cluster-role-binding_{{ context }}"}
...
## oc create configmap {id="microshift-oc-create-config-map_{{ context }}"}
...
## oc create cronjob {id="microshift-oc-create-cronjob_{{ context }}"}
...
## oc create deployment {id="microshift-oc-create-deployment_{{ context }}"}
...
## oc create ingress {id="microshift-oc-create-ingress_{{ context }}"}
...
## oc create job {id="microshift-oc-create-job_{{ context }}"}
...
## oc create namespace {id="microshift-oc-create-namespace_{{ context }}"}
...
## oc create poddisruptionbudget {id="microshift-oc-create-poddisruptionbudget_{{ context }}"}
...
## oc create priorityclass {id="microshift-oc-create-priorityclass_{{ context }}"}
...
## oc create quota {id="microshift-oc-create-quota_{{ context }}"}
...
## oc create role {id="microshift-oc-create-role_{{ context }}"}
...
## oc create rolebinding {id="microshift-oc-create-rolebinding_{{ context }}"}
...
## oc create route edge {id="microshift-oc-create-route-edge_{{ context }}"}
...
## oc create route passthrough {id="microshift-oc-create-route-passthrough_{{ context }}"}
...
## oc create route reencrypt {id="microshift-oc-create-route-reencrypt_{{ context }}"}
...
## oc create secret docker-registry {id="microshift-oc-create-secret-docker-registry_{{ context }}"}
...
## oc create secret generic {id="microshift-oc-create-secret-generic_{{ context }}"}
...
## oc create secret tls {id="microshift-oc-create-secret-tls_{{ context }}"}
Create a TLS secret
...
## oc create service clusterip {id="microshift-oc-create-service-clusterip_{{ context }}"}
...
## oc create service externalname {id="microshift-oc-create-service-externalname_{{ context }}"}
...
## oc create service loadbalancer {id="microshift-oc-create-service-loadbalancer_{{ context }}"}
...
## oc create service nodeport {id="microshift-oc-create-service-nodeport_{{ context }}"}
...
## oc create serviceaccount {id="microshift-oc-create-serviceaccount_{{ context }}"}
...
## oc create token {id="microshift-oc-create-token_{{ context }}"}
...
## oc debug {id="microshift-oc-debug_{{ context }}"}
...
## oc delete {id="microshift-oc-delete_{{ context }}"}
...
## oc describe {id="microshift-oc-describe_{{ context }}"}
...
## oc diff {id="microshift-oc-diff_{{ context }}"}
...
## oc edit {id="microshift-oc-edit_{{ context }}"}
...
## oc events {id="microshift-oc-events_{{ context }}"}
List events
...
## oc exec {id="microshift-oc-exec_{{ context }}"}
...
## oc explain {id="microshift-oc-explain_{{ context }}"}
...
## oc expose {id="microshift-oc-expose_{{ context }}"}
...
## oc extract {id="microshift-oc-extract_{{ context }}"}
...
## oc get {id="microshift-oc-get_{{ context }}"}
...
## oc image append {id="microshift-oc-image-append_{{ context }}"}
...
## oc image extract {id="microshift-oc-image-extract_{{ context }}"}
...
## oc image info {id="microshift-oc-image-info_{{ context }}"}
...
## oc image mirror {id="microshift-oc-image-mirror_{{ context }}"}
...
## oc kustomize {id="microshift-oc-kustomize_{{ context }}"}
...
## oc label {id="microshift-oc-label_{{ context }}"}
...
## oc logs {id="microshift-oc-logs_{{ context }}"}
...
## oc observe {id="microshift-oc-observe_{{ context }}"}
...
## oc patch {id="microshift-oc-patch_{{ context }}"}
...
## oc plugin list {id="microshift-oc-plugin-list_{{ context }}"}
...
## oc policy add-role-to-user {id="microshift-oc-policy-add-role-to-user_{{ context }}"}
...
## oc policy scc-review {id="microshift-oc-policy-scc-review_{{ context }}"}
...
## oc policy scc-subject-review {id="microshift-oc-policy-scc-subject-review_{{ context }}"}
...
## oc port-forward {id="microshift-oc-port-forward_{{ context }}"}
...
## oc proxy {id="microshift-oc-proxy_{{ context }}"}
...
## oc rollback {id="microshift-oc-rollback_{{ context }}"}
...
## oc rollout cancel {id="microshift-oc-rollout-cancel_{{ context }}"}
...
## oc rollout history {id="microshift-oc-rollout-history_{{ context }}"}
...
## oc rollout latest {id="microshift-oc-rollout-latest_{{ context }}"}
...
## oc rollout pause {id="microshift-oc-rollout-pause_{{ context }}"}
...
## oc rollout restart {id="microshift-oc-rollout-restart_{{ context }}"}
Restart a resource
...
## oc rollout resume {id="microshift-oc-rollout-resume_{{ context }}"}
...
## oc rollout retry {id="microshift-oc-rollout-retry_{{ context }}"}
...
## oc rollout status {id="microshift-oc-rollout-status_{{ context }}"}
...
## oc rollout undo {id="microshift-oc-rollout-undo_{{ context }}"}
...
## oc rsh {id="microshift-oc-rsh_{{ context }}"}
...
## oc rsync {id="microshift-oc-rsync_{{ context }}"}
...
## oc run {id="microshift-oc-run_{{ context }}"}
...
## oc scale {id="microshift-oc-scale_{{ context }}"}
...
## oc secrets link {id="microshift-oc-secrets-link_{{ context }}"}
...
## oc secrets unlink {id="microshift-oc-secrets-unlink_{{ context }}"}
...
## oc set data {id="microshift-oc-set-data_{{ context }}"}
...
## oc set env {id="microshift-oc-set-env_{{ context }}"}
...
## oc set image {id="microshift-oc-set-image_{{ context }}"}
...
## oc set image-lookup {id="microshift-oc-set-image-lookup_{{ context }}"}
...
## oc set probe {id="microshift-oc-set-probe_{{ context }}"}
...
## oc set resources {id="microshift-oc-set-resources_{{ context }}"}
...
## oc set route-backends {id="microshift-oc-set-route-backends_{{ context }}"}
...
## oc set selector {id="microshift-oc-set-selector_{{ context }}"}
...
## oc set serviceaccount {id="microshift-oc-set-serviceaccount_{{ context }}"}
...
## oc set subject {id="microshift-oc-set-subject_{{ context }}"}
...
## oc set volumes {id="microshift-oc-set-volumes_{{ context }}"}
...
## oc tag {id="microshift-oc-tag_{{ context }}"}
...
## oc version {id="microshift-oc-version_{{ context }}"}
...
## oc wait {id="microshift-oc-wait_{{ context }}"}
