# Release notes for {{ gitops_title }} 1.2.1 {id="gitops-release-notes-1-2-1_{{ context }}"}

{{ gitops_title }} 1.2.1 is now available on {{ product_title }} 4.8.

## Support matrix {id="support-matrix-1-2-1_{{ context }}"}
...
| Feature | {{ gitops_title }} 1.2.1 |
| --- | --- |
| Argo CD | GA |
| Argo CD ApplicationSet | TP |
| {{ gitops_title }} Application Manager CLI (`kam`) | TP |

## Fixed issues {id="fixed-issues-1-2-1_{{ context }}"}
...
[GITOPS-1255](https://issues.redhat.com/browse/GITOPS-1255)
...
[GITOPS-1273](https://issues.redhat.com/browse/GITOPS-1273)
...
[GITOPS-1228](https://issues.redhat.com/browse/GITOPS-1228)
...
[GITOPS-1247](https://issues.redhat.com/browse/GITOPS-1247)
...
[GITOPS-1274](https://issues.redhat.com/browse/GITOPS-1274)