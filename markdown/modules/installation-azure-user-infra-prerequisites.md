...
# Prerequisites {id="installation-azure-user-infra-prerequisites_{{ context }}"}

Before you install a cluster on Azure by using Azure Resource Manager (ARM) templates, complete the following prerequisites. {._abstract}
