...
# Managing host firmware settings with {{ ztp }} {id="ztp-configuring-host-firmware-with-gitops-ztp_{{ context }}"}

Hosts require the correct firmware configuration to ensure high performance and optimal efficiency.
You can deploy custom host firmware configurations for managed clusters with {{ ztp }}. {._abstract}
