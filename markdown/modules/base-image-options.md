...
# Base image options {id="base-image-options_{{ context }}"}

The base image you choose to build your application on contains a set of
software that provides a Linux system to your application.  {._abstract}
...
S2I images are available for you to use directly from the {{ product_title }} web UI. In the Developer perspective, you can navigate to the **+Add** view and in the **Developer Catalog** tile, view all of the available services in the Developer Catalog.
