...
# Cluster infrastructure reference CRs {id="cluster-infrastructure-crs_{{ context }}"}

Use the following custom resources (CRs) to configure cluster infrastructure components for the telco core profile. {._abstract}
