...
# Understanding skew and maxSkew {id="pod-topology-spread-constraints-max-skew_{{ context }}"}

You can configure skew to control the uneven distribution of pods across topology domains. {._abstract}
...
## Example skew calculation {id="pod-topology-spread-constraints-max-skew-calculation_{{ context }}"}
...
## The maxSkew parameter {id="pod-topology-spread-constraints-max-skew-parameter_{{ context }}"}
