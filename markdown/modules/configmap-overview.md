...
# Understanding ConfigMaps {id="configmap-overview_{{ context }}"}
...
configuration data while keeping containers agnostic of {{ product_title }}. A
...
1.  Points to a file that contains non-UTF8 data, for example, a binary Java keystore file.
...
1.  Set command-line arguments in a container.
1.  Populate configuration files in a volume.
