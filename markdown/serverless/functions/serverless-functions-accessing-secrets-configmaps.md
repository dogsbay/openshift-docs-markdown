...
{% leveloffset +1 %}{% include "./modules/serverless-functions-secrets-configmaps-interactively.md" %}{% endleveloffset %}
{% leveloffset +1 %}{% include "./modules/serverless-functions-secrets-configmaps-interactively-specialized.md" %}{% endleveloffset %}

## Adding function access to secrets and config maps manually {id="serverless-functions-secrets-configmaps-manually_{{ context }}"}
...
{% leveloffset +2 %}{% include "./modules/serverless-functions-mounting-secret-as-volume.md" %}{% endleveloffset %}
{% leveloffset +2 %}{% include "./modules/serverless-functions-mounting-configmap-as-volume.md" %}{% endleveloffset %}
{% leveloffset +2 %}{% include "./modules/serverless-functions-key-value-in-secret-to-env-variable.md" %}{% endleveloffset %}
{% leveloffset +2 %}{% include "./modules/serverless-functions-key-value-in-configmap-to-env-variable.md" %}{% endleveloffset %}
{% leveloffset +2 %}{% include "./modules/serverless-functions-all-values-in-secret-to-env-variables.md" %}{% endleveloffset %}
{% leveloffset +2 %}{% include "./modules/serverless-functions-all-values-in-configmap-to-env-variables.md" %}{% endleveloffset %}