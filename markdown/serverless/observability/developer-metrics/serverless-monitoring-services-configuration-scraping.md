...
# Configuration for scraping custom metrics {id="serverless-monitoring-services-configuration-scraping"}
{%- set context = "serverless-monitoring-services-configuration-scraping" %}
...
1.  Configuration of which application’s metrics are scraped.
1.  Configuration of the way metrics are scraped.