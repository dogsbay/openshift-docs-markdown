...
# Understanding the image-based upgrade for {{ sno }} clusters {id="cnf-understanding-image-based-upgrade"}
...
{% leveloffset +2 %}{% include "./modules/cnf-image-based-upgrade-cluster-validated-software.md" %}{% endleveloffset %}

{% leveloffset +2 %}{% include "./modules/ztp-image-based-upgrade-hub-cluster-guide.md" %}{% endleveloffset %}
...
{% leveloffset +2 %}{% include "./modules/cnf-image-based-upgrade-backup-guide.md" %}{% endleveloffset %}
