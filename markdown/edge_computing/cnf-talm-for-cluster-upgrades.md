...
You can use the {{ cgu_operator_first }} to manage the software lifecycle of multiple clusters. {{ cgu_operator }} uses {{ rh_rhacm_first }} policies to perform changes on the target clusters. {._abstract}
