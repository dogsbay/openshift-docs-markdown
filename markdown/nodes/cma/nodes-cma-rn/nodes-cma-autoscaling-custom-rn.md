...
You can review the following release notes to learn about changes in the Custom Metrics Autoscaler Operator version 2.19.0-3. The release notes for the Custom Metrics Autoscaler Operator for Red Hat OpenShift describe new features and enhancements, deprecated features, and known issues. {._abstract}
...
{% leveloffset +1 %}{% include "./modules/nodes-pods-autoscaling-custom-rn-2190-3.md" %}{% endleveloffset %}