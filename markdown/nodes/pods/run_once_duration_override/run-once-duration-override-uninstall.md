...
You can remove the {{ run_once_operator }} from {{ product_title }} by uninstalling the Operator and deleting its related resources, such as custom resource definitions, the namespace, and configuration labels.
