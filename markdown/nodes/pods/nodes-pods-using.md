...
To run your application containers in {{ product_title }}, you must use pods. Pods allow you to group tightly coupled containers together on a single host for shared networking and storage. {._abstract}
