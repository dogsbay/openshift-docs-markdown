...
{% leveloffset +1 %}{% include "./modules/ai-sno-requirements-for-installing-worker-nodes.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/sno-adding-worker-nodes-to-sno-clusters.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/ai-adding-worker-nodes-using-the-assisted-installer-api.md" %}{% endleveloffset %}

{% leveloffset +2 %}{% include "./modules/ai-authenticating-against-ai-rest-api.md" %}{% endleveloffset %}

{% leveloffset +2 %}{% include "./modules/ai-adding-worker-nodes-to-cluster.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/sno-adding-worker-nodes-to-sno-clusters-manually.md" %}{% endleveloffset %}
