...
{% leveloffset +1 %}{% include "./modules/op-differences-between-non-versioned-and-versioned-cluster-tasks.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/op-advantages-and-disadvantages-of-non-versioned-and-versioned-cluster-tasks.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/op-disabling-non-versioned-and-versioned-cluster-tasks.md" %}{% endleveloffset %}