...
{% leveloffset +1 %}{% include "./modules/builds-disabling-build-strategy-globally.md" %}{% endleveloffset %}
{% leveloffset +1 %}{% include "./modules/builds-restricting-build-strategy-globally.md" %}{% endleveloffset %}
{% leveloffset +1 %}{% include "./modules/builds-restricting-build-strategy-to-user.md" %}{% endleveloffset %}