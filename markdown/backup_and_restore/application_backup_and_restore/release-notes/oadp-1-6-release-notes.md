...
# {{ oadp_short }} 1.6 release notes {id="oadp-1-6-release-notes"}
...
For additional information about {{ oadp_short }}, see _{{ oadp_first }} FAQ_.

:::


{% leveloffset +1 %}{% include "./modules/oadp-1-6-1-release-notes.md" %}{% endleveloffset %}
