...
The {{ oadp_first }} command-line interface (CLI) plugin for the OpenShift CLI (`oc`) provides a kubectl-native interface for managing backup and restore operations on an {{ product_title }} cluster. {._abstract}
