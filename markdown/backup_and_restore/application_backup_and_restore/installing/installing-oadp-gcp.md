...
# Configuring the OpenShift API for Data Protection with {{ gcp_full }} {id="installing-oadp-gcp"}
{%- set context = "installing-oadp-gcp" -%}
{%- set installing_oadp_gcp = true -%}
...
{% leveloffset +1 %}{% include "./modules/migration-configuring-gcp.md" %}{% endleveloffset %}
...
{% leveloffset +1 %}{% include "./modules/oadp-gcp-wif-cloud-authentication.md" %}{% endleveloffset %}
