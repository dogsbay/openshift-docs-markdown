...
Explore how to back up application data from one {{ product_title }} cluster and restore it to another cluster. While more complex than single-cluster operations, {{ oadp_full }} provides the tools to manage this cross-cluster data recovery. {._abstract}
...
{%- set oadp_backing_up_data_one_cluster_restoring_another_cluster = "" -%}