...
## Additional resources {id="additional-resources_oadp-advanced-topics" ._additional-resources}

*   [Working with different Kubernetes API versions on the same cluster](/backup_and_restore/application_backup_and_restore/oadp-advanced-topics/oadp-different-kubernetes-api-versions#oadp-different-kubernetes-api-versions)
