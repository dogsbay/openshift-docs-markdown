...
If the control plane machines in an {{ aws_first }} cluster require more resources, you can select a larger {{ aws_short }} instance type for the control plane machines to use. {._abstract}
