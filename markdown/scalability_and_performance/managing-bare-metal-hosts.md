...
You can configure bare-metal hosts directly within {{ product_title }}. To provision and manage nodes in a bare-metal cluster, use `Machine` and `MachineSet` custom resources (CRs). {._abstract}
