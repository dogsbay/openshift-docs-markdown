...
# Installing the cluster-compare plugin {id="installing-cluster-compare-plugin"}
{% include "./_attributes/common-attributes.md" %}
{%- set context = "installing-cluster-compare-plugin" %}
...
{% leveloffset +1 %}{% include "./modules/installing-cluster-compare.md" %}{% endleveloffset %}
