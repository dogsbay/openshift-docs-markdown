...
## Reference performance profiles {id="cnf-create-performance-profiles-reference"}
...
## Reducing NIC queues using the Node Tuning Operator {id="cnf-reducing-nic-queues-with-nto"}
