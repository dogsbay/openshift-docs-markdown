...
{% leveloffset +1 %}{% include "./modules/update-canary-example.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/update-canary-about.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/update-using-custom-machine-config-pools-about.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/update-using-custom-machine-config-pools-mcp.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/update-using-custom-machine-config-pools-inheritance.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/update-using-custom-machine-config-pools-pause.md" %}{% endleveloffset %}
...
{% leveloffset +1 %}{% include "./modules/update-using-custom-machine-config-pools-unpause.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/update-using-custom-machine-config-pools-mcp-remove.md" %}{% endleveloffset %}