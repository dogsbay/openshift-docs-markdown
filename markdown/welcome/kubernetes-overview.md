...
{% leveloffset +1 %}{% include "./modules/kubernetes-components.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/kubernetes-resources.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/kubernetes-architecture.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/kubernetes-conceptual-guidelines.md" %}{% endleveloffset %}