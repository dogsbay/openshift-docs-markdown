...
{% leveloffset +1 %}{% include "./modules/ocm-accessing.md" %}{% endleveloffset %}

## General actions {id="ocm-general-actions-ocp"}
...
{% leveloffset +2 %}{% include "./modules/ocm-overview-tab.md" %}{% endleveloffset %}

{% leveloffset +2 %}{% include "./modules/ocm-accesscontrol-tab.md" %}{% endleveloffset %}

{% leveloffset +2 %}{% include "./modules/ocm-addons-tab.md" %}{% endleveloffset %}

{% leveloffset +2 %}{% include "./modules/ocm-insightsadvisor-tab.md" %}{% endleveloffset %}

{% leveloffset +2 %}{% include "./modules/ocm-machinepools-tab.md" %}{% endleveloffset %}

{% leveloffset +2 %}{% include "./modules/ocm-support-tab.md" %}{% endleveloffset %}

{% leveloffset +2 %}{% include "./modules/ocm-settings-tab.md" %}{% endleveloffset %}

## Additional resources {id="ocm-additional-resources-ocp"}
