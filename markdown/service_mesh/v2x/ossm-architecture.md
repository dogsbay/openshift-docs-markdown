...
{% leveloffset +1 %}{% include "./modules/ossm-architecture.md" %}{% endleveloffset %}
...
## Understanding distributed tracing {id="_understanding_distributed_tracing"}
...
{% leveloffset +2 %}{% include "./modules/distr-tracing-tempo-architecture.md" %}{% endleveloffset %}

{% leveloffset +2 %}{% include "./modules/distr-tracing-tempo-features.md" %}{% endleveloffset %}

## Next steps {id="_next_steps"}

*   [Prepare to install {{ SMProductName }}](/service_mesh/v2x/preparing-ossm-installation#preparing-ossm-installation) in your {{ product_title }} environment.