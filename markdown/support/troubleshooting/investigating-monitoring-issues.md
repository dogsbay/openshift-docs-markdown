...
{{ product_title }} includes a preconfigured, preinstalled, and self-updating monitoring stack that provides monitoring for core platform components. In {{ product_title }} {{ product_version }}, cluster administrators can optionally enable monitoring for user-defined projects. {._abstract}
