...
{{ product_title }} collects telemetry and configuration data about your cluster and reports it to Red&#160;Hat by using the Telemeter Client and the {{ insights_operator }}. The data that is provided to Red&#160;Hat enables the benefits outlined in this document.
