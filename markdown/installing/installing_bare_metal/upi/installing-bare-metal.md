...
To optimize performance and maintain more control over your hardware in {{ product_title }} {{ product_version }}, you can install a cluster on bare-metal infrastructure that you provision.
