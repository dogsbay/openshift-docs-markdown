...
*   You have read details about the {{ product_title }} installation and update processes.
...
## Choosing a method to install {{ product_title }} on bare metal {id="choosing-a-method-to-install-ocp-on-bare-metal"}

The {{ product_title }} installation program offers four methods for deploying a cluster:

*   **Interactive**: You can deploy a cluster with the web-based {{ ai_full }}. This is the recommended approach for clusters with networks connected to the internet. The {{ ai_full }} is the easiest way to install {{ product_title }}, it provides smart defaults, and it performs pre-flight validations before installing the cluster. It also provides a RESTful API for automation and advanced configuration scenarios.
...
## Installing a cluster on installer-provisioned infrastructure {id="choosing-a-method-to-install-ocp-on-bare-metal-installer-provisioned"}
