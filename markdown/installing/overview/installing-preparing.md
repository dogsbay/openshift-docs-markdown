...
{% leveloffset +1 %}{% include "./modules/installing-preparing-cluster-for-users-reference.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/installing-preparing-cluster-for-workloads-reference.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/installing-preparing-supported-installation-methods-reference.md" %}{% endleveloffset %}