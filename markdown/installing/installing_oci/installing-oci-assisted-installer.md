...
You can use the {{ ai_full }} to install a cluster on {{ oci_distributed }}. This method is recommended for most users, and requires an internet connection. {._abstract}
