...
# Installing a cluster with z/VM on {{ ibm_z_title }} and {{ ibm_linuxone_title }} in a disconnected environment {id="installing-restricted-networks-ibm-z"}
{%- set context = "installing-restricted-networks-ibm-z" %}

You can install {{ product_title }} on {{ ibm_z_name }} or {{ ibm_linuxone_name }} by using z/VM on infrastructure that you provision in a disconnected environment, using an internal mirror of the installation release content. {._abstract}
