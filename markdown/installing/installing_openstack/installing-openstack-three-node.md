...
In {{ product_title }} version {{ product_version }}, you can install a three-node cluster on {{ rh_openstack_first }}. A three-node cluster consists of three control plane machines, which also act as compute machines.  {._abstract}
