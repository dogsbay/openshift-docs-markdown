...
After installation, you can resolve and prevent performance issues of your {{ rh_openstack_first }} installation by moving etcd from a root volume (provided by {{ rh_openstack }} Cinder) to a dedicated ephemeral local disk. {._abstract}

{% leveloffset +1 %}{% include "./modules/installation-osp-local-disk-deployment.md" %}{% endleveloffset %}

## Additional resources {id="additional-resources_deploying-openstack-on-local-disk" ._additional-resources}
