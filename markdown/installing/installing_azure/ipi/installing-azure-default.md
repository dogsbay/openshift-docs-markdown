...
You can install an {{ product_title }} cluster on {{ azure_first }} by using the default configuration options. The installation program provisions the required infrastructure.
