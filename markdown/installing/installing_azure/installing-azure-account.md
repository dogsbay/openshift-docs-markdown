...
Before you can install {{ product_title }} on {{ azure_first }}, you must configure an {{ azure_short }} account with the correct identity and permissions before you start the installation. {._abstract}
