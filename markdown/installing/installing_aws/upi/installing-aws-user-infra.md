...
To deploy {{ product_title }} version {{ product_version }} on Amazon Web Services (AWS) with your own infrastructure, use the `CloudFormation` templates or create resources according to your company’s policies.
