...
Before you begin an installation using installer-provisioned infrastructure, be sure that your vSphere environment meets the following installation requirements. {._abstract}
...
*   [Scaling machines to use static IP addresses](/post_installation_configuration/node-tasks#nodes-vsphere-scaling-machines-static-ip_post-install-node-tasks)
*   [Using a machine set to scale machines with configured static IP addresses](/post_installation_configuration/node-tasks#nodes-vsphere-machine-set-scaling-static-ip_post-install-node-tasks)