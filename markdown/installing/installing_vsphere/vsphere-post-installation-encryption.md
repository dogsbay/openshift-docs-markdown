...
You can encrypt your virtual machines after installing {{ product_title }} {{ product_version }} on vSphere by draining and shutting down your nodes one at a time. While each virtual machine is shutdown, you can enable encryption in the vCenter web interface. {._abstract}

{% leveloffset +1 %}{% include "./modules/vsphere-encrypting-vms.md" %}{% endleveloffset %}

## Additional resources {id="additional-resources_enabling-encryption-installation" ._additional-resources}
