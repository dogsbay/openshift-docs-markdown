...
*   **Git repository**: Import an existing codebase, Devfile, or Dockerfile from your Git repository using the **From Git**, **From Devfile**, or **From Dockerfile** options respectively, to build and deploy an application on {{ product_title }}.
*   **Container images**: Use existing images from an image stream or registry to deploy it on to the {{ product_title }}.
*   **Pipelines**: Use Tekton pipeline to create CI/CD pipelines for your software delivery process on the {{ product_title }}.
*   **Serverless**: Explore the **Serverless** options to create, build, and deploy stateless and serverless applications on the {{ product_title }}.
...
{% leveloffset +1 %}{% include "./modules/odc-creating-sample-applications.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/odc-using-quickstarts.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/odc-importing-codebase-from-git-to-create-application.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/odc-deploying-container-image.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/odc-deploying-java-applications.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/odc-using-the-devfile-registry.md" %}{% endleveloffset %}
