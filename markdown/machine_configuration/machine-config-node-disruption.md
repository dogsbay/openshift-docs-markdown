...
{% include "./snippets/machine-config-node-disruption-actions.md" %}

{% leveloffset +1 %}{% include "./modules/machine-config-node-disruption-example.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/machine-config-node-disruption-config.md" %}{% endleveloffset %}