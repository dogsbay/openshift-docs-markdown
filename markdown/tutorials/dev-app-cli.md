...
1.  [Grant view permissions](/tutorials/dev-app-cli#getting-started-cli-granting-permissions_dev-app-cli).
...
1.  [Deploy the front-end application](/tutorials/dev-app-cli#getting-started-cli-deploying-first-image_dev-app-cli).

    This step deploys the `parksmap` front-end application, exposes it externally, and scales it up to two instances.
1.  [Deploy the back-end application](/tutorials/dev-app-cli#getting-started-cli-deploying-python-app_dev-app-cli).

    This step deploys the `nationalparks` back-end application and exposes it externally.
1.  [Deploy the database application](/tutorials/dev-app-cli#getting-started-cli-connecting-database_dev-app-cli).
...
{% leveloffset +1 %}{% include "./modules/getting-started-cli-deploying-python-app.md" %}{% endleveloffset %}
...
{% leveloffset +1 %}{% include "./modules/getting-started-cli-connecting-a-database.md" %}{% endleveloffset %}
...
{% leveloffset +1 %}{% include "./modules/getting-started-cli-view.md" %}{% endleveloffset %}