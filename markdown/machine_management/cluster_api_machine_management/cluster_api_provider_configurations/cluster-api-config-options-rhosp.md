...
You can change the configuration of your {{ rh_openstack_first }} Cluster API machines by updating values in the Cluster API custom resource manifests. {._abstract}
