...
Evaluate considerations and metrics for {{ product_title }} clusters that span data centers so you can design supported, resilient multisite deployments.
...
## Additional resources {id="additional-resources-etcd-span_{{ context }}"}
