...
Operator Lifecycle Manager (OLM) uses Operator conditions to communicate additional lifecycle information about an Operator that OLM cannot infer on its own. {._abstract}
...
## Additional resources {id="olm-operatorconditions-addtl-resources" ._additional-resources}
