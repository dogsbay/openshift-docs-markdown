...
You can learn how Operator Lifecycle Manager (OLM) components interact to manage Operators in {{ product_title }}. The architecture includes the OLM Operator, Catalog Operator, and Catalog Registry. {._abstract}
