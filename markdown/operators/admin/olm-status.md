...
You can view the status of installed Operators in {{ product_title }} through Operator Lifecycle Manager (OLM). OLM reports subscription and catalog source conditions to help you assess Operator health.
