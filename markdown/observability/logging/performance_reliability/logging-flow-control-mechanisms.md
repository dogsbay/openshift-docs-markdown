...
# Flow control mechanisms {id="logging-flow-control-mechanisms"}
{%- set context = "logging-flow-control-mechanisms" %}
...
## Benefits of flow control mechanisms {id="logging-configuring-flow-control-benefits"}
...
## Configuring rate limits {id="logging-configuring-flow-control-about-rate-limits"}
...
{% leveloffset +1 %}{% include "./modules/logging-set-output-rate-limit.md" %}{% endleveloffset %}

**Additional resources**
{._additional-resources}

*   [Log output types](/observability/logging/log_collection_forwarding/logging-output-types#logging-output-types)

{% leveloffset +1 %}{% include "./modules/logging-set-input-rate-limit.md" %}{% endleveloffset %}