...
# Configuring log forwarding {id="log6x-clf-6-2"}
...
{% leveloffset +1 %}{% include "./modules/log6x-collection-setup.md" %}{% endleveloffset %}

## Modifying log level in collector {id="modifying-log-level_6-2_{{ context }}"}
...
```yaml title="Example log level annotation"
...
## Managing the Operator {id="managing-the-operator_6-2_{{ context }}"}
...
## Structure of the ClusterLogForwarder {id="clf-structure_6-2_{{ context }}"}
...
### Inputs {id="clf-inputs_6-2_{{ context }}"}
...
### Outputs {id="clf-outputs_6-2_{{ context }}"}
...
googleCloudLogging
:   Forwards logs to {{ gcp_full }} Logging.
...
lokistack
:   Forwards logs to the logging supported combination of Loki and web proxy with {{ Product_Title }} authentication integration. LokiStack’s proxy uses {{ Product_Title }} authentication to enforce multi-tenancy
...
{% leveloffset +1 %}{% include "./modules/log6x-configuring-otlp-output.md" %}{% endleveloffset %}

### Pipelines {id="clf-pipelines_6-2_{{ context }}"}
...
### Filters {id="clf-filters_6-2_{{ context }}"}
...
{% leveloffset +1 %}{% include "./modules/log6x-multiline-except.md" %}{% endleveloffset %}
{% leveloffset +1 %}{% include "./modules/log6x-logging-http-forward-6-2.md" %}{% endleveloffset %}
{% leveloffset +1 %}{% include "./modules/log6x-cluster-logging-collector-log-forward-syslog.md" %}{% endleveloffset %}
{% leveloffset +1 %}{% include "./modules/log6x-content-filter-drop-records.md" %}{% endleveloffset %}
{% leveloffset +1 %}{% include "./modules/log6x-audit-log-filtering.md" %}{% endleveloffset %}
{% leveloffset +1 %}{% include "./modules/log6x-input-spec-filter-labels-expressions.md" %}{% endleveloffset %}
{% leveloffset +1 %}{% include "./modules/log6x-content-filter-prune-records.md" %}{% endleveloffset %}
{% leveloffset +1 %}{% include "./modules/log6x-input-spec-filter-audit-infrastructure.md" %}{% endleveloffset %}
{% leveloffset +1 %}{% include "./modules/log6x-input-spec-filter-namespace-container.md" %}{% endleveloffset %}