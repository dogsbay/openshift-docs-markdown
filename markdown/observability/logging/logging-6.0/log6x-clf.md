...
# Configuring log forwarding {id="log6x-clf"}
...
## Modifying log level in collector {id="_modifying_log_level_in_collector"}
...
## Managing the Operator {id="_managing_the_operator"}
...
## Structure of the ClusterLogForwarder {id="_structure_of_the_clusterlogforwarder"}
