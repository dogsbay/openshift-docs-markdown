...
# Logging 6.1 {id="log6x-about-6-1"}
...
## Inputs and outputs {id="inputs-and-outputs_6-1_{{ context }}"}
...
## Receiver input type {id="receiver-input-type_6-1_{{ context }}"}
...
## Pipelines and filters {id="pipelines-and-filters_6-1_{{ context }}"}
...
## Operator behavior {id="operator-behavior_6-1_{{ context }}"}
...
## Validation {id="validation_6-1_{{ context }}"}
...
## Quick start {id="quick-start_6-1_{{ context }}"}
