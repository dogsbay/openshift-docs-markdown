...
# Configuring log forwarding {id="log6x-clf-6-1"}
{%- set context = "logging-6x-6.1" %}
...
## Modifying log level in collector {id="modifying-log-level_6-1_{{ context }}"}
...
## Managing the Operator {id="managing-the-operator_6-1_{{ context }}"}
...
## Structure of the ClusterLogForwarder {id="clf-structure_6-1_{{ context }}"}
...
### Inputs {id="clf-inputs_6-1_{{ context }}"}
...
### Outputs {id="clf-outputs_6-1_{{ context }}"}
...
### Pipelines {id="clf-pipelines_6-1_{{ context }}"}
...
### Filters {id="clf-filters_6-1_{{ context }}"}
...
{% leveloffset +2 %}{% include "./modules/log6x-multiline-except.md" %}{% endleveloffset %}
{% leveloffset +2 %}{% include "./modules/log6x-content-filter-drop-records.md" %}{% endleveloffset %}
{% leveloffset +2 %}{% include "./modules/log6x-audit-log-filtering.md" %}{% endleveloffset %}
{% leveloffset +2 %}{% include "./modules/log6x-input-spec-filter-labels-expressions.md" %}{% endleveloffset %}
{% leveloffset +2 %}{% include "./modules/log6x-content-filter-prune-records.md" %}{% endleveloffset %}
