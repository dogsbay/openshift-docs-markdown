...
Parts of {{ product_title }} cluster monitoring are configurable.
The API is accessible by setting parameters defined in various config maps. {._abstract}
...
These configurations are defined by [ClusterMonitoringConfiguration](#clustermonitoringconfiguration).
{% endif %}
...
These configurations are defined by [UserWorkloadConfiguration](#userworkloadconfiguration).
...
For more information about supported configurations, see [Maintenance and support for monitoring](/observability/monitoring/getting-started/maintenance-and-support-for-monitoring#maintenance-and-support-for-monitoring).
...
## AdditionalAlertmanagerConfig {id="_additionalalertmanagerconfig"}
...
### Required {id="_required"}
*   `apiVersion`

Appears in: [PrometheusK8sConfig](#prometheusk8sconfig),
...
## AlertmanagerMainConfig {id="_alertmanagermainconfig"}
...
Appears in: [ClusterMonitoringConfiguration](#clustermonitoringconfiguration)
...
## AlertmanagerUserWorkloadConfig {id="_alertmanageruserworkloadconfig"}
...
Appears in: [UserWorkloadConfiguration](#userworkloadconfiguration)
...
## ClusterMonitoringConfiguration {id="_clustermonitoringconfiguration"}
...
| metricsServer | *[MetricsServerConfig](#metricsserverconfig) | `MetricsServer` defines settings for the Metrics Server component. |
...
| prometheusOperatorAdmissionWebhook | *[PrometheusOperatorAdmissionWebhookConfig](#prometheusoperatoradmissionwebhookconfig) | `PrometheusOperatorAdmissionWebhookConfig` defines settings for the admission webhook component of Prometheus Operator. |
...
| monitoringPlugin | *[MonitoringPluginConfig](#monitoringpluginconfig) | `MonitoringPluginConfig` defines settings for the monitoring `console-plugin` component. |

## KubeStateMetricsConfig {id="_kubestatemetricsconfig"}
...
## MetricsServerConfig {id="_metricsserverconfig"}
...
## MonitoringPluginConfig {id="_monitoringpluginconfig"}
...
## NodeExporterCollectorBuddyInfoConfig {id="_nodeexportercollectorbuddyinfoconfig"}
...
## NodeExporterCollectorCpufreqConfig {id="_nodeexportercollectorcpufreqconfig"}
...
## NodeExporterCollectorKSMDConfig {id="_nodeexportercollectorksmdconfig"}
...
## NodeExporterCollectorMountStatsConfig {id="_nodeexportercollectormountstatsconfig"}
...
## NodeExporterCollectorNetClassConfig {id="_nodeexportercollectornetclassconfig"}
...
## NodeExporterCollectorNetDevConfig {id="_nodeexportercollectornetdevconfig"}
...
## NodeExporterCollectorProcessesConfig {id="_nodeexportercollectorprocessesconfig"}
...
## NodeExporterCollectorSystemdConfig {id="_nodeexportercollectorsystemdconfig"}
...
## NodeExporterCollectorTcpStatConfig {id="_nodeexportercollectortcpstatconfig"}
...
## NodeExporterConfig {id="_nodeexporterconfig"}
...
## OpenShiftStateMetricsConfig {id="_openshiftstatemetricsconfig"}
...
## PrometheusK8sConfig {id="_prometheusk8sconfig"}
...
## PrometheusOperatorConfig {id="_prometheusoperatorconfig"}
...
## PrometheusOperatorAdmissionWebhookConfig {id="_prometheusoperatoradmissionwebhookconfig"}
...
## PrometheusRestrictedConfig {id="_prometheusrestrictedconfig"}
...
## RemoteWriteSpec {id="_remotewritespec"}
...
Appears in: [AdditionalAlertmanagerConfig](#additionalalertmanagerconfig)
...
<tr>
  <td>ca</td>
  <td>*v1.SecretKeySelector</td>
  <td>Defines the secret key reference containing the Certificate Authority (CA) to use for the remote host.</td>
</tr>
<tr>
  <td>cert</td>
  <td>*v1.SecretKeySelector</td>
  <td>Defines the secret key reference containing the public certificate to use for the remote host.</td>
</tr>
<tr>
  <td>key</td>
  <td>*v1.SecretKeySelector</td>
  <td>Defines the secret key reference containing the private key to use for the remote host.</td>
</tr>
<tr>
  <td>serverName</td>
  <td>string</td>
  <td>Used to verify the hostname on the returned certificate.</td>
</tr>
<tr>
  <td>insecureSkipVerify</td>
  <td>bool</td>
  <td>When set to <code>true</code>, disables the verification of the remote host's certificate and name.</td>
</tr>
</tbody>
</table>

## TelemeterClientConfig {id="_telemeterclientconfig"}
...
## ThanosQuerierConfig {id="_thanosquerierconfig"}
...
## ThanosRulerConfig {id="_thanosrulerconfig"}
...
## UserWorkloadConfig {id="_userworkloadconfig"}
...
## UserWorkloadConfiguration {id="_userworkloadconfiguration"}
