...
# Managing alerts as an Administrator {id="managing-alerts-as-an-administrator"}
{%- set context = "managing-alerts-as-an-administrator" %}
...
{% if not (openshift_dedicated or openshift_rosa) %}
## Managing alerting rules for core platform monitoring {id="managing-alerting-rules-for-core-platform-monitoring_{{ context }}" ._additional-resources}

The {{ product_title }} monitoring includes a large set of default alerting rules for platform metrics.
...
*   [Managing alerting rules for core platform monitoring](/observability/monitoring/about-ocp-monitoring/key-concepts#managing-core-platform-alerting-rules_key-concepts)
*   [Tips for optimizing alerting rules for core platform monitoring](/observability/monitoring/about-ocp-monitoring/key-concepts#tips-for-optimizing-alerting-rules-for-core-platform-monitoring_key-concepts)

{% leveloffset +2 %}{% include "./modules/monitoring-creating-new-alerting-rules.md" %}{% endleveloffset %}

{% leveloffset +2 %}{% include "./modules/monitoring-modifying-core-platform-alerting-rules.md" %}{% endleveloffset %}
...
## Managing alerting rules for user-defined projects {id="managing-alerting-rules-for-user-defined-projects_{{ context }}" ._additional-resources}
...
{% leveloffset +2 %}{% include "./modules/monitoring-listing-alerting-rules-for-all-projects-in-a-single-view.md" %}{% endleveloffset %}

{% leveloffset +2 %}{% include "./modules/monitoring-removing-alerting-rules-for-user-defined-projects.md" %}{% endleveloffset %}

{% leveloffset +2 %}{% include "./modules/monitoring-disabling-cross-project-alerting-rules-for-user-defined-projects.md" %}{% endleveloffset %}
