...
As an administrator, you can observe the network traffic in the {{ product_title }} web console for detailed troubleshooting and analysis. This feature helps you get insights from different graphical representations of traffic flow. {._abstract}
