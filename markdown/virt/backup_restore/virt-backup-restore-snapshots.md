...
You can back up and restore virtual machines (VMs) by using snapshots. {._abstract}
...
{%- if not (openshift_rosa or openshift_dedicated or openshift_rosa_hcp) %}
## Additional resources {id="_additional_resources" ._additional-resources-snapshots}
