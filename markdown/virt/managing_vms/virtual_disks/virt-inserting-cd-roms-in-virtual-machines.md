...
{% leveloffset +1 %}{% include "./modules/virt-inserting-a-cd-rom-in-a-vm-by-using-the-command-line.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/virt-inserting-a-cd-rom-in-a-vm-by-using-the-web-console.md" %}{% endleveloffset %}