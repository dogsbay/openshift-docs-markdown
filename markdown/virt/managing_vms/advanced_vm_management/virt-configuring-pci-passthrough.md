...
## Preparing nodes for GPU passthrough {id="virt-preparing-nodes-for-gpu-passthrough"}
...
## Configuring virtual machines for PCI passthrough {id="virt-configuring-vms-for-pci-passthrough"}
