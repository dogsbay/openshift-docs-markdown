...
*   `mirror.platform.name`: Specifies the channel from which you want to retrieve the {{ product_title }} images.
...
*   `mirror.operators.catalog`: Specifies the Operator catalog from which you want to retrieve the {{ product_title }} images.
