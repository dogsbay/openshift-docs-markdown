...
This example output shows a basic {{ microshift_short }} installation. If you installed optional RPMs, the status of pods running those services is displayed in the output.
