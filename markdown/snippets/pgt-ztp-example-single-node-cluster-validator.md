...
:   Specifies the binding excluded rules. The label defined in `bindingExcludedRules` must be `ztp-done:`. The `ztp-done` label is used in coordination with the {{ cgu_operator_full }}.
...
:   Specifies the name for the generated {{ rh_rhacm }} policy. The generated validator policy for the single node example is `group-du-sno-validator-du-policy`.