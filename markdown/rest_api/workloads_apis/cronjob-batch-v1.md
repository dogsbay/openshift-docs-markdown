...
# CronJob [batch/v1] {id="cronjob-batch-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.jobTemplate {id="_specjobtemplate"}
...
### .spec.jobTemplate.spec {id="_specjobtemplatespec"}
...
### .spec.jobTemplate.spec.podFailurePolicy {id="_specjobtemplatespecpodfailurepolicy"}
...
### .spec.jobTemplate.spec.podFailurePolicy.rules {id="_specjobtemplatespecpodfailurepolicyrules"}
...
### .spec.jobTemplate.spec.podFailurePolicy.rules[].onExitCodes {id="_specjobtemplatespecpodfailurepolicyrulesonexitcodes"}
...
### .spec.jobTemplate.spec.podFailurePolicy.rules[].onPodConditions {id="_specjobtemplatespecpodfailurepolicyrulesonpodconditions"}
...
### .spec.jobTemplate.spec.successPolicy {id="_specjobtemplatespecsuccesspolicy"}
...
### .spec.jobTemplate.spec.successPolicy.rules {id="_specjobtemplatespecsuccesspolicyrules"}
...
*   `/apis/batch/v1/namespaces/{{ namespace }}/cronjobs`{minja}
    *   `DELETE`: delete collection of CronJob
    *   `GET`: list or watch objects of kind CronJob
    *   `POST`: create a CronJob
*   `/apis/batch/v1/watch/namespaces/{{ namespace }}/cronjobs`{minja}
    *   `GET`: watch individual changes to a list of CronJob. deprecated: use the &#x27;watch&#x27; parameter with a list operation instead.
*   `/apis/batch/v1/namespaces/{{ namespace }}/cronjobs/{{ name }}`{minja}
    *   `DELETE`: delete a CronJob
    *   `GET`: read the specified CronJob
    *   `PATCH`: partially update the specified CronJob
    *   `PUT`: replace the specified CronJob
*   `/apis/batch/v1/watch/namespaces/{{ namespace }}/cronjobs/{{ name }}`{minja}
...
*   `/apis/batch/v1/namespaces/{{ namespace }}/cronjobs/{{ name }}/status`{minja}
...
### /apis/batch/v1/cronjobs {id="_apisbatchv1cronjobs"}
...
### /apis/batch/v1/watch/cronjobs {id="_apisbatchv1watchcronjobs"}
...
### /apis/batch/v1/namespaces/{{ namespace }}/cronjobs {id="_apisbatchv1namespaces_namespace_cronjobs"}
...
### /apis/batch/v1/watch/namespaces/{{ namespace }}/cronjobs {id="_apisbatchv1watchnamespaces_namespace_cronjobs"}
...
### /apis/batch/v1/namespaces/{{ namespace }}/cronjobs/{{ name }} {id="_apisbatchv1namespaces_namespace_cronjobs_name"}
...
### /apis/batch/v1/watch/namespaces/{{ namespace }}/cronjobs/{{ name }} {id="_apisbatchv1watchnamespaces_namespace_cronjobs_name"}
...
### /apis/batch/v1/namespaces/{{ namespace }}/cronjobs/{{ name }}/status {id="_apisbatchv1namespaces_namespace_cronjobs_name_status"}
