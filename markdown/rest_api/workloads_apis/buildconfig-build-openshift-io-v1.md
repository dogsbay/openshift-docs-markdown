...
# BuildConfig [build.openshift.io/v1] {id="buildconfig-build-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
:   A BuildPostCommitSpec holds a build post commit hook specification. The hook executes a command in a temporary container running the build output image, immediately after the last layer of the image is committed and before the image is pushed to a registry. The command is executed with the current working directory ($PWD) set to the image’s WORKDIR.
    ...
    1.  A command as the image entrypoint:
    ...
    1.  Pass arguments to the default entrypoint:
...
| `from` | [`ObjectReference`](/rest_api/objects/index#io-k8s-api-core-v1-ObjectReference) | from is a reference to an ImageStreamTag, ImageStreamImage, or DockerImage to copy source from. |
...
| `from` | [`ObjectReference`](/rest_api/objects/index#io-k8s-api-core-v1-ObjectReference) | from is reference to an DockerImage, ImageStreamTag, or ImageStreamImage from which the container image should be pulled |
...
| Property | Type | Description |
| --- | --- | --- |
| `configMap` | [`ConfigMapVolumeSource`](/rest_api/objects/index#io-k8s-api-core-v1-ConfigMapVolumeSource) | configMap represents a ConfigMap that should populate this volume |
...
### .spec.triggers[].bitbucket {id="_spectriggersbitbucket"}
...
### .spec.triggers[].bitbucket.secretReference {id="_spectriggersbitbucketsecretreference"}
...
### .spec.triggers[].generic {id="_spectriggersgeneric"}
...
### .spec.triggers[].generic.secretReference {id="_spectriggersgenericsecretreference"}
...
### .spec.triggers[].github {id="_spectriggersgithub"}
...
### .spec.triggers[].github.secretReference {id="_spectriggersgithubsecretreference"}
...
### .spec.triggers[].gitlab {id="_spectriggersgitlab"}
...
### .spec.triggers[].gitlab.secretReference {id="_spectriggersgitlabsecretreference"}
...
### .spec.triggers[].imageChange {id="_spectriggersimagechange"}
...
### .status.imageChangeTriggers {id="_statusimagechangetriggers"}
...
| `lastTriggerTime` | [`Time`](/rest_api/objects/index#io-k8s-apimachinery-pkg-apis-meta-v1-Time) | lastTriggerTime is the last time this particular ImageStreamTag triggered a Build to start. This field is only updated when this trigger specifically started a Build. |
...
### .status.imageChangeTriggers[].from {id="_statusimagechangetriggersfrom"}
...
*   `/apis/build.openshift.io/v1/namespaces/{{ namespace }}/buildconfigs`{minja}
    *   `DELETE`: delete collection of BuildConfig
    *   `GET`: list or watch objects of kind BuildConfig
    *   `POST`: create a BuildConfig
*   `/apis/build.openshift.io/v1/watch/namespaces/{{ namespace }}/buildconfigs`{minja}
    *   `GET`: watch individual changes to a list of BuildConfig. deprecated: use the &#x27;watch&#x27; parameter with a list operation instead.
*   `/apis/build.openshift.io/v1/namespaces/{{ namespace }}/buildconfigs/{{ name }}`{minja}
...
*   `/apis/build.openshift.io/v1/watch/namespaces/{{ namespace }}/buildconfigs/{{ name }}`{minja}
...
### /apis/build.openshift.io/v1/buildconfigs {id="_apisbuildopenshiftiov1buildconfigs"}
...
| --- | --- |
| 200 - OK | [`BuildConfigList`](/rest_api/objects/index#com-github-openshift-api-build-v1-BuildConfigList) schema |
| 401 - Unauthorized | Empty |

### /apis/build.openshift.io/v1/watch/buildconfigs {id="_apisbuildopenshiftiov1watchbuildconfigs"}
...
### /apis/build.openshift.io/v1/namespaces/{{ namespace }}/buildconfigs {id="_apisbuildopenshiftiov1namespaces_namespace_buildconfigs"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`BuildConfig`](/rest_api/workloads_apis/buildconfig-build-openshift-io-v1#buildconfig-build-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`BuildConfig`](/rest_api/workloads_apis/buildconfig-build-openshift-io-v1#buildconfig-build-openshift-io-v1) schema |
| 201 - Created | [`BuildConfig`](/rest_api/workloads_apis/buildconfig-build-openshift-io-v1#buildconfig-build-openshift-io-v1) schema |
| 202 - Accepted | [`BuildConfig`](/rest_api/workloads_apis/buildconfig-build-openshift-io-v1#buildconfig-build-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/build.openshift.io/v1/watch/namespaces/{{ namespace }}/buildconfigs {id="_apisbuildopenshiftiov1watchnamespaces_namespace_buildconfigs"}
...
### /apis/build.openshift.io/v1/namespaces/{{ namespace }}/buildconfigs/{{ name }} {id="_apisbuildopenshiftiov1namespaces_namespace_buildconfigs_name"}
...
### /apis/build.openshift.io/v1/watch/namespaces/{{ namespace }}/buildconfigs/{{ name }} {id="_apisbuildopenshiftiov1watchnamespaces_namespace_buildconfigs_name"}
