...
# Deployment [apps/v1] {id="deployment-apps-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/apps/v1/deployments {id="_apisappsv1deployments"}
...
### /apis/apps/v1/watch/deployments {id="_apisappsv1watchdeployments"}
...
### /apis/apps/v1/namespaces/{{ namespace }}/deployments {id="_apisappsv1namespaces_namespace_deployments"}
...
### /apis/apps/v1/watch/namespaces/{{ namespace }}/deployments {id="_apisappsv1watchnamespaces_namespace_deployments"}
...
### /apis/apps/v1/namespaces/{{ namespace }}/deployments/{{ name }} {id="_apisappsv1namespaces_namespace_deployments_name"}
...
### /apis/apps/v1/watch/namespaces/{{ namespace }}/deployments/{{ name }} {id="_apisappsv1watchnamespaces_namespace_deployments_name"}
...
### /apis/apps/v1/namespaces/{{ namespace }}/deployments/{{ name }}/status {id="_apisappsv1namespaces_namespace_deployments_name_status"}
