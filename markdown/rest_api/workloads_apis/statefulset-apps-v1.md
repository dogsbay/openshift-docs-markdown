...
# StatefulSet [apps/v1] {id="statefulset-apps-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/apps/v1/statefulsets {id="_apisappsv1statefulsets"}
...
### /apis/apps/v1/watch/statefulsets {id="_apisappsv1watchstatefulsets"}
...
### /apis/apps/v1/namespaces/{{ namespace }}/statefulsets {id="_apisappsv1namespaces_namespace_statefulsets"}
...
### /apis/apps/v1/watch/namespaces/{{ namespace }}/statefulsets {id="_apisappsv1watchnamespaces_namespace_statefulsets"}
...
### /apis/apps/v1/namespaces/{{ namespace }}/statefulsets/{{ name }} {id="_apisappsv1namespaces_namespace_statefulsets_name"}
...
### /apis/apps/v1/watch/namespaces/{{ namespace }}/statefulsets/{{ name }} {id="_apisappsv1watchnamespaces_namespace_statefulsets_name"}
...
### /apis/apps/v1/namespaces/{{ namespace }}/statefulsets/{{ name }}/status {id="_apisappsv1namespaces_namespace_statefulsets_name_status"}
