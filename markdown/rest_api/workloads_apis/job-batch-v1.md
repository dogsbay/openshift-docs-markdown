...
### .spec.podFailurePolicy {id="_specpodfailurepolicy"}
...
### .spec.podFailurePolicy.rules {id="_specpodfailurepolicyrules"}
...
### .spec.podFailurePolicy.rules[].onExitCodes {id="_specpodfailurepolicyrulesonexitcodes"}
...
### .spec.podFailurePolicy.rules[].onPodConditions {id="_specpodfailurepolicyrulesonpodconditions"}
...
### .spec.successPolicy {id="_specsuccesspolicy"}
...
### .spec.successPolicy.rules {id="_specsuccesspolicyrules"}
...
### .status.uncountedTerminatedPods {id="_statusuncountedterminatedpods"}
...
*   `/apis/batch/v1/namespaces/{{ namespace }}/jobs`{minja}
    *   `DELETE`: delete collection of Job
    *   `GET`: list or watch objects of kind Job
    *   `POST`: create a Job
*   `/apis/batch/v1/watch/namespaces/{{ namespace }}/jobs`{minja}
    *   `GET`: watch individual changes to a list of Job. deprecated: use the &#x27;watch&#x27; parameter with a list operation instead.
*   `/apis/batch/v1/namespaces/{{ namespace }}/jobs/{{ name }}`{minja}
    *   `DELETE`: delete a Job
    *   `GET`: read the specified Job
    *   `PATCH`: partially update the specified Job
    *   `PUT`: replace the specified Job
*   `/apis/batch/v1/watch/namespaces/{{ namespace }}/jobs/{{ name }}`{minja}
...
*   `/apis/batch/v1/namespaces/{{ namespace }}/jobs/{{ name }}/status`{minja}
...
### /apis/batch/v1/jobs {id="_apisbatchv1jobs"}
...
### /apis/batch/v1/watch/jobs {id="_apisbatchv1watchjobs"}
...
### /apis/batch/v1/namespaces/{{ namespace }}/jobs {id="_apisbatchv1namespaces_namespace_jobs"}
...
### /apis/batch/v1/watch/namespaces/{{ namespace }}/jobs {id="_apisbatchv1watchnamespaces_namespace_jobs"}
...
### /apis/batch/v1/namespaces/{{ namespace }}/jobs/{{ name }} {id="_apisbatchv1namespaces_namespace_jobs_name"}
...
### /apis/batch/v1/watch/namespaces/{{ namespace }}/jobs/{{ name }} {id="_apisbatchv1watchnamespaces_namespace_jobs_name"}
...
### /apis/batch/v1/namespaces/{{ namespace }}/jobs/{{ name }}/status {id="_apisbatchv1namespaces_namespace_jobs_name_status"}
