...
# DaemonSet [apps/v1] {id="daemonset-apps-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
*   `/apis/apps/v1/namespaces/{{ namespace }}/daemonsets`{minja}
    *   `DELETE`: delete collection of DaemonSet
    *   `GET`: list or watch objects of kind DaemonSet
    *   `POST`: create a DaemonSet
*   `/apis/apps/v1/watch/namespaces/{{ namespace }}/daemonsets`{minja}
    *   `GET`: watch individual changes to a list of DaemonSet. deprecated: use the &#x27;watch&#x27; parameter with a list operation instead.
*   `/apis/apps/v1/namespaces/{{ namespace }}/daemonsets/{{ name }}`{minja}
...
*   `/apis/apps/v1/watch/namespaces/{{ namespace }}/daemonsets/{{ name }}`{minja}
...
*   `/apis/apps/v1/namespaces/{{ namespace }}/daemonsets/{{ name }}/status`{minja}
...
### /apis/apps/v1/daemonsets {id="_apisappsv1daemonsets"}
...
### /apis/apps/v1/watch/daemonsets {id="_apisappsv1watchdaemonsets"}
...
### /apis/apps/v1/namespaces/{{ namespace }}/daemonsets {id="_apisappsv1namespaces_namespace_daemonsets"}
...
### /apis/apps/v1/watch/namespaces/{{ namespace }}/daemonsets {id="_apisappsv1watchnamespaces_namespace_daemonsets"}
...
### /apis/apps/v1/namespaces/{{ namespace }}/daemonsets/{{ name }} {id="_apisappsv1namespaces_namespace_daemonsets_name"}
...
### /apis/apps/v1/watch/namespaces/{{ namespace }}/daemonsets/{{ name }} {id="_apisappsv1watchnamespaces_namespace_daemonsets_name"}
...
### /apis/apps/v1/namespaces/{{ namespace }}/daemonsets/{{ name }}/status {id="_apisappsv1namespaces_namespace_daemonsets_name_status"}
