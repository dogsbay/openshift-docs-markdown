...
# ReplicationController [core/v1] {id="replicationcontroller-core-v1"}
{%- if product_title %}
...
| `conditions` | [`array (ReplicationControllerCondition core/v1)`](/rest_api/objects/index#replicationcontrollercondition-core-v1) | Represents the latest available observations of a replication controller’s current state. |
...
*   `/api/v1/namespaces/{{ namespace }}/replicationcontrollers`{minja}
    *   `DELETE`: delete collection of ReplicationController
    *   `GET`: list or watch objects of kind ReplicationController
    *   `POST`: create a ReplicationController
*   `/api/v1/namespaces/{{ namespace }}/replicationcontrollers/{{ name }}`{minja}
...
*   `/api/v1/namespaces/{{ namespace }}/replicationcontrollers/{{ name }}/status`{minja}
...
| --- | --- |
| 200 - OK | [`ReplicationControllerList core/v1`](/rest_api/objects/index#replicationcontrollerlist-core-v1) |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`ReplicationController core/v1`](/rest_api/workloads_apis/replicationcontroller-core-v1#replicationcontroller-core-v1) |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ReplicationController core/v1`](/rest_api/workloads_apis/replicationcontroller-core-v1#replicationcontroller-core-v1) |
...
### /api/v1/namespaces/{{ namespace }}/replicationcontrollers/{{ name }}/scale {id="_apiv1namespaces_namespace_replicationcontrollers_name_scale"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Scale autoscaling/v1`](/rest_api/objects/index#scale-autoscaling-v1) |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`Scale autoscaling/v1`](/rest_api/objects/index#scale-autoscaling-v1) |  |
