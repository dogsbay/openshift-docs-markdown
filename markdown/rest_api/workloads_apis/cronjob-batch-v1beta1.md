...
# CronJob [batch/v1beta1] {id="cronjob-batch-v1beta1"}
{%- if product_title %}
...
| Property | Type | Description |
| --- | --- | --- |
| `metadata` | [`ObjectMeta meta/v1`](/rest_api/objects/index#objectmeta-meta-v1) | Standard object’s metadata of the jobs created from this template. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata |
...
| `selector` | [`LabelSelector meta/v1`](/rest_api/objects/index#labelselector-meta-v1) | A label query over pods that should match the pod count. Normally, the system sets this field for you. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors |
...
| `template` | [`PodTemplateSpec core/v1`](/rest_api/objects/index#podtemplatespec-core-v1) | Describes the pod that will be created when executing a job. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/ |
...
| Property | Type | Description |
| --- | --- | --- |
| `active` | [`array (ObjectReference core/v1)`](/rest_api/objects/index#objectreference-core-v1) | A list of pointers to currently running jobs. |
| `lastScheduleTime` | [`Time meta/v1`](/rest_api/objects/index#time-meta-v1) | Information when was the last time the job was successfully scheduled. |
| `lastSuccessfulTime` | [`Time meta/v1`](/rest_api/objects/index#time-meta-v1) | Information when was the last time the job successfully completed. |
...
*   `/apis/batch/v1beta1/namespaces/{{ namespace }}/cronjobs`{minja}
    *   `DELETE`: delete collection of CronJob
    *   `GET`: list or watch objects of kind CronJob
    *   `POST`: create a CronJob
*   `/apis/batch/v1beta1/namespaces/{{ namespace }}/cronjobs/{{ name }}`{minja}
    *   `DELETE`: delete a CronJob
    *   `GET`: read the specified CronJob
    *   `PATCH`: partially update the specified CronJob
    *   `PUT`: replace the specified CronJob
*   `/apis/batch/v1beta1/namespaces/{{ namespace }}/cronjobs/{{ name }}/status`{minja}
...
### /apis/batch/v1beta1/cronjobs {id="_apisbatchv1beta1cronjobs"}
...
| --- | --- |
| 200 - OK | [`CronJobList batch/v1beta1`](/rest_api/objects/index#cronjoblist-batch-v1beta1) |

### /apis/batch/v1beta1/namespaces/{{ namespace }}/cronjobs {id="_apisbatchv1beta1namespaces_namespace_cronjobs"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`CronJob batch/v1beta1`](/rest_api/workloads_apis/cronjob-batch-v1beta1#cronjob-batch-v1beta1) |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`CronJob batch/v1beta1`](/rest_api/workloads_apis/cronjob-batch-v1beta1#cronjob-batch-v1beta1) |

### /apis/batch/v1beta1/namespaces/{{ namespace }}/cronjobs/{{ name }} {id="_apisbatchv1beta1namespaces_namespace_cronjobs_name"}
...
### /apis/batch/v1beta1/namespaces/{{ namespace }}/cronjobs/{{ name }}/status {id="_apisbatchv1beta1namespaces_namespace_cronjobs_name_status"}
