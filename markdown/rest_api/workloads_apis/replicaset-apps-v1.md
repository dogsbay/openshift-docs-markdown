...
# ReplicaSet [apps/v1] {id="replicaset-apps-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/apps/v1/replicasets {id="_apisappsv1replicasets"}
...
### /apis/apps/v1/watch/replicasets {id="_apisappsv1watchreplicasets"}
...
### /apis/apps/v1/namespaces/{{ namespace }}/replicasets {id="_apisappsv1namespaces_namespace_replicasets"}
...
### /apis/apps/v1/watch/namespaces/{{ namespace }}/replicasets {id="_apisappsv1watchnamespaces_namespace_replicasets"}
...
### /apis/apps/v1/namespaces/{{ namespace }}/replicasets/{{ name }} {id="_apisappsv1namespaces_namespace_replicasets_name"}
...
### /apis/apps/v1/watch/namespaces/{{ namespace }}/replicasets/{{ name }} {id="_apisappsv1watchnamespaces_namespace_replicasets_name"}
...
### /apis/apps/v1/namespaces/{{ namespace }}/replicasets/{{ name }}/status {id="_apisappsv1namespaces_namespace_replicasets_name_status"}
