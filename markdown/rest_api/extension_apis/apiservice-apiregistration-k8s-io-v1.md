...
# APIService [apiregistration.k8s.io/v1] {id="apiservice-apiregistration-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/apiregistration.k8s.io/v1/apiservices {id="_apisapiregistrationk8siov1apiservices"}
...
### /apis/apiregistration.k8s.io/v1/watch/apiservices {id="_apisapiregistrationk8siov1watchapiservices"}
...
### /apis/apiregistration.k8s.io/v1/apiservices/{{ name }} {id="_apisapiregistrationk8siov1apiservices_name"}
...
### /apis/apiregistration.k8s.io/v1/watch/apiservices/{{ name }} {id="_apisapiregistrationk8siov1watchapiservices_name"}
...
### /apis/apiregistration.k8s.io/v1/apiservices/{{ name }}/status {id="_apisapiregistrationk8siov1apiservices_name_status"}
