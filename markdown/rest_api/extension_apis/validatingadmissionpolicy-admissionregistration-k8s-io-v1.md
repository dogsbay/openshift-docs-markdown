...
# ValidatingAdmissionPolicy [admissionregistration.k8s.io/v1] {id="validatingadmissionpolicy-admissionregistration-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.auditAnnotations {id="_specauditannotations"}
...
### .spec.matchConditions {id="_specmatchconditions"}
...
| `name` | `string` | Name is an identifier for this match condition, used for strategic merging of MatchConditions, as well as providing an identifier for logging purposes. A good name should be descriptive of the associated expression. Name must be a qualified name consisting of alphanumeric characters, '-', '_' or '.', and must start and end with an alphanumeric character (e.g. 'MyName',  or 'my.name',  or '123-abc', regex used for validation is '([A-Za-z0-9][-A-Za-z0-9_.]*)?[A-Za-z0-9]') with an optional DNS subdomain prefix and '/' (e.g. 'example.com/MyName')<br>Required. |

### .spec.matchConstraints {id="_specmatchconstraints"}
...
| `resourceRules` | `array` | ResourceRules describes what operations on what resources/subresources the ValidatingAdmissionPolicy matches. The policy cares about an operation if it matches _any_ Rule. |
| `resourceRules[]` | `object` | NamedRuleWithOperations is a tuple of Operations and Resources with ResourceNames. |

### .spec.matchConstraints.excludeResourceRules {id="_specmatchconstraintsexcluderesourcerules"}
...
### .spec.matchConstraints.resourceRules {id="_specmatchconstraintsresourcerules"}
...
### .spec.paramKind {id="_specparamkind"}
...
### .spec.validations {id="_specvalidations"}
...
### .spec.variables {id="_specvariables"}
...
### .status.typeChecking {id="_statustypechecking"}
...
### .status.typeChecking.expressionWarnings {id="_statustypecheckingexpressionwarnings"}
...
*   `/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{{ name }}`{minja}
...
*   `/apis/admissionregistration.k8s.io/v1/watch/validatingadmissionpolicies/{{ name }}`{minja}
...
*   `/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{{ name }}/status`{minja}
...
### /apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies {id="_apisadmissionregistrationk8siov1validatingadmissionpolicies"}
...
### /apis/admissionregistration.k8s.io/v1/watch/validatingadmissionpolicies {id="_apisadmissionregistrationk8siov1watchvalidatingadmissionpolicies"}
...
### /apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{{ name }} {id="_apisadmissionregistrationk8siov1validatingadmissionpolicies_name"}
...
### /apis/admissionregistration.k8s.io/v1/watch/validatingadmissionpolicies/{{ name }} {id="_apisadmissionregistrationk8siov1watchvalidatingadmissionpolicies_name"}
...
### /apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{{ name }}/status {id="_apisadmissionregistrationk8siov1validatingadmissionpolicies_name_status"}
