...
# MutatingWebhookConfiguration [admissionregistration.k8s.io/v1] {id="mutatingwebhookconfiguration-admissionregistration-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
*   `/apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/{{ name }}`{minja}
...
*   `/apis/admissionregistration.k8s.io/v1/watch/mutatingwebhookconfigurations/{{ name }}`{minja}
...
### /apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations {id="_apisadmissionregistrationk8siov1mutatingwebhookconfigurations"}
...
### /apis/admissionregistration.k8s.io/v1/watch/mutatingwebhookconfigurations {id="_apisadmissionregistrationk8siov1watchmutatingwebhookconfigurations"}
...
### /apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/{{ name }} {id="_apisadmissionregistrationk8siov1mutatingwebhookconfigurations_name"}
...
### /apis/admissionregistration.k8s.io/v1/watch/mutatingwebhookconfigurations/{{ name }} {id="_apisadmissionregistrationk8siov1watchmutatingwebhookconfigurations_name"}
