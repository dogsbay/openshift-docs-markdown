...
# CustomResourceDefinition [apiextensions.k8s.io/v1] {id="customresourcedefinition-apiextensions-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/apiextensions.k8s.io/v1/customresourcedefinitions {id="_apisapiextensionsk8siov1customresourcedefinitions"}
...
### /apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions {id="_apisapiextensionsk8siov1watchcustomresourcedefinitions"}
...
### /apis/apiextensions.k8s.io/v1/customresourcedefinitions/{{ name }} {id="_apisapiextensionsk8siov1customresourcedefinitions_name"}
...
### /apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions/{{ name }} {id="_apisapiextensionsk8siov1watchcustomresourcedefinitions_name"}
...
### /apis/apiextensions.k8s.io/v1/customresourcedefinitions/{{ name }}/status {id="_apisapiextensionsk8siov1customresourcedefinitions_name_status"}
