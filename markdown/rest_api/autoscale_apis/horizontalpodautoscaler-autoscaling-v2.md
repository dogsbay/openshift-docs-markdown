...
# HorizontalPodAutoscaler [autoscaling/v2] {id="horizontalpodautoscaler-autoscaling-v2"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/autoscaling/v2/horizontalpodautoscalers {id="_apisautoscalingv2horizontalpodautoscalers"}
...
### /apis/autoscaling/v2/watch/horizontalpodautoscalers {id="_apisautoscalingv2watchhorizontalpodautoscalers"}
...
### /apis/autoscaling/v2/namespaces/{{ namespace }}/horizontalpodautoscalers {id="_apisautoscalingv2namespaces_namespace_horizontalpodautoscalers"}
...
### /apis/autoscaling/v2/watch/namespaces/{{ namespace }}/horizontalpodautoscalers {id="_apisautoscalingv2watchnamespaces_namespace_horizontalpodautoscalers"}
...
### /apis/autoscaling/v2/namespaces/{{ namespace }}/horizontalpodautoscalers/{{ name }} {id="_apisautoscalingv2namespaces_namespace_horizontalpodautoscalers_name"}
...
### /apis/autoscaling/v2/watch/namespaces/{{ namespace }}/horizontalpodautoscalers/{{ name }} {id="_apisautoscalingv2watchnamespaces_namespace_horizontalpodautoscalers_name"}
...
### /apis/autoscaling/v2/namespaces/{{ namespace }}/horizontalpodautoscalers/{{ name }}/status {id="_apisautoscalingv2namespaces_namespace_horizontalpodautoscalers_name_status"}
