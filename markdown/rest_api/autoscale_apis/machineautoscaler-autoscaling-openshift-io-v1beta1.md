...
# MachineAutoscaler [autoscaling.openshift.io/v1beta1] {id="machineautoscaler-autoscaling-openshift-io-v1beta1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/autoscaling.openshift.io/v1beta1/machineautoscalers {id="_apisautoscalingopenshiftiov1beta1machineautoscalers"}
...
### /apis/autoscaling.openshift.io/v1beta1/namespaces/{{ namespace }}/machineautoscalers {id="_apisautoscalingopenshiftiov1beta1namespaces_namespace_machineautoscalers"}
...
### /apis/autoscaling.openshift.io/v1beta1/namespaces/{{ namespace }}/machineautoscalers/{{ name }} {id="_apisautoscalingopenshiftiov1beta1namespaces_namespace_machineautoscalers_name"}
...
### /apis/autoscaling.openshift.io/v1beta1/namespaces/{{ namespace }}/machineautoscalers/{{ name }}/status {id="_apisautoscalingopenshiftiov1beta1namespaces_namespace_machineautoscalers_name_status"}
