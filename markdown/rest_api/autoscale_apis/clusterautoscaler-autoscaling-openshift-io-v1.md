...
# ClusterAutoscaler [autoscaling.openshift.io/v1] {id="clusterautoscaler-autoscaling-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/autoscaling.openshift.io/v1/clusterautoscalers {id="_apisautoscalingopenshiftiov1clusterautoscalers"}
...
### /apis/autoscaling.openshift.io/v1/clusterautoscalers/{{ name }} {id="_apisautoscalingopenshiftiov1clusterautoscalers_name"}
...
### /apis/autoscaling.openshift.io/v1/clusterautoscalers/{{ name }}/status {id="_apisautoscalingopenshiftiov1clusterautoscalers_name_status"}
