...
# ProjectHelmChartRepository [helm.openshift.io/v1beta1] {id="projecthelmchartrepository-helm-openshift-io-v1beta1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/helm.openshift.io/v1beta1/projecthelmchartrepositories {id="_apishelmopenshiftiov1beta1projecthelmchartrepositories"}
...
### /apis/helm.openshift.io/v1beta1/namespaces/{{ namespace }}/projecthelmchartrepositories {id="_apishelmopenshiftiov1beta1namespaces_namespace_projecthelmchartrepositories"}
...
### /apis/helm.openshift.io/v1beta1/namespaces/{{ namespace }}/projecthelmchartrepositories/{{ name }} {id="_apishelmopenshiftiov1beta1namespaces_namespace_projecthelmchartrepositories_name"}
...
### /apis/helm.openshift.io/v1beta1/namespaces/{{ namespace }}/projecthelmchartrepositories/{{ name }}/status {id="_apishelmopenshiftiov1beta1namespaces_namespace_projecthelmchartrepositories_name_status"}
