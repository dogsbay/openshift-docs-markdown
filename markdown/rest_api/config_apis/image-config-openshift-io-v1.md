...
# Image [config.openshift.io/v1] {id="image-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/config.openshift.io/v1/images {id="_apisconfigopenshiftiov1images"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ImageList`](/rest_api/objects/index#io-openshift-config-v1-ImageList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`Image`](/rest_api/config_apis/image-config-openshift-io-v1#image-config-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Image`](/rest_api/config_apis/image-config-openshift-io-v1#image-config-openshift-io-v1) schema |
| 201 - Created | [`Image`](/rest_api/config_apis/image-config-openshift-io-v1#image-config-openshift-io-v1) schema |
| 202 - Accepted | [`Image`](/rest_api/config_apis/image-config-openshift-io-v1#image-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/config.openshift.io/v1/images/{{ name }} {id="_apisconfigopenshiftiov1images_name"}
...
### /apis/config.openshift.io/v1/images/{{ name }}/status {id="_apisconfigopenshiftiov1images_name_status"}
