...
# Infrastructure [config.openshift.io/v1] {id="infrastructure-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.platformSpec.aws {id="_specplatformspecaws"}
...
### .spec.platformSpec.baremetal {id="_specplatformspecbaremetal"}
...
### .spec.platformSpec.external {id="_specplatformspecexternal"}
...
### .spec.platformSpec.ibmcloud {id="_specplatformspecibmcloud"}
...
### .spec.platformSpec.kubevirt {id="_specplatformspeckubevirt"}
...
### .spec.platformSpec.nutanix {id="_specplatformspecnutanix"}
...
### .spec.platformSpec.powervs {id="_specplatformspecpowervs"}
...
### /apis/config.openshift.io/v1/infrastructures {id="_apisconfigopenshiftiov1infrastructures"}
...
### /apis/config.openshift.io/v1/infrastructures/{{ name }} {id="_apisconfigopenshiftiov1infrastructures_name"}
...
### /apis/config.openshift.io/v1/infrastructures/{{ name }}/status {id="_apisconfigopenshiftiov1infrastructures_name_status"}
