...
# InsightsDataGather [config.openshift.io/v1] {id="insightsdatagather-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/config.openshift.io/v1/insightsdatagathers {id="_apisconfigopenshiftiov1insightsdatagathers"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`InsightsDataGatherList`](/rest_api/objects/index#io-openshift-config-v1-InsightsDataGatherList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`InsightsDataGather`](/rest_api/config_apis/insightsdatagather-config-openshift-io-v1#insightsdatagather-config-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`InsightsDataGather`](/rest_api/config_apis/insightsdatagather-config-openshift-io-v1#insightsdatagather-config-openshift-io-v1) schema |
| 201 - Created | [`InsightsDataGather`](/rest_api/config_apis/insightsdatagather-config-openshift-io-v1#insightsdatagather-config-openshift-io-v1) schema |
| 202 - Accepted | [`InsightsDataGather`](/rest_api/config_apis/insightsdatagather-config-openshift-io-v1#insightsdatagather-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/config.openshift.io/v1/insightsdatagathers/{{ name }} {id="_apisconfigopenshiftiov1insightsdatagathers_name"}
