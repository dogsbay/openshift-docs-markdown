...
# ImagePolicy [config.openshift.io/v1] {id="imagepolicy-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
*   `/apis/config.openshift.io/v1/namespaces/{{ namespace }}/imagepolicies`{minja}
    *   `DELETE`: delete collection of ImagePolicy
    *   `GET`: list objects of kind ImagePolicy
    *   `POST`: create an ImagePolicy
*   `/apis/config.openshift.io/v1/namespaces/{{ namespace }}/imagepolicies/{{ name }}`{minja}
...
*   `/apis/config.openshift.io/v1/namespaces/{{ namespace }}/imagepolicies/{{ name }}/status`{minja}
...
### /apis/config.openshift.io/v1/imagepolicies {id="_apisconfigopenshiftiov1imagepolicies"}
...
| --- | --- |
| 200 - OK | [`ImagePolicyList`](/rest_api/objects/index#io-openshift-config-v1-ImagePolicyList) schema |
| 401 - Unauthorized | Empty |

### /apis/config.openshift.io/v1/namespaces/{{ namespace }}/imagepolicies {id="_apisconfigopenshiftiov1namespaces_namespace_imagepolicies"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`ImagePolicy`](/rest_api/config_apis/imagepolicy-config-openshift-io-v1#imagepolicy-config-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ImagePolicy`](/rest_api/config_apis/imagepolicy-config-openshift-io-v1#imagepolicy-config-openshift-io-v1) schema |
| 201 - Created | [`ImagePolicy`](/rest_api/config_apis/imagepolicy-config-openshift-io-v1#imagepolicy-config-openshift-io-v1) schema |
| 202 - Accepted | [`ImagePolicy`](/rest_api/config_apis/imagepolicy-config-openshift-io-v1#imagepolicy-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/config.openshift.io/v1/namespaces/{{ namespace }}/imagepolicies/{{ name }} {id="_apisconfigopenshiftiov1namespaces_namespace_imagepolicies_name"}
...
### /apis/config.openshift.io/v1/namespaces/{{ namespace }}/imagepolicies/{{ name }}/status {id="_apisconfigopenshiftiov1namespaces_namespace_imagepolicies_name_status"}
