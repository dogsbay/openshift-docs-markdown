...
# Ingress [config.openshift.io/v1] {id="ingress-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.componentRoutes {id="_speccomponentroutes"}
...
### .spec.componentRoutes[].servingCertKeyPairSecret {id="_speccomponentroutesservingcertkeypairsecret"}
...
### .spec.loadBalancer {id="_specloadbalancer"}
...
### .spec.loadBalancer.platform {id="_specloadbalancerplatform"}
...
### .spec.loadBalancer.platform.aws {id="_specloadbalancerplatformaws"}
...
### .spec.requiredHSTSPolicies {id="_specrequiredhstspolicies"}
...
### .spec.requiredHSTSPolicies[].maxAge {id="_specrequiredhstspoliciesmaxage"}
...
### .spec.requiredHSTSPolicies[].namespaceSelector {id="_specrequiredhstspoliciesnamespaceselector"}
...
### .spec.requiredHSTSPolicies[].namespaceSelector.matchExpressions {id="_specrequiredhstspoliciesnamespaceselectormatchexpressions"}
...
### .status.componentRoutes {id="_statuscomponentroutes"}
...
### .status.componentRoutes[].conditions {id="_statuscomponentroutesconditions"}
...
### .status.componentRoutes[].relatedObjects {id="_statuscomponentroutesrelatedobjects"}
...
*   `/apis/config.openshift.io/v1/ingresses/{{ name }}`{minja}
...
*   `/apis/config.openshift.io/v1/ingresses/{{ name }}/status`{minja}
...
### /apis/config.openshift.io/v1/ingresses {id="_apisconfigopenshiftiov1ingresses"}
...
### /apis/config.openshift.io/v1/ingresses/{{ name }} {id="_apisconfigopenshiftiov1ingresses_name"}
...
### /apis/config.openshift.io/v1/ingresses/{{ name }}/status {id="_apisconfigopenshiftiov1ingresses_name_status"}
