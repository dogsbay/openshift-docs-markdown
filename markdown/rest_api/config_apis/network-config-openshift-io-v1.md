...
# Network [config.openshift.io/v1] {id="network-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/config.openshift.io/v1/networks {id="_apisconfigopenshiftiov1networks"}
...
### /apis/config.openshift.io/v1/networks/{{ name }} {id="_apisconfigopenshiftiov1networks_name"}
