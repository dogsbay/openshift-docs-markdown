...
# Authentication [config.openshift.io/v1] {id="authentication-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/config.openshift.io/v1/authentications {id="_apisconfigopenshiftiov1authentications"}
...
### /apis/config.openshift.io/v1/authentications/{{ name }} {id="_apisconfigopenshiftiov1authentications_name"}
...
### /apis/config.openshift.io/v1/authentications/{{ name }}/status {id="_apisconfigopenshiftiov1authentications_name_status"}
