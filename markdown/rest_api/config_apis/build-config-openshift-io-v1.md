...
# Build [config.openshift.io/v1] {id="build-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/config.openshift.io/v1/builds {id="_apisconfigopenshiftiov1builds"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`BuildList`](/rest_api/objects/index#io-openshift-config-v1-BuildList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`Build`](/rest_api/config_apis/build-config-openshift-io-v1#build-config-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Build`](/rest_api/config_apis/build-config-openshift-io-v1#build-config-openshift-io-v1) schema |
| 201 - Created | [`Build`](/rest_api/config_apis/build-config-openshift-io-v1#build-config-openshift-io-v1) schema |
| 202 - Accepted | [`Build`](/rest_api/config_apis/build-config-openshift-io-v1#build-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/config.openshift.io/v1/builds/{{ name }} {id="_apisconfigopenshiftiov1builds_name"}
...
### /apis/config.openshift.io/v1/builds/{{ name }}/status {id="_apisconfigopenshiftiov1builds_name_status"}
