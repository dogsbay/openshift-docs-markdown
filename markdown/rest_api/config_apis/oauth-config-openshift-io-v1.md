...
# OAuth [config.openshift.io/v1] {id="oauth-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/config.openshift.io/v1/oauths {id="_apisconfigopenshiftiov1oauths"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`OAuthList`](/rest_api/objects/index#io-openshift-config-v1-OAuthList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`OAuth`](/rest_api/config_apis/oauth-config-openshift-io-v1#oauth-config-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`OAuth`](/rest_api/config_apis/oauth-config-openshift-io-v1#oauth-config-openshift-io-v1) schema |
| 201 - Created | [`OAuth`](/rest_api/config_apis/oauth-config-openshift-io-v1#oauth-config-openshift-io-v1) schema |
| 202 - Accepted | [`OAuth`](/rest_api/config_apis/oauth-config-openshift-io-v1#oauth-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/config.openshift.io/v1/oauths/{{ name }} {id="_apisconfigopenshiftiov1oauths_name"}
...
### /apis/config.openshift.io/v1/oauths/{{ name }}/status {id="_apisconfigopenshiftiov1oauths_name_status"}
