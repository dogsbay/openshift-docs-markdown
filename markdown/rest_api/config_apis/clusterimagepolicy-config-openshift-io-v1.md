...
# ClusterImagePolicy [config.openshift.io/v1] {id="clusterimagepolicy-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/config.openshift.io/v1/clusterimagepolicies {id="_apisconfigopenshiftiov1clusterimagepolicies"}
...
### /apis/config.openshift.io/v1/clusterimagepolicies/{{ name }} {id="_apisconfigopenshiftiov1clusterimagepolicies_name"}
...
### /apis/config.openshift.io/v1/clusterimagepolicies/{{ name }}/status {id="_apisconfigopenshiftiov1clusterimagepolicies_name_status"}
