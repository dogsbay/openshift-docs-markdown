...
# APIServer [config.openshift.io/v1] {id="apiserver-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.audit.customRules {id="_specauditcustomrules"}
...
### .spec.clientCA {id="_specclientca"}
...
### .spec.encryption {id="_specencryption"}
...
### .spec.servingCerts {id="_specservingcerts"}
...
### .spec.servingCerts.namedCertificates {id="_specservingcertsnamedcertificates"}
...
### .spec.servingCerts.namedCertificates[].servingCertificate {id="_specservingcertsnamedcertificatesservingcertificate"}
...
*   `/apis/config.openshift.io/v1/apiservers/{{ name }}`{minja}
...
*   `/apis/config.openshift.io/v1/apiservers/{{ name }}/status`{minja}
...
### /apis/config.openshift.io/v1/apiservers {id="_apisconfigopenshiftiov1apiservers"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`APIServerList`](/rest_api/objects/index#io-openshift-config-v1-APIServerList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`APIServer`](/rest_api/config_apis/apiserver-config-openshift-io-v1#apiserver-config-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`APIServer`](/rest_api/config_apis/apiserver-config-openshift-io-v1#apiserver-config-openshift-io-v1) schema |
| 201 - Created | [`APIServer`](/rest_api/config_apis/apiserver-config-openshift-io-v1#apiserver-config-openshift-io-v1) schema |
| 202 - Accepted | [`APIServer`](/rest_api/config_apis/apiserver-config-openshift-io-v1#apiserver-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/config.openshift.io/v1/apiservers/{{ name }} {id="_apisconfigopenshiftiov1apiservers_name"}
...
### /apis/config.openshift.io/v1/apiservers/{{ name }}/status {id="_apisconfigopenshiftiov1apiservers_name_status"}
