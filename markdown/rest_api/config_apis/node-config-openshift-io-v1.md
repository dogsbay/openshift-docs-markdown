...
# Node [config.openshift.io/v1] {id="node-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/config.openshift.io/v1/nodes {id="_apisconfigopenshiftiov1nodes"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`NodeList`](/rest_api/objects/index#io-openshift-config-v1-NodeList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`Node`](/rest_api/config_apis/node-config-openshift-io-v1#node-config-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Node`](/rest_api/config_apis/node-config-openshift-io-v1#node-config-openshift-io-v1) schema |
| 201 - Created | [`Node`](/rest_api/config_apis/node-config-openshift-io-v1#node-config-openshift-io-v1) schema |
| 202 - Accepted | [`Node`](/rest_api/config_apis/node-config-openshift-io-v1#node-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/config.openshift.io/v1/nodes/{{ name }} {id="_apisconfigopenshiftiov1nodes_name"}
...
### /apis/config.openshift.io/v1/nodes/{{ name }}/status {id="_apisconfigopenshiftiov1nodes_name_status"}
