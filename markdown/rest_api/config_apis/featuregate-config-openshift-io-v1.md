...
# FeatureGate [config.openshift.io/v1] {id="featuregate-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/config.openshift.io/v1/featuregates {id="_apisconfigopenshiftiov1featuregates"}
...
### /apis/config.openshift.io/v1/featuregates/{{ name }} {id="_apisconfigopenshiftiov1featuregates_name"}
...
### /apis/config.openshift.io/v1/featuregates/{{ name }}/status {id="_apisconfigopenshiftiov1featuregates_name_status"}
