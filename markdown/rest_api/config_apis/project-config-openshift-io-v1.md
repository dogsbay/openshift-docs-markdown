...
# Project [config.openshift.io/v1] {id="project-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/config.openshift.io/v1/projects {id="_apisconfigopenshiftiov1projects"}
...
### /apis/config.openshift.io/v1/projects/{{ name }} {id="_apisconfigopenshiftiov1projects_name"}
...
### /apis/config.openshift.io/v1/projects/{{ name }}/status {id="_apisconfigopenshiftiov1projects_name_status"}
