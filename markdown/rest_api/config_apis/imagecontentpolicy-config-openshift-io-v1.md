...
# ImageContentPolicy [config.openshift.io/v1] {id="imagecontentpolicy-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/config.openshift.io/v1/imagecontentpolicies {id="_apisconfigopenshiftiov1imagecontentpolicies"}
...
### /apis/config.openshift.io/v1/imagecontentpolicies/{{ name }} {id="_apisconfigopenshiftiov1imagecontentpolicies_name"}
...
### /apis/config.openshift.io/v1/imagecontentpolicies/{{ name }}/status {id="_apisconfigopenshiftiov1imagecontentpolicies_name_status"}
