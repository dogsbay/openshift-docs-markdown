...
# OperatorHub [config.openshift.io/v1] {id="operatorhub-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/config.openshift.io/v1/operatorhubs {id="_apisconfigopenshiftiov1operatorhubs"}
...
### /apis/config.openshift.io/v1/operatorhubs/{{ name }} {id="_apisconfigopenshiftiov1operatorhubs_name"}
...
### /apis/config.openshift.io/v1/operatorhubs/{{ name }}/status {id="_apisconfigopenshiftiov1operatorhubs_name_status"}
