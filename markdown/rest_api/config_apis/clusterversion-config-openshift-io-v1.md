...
# ClusterVersion [config.openshift.io/v1] {id="clusterversion-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.capabilities {id="_speccapabilities"}
...
### .spec.desiredUpdate {id="_specdesiredupdate"}
...
:   desiredUpdate is an optional field that indicates the desired value of
    ...
    1.  image is specified, version is specified, architecture is not specified. The version extracted from the referenced image must match the specified version.
    1.  image is specified, version is not specified, architecture is specified. API validation error.
    1.  image is specified, version is not specified, architecture is not specified. image is used.
    1.  image is not specified, version is specified, architecture is specified. version and desired architecture are used to select an image.
    1.  image is not specified, version is specified, architecture is not specified. version and current architecture are used to select an image.
    1.  image is not specified, version is not specified, architecture is specified. API validation error.
    1.  image is not specified, version is not specified, architecture is not specified. API validation error.
...
### .status.capabilities {id="_statuscapabilities"}
...
### .status.conditionalUpdates {id="_statusconditionalupdates"}
...
### .status.conditionalUpdates[].conditions {id="_statusconditionalupdatesconditions"}
...
### .status.conditionalUpdates[].release {id="_statusconditionalupdatesrelease"}
...
### .status.conditionalUpdates[].risks {id="_statusconditionalupdatesrisks"}
...
### .status.conditionalUpdates[].risks[].matchingRules {id="_statusconditionalupdatesrisksmatchingrules"}
...
### .status.conditionalUpdates[].risks[].matchingRules[].promql {id="_statusconditionalupdatesrisksmatchingrulespromql"}
...
### .status.desired {id="_statusdesired"}
...
### .status.history {id="_statushistory"}
...
*   `/apis/config.openshift.io/v1/clusterversions/{{ name }}`{minja}
...
*   `/apis/config.openshift.io/v1/clusterversions/{{ name }}/status`{minja}
...
### /apis/config.openshift.io/v1/clusterversions {id="_apisconfigopenshiftiov1clusterversions"}
...
### /apis/config.openshift.io/v1/clusterversions/{{ name }} {id="_apisconfigopenshiftiov1clusterversions_name"}
...
### /apis/config.openshift.io/v1/clusterversions/{{ name }}/status {id="_apisconfigopenshiftiov1clusterversions_name_status"}
