...
# ImageDigestMirrorSet [config.openshift.io/v1] {id="imagedigestmirrorset-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.imageDigestMirrors {id="_specimagedigestmirrors"}
...
*   `/apis/config.openshift.io/v1/imagedigestmirrorsets/{{ name }}`{minja}
...
*   `/apis/config.openshift.io/v1/imagedigestmirrorsets/{{ name }}/status`{minja}
...
### /apis/config.openshift.io/v1/imagedigestmirrorsets {id="_apisconfigopenshiftiov1imagedigestmirrorsets"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ImageDigestMirrorSetList`](/rest_api/objects/index#io-openshift-config-v1-ImageDigestMirrorSetList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`ImageDigestMirrorSet`](/rest_api/config_apis/imagedigestmirrorset-config-openshift-io-v1#imagedigestmirrorset-config-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ImageDigestMirrorSet`](/rest_api/config_apis/imagedigestmirrorset-config-openshift-io-v1#imagedigestmirrorset-config-openshift-io-v1) schema |
| 201 - Created | [`ImageDigestMirrorSet`](/rest_api/config_apis/imagedigestmirrorset-config-openshift-io-v1#imagedigestmirrorset-config-openshift-io-v1) schema |
| 202 - Accepted | [`ImageDigestMirrorSet`](/rest_api/config_apis/imagedigestmirrorset-config-openshift-io-v1#imagedigestmirrorset-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/config.openshift.io/v1/imagedigestmirrorsets/{{ name }} {id="_apisconfigopenshiftiov1imagedigestmirrorsets_name"}
...
### /apis/config.openshift.io/v1/imagedigestmirrorsets/{{ name }}/status {id="_apisconfigopenshiftiov1imagedigestmirrorsets_name_status"}
