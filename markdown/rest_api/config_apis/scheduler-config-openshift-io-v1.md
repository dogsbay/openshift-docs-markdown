...
# Scheduler [config.openshift.io/v1] {id="scheduler-config-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/config.openshift.io/v1/schedulers {id="_apisconfigopenshiftiov1schedulers"}
...
### /apis/config.openshift.io/v1/schedulers/{{ name }} {id="_apisconfigopenshiftiov1schedulers_name"}
...
### /apis/config.openshift.io/v1/schedulers/{{ name }}/status {id="_apisconfigopenshiftiov1schedulers_name_status"}
