...
# TemplateInstance [template.openshift.io/v1] {id="templateinstance-template-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/template.openshift.io/v1/templateinstances {id="_apistemplateopenshiftiov1templateinstances"}
...
### /apis/template.openshift.io/v1/watch/templateinstances {id="_apistemplateopenshiftiov1watchtemplateinstances"}
...
### /apis/template.openshift.io/v1/namespaces/{{ namespace }}/templateinstances {id="_apistemplateopenshiftiov1namespaces_namespace_templateinstances"}
...
### /apis/template.openshift.io/v1/watch/namespaces/{{ namespace }}/templateinstances {id="_apistemplateopenshiftiov1watchnamespaces_namespace_templateinstances"}
...
### /apis/template.openshift.io/v1/namespaces/{{ namespace }}/templateinstances/{{ name }} {id="_apistemplateopenshiftiov1namespaces_namespace_templateinstances_name"}
...
### /apis/template.openshift.io/v1/watch/namespaces/{{ namespace }}/templateinstances/{{ name }} {id="_apistemplateopenshiftiov1watchnamespaces_namespace_templateinstances_name"}
...
### /apis/template.openshift.io/v1/namespaces/{{ namespace }}/templateinstances/{{ name }}/status {id="_apistemplateopenshiftiov1namespaces_namespace_templateinstances_name_status"}
