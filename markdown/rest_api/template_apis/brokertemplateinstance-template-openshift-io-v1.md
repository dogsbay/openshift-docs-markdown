...
# BrokerTemplateInstance [template.openshift.io/v1] {id="brokertemplateinstance-template-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/template.openshift.io/v1/watch/brokertemplateinstances {id="_apistemplateopenshiftiov1watchbrokertemplateinstances"}
...
### /apis/template.openshift.io/v1/brokertemplateinstances/{{ name }} {id="_apistemplateopenshiftiov1brokertemplateinstances_name"}
...
### /apis/template.openshift.io/v1/watch/brokertemplateinstances/{{ name }} {id="_apistemplateopenshiftiov1watchbrokertemplateinstances_name"}
