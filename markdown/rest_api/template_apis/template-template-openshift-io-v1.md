...
# Template [template.openshift.io/v1] {id="template-template-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/template.openshift.io/v1/watch/templates {id="_apistemplateopenshiftiov1watchtemplates"}
...
### /apis/template.openshift.io/v1/namespaces/{{ namespace }}/templates {id="_apistemplateopenshiftiov1namespaces_namespace_templates"}
...
### /apis/template.openshift.io/v1/watch/namespaces/{{ namespace }}/templates {id="_apistemplateopenshiftiov1watchnamespaces_namespace_templates"}
...
### /apis/template.openshift.io/v1/namespaces/{{ namespace }}/templates/{{ name }} {id="_apistemplateopenshiftiov1namespaces_namespace_templates_name"}
...
### /apis/template.openshift.io/v1/namespaces/{{ namespace }}/processedtemplates {id="_apistemplateopenshiftiov1namespaces_namespace_processedtemplates"}
...
### /apis/template.openshift.io/v1/watch/namespaces/{{ namespace }}/templates/{{ name }} {id="_apistemplateopenshiftiov1watchnamespaces_namespace_templates_name"}
