...
*   `/apis/gateway.networking.k8s.io/v1/namespaces/{{ namespace }}/httproutes`{minja}
    *   `DELETE`: delete collection of HTTPRoute
    *   `GET`: list objects of kind HTTPRoute
    *   `POST`: create a HTTPRoute
*   `/apis/gateway.networking.k8s.io/v1/namespaces/{{ namespace }}/httproutes/{{ name }}`{minja}
...
*   `/apis/gateway.networking.k8s.io/v1/namespaces/{{ namespace }}/httproutes/{{ name }}/status`{minja}
