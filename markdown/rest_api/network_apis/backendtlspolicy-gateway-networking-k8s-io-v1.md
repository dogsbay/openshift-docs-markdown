...
*   `/apis/gateway.networking.k8s.io/v1/namespaces/{{ namespace }}/backendtlspolicies`{minja}
    *   `DELETE`: delete collection of BackendTLSPolicy
    *   `GET`: list objects of kind BackendTLSPolicy
    *   `POST`: create a BackendTLSPolicy
*   `/apis/gateway.networking.k8s.io/v1/namespaces/{{ namespace }}/backendtlspolicies/{{ name }}`{minja}
...
*   `/apis/gateway.networking.k8s.io/v1/namespaces/{{ namespace }}/backendtlspolicies/{{ name }}/status`{minja}
