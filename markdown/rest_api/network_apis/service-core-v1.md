...
# Service [core/v1] {id="service-core-v1"}
{%- if product_title %}
...
| `ports` | [`array (ServicePort core/v1)`](/rest_api/objects/index#serviceport-core-v1) | The list of ports that are exposed by this service. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies |
...
| `sessionAffinityConfig` | [`SessionAffinityConfig core/v1`](/rest_api/objects/index#sessionaffinityconfig-core-v1) | sessionAffinityConfig contains the configurations of session affinity. |
...
| Property | Type | Description |
| --- | --- | --- |
| `conditions` | [`array (Condition meta/v1)`](/rest_api/objects/index#condition-meta-v1) | Current service state |
...
| Property | Type | Description |
| --- | --- | --- |
| `ingress` | [`array (LoadBalancerIngress core/v1)`](/rest_api/objects/index#loadbalanceringress-core-v1) | Ingress is a list containing ingress points for the load-balancer. Traffic intended for the service should be sent to these ingress points. |
...
*   `/api/v1/namespaces/{{ namespace }}/services`{minja}
    *   `GET`: list or watch objects of kind Service
    *   `POST`: create a Service
*   `/api/v1/namespaces/{{ namespace }}/services/{{ name }}`{minja}
    *   `DELETE`: delete a Service
    *   `GET`: read the specified Service
    *   `PATCH`: partially update the specified Service
    *   `PUT`: replace the specified Service
*   `/api/v1/namespaces/{{ namespace }}/services/{{ name }}/proxy`{minja}
...
*   `/api/v1/namespaces/{{ namespace }}/services/{{ name }}/status`{minja}
...
*   `/api/v1/namespaces/{{ namespace }}/services/{{ name }}/proxy/{{ path }}`{minja}
    *   `DELETE`: connect DELETE requests to proxy of Service
    *   `GET`: connect GET requests to proxy of Service
    *   `HEAD`: connect HEAD requests to proxy of Service
    *   `OPTIONS`: connect OPTIONS requests to proxy of Service
...
### /api/v1/services {id="_apiv1services"}
...
| --- | --- |
| 200 - OK | [`ServiceList core/v1`](/rest_api/objects/index#servicelist-core-v1) |

### /api/v1/namespaces/{{ namespace }}/services {id="_apiv1namespaces_namespace_services"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`Service core/v1`](/rest_api/network_apis/service-core-v1#service-core-v1) |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Service core/v1`](/rest_api/network_apis/service-core-v1#service-core-v1) |

### /api/v1/namespaces/{{ namespace }}/services/{{ name }} {id="_apiv1namespaces_namespace_services_name"}
...
### /api/v1/namespaces/{{ namespace }}/services/{{ name }}/proxy {id="_apiv1namespaces_namespace_services_name_proxy"}
...
### /api/v1/namespaces/{{ namespace }}/services/{{ name }}/status {id="_apiv1namespaces_namespace_services_name_status"}
...
### /api/v1/namespaces/{{ namespace }}/services/{{ name }}/proxy/{{ path }} {id="_apiv1namespaces_namespace_services_name_proxy_path"}
