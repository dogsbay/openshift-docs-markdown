...
# CloudPrivateIPConfig [cloud.network.openshift.io/v1] {id="cloudprivateipconfig-cloud-network-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/cloud.network.openshift.io/v1/cloudprivateipconfigs {id="_apiscloudnetworkopenshiftiov1cloudprivateipconfigs"}
...
### /apis/cloud.network.openshift.io/v1/cloudprivateipconfigs/{{ name }} {id="_apiscloudnetworkopenshiftiov1cloudprivateipconfigs_name"}
...
### /apis/cloud.network.openshift.io/v1/cloudprivateipconfigs/{{ name }}/status {id="_apiscloudnetworkopenshiftiov1cloudprivateipconfigs_name_status"}
