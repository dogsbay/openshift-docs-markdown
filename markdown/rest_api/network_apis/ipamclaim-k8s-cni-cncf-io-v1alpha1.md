...
# IPAMClaim [k8s.cni.cncf.io/v1alpha1] {id="ipamclaim-k8s-cni-cncf-io-v1alpha1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/k8s.cni.cncf.io/v1alpha1/ipamclaims {id="_apisk8scnicncfiov1alpha1ipamclaims"}
...
| --- | --- |
| 200 - OK | [`IPAMClaimList`](/rest_api/objects/index#io-cncf-cni-k8s-v1alpha1-IPAMClaimList) schema |
| 401 - Unauthorized | Empty |

### /apis/k8s.cni.cncf.io/v1alpha1/namespaces/{{ namespace }}/ipamclaims {id="_apisk8scnicncfiov1alpha1namespaces_namespace_ipamclaims"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`IPAMClaim`](/rest_api/network_apis/ipamclaim-k8s-cni-cncf-io-v1alpha1#ipamclaim-k8s-cni-cncf-io-v1alpha1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`IPAMClaim`](/rest_api/network_apis/ipamclaim-k8s-cni-cncf-io-v1alpha1#ipamclaim-k8s-cni-cncf-io-v1alpha1) schema |
| 201 - Created | [`IPAMClaim`](/rest_api/network_apis/ipamclaim-k8s-cni-cncf-io-v1alpha1#ipamclaim-k8s-cni-cncf-io-v1alpha1) schema |
| 202 - Accepted | [`IPAMClaim`](/rest_api/network_apis/ipamclaim-k8s-cni-cncf-io-v1alpha1#ipamclaim-k8s-cni-cncf-io-v1alpha1) schema |
| 401 - Unauthorized | Empty |

### /apis/k8s.cni.cncf.io/v1alpha1/namespaces/{{ namespace }}/ipamclaims/{{ name }} {id="_apisk8scnicncfiov1alpha1namespaces_namespace_ipamclaims_name"}
...
### /apis/k8s.cni.cncf.io/v1alpha1/namespaces/{{ namespace }}/ipamclaims/{{ name }}/status {id="_apisk8scnicncfiov1alpha1namespaces_namespace_ipamclaims_name_status"}
