...
# ServiceCIDR [networking.k8s.io/v1] {id="servicecidr-networking-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/networking.k8s.io/v1/servicecidrs {id="_apisnetworkingk8siov1servicecidrs"}
...
### /apis/networking.k8s.io/v1/watch/servicecidrs {id="_apisnetworkingk8siov1watchservicecidrs"}
...
### /apis/networking.k8s.io/v1/servicecidrs/{{ name }} {id="_apisnetworkingk8siov1servicecidrs_name"}
...
### /apis/networking.k8s.io/v1/watch/servicecidrs/{{ name }} {id="_apisnetworkingk8siov1watchservicecidrs_name"}
...
### /apis/networking.k8s.io/v1/servicecidrs/{{ name }}/status {id="_apisnetworkingk8siov1servicecidrs_name_status"}
