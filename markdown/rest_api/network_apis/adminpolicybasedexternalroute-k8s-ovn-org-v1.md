...
# AdminPolicyBasedExternalRoute [k8s.ovn.org/v1] {id="adminpolicybasedexternalroute-k8s-ovn-org-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/k8s.ovn.org/v1/adminpolicybasedexternalroutes {id="_apisk8sovnorgv1adminpolicybasedexternalroutes"}
...
### /apis/k8s.ovn.org/v1/adminpolicybasedexternalroutes/{{ name }} {id="_apisk8sovnorgv1adminpolicybasedexternalroutes_name"}
...
### /apis/k8s.ovn.org/v1/adminpolicybasedexternalroutes/{{ name }}/status {id="_apisk8sovnorgv1adminpolicybasedexternalroutes_name_status"}
