...
### .spec.sessionAffinityConfig {id="_specsessionaffinityconfig"}
...
### .spec.sessionAffinityConfig.clientIP {id="_specsessionaffinityconfigclientip"}
...
*   `/api/v1/watch/namespaces/{{ namespace }}/services`{minja}
    *   `GET`: watch individual changes to a list of Service. deprecated: use the &#x27;watch&#x27; parameter with a list operation instead.
...
*   `/api/v1/watch/namespaces/{{ namespace }}/services/{{ name }}`{minja}
...
### /api/v1/watch/services {id="_apiv1watchservices"}
...
### /api/v1/watch/namespaces/{{ namespace }}/services {id="_apiv1watchnamespaces_namespace_services"}
...
### /api/v1/watch/namespaces/{{ namespace }}/services/{{ name }} {id="_apiv1watchnamespaces_namespace_services_name"}
