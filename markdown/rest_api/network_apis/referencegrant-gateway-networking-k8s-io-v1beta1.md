...
# ReferenceGrant [gateway.networking.k8s.io/v1beta1] {id="referencegrant-gateway-networking-k8s-io-v1beta1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/gateway.networking.k8s.io/v1beta1/referencegrants {id="_apisgatewaynetworkingk8siov1beta1referencegrants"}
...
### /apis/gateway.networking.k8s.io/v1beta1/namespaces/{{ namespace }}/referencegrants {id="_apisgatewaynetworkingk8siov1beta1namespaces_namespace_referencegrants"}
...
### /apis/gateway.networking.k8s.io/v1beta1/namespaces/{{ namespace }}/referencegrants/{{ name }} {id="_apisgatewaynetworkingk8siov1beta1namespaces_namespace_referencegrants_name"}
