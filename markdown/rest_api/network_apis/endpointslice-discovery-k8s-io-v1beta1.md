...
# EndpointSlice [discovery.k8s.io/v1beta1] {id="endpointslice-discovery-k8s-io-v1beta1"}
{%- if product_title %}
...
| `metadata` | [`ObjectMeta meta/v1`](/rest_api/objects/index#objectmeta-meta-v1) | Standard object’s metadata. |
...
| `targetRef` | [`ObjectReference core/v1`](/rest_api/objects/index#objectreference-core-v1) | targetRef is a reference to a Kubernetes object that represents this endpoint. |
| `topology` | `object (string)` | topology contains arbitrary topology information associated with the endpoint. These key/value pairs must conform with the label format. https://kubernetes.io/docs/concepts/overview/working-with-objects/labels Topology may include a maximum of 16 key/value pairs. This includes, but is not limited to the following well known keys: * kubernetes.io/hostname: the value indicates the hostname of the node   where the endpoint is located. This should match the corresponding   node label. * topology.kubernetes.io/zone: the value indicates the zone where the   endpoint is located. This should match the corresponding node label. * topology.kubernetes.io/region: the value indicates the region where the   endpoint is located. This should match the corresponding node label. This field is deprecated and will be removed in future api versions. |
...
| Property | Type | Description |
| --- | --- | --- |
| `forZones` | `array` | forZones indicates the zone(s) this endpoint should be consumed by to enable topology aware routing. May contain a maximum of 8 entries. |
...
*   `/apis/discovery.k8s.io/v1beta1/namespaces/{{ namespace }}/endpointslices`{minja}
    *   `DELETE`: delete collection of EndpointSlice
    *   `GET`: list or watch objects of kind EndpointSlice
    *   `POST`: create an EndpointSlice
*   `/apis/discovery.k8s.io/v1beta1/namespaces/{{ namespace }}/endpointslices/{{ name }}`{minja}
...
### /apis/discovery.k8s.io/v1beta1/endpointslices {id="_apisdiscoveryk8siov1beta1endpointslices"}
...
| --- | --- |
| 200 - OK | [`EndpointSliceList discovery.k8s.io/v1beta1`](/rest_api/objects/index#endpointslicelist-discovery-k8s-io-v1beta1) |

### /apis/discovery.k8s.io/v1beta1/namespaces/{{ namespace }}/endpointslices {id="_apisdiscoveryk8siov1beta1namespaces_namespace_endpointslices"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`EndpointSlice discovery.k8s.io/v1beta1`](/rest_api/network_apis/endpointslice-discovery-k8s-io-v1beta1#endpointslice-discovery-k8s-io-v1beta1) |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`EndpointSlice discovery.k8s.io/v1beta1`](/rest_api/network_apis/endpointslice-discovery-k8s-io-v1beta1#endpointslice-discovery-k8s-io-v1beta1) |

### /apis/discovery.k8s.io/v1beta1/namespaces/{{ namespace }}/endpointslices/{{ name }} {id="_apisdiscoveryk8siov1beta1namespaces_namespace_endpointslices_name"}
