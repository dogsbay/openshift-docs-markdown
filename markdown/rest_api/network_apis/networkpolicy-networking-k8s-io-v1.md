...
# NetworkPolicy [networking.k8s.io/v1] {id="networkpolicy-networking-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
| --- | --- |
| 200 - OK | [`NetworkPolicyList`](/rest_api/objects/index#io-k8s-api-networking-v1-NetworkPolicyList) schema |
| 401 - Unauthorized | Empty |

### /apis/networking.k8s.io/v1/watch/networkpolicies {id="_apisnetworkingk8siov1watchnetworkpolicies"}
...
### /apis/networking.k8s.io/v1/namespaces/{{ namespace }}/networkpolicies {id="_apisnetworkingk8siov1namespaces_namespace_networkpolicies"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`NetworkPolicy`](/rest_api/network_apis/networkpolicy-networking-k8s-io-v1#networkpolicy-networking-k8s-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`NetworkPolicy`](/rest_api/network_apis/networkpolicy-networking-k8s-io-v1#networkpolicy-networking-k8s-io-v1) schema |
| 201 - Created | [`NetworkPolicy`](/rest_api/network_apis/networkpolicy-networking-k8s-io-v1#networkpolicy-networking-k8s-io-v1) schema |
| 202 - Accepted | [`NetworkPolicy`](/rest_api/network_apis/networkpolicy-networking-k8s-io-v1#networkpolicy-networking-k8s-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/networking.k8s.io/v1/watch/namespaces/{{ namespace }}/networkpolicies {id="_apisnetworkingk8siov1watchnamespaces_namespace_networkpolicies"}
...
### /apis/networking.k8s.io/v1/namespaces/{{ namespace }}/networkpolicies/{{ name }} {id="_apisnetworkingk8siov1namespaces_namespace_networkpolicies_name"}
...
### /apis/networking.k8s.io/v1/watch/namespaces/{{ namespace }}/networkpolicies/{{ name }} {id="_apisnetworkingk8siov1watchnamespaces_namespace_networkpolicies_name"}
