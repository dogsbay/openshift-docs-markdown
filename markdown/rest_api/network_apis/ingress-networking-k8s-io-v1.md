...
# Ingress [networking.k8s.io/v1] {id="ingress-networking-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.defaultBackend {id="_specdefaultbackend"}
...
### .spec.defaultBackend.service {id="_specdefaultbackendservice"}
...
### .spec.defaultBackend.service.port {id="_specdefaultbackendserviceport"}
...
### .spec.rules[].http {id="_specruleshttp"}
...
### .spec.rules[].http.paths {id="_specruleshttppaths"}
...
### .spec.rules[].http.paths[].backend {id="_specruleshttppathsbackend"}
...
### .spec.rules[].http.paths[].backend.service {id="_specruleshttppathsbackendservice"}
...
### .spec.rules[].http.paths[].backend.service.port {id="_specruleshttppathsbackendserviceport"}
...
### .status.loadBalancer {id="_statusloadbalancer"}
...
### .status.loadBalancer.ingress {id="_statusloadbalanceringress"}
...
### .status.loadBalancer.ingress[].ports {id="_statusloadbalanceringressports"}
...
*   `/apis/networking.k8s.io/v1/namespaces/{{ namespace }}/ingresses`{minja}
    *   `DELETE`: delete collection of Ingress
    *   `GET`: list or watch objects of kind Ingress
    *   `POST`: create an Ingress
*   `/apis/networking.k8s.io/v1/watch/namespaces/{{ namespace }}/ingresses`{minja}
    *   `GET`: watch individual changes to a list of Ingress. deprecated: use the &#x27;watch&#x27; parameter with a list operation instead.
*   `/apis/networking.k8s.io/v1/namespaces/{{ namespace }}/ingresses/{{ name }}`{minja}
...
*   `/apis/networking.k8s.io/v1/watch/namespaces/{{ namespace }}/ingresses/{{ name }}`{minja}
...
*   `/apis/networking.k8s.io/v1/namespaces/{{ namespace }}/ingresses/{{ name }}/status`{minja}
...
### /apis/networking.k8s.io/v1/ingresses {id="_apisnetworkingk8siov1ingresses"}
...
### /apis/networking.k8s.io/v1/watch/ingresses {id="_apisnetworkingk8siov1watchingresses"}
...
### /apis/networking.k8s.io/v1/namespaces/{{ namespace }}/ingresses {id="_apisnetworkingk8siov1namespaces_namespace_ingresses"}
...
### /apis/networking.k8s.io/v1/watch/namespaces/{{ namespace }}/ingresses {id="_apisnetworkingk8siov1watchnamespaces_namespace_ingresses"}
...
### /apis/networking.k8s.io/v1/namespaces/{{ namespace }}/ingresses/{{ name }} {id="_apisnetworkingk8siov1namespaces_namespace_ingresses_name"}
...
### /apis/networking.k8s.io/v1/watch/namespaces/{{ namespace }}/ingresses/{{ name }} {id="_apisnetworkingk8siov1watchnamespaces_namespace_ingresses_name"}
...
### /apis/networking.k8s.io/v1/namespaces/{{ namespace }}/ingresses/{{ name }}/status {id="_apisnetworkingk8siov1namespaces_namespace_ingresses_name_status"}
