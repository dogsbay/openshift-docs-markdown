...
# MultiNetworkPolicy [k8s.cni.cncf.io/v1beta1] {id="multinetworkpolicy-k8s-cni-cncf-io-v1beta1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/k8s.cni.cncf.io/v1beta1/multi-networkpolicies {id="_apisk8scnicncfiov1beta1multi-networkpolicies"}
...
### /apis/k8s.cni.cncf.io/v1beta1/namespaces/{{ namespace }}/multi-networkpolicies {id="_apisk8scnicncfiov1beta1namespaces_namespace_multi-networkpolicies"}
...
### /apis/k8s.cni.cncf.io/v1beta1/namespaces/{{ namespace }}/multi-networkpolicies/{{ name }} {id="_apisk8scnicncfiov1beta1namespaces_namespace_multi-networkpolicies_name"}
