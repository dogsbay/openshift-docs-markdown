...
# IPPool [whereabouts.cni.cncf.io/v1alpha1] {id="ippool-whereabouts-cni-cncf-io-v1alpha1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/whereabouts.cni.cncf.io/v1alpha1/ippools {id="_apiswhereaboutscnicncfiov1alpha1ippools"}
...
### /apis/whereabouts.cni.cncf.io/v1alpha1/namespaces/{{ namespace }}/ippools {id="_apiswhereaboutscnicncfiov1alpha1namespaces_namespace_ippools"}
...
### /apis/whereabouts.cni.cncf.io/v1alpha1/namespaces/{{ namespace }}/ippools/{{ name }} {id="_apiswhereaboutscnicncfiov1alpha1namespaces_namespace_ippools_name"}
