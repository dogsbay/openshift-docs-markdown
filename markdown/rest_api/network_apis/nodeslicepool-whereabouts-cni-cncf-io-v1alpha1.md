...
# NodeSlicePool [whereabouts.cni.cncf.io/v1alpha1] {id="nodeslicepool-whereabouts-cni-cncf-io-v1alpha1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/whereabouts.cni.cncf.io/v1alpha1/nodeslicepools {id="_apiswhereaboutscnicncfiov1alpha1nodeslicepools"}
...
### /apis/whereabouts.cni.cncf.io/v1alpha1/namespaces/{{ namespace }}/nodeslicepools {id="_apiswhereaboutscnicncfiov1alpha1namespaces_namespace_nodeslicepools"}
...
### /apis/whereabouts.cni.cncf.io/v1alpha1/namespaces/{{ namespace }}/nodeslicepools/{{ name }} {id="_apiswhereaboutscnicncfiov1alpha1namespaces_namespace_nodeslicepools_name"}
