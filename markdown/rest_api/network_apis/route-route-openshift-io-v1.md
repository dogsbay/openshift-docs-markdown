...
# Route [route.openshift.io/v1] {id="route-route-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.alternateBackends {id="_specalternatebackends"}
...
### .status.ingress {id="_statusingress"}
...
### .status.ingress[].conditions {id="_statusingressconditions"}
...
### /apis/route.openshift.io/v1/routes {id="_apisrouteopenshiftiov1routes"}
...
### /apis/route.openshift.io/v1/watch/routes {id="_apisrouteopenshiftiov1watchroutes"}
...
### /apis/route.openshift.io/v1/namespaces/{{ namespace }}/routes {id="_apisrouteopenshiftiov1namespaces_namespace_routes"}
...
### /apis/route.openshift.io/v1/watch/namespaces/{{ namespace }}/routes {id="_apisrouteopenshiftiov1watchnamespaces_namespace_routes"}
...
### /apis/route.openshift.io/v1/namespaces/{{ namespace }}/routes/{{ name }} {id="_apisrouteopenshiftiov1namespaces_namespace_routes_name"}
...
### /apis/route.openshift.io/v1/watch/namespaces/{{ namespace }}/routes/{{ name }} {id="_apisrouteopenshiftiov1watchnamespaces_namespace_routes_name"}
...
### /apis/route.openshift.io/v1/namespaces/{{ namespace }}/routes/{{ name }}/status {id="_apisrouteopenshiftiov1namespaces_namespace_routes_name_status"}
