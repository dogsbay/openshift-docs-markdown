...
# Network APIs {id="network-apis"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}

## ClusterUserDefinedNetwork [k8s.ovn.org/v1] {id="_clusteruserdefinednetwork_k8sovnorgv1"}
...
## AdminNetworkPolicy [policy.networking.k8s.io/v1alpha1] {id="_adminnetworkpolicy_policynetworkingk8siov1alpha1"}
...
## AdminPolicyBasedExternalRoute [k8s.ovn.org/v1] {id="_adminpolicybasedexternalroute_k8sovnorgv1"}
...
## BackendTLSPolicy [gateway.networking.k8s.io/v1] {id="_backendtlspolicy_gatewaynetworkingk8siov1"}
...
## BaselineAdminNetworkPolicy [policy.networking.k8s.io/v1alpha1] {id="_baselineadminnetworkpolicy_policynetworkingk8siov1alpha1"}
...
## CloudPrivateIPConfig [cloud.network.openshift.io/v1] {id="_cloudprivateipconfig_cloudnetworkopenshiftiov1"}
...
## EgressFirewall [k8s.ovn.org/v1] {id="_egressfirewall_k8sovnorgv1"}
...
## EgressIP [k8s.ovn.org/v1] {id="_egressip_k8sovnorgv1"}
...
## EgressQoS [k8s.ovn.org/v1] {id="_egressqos_k8sovnorgv1"}
...
## EgressService [k8s.ovn.org/v1] {id="_egressservice_k8sovnorgv1"}
...
## EndpointSlice [discovery.k8s.io/v1] {id="_endpointslice_discoveryk8siov1"}
...
## EgressRouter [network.operator.openshift.io/v1] {id="_egressrouter_networkoperatoropenshiftiov1"}
...
## GRPCRoute [gateway.networking.k8s.io/v1] {id="_grpcroute_gatewaynetworkingk8siov1"}
...
## Gateway [gateway.networking.k8s.io/v1] {id="_gateway_gatewaynetworkingk8siov1"}
...
## GatewayClass [gateway.networking.k8s.io/v1] {id="_gatewayclass_gatewaynetworkingk8siov1"}
...
## HTTPRoute [gateway.networking.k8s.io/v1] {id="_httproute_gatewaynetworkingk8siov1"}
...
## Ingress [networking.k8s.io/v1] {id="_ingress_networkingk8siov1"}
...
## IngressClass [networking.k8s.io/v1] {id="_ingressclass_networkingk8siov1"}
...
## IPAddress [networking.k8s.io/v1] {id="_ipaddress_networkingk8siov1"}
...
## IPAMClaim [k8s.cni.cncf.io/v1alpha1] {id="_ipamclaim_k8scnicncfiov1alpha1"}
...
## IPPool [whereabouts.cni.cncf.io/v1alpha1] {id="_ippool_whereaboutscnicncfiov1alpha1"}
...
## MultiNetworkPolicy [k8s.cni.cncf.io/v1beta1] {id="_multinetworkpolicy_k8scnicncfiov1beta1"}
...
## NetworkAttachmentDefinition [k8s.cni.cncf.io/v1] {id="_networkattachmentdefinition_k8scnicncfiov1"}
...
## NetworkPolicy [networking.k8s.io/v1] {id="_networkpolicy_networkingk8siov1"}
...
## NodeSlicePool [whereabouts.cni.cncf.io/v1alpha1] {id="_nodeslicepool_whereaboutscnicncfiov1alpha1"}
...
## OverlappingRangeIPReservation [whereabouts.cni.cncf.io/v1alpha1] {id="_overlappingrangeipreservation_whereaboutscnicncfiov1alpha1"}
...
## PodNetworkConnectivityCheck [controlplane.operator.openshift.io/v1alpha1] {id="_podnetworkconnectivitycheck_controlplaneoperatoropenshiftiov1alpha1"}
...
## ReferenceGrant [gateway.networking.k8s.io/v1beta1] {id="_referencegrant_gatewaynetworkingk8siov1beta1"}
...
## Route [route.openshift.io/v1] {id="_route_routeopenshiftiov1"}
...
## ServiceCIDR [networking.k8s.io/v1] {id="_servicecidr_networkingk8siov1"}
...
## IPAddressClaim [ipam.cluster.x-k8s.io/v1beta1] {id="_ipaddressclaim_ipamclusterx-k8siov1beta1"}
...
## UserDefinedNetwork [k8s.ovn.org/v1] {id="_userdefinednetwork_k8sovnorgv1"}
