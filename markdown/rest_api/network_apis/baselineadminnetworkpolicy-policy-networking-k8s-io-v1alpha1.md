...
# BaselineAdminNetworkPolicy [policy.networking.k8s.io/v1alpha1] {id="baselineadminnetworkpolicy-policy-networking-k8s-io-v1alpha1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
*   `/apis/policy.networking.k8s.io/v1alpha1/baselineadminnetworkpolicies/{{ name }}`{minja}
...
*   `/apis/policy.networking.k8s.io/v1alpha1/baselineadminnetworkpolicies/{{ name }}/status`{minja}
...
### /apis/policy.networking.k8s.io/v1alpha1/baselineadminnetworkpolicies {id="_apispolicynetworkingk8siov1alpha1baselineadminnetworkpolicies"}
...
### /apis/policy.networking.k8s.io/v1alpha1/baselineadminnetworkpolicies/{{ name }} {id="_apispolicynetworkingk8siov1alpha1baselineadminnetworkpolicies_name"}
...
### /apis/policy.networking.k8s.io/v1alpha1/baselineadminnetworkpolicies/{{ name }}/status {id="_apispolicynetworkingk8siov1alpha1baselineadminnetworkpolicies_name_status"}
