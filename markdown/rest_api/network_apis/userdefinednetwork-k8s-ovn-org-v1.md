...
# UserDefinedNetwork [k8s.ovn.org/v1] {id="userdefinednetwork-k8s-ovn-org-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/k8s.ovn.org/v1/userdefinednetworks {id="_apisk8sovnorgv1userdefinednetworks"}
...
### /apis/k8s.ovn.org/v1/namespaces/{{ namespace }}/userdefinednetworks {id="_apisk8sovnorgv1namespaces_namespace_userdefinednetworks"}
...
### /apis/k8s.ovn.org/v1/namespaces/{{ namespace }}/userdefinednetworks/{{ name }} {id="_apisk8sovnorgv1namespaces_namespace_userdefinednetworks_name"}
...
### /apis/k8s.ovn.org/v1/namespaces/{{ namespace }}/userdefinednetworks/{{ name }}/status {id="_apisk8sovnorgv1namespaces_namespace_userdefinednetworks_name_status"}
