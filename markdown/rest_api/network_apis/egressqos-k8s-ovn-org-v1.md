...
# EgressQoS [k8s.ovn.org/v1] {id="egressqos-k8s-ovn-org-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/k8s.ovn.org/v1/egressqoses {id="_apisk8sovnorgv1egressqoses"}
...
### /apis/k8s.ovn.org/v1/namespaces/{{ namespace }}/egressqoses {id="_apisk8sovnorgv1namespaces_namespace_egressqoses"}
...
### /apis/k8s.ovn.org/v1/namespaces/{{ namespace }}/egressqoses/{{ name }} {id="_apisk8sovnorgv1namespaces_namespace_egressqoses_name"}
...
### /apis/k8s.ovn.org/v1/namespaces/{{ namespace }}/egressqoses/{{ name }}/status {id="_apisk8sovnorgv1namespaces_namespace_egressqoses_name_status"}
