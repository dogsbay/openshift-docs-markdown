...
# EndpointSlice [discovery.k8s.io/v1] {id="endpointslice-discovery-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
| `targetRef` | [`ObjectReference`](/rest_api/objects/index#io-k8s-api-core-v1-ObjectReference) | targetRef is a reference to a Kubernetes object that represents this endpoint. |
| `zone` | `string` | zone is the name of the Zone this endpoint exists in. |

### .endpoints[].conditions {id="_endpointsconditions"}
...
### .endpoints[].hints {id="_endpointshints"}
...
### .endpoints[].hints.forNodes {id="_endpointshintsfornodes"}
...
### .endpoints[].hints.forZones {id="_endpointshintsforzones"}
...
*   `/apis/discovery.k8s.io/v1/namespaces/{{ namespace }}/endpointslices`{minja}
    *   `DELETE`: delete collection of EndpointSlice
    *   `GET`: list or watch objects of kind EndpointSlice
    *   `POST`: create an EndpointSlice
*   `/apis/discovery.k8s.io/v1/watch/namespaces/{{ namespace }}/endpointslices`{minja}
    *   `GET`: watch individual changes to a list of EndpointSlice. deprecated: use the &#x27;watch&#x27; parameter with a list operation instead.
*   `/apis/discovery.k8s.io/v1/namespaces/{{ namespace }}/endpointslices/{{ name }}`{minja}
...
*   `/apis/discovery.k8s.io/v1/watch/namespaces/{{ namespace }}/endpointslices/{{ name }}`{minja}
...
### /apis/discovery.k8s.io/v1/endpointslices {id="_apisdiscoveryk8siov1endpointslices"}
...
| --- | --- |
| 200 - OK | [`EndpointSliceList`](/rest_api/objects/index#io-k8s-api-discovery-v1-EndpointSliceList) schema |
| 401 - Unauthorized | Empty |

### /apis/discovery.k8s.io/v1/watch/endpointslices {id="_apisdiscoveryk8siov1watchendpointslices"}
...
### /apis/discovery.k8s.io/v1/namespaces/{{ namespace }}/endpointslices {id="_apisdiscoveryk8siov1namespaces_namespace_endpointslices"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`EndpointSlice`](/rest_api/network_apis/endpointslice-discovery-k8s-io-v1#endpointslice-discovery-k8s-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`EndpointSlice`](/rest_api/network_apis/endpointslice-discovery-k8s-io-v1#endpointslice-discovery-k8s-io-v1) schema |
| 201 - Created | [`EndpointSlice`](/rest_api/network_apis/endpointslice-discovery-k8s-io-v1#endpointslice-discovery-k8s-io-v1) schema |
| 202 - Accepted | [`EndpointSlice`](/rest_api/network_apis/endpointslice-discovery-k8s-io-v1#endpointslice-discovery-k8s-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/discovery.k8s.io/v1/watch/namespaces/{{ namespace }}/endpointslices {id="_apisdiscoveryk8siov1watchnamespaces_namespace_endpointslices"}
...
### /apis/discovery.k8s.io/v1/namespaces/{{ namespace }}/endpointslices/{{ name }} {id="_apisdiscoveryk8siov1namespaces_namespace_endpointslices_name"}
...
### /apis/discovery.k8s.io/v1/watch/namespaces/{{ namespace }}/endpointslices/{{ name }} {id="_apisdiscoveryk8siov1watchnamespaces_namespace_endpointslices_name"}
