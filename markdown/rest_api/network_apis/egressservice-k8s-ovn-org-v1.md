...
# EgressService [k8s.ovn.org/v1] {id="egressservice-k8s-ovn-org-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/k8s.ovn.org/v1/egressservices {id="_apisk8sovnorgv1egressservices"}
...
### /apis/k8s.ovn.org/v1/namespaces/{{ namespace }}/egressservices {id="_apisk8sovnorgv1namespaces_namespace_egressservices"}
...
### /apis/k8s.ovn.org/v1/namespaces/{{ namespace }}/egressservices/{{ name }} {id="_apisk8sovnorgv1namespaces_namespace_egressservices_name"}
...
### /apis/k8s.ovn.org/v1/namespaces/{{ namespace }}/egressservices/{{ name }}/status {id="_apisk8sovnorgv1namespaces_namespace_egressservices_name_status"}
