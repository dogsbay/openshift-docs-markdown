...
| --- | --- |
| 200 - OK | [`EndpointsList`](/rest_api/objects/index#io-k8s-api-core-v1-EndpointsList) schema |
| 401 - Unauthorized | Empty |

### /api/v1/watch/endpoints {id="_apiv1watchendpoints"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`Endpoints`](/rest_api/network_apis/endpoints-v1#endpoints-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Endpoints`](/rest_api/network_apis/endpoints-v1#endpoints-v1) schema |
| 201 - Created | [`Endpoints`](/rest_api/network_apis/endpoints-v1#endpoints-v1) schema |
| 202 - Accepted | [`Endpoints`](/rest_api/network_apis/endpoints-v1#endpoints-v1) schema |
| 401 - Unauthorized | Empty |

### /api/v1/watch/namespaces/{{ namespace }}/endpoints {id="_apiv1watchnamespaces_namespace_endpoints"}
...
### /api/v1/watch/namespaces/{{ namespace }}/endpoints/{{ name }} {id="_apiv1watchnamespaces_namespace_endpoints_name"}
