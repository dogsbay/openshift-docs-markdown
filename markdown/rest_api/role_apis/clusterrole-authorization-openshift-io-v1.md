...
# ClusterRole [authorization.openshift.io/v1] {id="clusterrole-authorization-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/authorization.openshift.io/v1/clusterroles {id="_apisauthorizationopenshiftiov1clusterroles"}
...
### /apis/authorization.openshift.io/v1/clusterroles/{{ name }} {id="_apisauthorizationopenshiftiov1clusterroles_name"}
