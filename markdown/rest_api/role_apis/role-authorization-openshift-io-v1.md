...
# Role [authorization.openshift.io/v1] {id="role-authorization-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
*   `/apis/authorization.openshift.io/v1/namespaces/{{ namespace }}/roles`{minja}
    *   `GET`: list objects of kind Role
    *   `POST`: create a Role
*   `/apis/authorization.openshift.io/v1/namespaces/{{ namespace }}/roles/{{ name }}`{minja}
    *   `DELETE`: delete a Role
    *   `GET`: read the specified Role
    *   `PATCH`: partially update the specified Role
    *   `PUT`: replace the specified Role

### /apis/authorization.openshift.io/v1/roles {id="_apisauthorizationopenshiftiov1roles"}
...
### /apis/authorization.openshift.io/v1/namespaces/{{ namespace }}/roles {id="_apisauthorizationopenshiftiov1namespaces_namespace_roles"}
...
### /apis/authorization.openshift.io/v1/namespaces/{{ namespace }}/roles/{{ name }} {id="_apisauthorizationopenshiftiov1namespaces_namespace_roles_name"}
