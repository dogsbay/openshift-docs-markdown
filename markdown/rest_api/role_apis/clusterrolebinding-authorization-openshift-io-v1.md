...
# ClusterRoleBinding [authorization.openshift.io/v1] {id="clusterrolebinding-authorization-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/authorization.openshift.io/v1/clusterrolebindings {id="_apisauthorizationopenshiftiov1clusterrolebindings"}
...
### /apis/authorization.openshift.io/v1/clusterrolebindings/{{ name }} {id="_apisauthorizationopenshiftiov1clusterrolebindings_name"}
