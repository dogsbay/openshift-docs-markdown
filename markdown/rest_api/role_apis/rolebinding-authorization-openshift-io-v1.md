...
# RoleBinding [authorization.openshift.io/v1] {id="rolebinding-authorization-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
| `roleRef` | [`ObjectReference`](/rest_api/objects/index#io-k8s-api-core-v1-ObjectReference) | roleRef can only reference the current namespace and the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error. Since Policy is a singleton, this is sufficient knowledge to locate a role. |
...
### /apis/authorization.openshift.io/v1/rolebindings {id="_apisauthorizationopenshiftiov1rolebindings"}
...
| --- | --- |
| 200 - OK | [`RoleBindingList`](/rest_api/objects/index#com-github-openshift-api-authorization-v1-RoleBindingList) schema |
| 401 - Unauthorized | Empty |

### /apis/authorization.openshift.io/v1/namespaces/{{ namespace }}/rolebindings {id="_apisauthorizationopenshiftiov1namespaces_namespace_rolebindings"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`RoleBinding`](/rest_api/role_apis/rolebinding-authorization-openshift-io-v1#rolebinding-authorization-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`RoleBinding`](/rest_api/role_apis/rolebinding-authorization-openshift-io-v1#rolebinding-authorization-openshift-io-v1) schema |
| 201 - Created | [`RoleBinding`](/rest_api/role_apis/rolebinding-authorization-openshift-io-v1#rolebinding-authorization-openshift-io-v1) schema |
| 202 - Accepted | [`RoleBinding`](/rest_api/role_apis/rolebinding-authorization-openshift-io-v1#rolebinding-authorization-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/authorization.openshift.io/v1/namespaces/{{ namespace }}/rolebindings/{{ name }} {id="_apisauthorizationopenshiftiov1namespaces_namespace_rolebindings_name"}
