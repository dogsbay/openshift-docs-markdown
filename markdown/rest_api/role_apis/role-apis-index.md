...
# Role APIs {id="role-apis"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}

## ClusterRoleBinding [authorization.openshift.io/v1] {id="_clusterrolebinding_authorizationopenshiftiov1"}
...
## ClusterRole [authorization.openshift.io/v1] {id="_clusterrole_authorizationopenshiftiov1"}
...
## RoleBindingRestriction [authorization.openshift.io/v1] {id="_rolebindingrestriction_authorizationopenshiftiov1"}
...
## RoleBinding [authorization.openshift.io/v1] {id="_rolebinding_authorizationopenshiftiov1"}
...
## Role [authorization.openshift.io/v1] {id="_role_authorizationopenshiftiov1"}
