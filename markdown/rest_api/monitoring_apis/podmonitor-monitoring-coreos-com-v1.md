...
*   `/apis/monitoring.coreos.com/v1/namespaces/{{ namespace }}/podmonitors`{minja}
    *   `DELETE`: delete collection of PodMonitor
    *   `GET`: list objects of kind PodMonitor
    *   `POST`: create a PodMonitor
*   `/apis/monitoring.coreos.com/v1/namespaces/{{ namespace }}/podmonitors/{{ name }}`{minja}
...
*   `/apis/monitoring.coreos.com/v1/namespaces/{{ namespace }}/podmonitors/{{ name }}/status`{minja}
