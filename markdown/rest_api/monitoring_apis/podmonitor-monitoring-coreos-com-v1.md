...
# PodMonitor [monitoring.coreos.com/v1] {id="podmonitor-monitoring-coreos-com-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
| Property | Type | Description |
| --- | --- | --- |
| `attachMetadata` | `object` | attachMetadata defines additional metadata which is added to the discovered targets. It requires Prometheus >= v2.35.0. |
| `bodySizeLimit` | `string` | bodySizeLimit when defined specifies a job level limit on the size of uncompressed response body that will be accepted by Prometheus. It requires Prometheus >= v2.28.0. |
...
### .spec.podMetricsEndpoints {id="_specpodmetricsendpoints"}
...
| `targetPort` | `integer-or-string` | targetPort defines the name or number of the target port of the `Pod` object behind the Service, the port must be specified with container port property. Deprecated: use 'port' or 'portNumber' instead. |
...
### .spec.podMetricsEndpoints[].authorization {id="_specpodmetricsendpointsauthorization"}
...
### .spec.podMetricsEndpoints[].authorization.credentials {id="_specpodmetricsendpointsauthorizationcredentials"}
...
### .spec.podMetricsEndpoints[].basicAuth {id="_specpodmetricsendpointsbasicauth"}
...
### .spec.podMetricsEndpoints[].basicAuth.password {id="_specpodmetricsendpointsbasicauthpassword"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the Secret or its key must be defined |
### .spec.podMetricsEndpoints[].basicAuth.username {id="_specpodmetricsendpointsbasicauthusername"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the Secret or its key must be defined |
### .spec.podMetricsEndpoints[].bearerTokenSecret {id="_specpodmetricsendpointsbearertokensecret"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the Secret or its key must be defined |
### .spec.podMetricsEndpoints[].metricRelabelings {id="_specpodmetricsendpointsmetricrelabelings"}
...
### .spec.podMetricsEndpoints[].oauth2 {id="_specpodmetricsendpointsoauth2"}
...
### .spec.podMetricsEndpoints[].oauth2.clientId {id="_specpodmetricsendpointsoauth2clientid"}
...
### .spec.podMetricsEndpoints[].oauth2.clientId.configMap {id="_specpodmetricsendpointsoauth2clientidconfigmap"}
...
### .spec.podMetricsEndpoints[].oauth2.clientId.secret {id="_specpodmetricsendpointsoauth2clientidsecret"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the Secret or its key must be defined |
### .spec.podMetricsEndpoints[].oauth2.clientSecret {id="_specpodmetricsendpointsoauth2clientsecret"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the Secret or its key must be defined |
### .spec.podMetricsEndpoints[].oauth2.proxyConnectHeader {id="_specpodmetricsendpointsoauth2proxyconnectheader"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the Secret or its key must be defined |
### .spec.podMetricsEndpoints[].oauth2.tlsConfig {id="_specpodmetricsendpointsoauth2tlsconfig"}
...
### .spec.podMetricsEndpoints[].oauth2.tlsConfig.ca {id="_specpodmetricsendpointsoauth2tlsconfigca"}
...
| `configMap` | `object` | configMap defines the ConfigMap containing data to use for the targets. |
| `secret` | `object` | secret defines the Secret containing data to use for the targets. |
### .spec.podMetricsEndpoints[].oauth2.tlsConfig.ca.configMap {id="_specpodmetricsendpointsoauth2tlsconfigcaconfigmap"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the ConfigMap or its key must be defined |
### .spec.podMetricsEndpoints[].oauth2.tlsConfig.ca.secret {id="_specpodmetricsendpointsoauth2tlsconfigcasecret"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the Secret or its key must be defined |
### .spec.podMetricsEndpoints[].oauth2.tlsConfig.cert {id="_specpodmetricsendpointsoauth2tlsconfigcert"}
...
| `configMap` | `object` | configMap defines the ConfigMap containing data to use for the targets. |
| `secret` | `object` | secret defines the Secret containing data to use for the targets. |
### .spec.podMetricsEndpoints[].oauth2.tlsConfig.cert.configMap {id="_specpodmetricsendpointsoauth2tlsconfigcertconfigmap"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the ConfigMap or its key must be defined |
### .spec.podMetricsEndpoints[].oauth2.tlsConfig.cert.secret {id="_specpodmetricsendpointsoauth2tlsconfigcertsecret"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the Secret or its key must be defined |
### .spec.podMetricsEndpoints[].oauth2.tlsConfig.keySecret {id="_specpodmetricsendpointsoauth2tlsconfigkeysecret"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the Secret or its key must be defined |
### .spec.podMetricsEndpoints[].params {id="_specpodmetricsendpointsparams"}
...
### .spec.podMetricsEndpoints[].proxyConnectHeader {id="_specpodmetricsendpointsproxyconnectheader"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the Secret or its key must be defined |
### .spec.podMetricsEndpoints[].relabelings {id="_specpodmetricsendpointsrelabelings"}
...
| `sourceLabels` | `array (string)` | sourceLabels defines the source labels select values from existing labels. Their content is concatenated using the configured Separator and matched against the configured regular expression. |
| `targetLabel` | `string` | targetLabel defines the label to which the resulting string is written in a replacement. It is mandatory for `Replace`, `HashMod`, `Lowercase`, `Uppercase`, `KeepEqual` and `DropEqual` actions. Regex capture groups are available. |
### .spec.podMetricsEndpoints[].tlsConfig {id="_specpodmetricsendpointstlsconfig"}
...
| `minVersion` | `string` | minVersion defines the minimum acceptable TLS version. It requires Prometheus >= v2.35.0 or Thanos >= v0.28.0. |
| `serverName` | `string` | serverName is used to verify the hostname for the targets. |
### .spec.podMetricsEndpoints[].tlsConfig.ca {id="_specpodmetricsendpointstlsconfigca"}
...
| `configMap` | `object` | configMap defines the ConfigMap containing data to use for the targets. |
| `secret` | `object` | secret defines the Secret containing data to use for the targets. |
### .spec.podMetricsEndpoints[].tlsConfig.ca.configMap {id="_specpodmetricsendpointstlsconfigcaconfigmap"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the ConfigMap or its key must be defined |
### .spec.podMetricsEndpoints[].tlsConfig.ca.secret {id="_specpodmetricsendpointstlsconfigcasecret"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the Secret or its key must be defined |
### .spec.podMetricsEndpoints[].tlsConfig.cert {id="_specpodmetricsendpointstlsconfigcert"}
...
| `configMap` | `object` | configMap defines the ConfigMap containing data to use for the targets. |
| `secret` | `object` | secret defines the Secret containing data to use for the targets. |
### .spec.podMetricsEndpoints[].tlsConfig.cert.configMap {id="_specpodmetricsendpointstlsconfigcertconfigmap"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the ConfigMap or its key must be defined |
### .spec.podMetricsEndpoints[].tlsConfig.cert.secret {id="_specpodmetricsendpointstlsconfigcertsecret"}
...
| `name` | `string` | Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names |
| `optional` | `boolean` | Specify whether the Secret or its key must be defined |
### .spec.podMetricsEndpoints[].tlsConfig.keySecret {id="_specpodmetricsendpointstlsconfigkeysecret"}
...
### /apis/monitoring.coreos.com/v1/podmonitors {id="_apismonitoringcoreoscomv1podmonitors"}
...
### /apis/monitoring.coreos.com/v1/namespaces/{{ namespace }}/podmonitors {id="_apismonitoringcoreoscomv1namespaces_namespace_podmonitors"}
...
### /apis/monitoring.coreos.com/v1/namespaces/{{ namespace }}/podmonitors/{{ name }} {id="_apismonitoringcoreoscomv1namespaces_namespace_podmonitors_name"}
...
### /apis/monitoring.coreos.com/v1/namespaces/{{ namespace }}/podmonitors/{{ name }}/status {id="_apismonitoringcoreoscomv1namespaces_namespace_podmonitors_name_status"}
