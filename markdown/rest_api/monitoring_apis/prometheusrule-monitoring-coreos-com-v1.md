...
# PrometheusRule [monitoring.coreos.com/v1] {id="prometheusrule-monitoring-coreos-com-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/monitoring.coreos.com/v1/prometheusrules {id="_apismonitoringcoreoscomv1prometheusrules"}
...
| --- | --- |
| 200 - OK | [`PrometheusRuleList`](/rest_api/objects/index#com-coreos-monitoring-v1-PrometheusRuleList) schema |
| 401 - Unauthorized | Empty |

### /apis/monitoring.coreos.com/v1/namespaces/{{ namespace }}/prometheusrules {id="_apismonitoringcoreoscomv1namespaces_namespace_prometheusrules"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`PrometheusRule`](/rest_api/monitoring_apis/prometheusrule-monitoring-coreos-com-v1#prometheusrule-monitoring-coreos-com-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`PrometheusRule`](/rest_api/monitoring_apis/prometheusrule-monitoring-coreos-com-v1#prometheusrule-monitoring-coreos-com-v1) schema |
| 201 - Created | [`PrometheusRule`](/rest_api/monitoring_apis/prometheusrule-monitoring-coreos-com-v1#prometheusrule-monitoring-coreos-com-v1) schema |
| 202 - Accepted | [`PrometheusRule`](/rest_api/monitoring_apis/prometheusrule-monitoring-coreos-com-v1#prometheusrule-monitoring-coreos-com-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/monitoring.coreos.com/v1/namespaces/{{ namespace }}/prometheusrules/{{ name }} {id="_apismonitoringcoreoscomv1namespaces_namespace_prometheusrules_name"}
...
### /apis/monitoring.coreos.com/v1/namespaces/{{ namespace }}/prometheusrules/{{ name }}/status {id="_apismonitoringcoreoscomv1namespaces_namespace_prometheusrules_name_status"}
