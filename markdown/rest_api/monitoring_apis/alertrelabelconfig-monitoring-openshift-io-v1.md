...
# AlertRelabelConfig [monitoring.openshift.io/v1] {id="alertrelabelconfig-monitoring-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/monitoring.openshift.io/v1/alertrelabelconfigs {id="_apismonitoringopenshiftiov1alertrelabelconfigs"}
...
### /apis/monitoring.openshift.io/v1/namespaces/{{ namespace }}/alertrelabelconfigs {id="_apismonitoringopenshiftiov1namespaces_namespace_alertrelabelconfigs"}
...
### /apis/monitoring.openshift.io/v1/namespaces/{{ namespace }}/alertrelabelconfigs/{{ name }} {id="_apismonitoringopenshiftiov1namespaces_namespace_alertrelabelconfigs_name"}
...
### /apis/monitoring.openshift.io/v1/namespaces/{{ namespace }}/alertrelabelconfigs/{{ name }}/status {id="_apismonitoringopenshiftiov1namespaces_namespace_alertrelabelconfigs_name_status"}
