...
# PodMetrics [metrics.k8s.io/v1beta1] {id="podmetrics-metrics-k8s-io-v1beta1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/metrics.k8s.io/v1beta1/namespaces/{{ namespace }}/pods {id="_apismetricsk8siov1beta1namespaces_namespace_pods"}
...
### /apis/metrics.k8s.io/v1beta1/namespaces/{{ namespace }}/pods/{{ name }} {id="_apismetricsk8siov1beta1namespaces_namespace_pods_name"}
