...
# ServiceMonitor [monitoring.coreos.com/v1] {id="servicemonitor-monitoring-coreos-com-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.endpoints[].proxyConnectHeader {id="_specendpointsproxyconnectheader"}
...
### /apis/monitoring.coreos.com/v1/servicemonitors {id="_apismonitoringcoreoscomv1servicemonitors"}
...
| --- | --- |
| 200 - OK | [`ServiceMonitorList`](/rest_api/objects/index#com-coreos-monitoring-v1-ServiceMonitorList) schema |
| 401 - Unauthorized | Empty |

### /apis/monitoring.coreos.com/v1/namespaces/{{ namespace }}/servicemonitors {id="_apismonitoringcoreoscomv1namespaces_namespace_servicemonitors"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`ServiceMonitor`](/rest_api/monitoring_apis/servicemonitor-monitoring-coreos-com-v1#servicemonitor-monitoring-coreos-com-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ServiceMonitor`](/rest_api/monitoring_apis/servicemonitor-monitoring-coreos-com-v1#servicemonitor-monitoring-coreos-com-v1) schema |
| 201 - Created | [`ServiceMonitor`](/rest_api/monitoring_apis/servicemonitor-monitoring-coreos-com-v1#servicemonitor-monitoring-coreos-com-v1) schema |
| 202 - Accepted | [`ServiceMonitor`](/rest_api/monitoring_apis/servicemonitor-monitoring-coreos-com-v1#servicemonitor-monitoring-coreos-com-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/monitoring.coreos.com/v1/namespaces/{{ namespace }}/servicemonitors/{{ name }} {id="_apismonitoringcoreoscomv1namespaces_namespace_servicemonitors_name"}
...
### /apis/monitoring.coreos.com/v1/namespaces/{{ namespace }}/servicemonitors/{{ name }}/status {id="_apismonitoringcoreoscomv1namespaces_namespace_servicemonitors_name_status"}
