...
# Monitoring APIs {id="monitoring-apis"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}

## Alertmanager [monitoring.coreos.com/v1] {id="_alertmanager_monitoringcoreoscomv1"}
...
## AlertmanagerConfig [monitoring.coreos.com/v1beta1] {id="_alertmanagerconfig_monitoringcoreoscomv1beta1"}
...
## AlertRelabelConfig [monitoring.openshift.io/v1] {id="_alertrelabelconfig_monitoringopenshiftiov1"}
...
## AlertingRule [monitoring.openshift.io/v1] {id="_alertingrule_monitoringopenshiftiov1"}
...
## DataGather [insights.openshift.io/v1] {id="_datagather_insightsopenshiftiov1"}
...
## PodMonitor [monitoring.coreos.com/v1] {id="_podmonitor_monitoringcoreoscomv1"}
...
## Probe [monitoring.coreos.com/v1] {id="_probe_monitoringcoreoscomv1"}
...
## Prometheus [monitoring.coreos.com/v1] {id="_prometheus_monitoringcoreoscomv1"}
...
## PrometheusRule [monitoring.coreos.com/v1] {id="_prometheusrule_monitoringcoreoscomv1"}
...
## ServiceMonitor [monitoring.coreos.com/v1] {id="_servicemonitor_monitoringcoreoscomv1"}
...
## ThanosRuler [monitoring.coreos.com/v1] {id="_thanosruler_monitoringcoreoscomv1"}
...
## NodeMetrics [metrics.k8s.io/v1beta1] {id="_nodemetrics_metricsk8siov1beta1"}
...
## PodMetrics [metrics.k8s.io/v1beta1] {id="_podmetrics_metricsk8siov1beta1"}
