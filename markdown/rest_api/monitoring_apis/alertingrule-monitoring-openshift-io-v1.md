...
# AlertingRule [monitoring.openshift.io/v1] {id="alertingrule-monitoring-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .status.prometheusRule {id="_statusprometheusrule"}
...
*   `/apis/monitoring.openshift.io/v1/namespaces/{{ namespace }}/alertingrules`{minja}
    *   `DELETE`: delete collection of AlertingRule
    *   `GET`: list objects of kind AlertingRule
    *   `POST`: create an AlertingRule
*   `/apis/monitoring.openshift.io/v1/namespaces/{{ namespace }}/alertingrules/{{ name }}`{minja}
...
*   `/apis/monitoring.openshift.io/v1/namespaces/{{ namespace }}/alertingrules/{{ name }}/status`{minja}
...
### /apis/monitoring.openshift.io/v1/alertingrules {id="_apismonitoringopenshiftiov1alertingrules"}
...
### /apis/monitoring.openshift.io/v1/namespaces/{{ namespace }}/alertingrules {id="_apismonitoringopenshiftiov1namespaces_namespace_alertingrules"}
...
### /apis/monitoring.openshift.io/v1/namespaces/{{ namespace }}/alertingrules/{{ name }} {id="_apismonitoringopenshiftiov1namespaces_namespace_alertingrules_name"}
...
### /apis/monitoring.openshift.io/v1/namespaces/{{ namespace }}/alertingrules/{{ name }}/status {id="_apismonitoringopenshiftiov1namespaces_namespace_alertingrules_name_status"}
