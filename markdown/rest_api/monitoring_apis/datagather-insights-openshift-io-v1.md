...
# DataGather [insights.openshift.io/v1] {id="datagather-insights-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.gatherers {id="_specgatherers"}
...
### .spec.gatherers.custom {id="_specgathererscustom"}
...
### .spec.gatherers.custom.configs {id="_specgathererscustomconfigs"}
...
### .spec.storage.persistentVolume {id="_specstoragepersistentvolume"}
...
### .spec.storage.persistentVolume.claim {id="_specstoragepersistentvolumeclaim"}
...
### .status.gatherers {id="_statusgatherers"}
...
### .status.gatherers[].conditions {id="_statusgatherersconditions"}
...
*   `/apis/insights.openshift.io/v1/datagathers/{{ name }}`{minja}
...
*   `/apis/insights.openshift.io/v1/datagathers/{{ name }}/status`{minja}
...
### /apis/insights.openshift.io/v1/datagathers {id="_apisinsightsopenshiftiov1datagathers"}
...
### /apis/insights.openshift.io/v1/datagathers/{{ name }} {id="_apisinsightsopenshiftiov1datagathers_name"}
...
### /apis/insights.openshift.io/v1/datagathers/{{ name }}/status {id="_apisinsightsopenshiftiov1datagathers_name_status"}
