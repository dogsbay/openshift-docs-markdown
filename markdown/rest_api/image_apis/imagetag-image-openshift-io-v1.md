...
# ImageTag [image.openshift.io/v1] {id="imagetag-image-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/image.openshift.io/v1/imagetags {id="_apisimageopenshiftiov1imagetags"}
...
### /apis/image.openshift.io/v1/namespaces/{{ namespace }}/imagetags {id="_apisimageopenshiftiov1namespaces_namespace_imagetags"}
...
### /apis/image.openshift.io/v1/namespaces/{{ namespace }}/imagetags/{{ name }} {id="_apisimageopenshiftiov1namespaces_namespace_imagetags_name"}
