...
# ImageSignature [image.openshift.io/v1] {id="imagesignature-image-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/image.openshift.io/v1/imagesignatures/{{ name }} {id="_apisimageopenshiftiov1imagesignatures_name"}
