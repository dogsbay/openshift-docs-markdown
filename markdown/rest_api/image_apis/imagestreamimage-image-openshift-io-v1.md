...
# ImageStreamImage [image.openshift.io/v1] {id="imagestreamimage-image-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
*   `/apis/image.openshift.io/v1/namespaces/{{ namespace }}/imagestreamimages/{{ name }}`{minja}
    *   `GET`: read the specified ImageStreamImage

### /apis/image.openshift.io/v1/namespaces/{{ namespace }}/imagestreamimages/{{ name }} {id="_apisimageopenshiftiov1namespaces_namespace_imagestreamimages_name"}
