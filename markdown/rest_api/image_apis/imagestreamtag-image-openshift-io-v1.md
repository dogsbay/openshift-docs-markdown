...
# ImageStreamTag [image.openshift.io/v1] {id="imagestreamtag-image-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .tag.importPolicy {id="_tagimportpolicy"}
...
### .tag.referencePolicy {id="_tagreferencepolicy"}
...
*   `/apis/image.openshift.io/v1/namespaces/{{ namespace }}/imagestreamtags`{minja}
    *   `GET`: list objects of kind ImageStreamTag
    *   `POST`: create an ImageStreamTag
*   `/apis/image.openshift.io/v1/namespaces/{{ namespace }}/imagestreamtags/{{ name }}`{minja}
...
### /apis/image.openshift.io/v1/imagestreamtags {id="_apisimageopenshiftiov1imagestreamtags"}
...
| --- | --- |
| 200 - OK | [`ImageStreamTagList`](/rest_api/objects/index#com-github-openshift-api-image-v1-ImageStreamTagList) schema |
| 401 - Unauthorized | Empty |

### /apis/image.openshift.io/v1/namespaces/{{ namespace }}/imagestreamtags {id="_apisimageopenshiftiov1namespaces_namespace_imagestreamtags"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`ImageStreamTag`](/rest_api/image_apis/imagestreamtag-image-openshift-io-v1#imagestreamtag-image-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ImageStreamTag`](/rest_api/image_apis/imagestreamtag-image-openshift-io-v1#imagestreamtag-image-openshift-io-v1) schema |
| 201 - Created | [`ImageStreamTag`](/rest_api/image_apis/imagestreamtag-image-openshift-io-v1#imagestreamtag-image-openshift-io-v1) schema |
| 202 - Accepted | [`ImageStreamTag`](/rest_api/image_apis/imagestreamtag-image-openshift-io-v1#imagestreamtag-image-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/image.openshift.io/v1/namespaces/{{ namespace }}/imagestreamtags/{{ name }} {id="_apisimageopenshiftiov1namespaces_namespace_imagestreamtags_name"}
