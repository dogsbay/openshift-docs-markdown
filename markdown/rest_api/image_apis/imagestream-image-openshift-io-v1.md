...
# ImageStream [image.openshift.io/v1] {id="imagestream-image-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/image.openshift.io/v1/imagestreams {id="_apisimageopenshiftiov1imagestreams"}
...
### /apis/image.openshift.io/v1/watch/imagestreams {id="_apisimageopenshiftiov1watchimagestreams"}
...
### /apis/image.openshift.io/v1/namespaces/{{ namespace }}/imagestreams {id="_apisimageopenshiftiov1namespaces_namespace_imagestreams"}
...
### /apis/image.openshift.io/v1/watch/namespaces/{{ namespace }}/imagestreams {id="_apisimageopenshiftiov1watchnamespaces_namespace_imagestreams"}
...
### /apis/image.openshift.io/v1/namespaces/{{ namespace }}/imagestreams/{{ name }} {id="_apisimageopenshiftiov1namespaces_namespace_imagestreams_name"}
...
### /apis/image.openshift.io/v1/watch/namespaces/{{ namespace }}/imagestreams/{{ name }} {id="_apisimageopenshiftiov1watchnamespaces_namespace_imagestreams_name"}
...
### /apis/image.openshift.io/v1/namespaces/{{ namespace }}/imagestreams/{{ name }}/status {id="_apisimageopenshiftiov1namespaces_namespace_imagestreams_name_status"}
