...
# ImageStreamMapping [image.openshift.io/v1] {id="imagestreammapping-image-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
*   `/apis/image.openshift.io/v1/namespaces/{{ namespace }}/imagestreammappings`{minja}
    *   `POST`: create an ImageStreamMapping

### /apis/image.openshift.io/v1/namespaces/{{ namespace }}/imagestreammappings {id="_apisimageopenshiftiov1namespaces_namespace_imagestreammappings"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`ImageStreamMapping`](/rest_api/image_apis/imagestreammapping-image-openshift-io-v1#imagestreammapping-image-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ImageStreamMapping`](/rest_api/image_apis/imagestreammapping-image-openshift-io-v1#imagestreammapping-image-openshift-io-v1) schema |
| 201 - Created | [`ImageStreamMapping`](/rest_api/image_apis/imagestreammapping-image-openshift-io-v1#imagestreammapping-image-openshift-io-v1) schema |
| 202 - Accepted | [`ImageStreamMapping`](/rest_api/image_apis/imagestreammapping-image-openshift-io-v1#imagestreammapping-image-openshift-io-v1) schema |
