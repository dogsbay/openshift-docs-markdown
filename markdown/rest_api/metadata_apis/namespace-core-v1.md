...
# Namespace [core/v1] {id="namespace-core-v1"}
{%- if product_title %}
...
| Property | Type | Description |
| --- | --- | --- |
| `conditions` | [`array (NamespaceCondition core/v1)`](/rest_api/objects/index#namespacecondition-core-v1) | Represents the latest available observations of a namespace’s current state. |
...
| --- | --- |
| 200 - OK | [`NamespaceList core/v1`](/rest_api/objects/index#namespacelist-core-v1) |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`Namespace core/v1`](/rest_api/metadata_apis/namespace-core-v1#namespace-core-v1) |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Namespace core/v1`](/rest_api/metadata_apis/namespace-core-v1#namespace-core-v1) |

### /api/v1/namespaces/{{ name }} {id="_apiv1namespaces_name"}
...
### /api/v1/namespaces/{{ name }}/status {id="_apiv1namespaces_name_status"}
...
### /api/v1/namespaces/{{ name }}/finalize {id="_apiv1namespaces_name_finalize"}
