...
# Lease [coordination.k8s.io/v1] {id="lease-coordination-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/coordination.k8s.io/v1/watch/leases {id="_apiscoordinationk8siov1watchleases"}
...
### /apis/coordination.k8s.io/v1/namespaces/{{ namespace }}/leases {id="_apiscoordinationk8siov1namespaces_namespace_leases"}
...
### /apis/coordination.k8s.io/v1/watch/namespaces/{{ namespace }}/leases {id="_apiscoordinationk8siov1watchnamespaces_namespace_leases"}
...
### /apis/coordination.k8s.io/v1/namespaces/{{ namespace }}/leases/{{ name }} {id="_apiscoordinationk8siov1namespaces_namespace_leases_name"}
...
### /apis/coordination.k8s.io/v1/watch/namespaces/{{ namespace }}/leases/{{ name }} {id="_apiscoordinationk8siov1watchnamespaces_namespace_leases_name"}
