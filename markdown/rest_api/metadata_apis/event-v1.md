...
### /api/v1/watch/events {id="_apiv1watchevents"}
...
### /api/v1/watch/namespaces/{{ namespace }}/events {id="_apiv1watchnamespaces_namespace_events"}
...
### /api/v1/watch/namespaces/{{ namespace }}/events/{{ name }} {id="_apiv1watchnamespaces_namespace_events_name"}
