...
# APIRequestCount [apiserver.openshift.io/v1] {id="apirequestcount-apiserver-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/apiserver.openshift.io/v1/apirequestcounts {id="_apisapiserveropenshiftiov1apirequestcounts"}
...
### /apis/apiserver.openshift.io/v1/apirequestcounts/{{ name }} {id="_apisapiserveropenshiftiov1apirequestcounts_name"}
...
### /apis/apiserver.openshift.io/v1/apirequestcounts/{{ name }}/status {id="_apisapiserveropenshiftiov1apirequestcounts_name_status"}
