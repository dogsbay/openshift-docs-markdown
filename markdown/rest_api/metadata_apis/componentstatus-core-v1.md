...
# ComponentStatus [core/v1] {id="componentstatus-core-v1"}
{%- if product_title %}
...
| `conditions` | [`array (ComponentCondition core/v1)`](/rest_api/objects/index#componentcondition-core-v1) | List of component conditions observed |
...
| --- | --- |
| 200 - OK | [`ComponentStatusList core/v1`](/rest_api/objects/index#componentstatuslist-core-v1) |

### /api/v1/componentstatuses/{{ name }} {id="_apiv1componentstatuses_name"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ComponentStatus core/v1`](/rest_api/metadata_apis/componentstatus-core-v1#componentstatus-core-v1) |