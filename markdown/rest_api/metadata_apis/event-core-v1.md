...
# Event [core/v1] {id="event-core-v1"}
{%- if product_title %}
...
| `eventTime` | [`MicroTime meta/v1`](/rest_api/objects/index#microtime-meta-v1) | Time when this Event was first observed. |
| `firstTimestamp` | [`Time meta/v1`](/rest_api/objects/index#time-meta-v1) | The time at which the event was first recorded. (Time of server receipt is in TypeMeta.) |
| `involvedObject` | [`ObjectReference core/v1`](/rest_api/objects/index#objectreference-core-v1) | The object that this event is about. |
| `kind` | `string` | Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds |
| `lastTimestamp` | [`Time meta/v1`](/rest_api/objects/index#time-meta-v1) | The time at which the most recent occurrence of this event was recorded. |
...
| `related` | [`ObjectReference core/v1`](/rest_api/objects/index#objectreference-core-v1) | Optional secondary object for more complex actions. |
...
| `series` | [`EventSeries core/v1`](/rest_api/objects/index#eventseries-core-v1) | Data about the Event series this event represents or nil if it’s a singleton Event. |
| `source` | [`EventSource core/v1`](/rest_api/objects/index#eventsource-core-v1) | The component reporting this event. Should be a short machine understandable string. |
...
| --- | --- |
| 200 - OK | [`EventList core/v1`](/rest_api/objects/index#eventlist-core-v1) |

### /api/v1/namespaces/{{ namespace }}/events {id="_apiv1namespaces_namespace_events"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`Event core/v1`](/rest_api/metadata_apis/event-core-v1#event-core-v1) |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Event core/v1`](/rest_api/metadata_apis/event-core-v1#event-core-v1) |

### /api/v1/namespaces/{{ namespace }}/events/{{ name }} {id="_apiv1namespaces_namespace_events_name"}
