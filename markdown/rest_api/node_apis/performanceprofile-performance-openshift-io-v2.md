...
# PerformanceProfile [performance.openshift.io/v2] {id="performanceprofile-performance-openshift-io-v2"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/performance.openshift.io/v2/performanceprofiles {id="_apisperformanceopenshiftiov2performanceprofiles"}
...
### /apis/performance.openshift.io/v2/performanceprofiles/{{ name }} {id="_apisperformanceopenshiftiov2performanceprofiles_name"}
...
### /apis/performance.openshift.io/v2/performanceprofiles/{{ name }}/status {id="_apisperformanceopenshiftiov2performanceprofiles_name_status"}
