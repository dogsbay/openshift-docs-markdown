...
# RuntimeClass [node.k8s.io/v1] {id="runtimeclass-node-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/node.k8s.io/v1/watch/runtimeclasses {id="_apisnodek8siov1watchruntimeclasses"}
...
### /apis/node.k8s.io/v1/runtimeclasses/{{ name }} {id="_apisnodek8siov1runtimeclasses_name"}
...
### /apis/node.k8s.io/v1/watch/runtimeclasses/{{ name }} {id="_apisnodek8siov1watchruntimeclasses_name"}
