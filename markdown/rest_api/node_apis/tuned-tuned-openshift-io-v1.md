...
# Tuned [tuned.openshift.io/v1] {id="tuned-tuned-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/tuned.openshift.io/v1/tuneds {id="_apistunedopenshiftiov1tuneds"}
...
| --- | --- |
| 200 - OK | [`TunedList`](/rest_api/objects/index#io-openshift-tuned-v1-TunedList) schema |
| 401 - Unauthorized | Empty |

### /apis/tuned.openshift.io/v1/namespaces/{{ namespace }}/tuneds {id="_apistunedopenshiftiov1namespaces_namespace_tuneds"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`Tuned`](/rest_api/node_apis/tuned-tuned-openshift-io-v1#tuned-tuned-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Tuned`](/rest_api/node_apis/tuned-tuned-openshift-io-v1#tuned-tuned-openshift-io-v1) schema |
| 201 - Created | [`Tuned`](/rest_api/node_apis/tuned-tuned-openshift-io-v1#tuned-tuned-openshift-io-v1) schema |
| 202 - Accepted | [`Tuned`](/rest_api/node_apis/tuned-tuned-openshift-io-v1#tuned-tuned-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/tuned.openshift.io/v1/namespaces/{{ namespace }}/tuneds/{{ name }} {id="_apistunedopenshiftiov1namespaces_namespace_tuneds_name"}
...
### /apis/tuned.openshift.io/v1/namespaces/{{ namespace }}/tuneds/{{ name }}/status {id="_apistunedopenshiftiov1namespaces_namespace_tuneds_name_status"}
