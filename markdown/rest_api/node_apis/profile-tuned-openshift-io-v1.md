...
# Profile [tuned.openshift.io/v1] {id="profile-tuned-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/tuned.openshift.io/v1/profiles {id="_apistunedopenshiftiov1profiles"}
...
### /apis/tuned.openshift.io/v1/namespaces/{{ namespace }}/profiles {id="_apistunedopenshiftiov1namespaces_namespace_profiles"}
...
### /apis/tuned.openshift.io/v1/namespaces/{{ namespace }}/profiles/{{ name }} {id="_apistunedopenshiftiov1namespaces_namespace_profiles_name"}
...
### /apis/tuned.openshift.io/v1/namespaces/{{ namespace }}/profiles/{{ name }}/status {id="_apistunedopenshiftiov1namespaces_namespace_profiles_name_status"}
