...
# ConsolePlugin [console.openshift.io/v1] {id="consoleplugin-console-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.backend.service {id="_specbackendservice"}
...
### .spec.contentSecurityPolicy {id="_speccontentsecuritypolicy"}
...
### .spec.proxy[].endpoint {id="_specproxyendpoint"}
...
### .spec.proxy[].endpoint.service {id="_specproxyendpointservice"}
...
*   `/apis/console.openshift.io/v1/consoleplugins/{{ name }}`{minja}
...
### /apis/console.openshift.io/v1/consoleplugins {id="_apisconsoleopenshiftiov1consoleplugins"}
...
### /apis/console.openshift.io/v1/consoleplugins/{{ name }} {id="_apisconsoleopenshiftiov1consoleplugins_name"}
