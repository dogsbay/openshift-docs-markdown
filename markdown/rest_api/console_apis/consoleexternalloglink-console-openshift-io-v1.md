...
# ConsoleExternalLogLink [console.openshift.io/v1] {id="consoleexternalloglink-console-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/console.openshift.io/v1/consoleexternalloglinks {id="_apisconsoleopenshiftiov1consoleexternalloglinks"}
...
### /apis/console.openshift.io/v1/consoleexternalloglinks/{{ name }} {id="_apisconsoleopenshiftiov1consoleexternalloglinks_name"}
...
### /apis/console.openshift.io/v1/consoleexternalloglinks/{{ name }}/status {id="_apisconsoleopenshiftiov1consoleexternalloglinks_name_status"}
