...
# ConsoleSample [console.openshift.io/v1] {id="consolesample-console-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/console.openshift.io/v1/consolesamples {id="_apisconsoleopenshiftiov1consolesamples"}
...
### /apis/console.openshift.io/v1/consolesamples/{{ name }} {id="_apisconsoleopenshiftiov1consolesamples_name"}
