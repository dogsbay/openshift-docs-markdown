...
# Console APIs {id="console-apis"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}

## ConsoleCLIDownload [console.openshift.io/v1] {id="_consoleclidownload_consoleopenshiftiov1"}
...
## ConsoleExternalLogLink [console.openshift.io/v1] {id="_consoleexternalloglink_consoleopenshiftiov1"}
...
## ConsoleLink [console.openshift.io/v1] {id="_consolelink_consoleopenshiftiov1"}
...
## ConsoleNotification [console.openshift.io/v1] {id="_consolenotification_consoleopenshiftiov1"}
...
## ConsolePlugin [console.openshift.io/v1] {id="_consoleplugin_consoleopenshiftiov1"}
...
## ConsoleQuickStart [console.openshift.io/v1] {id="_consolequickstart_consoleopenshiftiov1"}
...
## ConsoleSample [console.openshift.io/v1] {id="_consolesample_consoleopenshiftiov1"}
...
## ConsoleYAMLSample [console.openshift.io/v1] {id="_consoleyamlsample_consoleopenshiftiov1"}
