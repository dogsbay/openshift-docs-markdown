...
# ConsoleCLIDownload [console.openshift.io/v1] {id="consoleclidownload-console-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/console.openshift.io/v1/consoleclidownloads {id="_apisconsoleopenshiftiov1consoleclidownloads"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ConsoleCLIDownloadList`](/rest_api/objects/index#io-openshift-console-v1-ConsoleCLIDownloadList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`ConsoleCLIDownload`](/rest_api/console_apis/consoleclidownload-console-openshift-io-v1#consoleclidownload-console-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ConsoleCLIDownload`](/rest_api/console_apis/consoleclidownload-console-openshift-io-v1#consoleclidownload-console-openshift-io-v1) schema |
| 201 - Created | [`ConsoleCLIDownload`](/rest_api/console_apis/consoleclidownload-console-openshift-io-v1#consoleclidownload-console-openshift-io-v1) schema |
| 202 - Accepted | [`ConsoleCLIDownload`](/rest_api/console_apis/consoleclidownload-console-openshift-io-v1#consoleclidownload-console-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/console.openshift.io/v1/consoleclidownloads/{{ name }} {id="_apisconsoleopenshiftiov1consoleclidownloads_name"}
...
### /apis/console.openshift.io/v1/consoleclidownloads/{{ name }}/status {id="_apisconsoleopenshiftiov1consoleclidownloads_name_status"}
