...
# ConsoleLink [console.openshift.io/v1] {id="consolelink-console-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/console.openshift.io/v1/consolelinks {id="_apisconsoleopenshiftiov1consolelinks"}
...
### /apis/console.openshift.io/v1/consolelinks/{{ name }} {id="_apisconsoleopenshiftiov1consolelinks_name"}
...
### /apis/console.openshift.io/v1/consolelinks/{{ name }}/status {id="_apisconsoleopenshiftiov1consolelinks_name_status"}
