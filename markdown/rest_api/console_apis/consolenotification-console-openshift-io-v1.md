...
# ConsoleNotification [console.openshift.io/v1] {id="consolenotification-console-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/console.openshift.io/v1/consolenotifications {id="_apisconsoleopenshiftiov1consolenotifications"}
...
### /apis/console.openshift.io/v1/consolenotifications/{{ name }} {id="_apisconsoleopenshiftiov1consolenotifications_name"}
...
### /apis/console.openshift.io/v1/consolenotifications/{{ name }}/status {id="_apisconsoleopenshiftiov1consolenotifications_name_status"}
