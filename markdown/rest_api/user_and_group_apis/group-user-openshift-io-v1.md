...
# Group [user.openshift.io/v1] {id="group-user-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/user.openshift.io/v1/watch/groups {id="_apisuseropenshiftiov1watchgroups"}
...
### /apis/user.openshift.io/v1/groups/{{ name }} {id="_apisuseropenshiftiov1groups_name"}
...
### /apis/user.openshift.io/v1/watch/groups/{{ name }} {id="_apisuseropenshiftiov1watchgroups_name"}
