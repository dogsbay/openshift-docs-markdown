...
# User and group APIs {id="user-and-group-apis"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}

## Group [user.openshift.io/v1] {id="_group_useropenshiftiov1"}
...
## Identity [user.openshift.io/v1] {id="_identity_useropenshiftiov1"}
...
## UserIdentityMapping [user.openshift.io/v1] {id="_useridentitymapping_useropenshiftiov1"}
...
## User [user.openshift.io/v1] {id="_user_useropenshiftiov1"}
