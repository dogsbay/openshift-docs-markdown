...
# User [user.openshift.io/v1] {id="user-user-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`UserList`](/rest_api/objects/index#com-github-openshift-api-user-v1-UserList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`User`](/rest_api/user_and_group_apis/user-user-openshift-io-v1#user-user-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`User`](/rest_api/user_and_group_apis/user-user-openshift-io-v1#user-user-openshift-io-v1) schema |
| 201 - Created | [`User`](/rest_api/user_and_group_apis/user-user-openshift-io-v1#user-user-openshift-io-v1) schema |
| 202 - Accepted | [`User`](/rest_api/user_and_group_apis/user-user-openshift-io-v1#user-user-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/user.openshift.io/v1/watch/users {id="_apisuseropenshiftiov1watchusers"}
...
### /apis/user.openshift.io/v1/users/{{ name }} {id="_apisuseropenshiftiov1users_name"}
...
### /apis/user.openshift.io/v1/watch/users/{{ name }} {id="_apisuseropenshiftiov1watchusers_name"}
