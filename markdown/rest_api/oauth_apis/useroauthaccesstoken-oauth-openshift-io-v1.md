...
# UserOAuthAccessToken [oauth.openshift.io/v1] {id="useroauthaccesstoken-oauth-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
| --- | --- |
| 200 - OK | [`UserOAuthAccessTokenList`](/rest_api/objects/index#com-github-openshift-api-oauth-v1-UserOAuthAccessTokenList) schema |
| 401 - Unauthorized | Empty |

### /apis/oauth.openshift.io/v1/watch/useroauthaccesstokens {id="_apisoauthopenshiftiov1watchuseroauthaccesstokens"}
...
### /apis/oauth.openshift.io/v1/useroauthaccesstokens/{{ name }} {id="_apisoauthopenshiftiov1useroauthaccesstokens_name"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`UserOAuthAccessToken`](/rest_api/oauth_apis/useroauthaccesstoken-oauth-openshift-io-v1#useroauthaccesstoken-oauth-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/oauth.openshift.io/v1/watch/useroauthaccesstokens/{{ name }} {id="_apisoauthopenshiftiov1watchuseroauthaccesstokens_name"}
