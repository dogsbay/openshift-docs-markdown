...
# OAuthAccessToken [oauth.openshift.io/v1] {id="oauthaccesstoken-oauth-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/oauth.openshift.io/v1/watch/oauthaccesstokens {id="_apisoauthopenshiftiov1watchoauthaccesstokens"}
...
### /apis/oauth.openshift.io/v1/oauthaccesstokens/{{ name }} {id="_apisoauthopenshiftiov1oauthaccesstokens_name"}
...
### /apis/oauth.openshift.io/v1/watch/oauthaccesstokens/{{ name }} {id="_apisoauthopenshiftiov1watchoauthaccesstokens_name"}
