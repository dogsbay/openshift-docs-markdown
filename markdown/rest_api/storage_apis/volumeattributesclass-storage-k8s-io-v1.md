...
# VolumeAttributesClass [storage.k8s.io/v1] {id="volumeattributesclass-storage-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/storage.k8s.io/v1/watch/volumeattributesclasses {id="_apisstoragek8siov1watchvolumeattributesclasses"}
...
### /apis/storage.k8s.io/v1/volumeattributesclasses/{{ name }} {id="_apisstoragek8siov1volumeattributesclasses_name"}
...
### /apis/storage.k8s.io/v1/watch/volumeattributesclasses/{{ name }} {id="_apisstoragek8siov1watchvolumeattributesclasses_name"}
