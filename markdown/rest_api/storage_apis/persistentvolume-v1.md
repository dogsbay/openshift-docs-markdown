...
# PersistentVolume [v1] {id="persistentvolume-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /api/v1/watch/persistentvolumes {id="_apiv1watchpersistentvolumes"}
...
### /api/v1/watch/persistentvolumes/{{ name }} {id="_apiv1watchpersistentvolumes_name"}
