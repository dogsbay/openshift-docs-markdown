...
# CSINode [storage.k8s.io/v1] {id="csinode-storage-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/storage.k8s.io/v1/watch/csinodes {id="_apisstoragek8siov1watchcsinodes"}
...
### /apis/storage.k8s.io/v1/csinodes/{{ name }} {id="_apisstoragek8siov1csinodes_name"}
...
### /apis/storage.k8s.io/v1/watch/csinodes/{{ name }} {id="_apisstoragek8siov1watchcsinodes_name"}
