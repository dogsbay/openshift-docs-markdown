...
# VolumeSnapshotContent [snapshot.storage.k8s.io/v1] {id="volumesnapshotcontent-snapshot-storage-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/snapshot.storage.k8s.io/v1/volumesnapshotcontents {id="_apissnapshotstoragek8siov1volumesnapshotcontents"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`VolumeSnapshotContentList`](/rest_api/objects/index#io-k8s-storage-snapshot-v1-VolumeSnapshotContentList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`VolumeSnapshotContent`](/rest_api/storage_apis/volumesnapshotcontent-snapshot-storage-k8s-io-v1#volumesnapshotcontent-snapshot-storage-k8s-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`VolumeSnapshotContent`](/rest_api/storage_apis/volumesnapshotcontent-snapshot-storage-k8s-io-v1#volumesnapshotcontent-snapshot-storage-k8s-io-v1) schema |
| 201 - Created | [`VolumeSnapshotContent`](/rest_api/storage_apis/volumesnapshotcontent-snapshot-storage-k8s-io-v1#volumesnapshotcontent-snapshot-storage-k8s-io-v1) schema |
| 202 - Accepted | [`VolumeSnapshotContent`](/rest_api/storage_apis/volumesnapshotcontent-snapshot-storage-k8s-io-v1#volumesnapshotcontent-snapshot-storage-k8s-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/snapshot.storage.k8s.io/v1/volumesnapshotcontents/{{ name }} {id="_apissnapshotstoragek8siov1volumesnapshotcontents_name"}
...
### /apis/snapshot.storage.k8s.io/v1/volumesnapshotcontents/{{ name }}/status {id="_apissnapshotstoragek8siov1volumesnapshotcontents_name_status"}
