...
# StorageState [migration.k8s.io/v1alpha1] {id="storagestate-migration-k8s-io-v1alpha1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/migration.k8s.io/v1alpha1/storagestates {id="_apismigrationk8siov1alpha1storagestates"}
...
### /apis/migration.k8s.io/v1alpha1/storagestates/{{ name }} {id="_apismigrationk8siov1alpha1storagestates_name"}
...
### /apis/migration.k8s.io/v1alpha1/storagestates/{{ name }}/status {id="_apismigrationk8siov1alpha1storagestates_name_status"}
