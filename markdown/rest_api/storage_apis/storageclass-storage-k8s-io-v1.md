...
# StorageClass [storage.k8s.io/v1] {id="storageclass-storage-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/storage.k8s.io/v1/watch/storageclasses {id="_apisstoragek8siov1watchstorageclasses"}
...
### /apis/storage.k8s.io/v1/storageclasses/{{ name }} {id="_apisstoragek8siov1storageclasses_name"}
...
### /apis/storage.k8s.io/v1/watch/storageclasses/{{ name }} {id="_apisstoragek8siov1watchstorageclasses_name"}
