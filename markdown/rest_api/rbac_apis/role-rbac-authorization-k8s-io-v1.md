...
# Role [rbac.authorization.k8s.io/v1] {id="role-rbac-authorization-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/rbac.authorization.k8s.io/v1/watch/roles {id="_apisrbacauthorizationk8siov1watchroles"}
...
### /apis/rbac.authorization.k8s.io/v1/namespaces/{{ namespace }}/roles {id="_apisrbacauthorizationk8siov1namespaces_namespace_roles"}
...
### /apis/rbac.authorization.k8s.io/v1/watch/namespaces/{{ namespace }}/roles {id="_apisrbacauthorizationk8siov1watchnamespaces_namespace_roles"}
...
### /apis/rbac.authorization.k8s.io/v1/namespaces/{{ namespace }}/roles/{{ name }} {id="_apisrbacauthorizationk8siov1namespaces_namespace_roles_name"}
...
### /apis/rbac.authorization.k8s.io/v1/watch/namespaces/{{ namespace }}/roles/{{ name }} {id="_apisrbacauthorizationk8siov1watchnamespaces_namespace_roles_name"}
