...
# RoleBinding [rbac.authorization.k8s.io/v1] {id="rolebinding-rbac-authorization-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/rbac.authorization.k8s.io/v1/watch/rolebindings {id="_apisrbacauthorizationk8siov1watchrolebindings"}
...
### /apis/rbac.authorization.k8s.io/v1/namespaces/{{ namespace }}/rolebindings {id="_apisrbacauthorizationk8siov1namespaces_namespace_rolebindings"}
...
### /apis/rbac.authorization.k8s.io/v1/watch/namespaces/{{ namespace }}/rolebindings {id="_apisrbacauthorizationk8siov1watchnamespaces_namespace_rolebindings"}
...
### /apis/rbac.authorization.k8s.io/v1/namespaces/{{ namespace }}/rolebindings/{{ name }} {id="_apisrbacauthorizationk8siov1namespaces_namespace_rolebindings_name"}
...
### /apis/rbac.authorization.k8s.io/v1/watch/namespaces/{{ namespace }}/rolebindings/{{ name }} {id="_apisrbacauthorizationk8siov1watchnamespaces_namespace_rolebindings_name"}
