...
# ClusterRole [rbac.authorization.k8s.io/v1] {id="clusterrole-rbac-authorization-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/rbac.authorization.k8s.io/v1/watch/clusterroles {id="_apisrbacauthorizationk8siov1watchclusterroles"}
...
### /apis/rbac.authorization.k8s.io/v1/clusterroles/{{ name }} {id="_apisrbacauthorizationk8siov1clusterroles_name"}
...
### /apis/rbac.authorization.k8s.io/v1/watch/clusterroles/{{ name }} {id="_apisrbacauthorizationk8siov1watchclusterroles_name"}
