...
# ClusterRoleBinding [rbac.authorization.k8s.io/v1] {id="clusterrolebinding-rbac-authorization-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
*   `/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{{ name }}`{minja}
...
*   `/apis/rbac.authorization.k8s.io/v1/watch/clusterrolebindings/{{ name }}`{minja}
...
### /apis/rbac.authorization.k8s.io/v1/clusterrolebindings {id="_apisrbacauthorizationk8siov1clusterrolebindings"}
...
### /apis/rbac.authorization.k8s.io/v1/watch/clusterrolebindings {id="_apisrbacauthorizationk8siov1watchclusterrolebindings"}
...
### /apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{{ name }} {id="_apisrbacauthorizationk8siov1clusterrolebindings_name"}
...
### /apis/rbac.authorization.k8s.io/v1/watch/clusterrolebindings/{{ name }} {id="_apisrbacauthorizationk8siov1watchclusterrolebindings_name"}
