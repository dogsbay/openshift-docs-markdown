...
# RangeAllocation [security.openshift.io/v1] {id="rangeallocation-security-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/security.openshift.io/v1/watch/rangeallocations {id="_apissecurityopenshiftiov1watchrangeallocations"}
...
### /apis/security.openshift.io/v1/rangeallocations/{{ name }} {id="_apissecurityopenshiftiov1rangeallocations_name"}
...
### /apis/security.openshift.io/v1/watch/rangeallocations/{{ name }} {id="_apissecurityopenshiftiov1watchrangeallocations_name"}
