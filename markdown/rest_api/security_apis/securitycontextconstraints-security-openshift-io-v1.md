...
# SecurityContextConstraints [security.openshift.io/v1] {id="securitycontextconstraints-security-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/security.openshift.io/v1/watch/securitycontextconstraints {id="_apissecurityopenshiftiov1watchsecuritycontextconstraints"}
...
### /apis/security.openshift.io/v1/securitycontextconstraints/{{ name }} {id="_apissecurityopenshiftiov1securitycontextconstraints_name"}
...
### /apis/security.openshift.io/v1/watch/securitycontextconstraints/{{ name }} {id="_apissecurityopenshiftiov1watchsecuritycontextconstraints_name"}
