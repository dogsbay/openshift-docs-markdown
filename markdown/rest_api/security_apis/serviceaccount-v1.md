...
# ServiceAccount [v1] {id="serviceaccount-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /api/v1/watch/serviceaccounts {id="_apiv1watchserviceaccounts"}
...
### /api/v1/watch/namespaces/{{ namespace }}/serviceaccounts {id="_apiv1watchnamespaces_namespace_serviceaccounts"}
...
### /api/v1/watch/namespaces/{{ namespace }}/serviceaccounts/{{ name }} {id="_apiv1watchnamespaces_namespace_serviceaccounts_name"}
