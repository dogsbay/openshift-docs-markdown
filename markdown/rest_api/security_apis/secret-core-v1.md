...
# Secret [core/v1] {id="secret-core-v1"}
{%- if product_title %}
...
| --- | --- |
| 200 - OK | [`SecretList core/v1`](/rest_api/objects/index#secretlist-core-v1) |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`Secret core/v1`](/rest_api/security_apis/secret-core-v1#secret-core-v1) |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Secret core/v1`](/rest_api/security_apis/secret-core-v1#secret-core-v1) |
