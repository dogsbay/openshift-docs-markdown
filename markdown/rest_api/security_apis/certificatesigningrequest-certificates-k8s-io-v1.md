...
# CertificateSigningRequest [certificates.k8s.io/v1] {id="certificatesigningrequest-certificates-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
:   CertificateSigningRequest objects provide a mechanism to obtain x509 certificates by submitting a certificate signing request, and having it asynchronously approved and issued.
    ...
    1.  serving certificates for TLS endpoints kube-apiserver can connect to securely (with the "kubernetes.io/kubelet-serving" signerName).
...
*   `/apis/certificates.k8s.io/v1/certificatesigningrequests/{{ name }}`{minja}
...
*   `/apis/certificates.k8s.io/v1/watch/certificatesigningrequests/{{ name }}`{minja}
...
*   `/apis/certificates.k8s.io/v1/certificatesigningrequests/{{ name }}/status`{minja}
...
*   `/apis/certificates.k8s.io/v1/certificatesigningrequests/{{ name }}/approval`{minja}
...
### /apis/certificates.k8s.io/v1/certificatesigningrequests {id="_apiscertificatesk8siov1certificatesigningrequests"}
...
### /apis/certificates.k8s.io/v1/watch/certificatesigningrequests {id="_apiscertificatesk8siov1watchcertificatesigningrequests"}
...
### /apis/certificates.k8s.io/v1/certificatesigningrequests/{{ name }} {id="_apiscertificatesk8siov1certificatesigningrequests_name"}
...
### /apis/certificates.k8s.io/v1/watch/certificatesigningrequests/{{ name }} {id="_apiscertificatesk8siov1watchcertificatesigningrequests_name"}
...
### /apis/certificates.k8s.io/v1/certificatesigningrequests/{{ name }}/status {id="_apiscertificatesk8siov1certificatesigningrequests_name_status"}
...
### /apis/certificates.k8s.io/v1/certificatesigningrequests/{{ name }}/approval {id="_apiscertificatesk8siov1certificatesigningrequests_name_approval"}
