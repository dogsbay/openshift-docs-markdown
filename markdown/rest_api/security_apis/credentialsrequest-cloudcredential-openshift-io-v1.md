...
# CredentialsRequest [cloudcredential.openshift.io/v1] {id="credentialsrequest-cloudcredential-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.secretRef {id="_specsecretref"}
...
*   `/apis/cloudcredential.openshift.io/v1/namespaces/{{ namespace }}/credentialsrequests`{minja}
    *   `DELETE`: delete collection of CredentialsRequest
    *   `GET`: list objects of kind CredentialsRequest
    *   `POST`: create a CredentialsRequest
*   `/apis/cloudcredential.openshift.io/v1/namespaces/{{ namespace }}/credentialsrequests/{{ name }}`{minja}
...
*   `/apis/cloudcredential.openshift.io/v1/namespaces/{{ namespace }}/credentialsrequests/{{ name }}/status`{minja}
...
### /apis/cloudcredential.openshift.io/v1/credentialsrequests {id="_apiscloudcredentialopenshiftiov1credentialsrequests"}
...
### /apis/cloudcredential.openshift.io/v1/namespaces/{{ namespace }}/credentialsrequests {id="_apiscloudcredentialopenshiftiov1namespaces_namespace_credentialsrequests"}
...
### /apis/cloudcredential.openshift.io/v1/namespaces/{{ namespace }}/credentialsrequests/{{ name }} {id="_apiscloudcredentialopenshiftiov1namespaces_namespace_credentialsrequests_name"}
...
### /apis/cloudcredential.openshift.io/v1/namespaces/{{ namespace }}/credentialsrequests/{{ name }}/status {id="_apiscloudcredentialopenshiftiov1namespaces_namespace_credentialsrequests_name_status"}
