...
# ServiceAccount [core/v1] {id="serviceaccount-core-v1"}
{%- if product_title %}
...
| `imagePullSecrets` | [`array (LocalObjectReference core/v1)`](/rest_api/objects/index#localobjectreference-core-v1) | ImagePullSecrets is a list of references to secrets in the same namespace to use for pulling any images in pods that reference this ServiceAccount. ImagePullSecrets are distinct from Secrets because Secrets can be mounted in the pod, but ImagePullSecrets are only accessed by the kubelet. More info: https://kubernetes.io/docs/concepts/containers/images/#specifying-imagepullsecrets-on-a-pod |
...
| `secrets` | [`array (ObjectReference core/v1)`](/rest_api/objects/index#objectreference-core-v1) | Secrets is the list of secrets allowed to be used by pods running using this ServiceAccount. More info: https://kubernetes.io/docs/concepts/configuration/secret |
...
| --- | --- |
| 200 - OK | [`ServiceAccountList core/v1`](/rest_api/objects/index#serviceaccountlist-core-v1) |

### /api/v1/namespaces/{{ namespace }}/serviceaccounts {id="_apiv1namespaces_namespace_serviceaccounts"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`ServiceAccount core/v1`](/rest_api/security_apis/serviceaccount-core-v1#serviceaccount-core-v1) |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ServiceAccount core/v1`](/rest_api/security_apis/serviceaccount-core-v1#serviceaccount-core-v1) |

### /api/v1/namespaces/{{ namespace }}/serviceaccounts/{{ name }} {id="_apiv1namespaces_namespace_serviceaccounts_name"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`TokenRequest authentication.k8s.io/v1`](/rest_api/objects/index#tokenrequest-authentication-k8s-io-v1) |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`TokenRequest authentication.k8s.io/v1`](/rest_api/objects/index#tokenrequest-authentication-k8s-io-v1) |