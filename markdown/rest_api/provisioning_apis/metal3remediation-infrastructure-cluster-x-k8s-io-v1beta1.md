...
# Metal3Remediation [infrastructure.cluster.x-k8s.io/v1beta1] {id="metal3remediation-infrastructure-cluster-x-k8s-io-v1beta1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/infrastructure.cluster.x-k8s.io/v1beta1/metal3remediations {id="_apisinfrastructureclusterx-k8siov1beta1metal3remediations"}
...
### /apis/infrastructure.cluster.x-k8s.io/v1beta1/namespaces/{{ namespace }}/metal3remediations {id="_apisinfrastructureclusterx-k8siov1beta1namespaces_namespace_metal3remediations"}
...
### /apis/infrastructure.cluster.x-k8s.io/v1beta1/namespaces/{{ namespace }}/metal3remediations/{{ name }} {id="_apisinfrastructureclusterx-k8siov1beta1namespaces_namespace_metal3remediations_name"}
...
### /apis/infrastructure.cluster.x-k8s.io/v1beta1/namespaces/{{ namespace }}/metal3remediations/{{ name }}/status {id="_apisinfrastructureclusterx-k8siov1beta1namespaces_namespace_metal3remediations_name_status"}
