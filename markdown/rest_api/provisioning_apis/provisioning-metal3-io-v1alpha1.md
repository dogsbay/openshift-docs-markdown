...
# Provisioning [metal3.io/v1alpha1] {id="provisioning-metal3-io-v1alpha1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/metal3.io/v1alpha1/provisionings {id="_apismetal3iov1alpha1provisionings"}
...
### /apis/metal3.io/v1alpha1/provisionings/{{ name }} {id="_apismetal3iov1alpha1provisionings_name"}
...
### /apis/metal3.io/v1alpha1/provisionings/{{ name }}/status {id="_apismetal3iov1alpha1provisionings_name_status"}
