...
# HostFirmwareComponents [metal3.io/v1alpha1] {id="hostfirmwarecomponents-metal3-io-v1alpha1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/metal3.io/v1alpha1/hostfirmwarecomponents {id="_apismetal3iov1alpha1hostfirmwarecomponents"}
...
### /apis/metal3.io/v1alpha1/namespaces/{{ namespace }}/hostfirmwarecomponents {id="_apismetal3iov1alpha1namespaces_namespace_hostfirmwarecomponents"}
...
### /apis/metal3.io/v1alpha1/namespaces/{{ namespace }}/hostfirmwarecomponents/{{ name }} {id="_apismetal3iov1alpha1namespaces_namespace_hostfirmwarecomponents_name"}
...
### /apis/metal3.io/v1alpha1/namespaces/{{ namespace }}/hostfirmwarecomponents/{{ name }}/status {id="_apismetal3iov1alpha1namespaces_namespace_hostfirmwarecomponents_name_status"}
