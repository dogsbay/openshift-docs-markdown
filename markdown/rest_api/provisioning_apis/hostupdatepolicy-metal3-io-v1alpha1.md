...
# HostUpdatePolicy [metal3.io/v1alpha1] {id="hostupdatepolicy-metal3-io-v1alpha1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/metal3.io/v1alpha1/hostupdatepolicies {id="_apismetal3iov1alpha1hostupdatepolicies"}
...
### /apis/metal3.io/v1alpha1/namespaces/{{ namespace }}/hostupdatepolicies {id="_apismetal3iov1alpha1namespaces_namespace_hostupdatepolicies"}
...
### /apis/metal3.io/v1alpha1/namespaces/{{ namespace }}/hostupdatepolicies/{{ name }} {id="_apismetal3iov1alpha1namespaces_namespace_hostupdatepolicies_name"}
