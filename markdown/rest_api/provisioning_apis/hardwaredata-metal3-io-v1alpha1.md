...
# HardwareData [metal3.io/v1alpha1] {id="hardwaredata-metal3-io-v1alpha1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/metal3.io/v1alpha1/hardwaredata {id="_apismetal3iov1alpha1hardwaredata"}
...
### /apis/metal3.io/v1alpha1/namespaces/{{ namespace }}/hardwaredata {id="_apismetal3iov1alpha1namespaces_namespace_hardwaredata"}
...
### /apis/metal3.io/v1alpha1/namespaces/{{ namespace }}/hardwaredata/{{ name }} {id="_apismetal3iov1alpha1namespaces_namespace_hardwaredata_name"}
