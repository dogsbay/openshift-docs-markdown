...
# Provisioning APIs {id="provisioning-apis"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}

## BMCEventSubscription [metal3.io/v1alpha1] {id="_bmceventsubscription_metal3iov1alpha1"}
...
## BareMetalHost [metal3.io/v1alpha1] {id="_baremetalhost_metal3iov1alpha1"}
...
## DataImage [metal3.io/v1alpha1] {id="_dataimage_metal3iov1alpha1"}
...
## FirmwareSchema [metal3.io/v1alpha1] {id="_firmwareschema_metal3iov1alpha1"}
...
## HardwareData [metal3.io/v1alpha1] {id="_hardwaredata_metal3iov1alpha1"}
...
## HostFirmwareComponents [metal3.io/v1alpha1] {id="_hostfirmwarecomponents_metal3iov1alpha1"}
...
## HostFirmwareSettings [metal3.io/v1alpha1] {id="_hostfirmwaresettings_metal3iov1alpha1"}
...
## HostUpdatePolicy [metal3.io/v1alpha1] {id="_hostupdatepolicy_metal3iov1alpha1"}
...
## Metal3Remediation [infrastructure.cluster.x-k8s.io/v1beta1] {id="_metal3remediation_infrastructureclusterx-k8siov1beta1"}
...
## Metal3RemediationTemplate [infrastructure.cluster.x-k8s.io/v1beta1] {id="_metal3remediationtemplate_infrastructureclusterx-k8siov1beta1"}
...
## PreprovisioningImage [metal3.io/v1alpha1] {id="_preprovisioningimage_metal3iov1alpha1"}
...
## Provisioning [metal3.io/v1alpha1] {id="_provisioning_metal3iov1alpha1"}
