...
# BareMetalHost [metal3.io/v1alpha1] {id="baremetalhost-metal3-io-v1alpha1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/metal3.io/v1alpha1/baremetalhosts {id="_apismetal3iov1alpha1baremetalhosts"}
...
### /apis/metal3.io/v1alpha1/namespaces/{{ namespace }}/baremetalhosts {id="_apismetal3iov1alpha1namespaces_namespace_baremetalhosts"}
...
### /apis/metal3.io/v1alpha1/namespaces/{{ namespace }}/baremetalhosts/{{ name }} {id="_apismetal3iov1alpha1namespaces_namespace_baremetalhosts_name"}
...
### /apis/metal3.io/v1alpha1/namespaces/{{ namespace }}/baremetalhosts/{{ name }}/status {id="_apismetal3iov1alpha1namespaces_namespace_baremetalhosts_name_status"}
