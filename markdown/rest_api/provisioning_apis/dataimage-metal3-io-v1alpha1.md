...
# DataImage [metal3.io/v1alpha1] {id="dataimage-metal3-io-v1alpha1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/metal3.io/v1alpha1/dataimages {id="_apismetal3iov1alpha1dataimages"}
...
### /apis/metal3.io/v1alpha1/namespaces/{{ namespace }}/dataimages {id="_apismetal3iov1alpha1namespaces_namespace_dataimages"}
...
### /apis/metal3.io/v1alpha1/namespaces/{{ namespace }}/dataimages/{{ name }} {id="_apismetal3iov1alpha1namespaces_namespace_dataimages_name"}
...
### /apis/metal3.io/v1alpha1/namespaces/{{ namespace }}/dataimages/{{ name }}/status {id="_apismetal3iov1alpha1namespaces_namespace_dataimages_name_status"}
