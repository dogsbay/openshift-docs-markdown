...
# Project APIs {id="project-apis"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}

## Project [project.openshift.io/v1] {id="_project_projectopenshiftiov1"}
...
## ProjectRequest [project.openshift.io/v1] {id="_projectrequest_projectopenshiftiov1"}
