...
# Project [project.openshift.io/v1] {id="project-project-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/project.openshift.io/v1/watch/projects {id="_apisprojectopenshiftiov1watchprojects"}
...
### /apis/project.openshift.io/v1/projects/{{ name }} {id="_apisprojectopenshiftiov1projects_name"}
...
### /apis/project.openshift.io/v1/watch/projects/{{ name }} {id="_apisprojectopenshiftiov1watchprojects_name"}
