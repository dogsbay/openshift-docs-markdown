...
# ClusterResourceQuota [quota.openshift.io/v1] {id="clusterresourcequota-quota-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/quota.openshift.io/v1/clusterresourcequotas {id="_apisquotaopenshiftiov1clusterresourcequotas"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ClusterResourceQuotaList`](/rest_api/objects/index#io-openshift-quota-v1-ClusterResourceQuotaList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`ClusterResourceQuota`](/rest_api/schedule_and_quota_apis/clusterresourcequota-quota-openshift-io-v1#clusterresourcequota-quota-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ClusterResourceQuota`](/rest_api/schedule_and_quota_apis/clusterresourcequota-quota-openshift-io-v1#clusterresourcequota-quota-openshift-io-v1) schema |
| 201 - Created | [`ClusterResourceQuota`](/rest_api/schedule_and_quota_apis/clusterresourcequota-quota-openshift-io-v1#clusterresourcequota-quota-openshift-io-v1) schema |
| 202 - Accepted | [`ClusterResourceQuota`](/rest_api/schedule_and_quota_apis/clusterresourcequota-quota-openshift-io-v1#clusterresourcequota-quota-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/quota.openshift.io/v1/watch/clusterresourcequotas {id="_apisquotaopenshiftiov1watchclusterresourcequotas"}
...
### /apis/quota.openshift.io/v1/clusterresourcequotas/{{ name }} {id="_apisquotaopenshiftiov1clusterresourcequotas_name"}
...
### /apis/quota.openshift.io/v1/watch/clusterresourcequotas/{{ name }} {id="_apisquotaopenshiftiov1watchclusterresourcequotas_name"}
...
### /apis/quota.openshift.io/v1/clusterresourcequotas/{{ name }}/status {id="_apisquotaopenshiftiov1clusterresourcequotas_name_status"}
