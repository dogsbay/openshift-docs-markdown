...
# LimitRange [core/v1] {id="limitrange-core-v1"}
{%- if product_title %}
...
| Property | Type | Description |
| --- | --- | --- |
| `limits` | [`array (LimitRangeItem core/v1)`](/rest_api/objects/index#limitrangeitem-core-v1) | Limits is the list of LimitRangeItem objects that are enforced. |
...
| --- | --- |
| 200 - OK | [`LimitRangeList core/v1`](/rest_api/objects/index#limitrangelist-core-v1) |

### /api/v1/namespaces/{{ namespace }}/limitranges {id="_apiv1namespaces_namespace_limitranges"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`LimitRange core/v1`](/rest_api/schedule_and_quota_apis/limitrange-core-v1#limitrange-core-v1) |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`LimitRange core/v1`](/rest_api/schedule_and_quota_apis/limitrange-core-v1#limitrange-core-v1) |

### /api/v1/namespaces/{{ namespace }}/limitranges/{{ name }} {id="_apiv1namespaces_namespace_limitranges_name"}
