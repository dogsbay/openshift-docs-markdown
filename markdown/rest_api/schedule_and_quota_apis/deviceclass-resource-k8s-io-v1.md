...
# DeviceClass [resource.k8s.io/v1] {id="deviceclass-resource-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/resource.k8s.io/v1/watch/deviceclasses {id="_apisresourcek8siov1watchdeviceclasses"}
...
### /apis/resource.k8s.io/v1/deviceclasses/{{ name }} {id="_apisresourcek8siov1deviceclasses_name"}
...
### /apis/resource.k8s.io/v1/watch/deviceclasses/{{ name }} {id="_apisresourcek8siov1watchdeviceclasses_name"}
