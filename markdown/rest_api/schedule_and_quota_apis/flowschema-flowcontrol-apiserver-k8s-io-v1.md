...
# FlowSchema [flowcontrol.apiserver.k8s.io/v1] {id="flowschema-flowcontrol-apiserver-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/flowcontrol.apiserver.k8s.io/v1/flowschemas {id="_apisflowcontrolapiserverk8siov1flowschemas"}
...
### /apis/flowcontrol.apiserver.k8s.io/v1/watch/flowschemas {id="_apisflowcontrolapiserverk8siov1watchflowschemas"}
...
### /apis/flowcontrol.apiserver.k8s.io/v1/flowschemas/{{ name }} {id="_apisflowcontrolapiserverk8siov1flowschemas_name"}
...
### /apis/flowcontrol.apiserver.k8s.io/v1/watch/flowschemas/{{ name }} {id="_apisflowcontrolapiserverk8siov1watchflowschemas_name"}
...
### /apis/flowcontrol.apiserver.k8s.io/v1/flowschemas/{{ name }}/status {id="_apisflowcontrolapiserverk8siov1flowschemas_name_status"}
