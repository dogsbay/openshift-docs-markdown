...
# PriorityLevelConfiguration [flowcontrol.apiserver.k8s.io/v1] {id="prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.limited.limitResponse {id="_speclimitedlimitresponse"}
...
### .spec.limited.limitResponse.queuing {id="_speclimitedlimitresponsequeuing"}
...
*   `/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{{ name }}`{minja}
...
*   `/apis/flowcontrol.apiserver.k8s.io/v1/watch/prioritylevelconfigurations/{{ name }}`{minja}
...
*   `/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{{ name }}/status`{minja}
...
### /apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations {id="_apisflowcontrolapiserverk8siov1prioritylevelconfigurations"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`PriorityLevelConfigurationList`](/rest_api/objects/index#io-k8s-api-flowcontrol-v1-PriorityLevelConfigurationList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`PriorityLevelConfiguration`](/rest_api/schedule_and_quota_apis/prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1#prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`PriorityLevelConfiguration`](/rest_api/schedule_and_quota_apis/prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1#prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1) schema |
| 201 - Created | [`PriorityLevelConfiguration`](/rest_api/schedule_and_quota_apis/prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1#prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1) schema |
| 202 - Accepted | [`PriorityLevelConfiguration`](/rest_api/schedule_and_quota_apis/prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1#prioritylevelconfiguration-flowcontrol-apiserver-k8s-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/flowcontrol.apiserver.k8s.io/v1/watch/prioritylevelconfigurations {id="_apisflowcontrolapiserverk8siov1watchprioritylevelconfigurations"}
...
### /apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{{ name }} {id="_apisflowcontrolapiserverk8siov1prioritylevelconfigurations_name"}
...
### /apis/flowcontrol.apiserver.k8s.io/v1/watch/prioritylevelconfigurations/{{ name }} {id="_apisflowcontrolapiserverk8siov1watchprioritylevelconfigurations_name"}
...
### /apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{{ name }}/status {id="_apisflowcontrolapiserverk8siov1prioritylevelconfigurations_name_status"}
