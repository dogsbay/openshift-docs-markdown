...
# ResourceQuota [core/v1] {id="resourcequota-core-v1"}
{%- if product_title %}
...
| Property | Type | Description |
| --- | --- | --- |
| `hard` | [`object (Quantity api/none)`](/rest_api/objects/index#quantity-api-none) | hard is the set of desired hard limits for each named resource. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/ |
| `scopeSelector` | [`ScopeSelector core/v1`](/rest_api/objects/index#scopeselector-core-v1) | scopeSelector is also a collection of filters like scopes that must match each object tracked by a quota but expressed using ScopeSelectorOperator in combination with possible values. For a resource to match, both scopes AND scopeSelector (if specified in spec), must be matched. |
...
| Property | Type | Description |
| --- | --- | --- |
| `hard` | [`object (Quantity api/none)`](/rest_api/objects/index#quantity-api-none) | Hard is the set of enforced hard limits for each named resource. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/ |
| `used` | [`object (Quantity api/none)`](/rest_api/objects/index#quantity-api-none) | Used is the current observed total usage of the resource in the namespace. |
...
| --- | --- |
| 200 - OK | [`ResourceQuotaList core/v1`](/rest_api/objects/index#resourcequotalist-core-v1) |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`ResourceQuota core/v1`](/rest_api/schedule_and_quota_apis/resourcequota-core-v1#resourcequota-core-v1) |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ResourceQuota core/v1`](/rest_api/schedule_and_quota_apis/resourcequota-core-v1#resourcequota-core-v1) |
