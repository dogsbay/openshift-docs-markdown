...
# ResourceClaimTemplate [resource.k8s.io/v1] {id="resourceclaimtemplate-resource-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
| Property | Type | Description |
| --- | --- | --- |
| `metadata` | [`ObjectMeta`](/rest_api/objects/index#io-k8s-apimachinery-pkg-apis-meta-v1-ObjectMeta) | ObjectMeta may contain labels and annotations that will be copied into the ResourceClaim when creating it. No other fields are allowed and will be rejected during validation. |
| `spec` | `object` | ResourceClaimSpec defines what is being requested in a ResourceClaim and how to configure it. |

### .spec.spec {id="_specspec"}
...
### .spec.spec.devices {id="_specspecdevices"}
...
### .spec.spec.devices.config {id="_specspecdevicesconfig"}
...
### .spec.spec.devices.config[].opaque {id="_specspecdevicesconfigopaque"}
...
### .spec.spec.devices.constraints {id="_specspecdevicesconstraints"}
...
### .spec.spec.devices.requests {id="_specspecdevicesrequests"}
...
### .spec.spec.devices.requests[].exactly {id="_specspecdevicesrequestsexactly"}
...
### .spec.spec.devices.requests[].exactly.capacity {id="_specspecdevicesrequestsexactlycapacity"}
...
### .spec.spec.devices.requests[].exactly.selectors {id="_specspecdevicesrequestsexactlyselectors"}
...
### .spec.spec.devices.requests[].exactly.selectors[].cel {id="_specspecdevicesrequestsexactlyselectorscel"}
...
### .spec.spec.devices.requests[].exactly.tolerations {id="_specspecdevicesrequestsexactlytolerations"}
...
### .spec.spec.devices.requests[].firstAvailable {id="_specspecdevicesrequestsfirstavailable"}
...
### .spec.spec.devices.requests[].firstAvailable[].capacity {id="_specspecdevicesrequestsfirstavailablecapacity"}
...
### .spec.spec.devices.requests[].firstAvailable[].selectors {id="_specspecdevicesrequestsfirstavailableselectors"}
...
### .spec.spec.devices.requests[].firstAvailable[].selectors[].cel {id="_specspecdevicesrequestsfirstavailableselectorscel"}
...
### .spec.spec.devices.requests[].firstAvailable[].tolerations {id="_specspecdevicesrequestsfirstavailabletolerations"}
...
*   `/apis/resource.k8s.io/v1/namespaces/{{ namespace }}/resourceclaimtemplates`{minja}
    *   `DELETE`: delete collection of ResourceClaimTemplate
    *   `GET`: list or watch objects of kind ResourceClaimTemplate
    *   `POST`: create a ResourceClaimTemplate
*   `/apis/resource.k8s.io/v1/watch/namespaces/{{ namespace }}/resourceclaimtemplates`{minja}
    *   `GET`: watch individual changes to a list of ResourceClaimTemplate. deprecated: use the &#x27;watch&#x27; parameter with a list operation instead.
*   `/apis/resource.k8s.io/v1/namespaces/{{ namespace }}/resourceclaimtemplates/{{ name }}`{minja}
...
*   `/apis/resource.k8s.io/v1/watch/namespaces/{{ namespace }}/resourceclaimtemplates/{{ name }}`{minja}
...
### /apis/resource.k8s.io/v1/resourceclaimtemplates {id="_apisresourcek8siov1resourceclaimtemplates"}
...
| --- | --- |
| 200 - OK | [`ResourceClaimTemplateList`](/rest_api/objects/index#io-k8s-api-resource-v1-ResourceClaimTemplateList) schema |
| 401 - Unauthorized | Empty |

### /apis/resource.k8s.io/v1/watch/resourceclaimtemplates {id="_apisresourcek8siov1watchresourceclaimtemplates"}
...
### /apis/resource.k8s.io/v1/namespaces/{{ namespace }}/resourceclaimtemplates {id="_apisresourcek8siov1namespaces_namespace_resourceclaimtemplates"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`ResourceClaimTemplate`](/rest_api/schedule_and_quota_apis/resourceclaimtemplate-resource-k8s-io-v1#resourceclaimtemplate-resource-k8s-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ResourceClaimTemplate`](/rest_api/schedule_and_quota_apis/resourceclaimtemplate-resource-k8s-io-v1#resourceclaimtemplate-resource-k8s-io-v1) schema |
| 201 - Created | [`ResourceClaimTemplate`](/rest_api/schedule_and_quota_apis/resourceclaimtemplate-resource-k8s-io-v1#resourceclaimtemplate-resource-k8s-io-v1) schema |
| 202 - Accepted | [`ResourceClaimTemplate`](/rest_api/schedule_and_quota_apis/resourceclaimtemplate-resource-k8s-io-v1#resourceclaimtemplate-resource-k8s-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/resource.k8s.io/v1/watch/namespaces/{{ namespace }}/resourceclaimtemplates {id="_apisresourcek8siov1watchnamespaces_namespace_resourceclaimtemplates"}
...
### /apis/resource.k8s.io/v1/namespaces/{{ namespace }}/resourceclaimtemplates/{{ name }} {id="_apisresourcek8siov1namespaces_namespace_resourceclaimtemplates_name"}
...
### /apis/resource.k8s.io/v1/watch/namespaces/{{ namespace }}/resourceclaimtemplates/{{ name }} {id="_apisresourcek8siov1watchnamespaces_namespace_resourceclaimtemplates_name"}
