...
# LimitRange [v1] {id="limitrange-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /api/v1/watch/limitranges {id="_apiv1watchlimitranges"}
...
### /api/v1/watch/namespaces/{{ namespace }}/limitranges {id="_apiv1watchnamespaces_namespace_limitranges"}
...
### /api/v1/watch/namespaces/{{ namespace }}/limitranges/{{ name }} {id="_apiv1watchnamespaces_namespace_limitranges_name"}
