...
This guidance does not cover layered {{ product_title }} offerings.
...
{% leveloffset +1 %}{% include "./modules/api-support-tiers.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/api-support-tiers-mapping.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/api-support-deprecation-policy.md" %}{% endleveloffset %}