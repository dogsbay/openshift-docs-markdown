...
# CloudCredential [operator.openshift.io/v1] {id="cloudcredential-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
*   `/apis/operator.openshift.io/v1/cloudcredentials/{{ name }}`{minja}
...
*   `/apis/operator.openshift.io/v1/cloudcredentials/{{ name }}/status`{minja}
...
### /apis/operator.openshift.io/v1/cloudcredentials {id="_apisoperatoropenshiftiov1cloudcredentials"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`CloudCredentialList`](/rest_api/objects/index#io-openshift-operator-v1-CloudCredentialList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`CloudCredential`](/rest_api/operator_apis/cloudcredential-operator-openshift-io-v1#cloudcredential-operator-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`CloudCredential`](/rest_api/operator_apis/cloudcredential-operator-openshift-io-v1#cloudcredential-operator-openshift-io-v1) schema |
| 201 - Created | [`CloudCredential`](/rest_api/operator_apis/cloudcredential-operator-openshift-io-v1#cloudcredential-operator-openshift-io-v1) schema |
| 202 - Accepted | [`CloudCredential`](/rest_api/operator_apis/cloudcredential-operator-openshift-io-v1#cloudcredential-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/operator.openshift.io/v1/cloudcredentials/{{ name }} {id="_apisoperatoropenshiftiov1cloudcredentials_name"}
...
### /apis/operator.openshift.io/v1/cloudcredentials/{{ name }}/status {id="_apisoperatoropenshiftiov1cloudcredentials_name_status"}
