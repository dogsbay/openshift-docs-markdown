...
# Authentication [operator.openshift.io/v1] {id="authentication-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/operator.openshift.io/v1/authentications {id="_apisoperatoropenshiftiov1authentications"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`AuthenticationList`](/rest_api/objects/index#io-openshift-operator-v1-AuthenticationList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`Authentication`](/rest_api/operator_apis/authentication-operator-openshift-io-v1#authentication-operator-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Authentication`](/rest_api/operator_apis/authentication-operator-openshift-io-v1#authentication-operator-openshift-io-v1) schema |
| 201 - Created | [`Authentication`](/rest_api/operator_apis/authentication-operator-openshift-io-v1#authentication-operator-openshift-io-v1) schema |
| 202 - Accepted | [`Authentication`](/rest_api/operator_apis/authentication-operator-openshift-io-v1#authentication-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/operator.openshift.io/v1/authentications/{{ name }} {id="_apisoperatoropenshiftiov1authentications_name"}
...
### /apis/operator.openshift.io/v1/authentications/{{ name }}/status {id="_apisoperatoropenshiftiov1authentications_name_status"}
