...
# Storage [operator.openshift.io/v1] {id="storage-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
*   `/apis/operator.openshift.io/v1/storages/{{ name }}`{minja}
...
*   `/apis/operator.openshift.io/v1/storages/{{ name }}/status`{minja}
...
### /apis/operator.openshift.io/v1/storages {id="_apisoperatoropenshiftiov1storages"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`StorageList`](/rest_api/objects/index#io-openshift-operator-v1-StorageList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`Storage`](/rest_api/operator_apis/storage-operator-openshift-io-v1#storage-operator-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Storage`](/rest_api/operator_apis/storage-operator-openshift-io-v1#storage-operator-openshift-io-v1) schema |
| 201 - Created | [`Storage`](/rest_api/operator_apis/storage-operator-openshift-io-v1#storage-operator-openshift-io-v1) schema |
| 202 - Accepted | [`Storage`](/rest_api/operator_apis/storage-operator-openshift-io-v1#storage-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/operator.openshift.io/v1/storages/{{ name }} {id="_apisoperatoropenshiftiov1storages_name"}
...
### /apis/operator.openshift.io/v1/storages/{{ name }}/status {id="_apisoperatoropenshiftiov1storages_name_status"}
