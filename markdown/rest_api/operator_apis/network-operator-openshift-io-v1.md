...
# Network [operator.openshift.io/v1] {id="network-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.migration {id="_specmigration"}
...
### /apis/operator.openshift.io/v1/networks {id="_apisoperatoropenshiftiov1networks"}
...
### /apis/operator.openshift.io/v1/networks/{{ name }} {id="_apisoperatoropenshiftiov1networks_name"}
...
### /apis/operator.openshift.io/v1/networks/{{ name }}/status {id="_apisoperatoropenshiftiov1networks_name_status"}
