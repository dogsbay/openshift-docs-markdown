...
# Config [operator.openshift.io/v1] {id="config-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/operator.openshift.io/v1/configs {id="_apisoperatoropenshiftiov1configs"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ConfigList`](/rest_api/objects/index#io-openshift-operator-v1-ConfigList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`Config`](/rest_api/operator_apis/config-operator-openshift-io-v1#config-operator-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Config`](/rest_api/operator_apis/config-operator-openshift-io-v1#config-operator-openshift-io-v1) schema |
| 201 - Created | [`Config`](/rest_api/operator_apis/config-operator-openshift-io-v1#config-operator-openshift-io-v1) schema |
| 202 - Accepted | [`Config`](/rest_api/operator_apis/config-operator-openshift-io-v1#config-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/operator.openshift.io/v1/configs/{{ name }} {id="_apisoperatoropenshiftiov1configs_name"}
...
### /apis/operator.openshift.io/v1/configs/{{ name }}/status {id="_apisoperatoropenshiftiov1configs_name_status"}
