...
# KubeScheduler [operator.openshift.io/v1] {id="kubescheduler-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
*   `/apis/operator.openshift.io/v1/kubeschedulers/{{ name }}`{minja}
...
*   `/apis/operator.openshift.io/v1/kubeschedulers/{{ name }}/status`{minja}
...
### /apis/operator.openshift.io/v1/kubeschedulers {id="_apisoperatoropenshiftiov1kubeschedulers"}
...
### /apis/operator.openshift.io/v1/kubeschedulers/{{ name }} {id="_apisoperatoropenshiftiov1kubeschedulers_name"}
...
### /apis/operator.openshift.io/v1/kubeschedulers/{{ name }}/status {id="_apisoperatoropenshiftiov1kubeschedulers_name_status"}
