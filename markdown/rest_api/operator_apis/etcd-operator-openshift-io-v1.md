...
# Etcd [operator.openshift.io/v1] {id="etcd-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/operator.openshift.io/v1/etcds {id="_apisoperatoropenshiftiov1etcds"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`EtcdList`](/rest_api/objects/index#io-openshift-operator-v1-EtcdList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`Etcd`](/rest_api/operator_apis/etcd-operator-openshift-io-v1#etcd-operator-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Etcd`](/rest_api/operator_apis/etcd-operator-openshift-io-v1#etcd-operator-openshift-io-v1) schema |
| 201 - Created | [`Etcd`](/rest_api/operator_apis/etcd-operator-openshift-io-v1#etcd-operator-openshift-io-v1) schema |
| 202 - Accepted | [`Etcd`](/rest_api/operator_apis/etcd-operator-openshift-io-v1#etcd-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/operator.openshift.io/v1/etcds/{{ name }} {id="_apisoperatoropenshiftiov1etcds_name"}
...
### /apis/operator.openshift.io/v1/etcds/{{ name }}/status {id="_apisoperatoropenshiftiov1etcds_name_status"}
