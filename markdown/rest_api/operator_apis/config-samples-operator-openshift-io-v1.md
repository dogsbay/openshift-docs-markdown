...
# Config [samples.operator.openshift.io/v1] {id="config-samples-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/samples.operator.openshift.io/v1/configs {id="_apissamplesoperatoropenshiftiov1configs"}
...
### /apis/samples.operator.openshift.io/v1/configs/{{ name }} {id="_apissamplesoperatoropenshiftiov1configs_name"}
...
### /apis/samples.operator.openshift.io/v1/configs/{{ name }}/status {id="_apissamplesoperatoropenshiftiov1configs_name_status"}
