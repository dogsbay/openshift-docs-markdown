...
# KubeAPIServer [operator.openshift.io/v1] {id="kubeapiserver-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/operator.openshift.io/v1/kubeapiservers {id="_apisoperatoropenshiftiov1kubeapiservers"}
...
### /apis/operator.openshift.io/v1/kubeapiservers/{{ name }} {id="_apisoperatoropenshiftiov1kubeapiservers_name"}
...
### /apis/operator.openshift.io/v1/kubeapiservers/{{ name }}/status {id="_apisoperatoropenshiftiov1kubeapiservers_name_status"}
