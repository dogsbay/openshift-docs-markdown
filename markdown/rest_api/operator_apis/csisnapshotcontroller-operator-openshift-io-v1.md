...
# CSISnapshotController [operator.openshift.io/v1] {id="csisnapshotcontroller-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
*   `/apis/operator.openshift.io/v1/csisnapshotcontrollers/{{ name }}`{minja}
...
*   `/apis/operator.openshift.io/v1/csisnapshotcontrollers/{{ name }}/status`{minja}
...
### /apis/operator.openshift.io/v1/csisnapshotcontrollers {id="_apisoperatoropenshiftiov1csisnapshotcontrollers"}
...
### /apis/operator.openshift.io/v1/csisnapshotcontrollers/{{ name }} {id="_apisoperatoropenshiftiov1csisnapshotcontrollers_name"}
...
### /apis/operator.openshift.io/v1/csisnapshotcontrollers/{{ name }}/status {id="_apisoperatoropenshiftiov1csisnapshotcontrollers_name_status"}
