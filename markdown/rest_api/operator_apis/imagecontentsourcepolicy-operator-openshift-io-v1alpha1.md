...
# ImageContentSourcePolicy [operator.openshift.io/v1alpha1] {id="imagecontentsourcepolicy-operator-openshift-io-v1alpha1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/operator.openshift.io/v1alpha1/imagecontentsourcepolicies {id="_apisoperatoropenshiftiov1alpha1imagecontentsourcepolicies"}
...
### /apis/operator.openshift.io/v1alpha1/imagecontentsourcepolicies/{{ name }} {id="_apisoperatoropenshiftiov1alpha1imagecontentsourcepolicies_name"}
...
### /apis/operator.openshift.io/v1alpha1/imagecontentsourcepolicies/{{ name }}/status {id="_apisoperatoropenshiftiov1alpha1imagecontentsourcepolicies_name_status"}
