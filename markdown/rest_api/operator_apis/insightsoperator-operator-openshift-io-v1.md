...
# InsightsOperator [operator.openshift.io/v1] {id="insightsoperator-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/operator.openshift.io/v1/insightsoperators {id="_apisoperatoropenshiftiov1insightsoperators"}
...
### /apis/operator.openshift.io/v1/insightsoperators/{{ name }} {id="_apisoperatoropenshiftiov1insightsoperators_name"}
...
### /apis/operator.openshift.io/v1/insightsoperators/{{ name }}/scale {id="_apisoperatoropenshiftiov1insightsoperators_name_scale"}
...
### /apis/operator.openshift.io/v1/insightsoperators/{{ name }}/status {id="_apisoperatoropenshiftiov1insightsoperators_name_status"}
