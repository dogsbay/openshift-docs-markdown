...
# Console [operator.openshift.io/v1] {id="console-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/operator.openshift.io/v1/consoles {id="_apisoperatoropenshiftiov1consoles"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ConsoleList`](/rest_api/objects/index#io-openshift-operator-v1-ConsoleList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`Console`](/rest_api/operator_apis/console-operator-openshift-io-v1#console-operator-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Console`](/rest_api/operator_apis/console-operator-openshift-io-v1#console-operator-openshift-io-v1) schema |
| 201 - Created | [`Console`](/rest_api/operator_apis/console-operator-openshift-io-v1#console-operator-openshift-io-v1) schema |
| 202 - Accepted | [`Console`](/rest_api/operator_apis/console-operator-openshift-io-v1#console-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/operator.openshift.io/v1/consoles/{{ name }} {id="_apisoperatoropenshiftiov1consoles_name"}
...
### /apis/operator.openshift.io/v1/consoles/{{ name }}/status {id="_apisoperatoropenshiftiov1consoles_name_status"}
