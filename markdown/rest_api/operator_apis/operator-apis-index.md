...
# Operator APIs {id="operator-apis"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}

## Authentication [operator.openshift.io/v1] {id="_authentication_operatoropenshiftiov1"}
...
## CloudCredential [operator.openshift.io/v1] {id="_cloudcredential_operatoropenshiftiov1"}
...
## ClusterCSIDriver [operator.openshift.io/v1] {id="_clustercsidriver_operatoropenshiftiov1"}
...
## Console [operator.openshift.io/v1] {id="_console_operatoropenshiftiov1"}
...
## Config [operator.openshift.io/v1] {id="_config_operatoropenshiftiov1"}
...
## Config [imageregistry.operator.openshift.io/v1] {id="_config_imageregistryoperatoropenshiftiov1"}
...
## Config [samples.operator.openshift.io/v1] {id="_config_samplesoperatoropenshiftiov1"}
...
## CSISnapshotController [operator.openshift.io/v1] {id="_csisnapshotcontroller_operatoropenshiftiov1"}
...
## DNS [operator.openshift.io/v1] {id="_dns_operatoropenshiftiov1"}
...
## DNSRecord [ingress.operator.openshift.io/v1] {id="_dnsrecord_ingressoperatoropenshiftiov1"}
...
## Etcd [operator.openshift.io/v1] {id="_etcd_operatoropenshiftiov1"}
...
## ImageContentSourcePolicy [operator.openshift.io/v1alpha1] {id="_imagecontentsourcepolicy_operatoropenshiftiov1alpha1"}
...
## ImagePruner [imageregistry.operator.openshift.io/v1] {id="_imagepruner_imageregistryoperatoropenshiftiov1"}
...
## IngressController [operator.openshift.io/v1] {id="_ingresscontroller_operatoropenshiftiov1"}
...
## InsightsOperator [operator.openshift.io/v1] {id="_insightsoperator_operatoropenshiftiov1"}
...
## KubeAPIServer [operator.openshift.io/v1] {id="_kubeapiserver_operatoropenshiftiov1"}
...
## KubeControllerManager [operator.openshift.io/v1] {id="_kubecontrollermanager_operatoropenshiftiov1"}
...
## KubeScheduler [operator.openshift.io/v1] {id="_kubescheduler_operatoropenshiftiov1"}
...
## KubeStorageVersionMigrator [operator.openshift.io/v1] {id="_kubestorageversionmigrator_operatoropenshiftiov1"}
...
## MachineConfiguration [operator.openshift.io/v1] {id="_machineconfiguration_operatoropenshiftiov1"}
...
## Network [operator.openshift.io/v1] {id="_network_operatoropenshiftiov1"}
...
## OpenShiftAPIServer [operator.openshift.io/v1] {id="_openshiftapiserver_operatoropenshiftiov1"}
...
## OpenShiftControllerManager [operator.openshift.io/v1] {id="_openshiftcontrollermanager_operatoropenshiftiov1"}
...
## OperatorPKI [network.operator.openshift.io/v1] {id="_operatorpki_networkoperatoropenshiftiov1"}
...
## ServiceCA [operator.openshift.io/v1] {id="_serviceca_operatoropenshiftiov1"}
...
## Storage [operator.openshift.io/v1] {id="_storage_operatoropenshiftiov1"}
