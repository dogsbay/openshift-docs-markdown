...
# Config [imageregistry.operator.openshift.io/v1] {id="config-imageregistry-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.requests {id="_specrequests"}
...
### .spec.requests.read {id="_specrequestsread"}
...
### .spec.requests.write {id="_specrequestswrite"}
...
### .spec.storage.azure {id="_specstorageazure"}
...
### .spec.storage.azure.networkAccess {id="_specstorageazurenetworkaccess"}
...
### .spec.storage.azure.networkAccess.internal {id="_specstorageazurenetworkaccessinternal"}
...
### .spec.storage.gcs {id="_specstoragegcs"}
...
### .spec.storage.ibmcos {id="_specstorageibmcos"}
...
### .spec.storage.oss {id="_specstorageoss"}
...
### .spec.storage.oss.encryption {id="_specstorageossencryption"}
...
### .spec.storage.oss.encryption.kms {id="_specstorageossencryptionkms"}
...
### .spec.storage.pvc {id="_specstoragepvc"}
...
### .spec.storage.s3 {id="_specstorages3"}
...
### .spec.storage.s3.cloudFront {id="_specstorages3cloudfront"}
...
### .spec.storage.s3.cloudFront.privateKey {id="_specstorages3cloudfrontprivatekey"}
...
### .spec.storage.s3.trustedCA {id="_specstorages3trustedca"}
...
### .spec.storage.swift {id="_specstorageswift"}
...
### .status.storage {id="_statusstorage"}
...
### .status.storage.azure {id="_statusstorageazure"}
...
### .status.storage.azure.networkAccess {id="_statusstorageazurenetworkaccess"}
...
### .status.storage.azure.networkAccess.internal {id="_statusstorageazurenetworkaccessinternal"}
...
### .status.storage.emptyDir {id="_statusstorageemptydir"}
...
### .status.storage.gcs {id="_statusstoragegcs"}
...
### .status.storage.ibmcos {id="_statusstorageibmcos"}
...
### .status.storage.oss {id="_statusstorageoss"}
...
### .status.storage.oss.encryption {id="_statusstorageossencryption"}
...
### .status.storage.oss.encryption.kms {id="_statusstorageossencryptionkms"}
...
### .status.storage.pvc {id="_statusstoragepvc"}
...
### .status.storage.s3 {id="_statusstorages3"}
...
### .status.storage.s3.cloudFront {id="_statusstorages3cloudfront"}
...
### .status.storage.s3.cloudFront.privateKey {id="_statusstorages3cloudfrontprivatekey"}
...
### .status.storage.s3.trustedCA {id="_statusstorages3trustedca"}
...
### .status.storage.swift {id="_statusstorageswift"}
...
*   `/apis/imageregistry.operator.openshift.io/v1/configs/{{ name }}`{minja}
    *   `DELETE`: delete a Config
    *   `GET`: read the specified Config
    *   `PATCH`: partially update the specified Config
    *   `PUT`: replace the specified Config
*   `/apis/imageregistry.operator.openshift.io/v1/configs/{{ name }}/status`{minja}
...
### /apis/imageregistry.operator.openshift.io/v1/configs {id="_apisimageregistryoperatoropenshiftiov1configs"}
...
### /apis/imageregistry.operator.openshift.io/v1/configs/{{ name }} {id="_apisimageregistryoperatoropenshiftiov1configs_name"}
...
### /apis/imageregistry.operator.openshift.io/v1/configs/{{ name }}/status {id="_apisimageregistryoperatoropenshiftiov1configs_name_status"}
