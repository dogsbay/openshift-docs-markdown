...
# DNSRecord [ingress.operator.openshift.io/v1] {id="dnsrecord-ingress-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .status.zones[].conditions {id="_statuszonesconditions"}
...
### .status.zones[].dnsZone {id="_statuszonesdnszone"}
...
*   `/apis/ingress.operator.openshift.io/v1/namespaces/{{ namespace }}/dnsrecords`{minja}
    *   `DELETE`: delete collection of DNSRecord
    *   `GET`: list objects of kind DNSRecord
    *   `POST`: create a DNSRecord
*   `/apis/ingress.operator.openshift.io/v1/namespaces/{{ namespace }}/dnsrecords/{{ name }}`{minja}
...
*   `/apis/ingress.operator.openshift.io/v1/namespaces/{{ namespace }}/dnsrecords/{{ name }}/status`{minja}
...
### /apis/ingress.operator.openshift.io/v1/dnsrecords {id="_apisingressoperatoropenshiftiov1dnsrecords"}
...
| --- | --- |
| 200 - OK | [`DNSRecordList`](/rest_api/objects/index#io-openshift-operator-ingress-v1-DNSRecordList) schema |
| 401 - Unauthorized | Empty |

### /apis/ingress.operator.openshift.io/v1/namespaces/{{ namespace }}/dnsrecords {id="_apisingressoperatoropenshiftiov1namespaces_namespace_dnsrecords"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`DNSRecord`](/rest_api/operator_apis/dnsrecord-ingress-operator-openshift-io-v1#dnsrecord-ingress-operator-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`DNSRecord`](/rest_api/operator_apis/dnsrecord-ingress-operator-openshift-io-v1#dnsrecord-ingress-operator-openshift-io-v1) schema |
| 201 - Created | [`DNSRecord`](/rest_api/operator_apis/dnsrecord-ingress-operator-openshift-io-v1#dnsrecord-ingress-operator-openshift-io-v1) schema |
| 202 - Accepted | [`DNSRecord`](/rest_api/operator_apis/dnsrecord-ingress-operator-openshift-io-v1#dnsrecord-ingress-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/ingress.operator.openshift.io/v1/namespaces/{{ namespace }}/dnsrecords/{{ name }} {id="_apisingressoperatoropenshiftiov1namespaces_namespace_dnsrecords_name"}
...
### /apis/ingress.operator.openshift.io/v1/namespaces/{{ namespace }}/dnsrecords/{{ name }}/status {id="_apisingressoperatoropenshiftiov1namespaces_namespace_dnsrecords_name_status"}
