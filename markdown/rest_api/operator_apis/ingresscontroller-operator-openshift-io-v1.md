...
*   `/apis/operator.openshift.io/v1/namespaces/{{ namespace }}/ingresscontrollers`{minja}
    *   `DELETE`: delete collection of IngressController
    *   `GET`: list objects of kind IngressController
    *   `POST`: create an IngressController
*   `/apis/operator.openshift.io/v1/namespaces/{{ namespace }}/ingresscontrollers/{{ name }}`{minja}
...
*   `/apis/operator.openshift.io/v1/namespaces/{{ namespace }}/ingresscontrollers/{{ name }}/scale`{minja}
...
*   `/apis/operator.openshift.io/v1/namespaces/{{ namespace }}/ingresscontrollers/{{ name }}/status`{minja}
