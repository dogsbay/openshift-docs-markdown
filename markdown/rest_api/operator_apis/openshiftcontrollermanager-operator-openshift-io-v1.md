...
# OpenShiftControllerManager [operator.openshift.io/v1] {id="openshiftcontrollermanager-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
*   `/apis/operator.openshift.io/v1/openshiftcontrollermanagers/{{ name }}`{minja}
...
*   `/apis/operator.openshift.io/v1/openshiftcontrollermanagers/{{ name }}/status`{minja}
...
### /apis/operator.openshift.io/v1/openshiftcontrollermanagers {id="_apisoperatoropenshiftiov1openshiftcontrollermanagers"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`OpenShiftControllerManagerList`](/rest_api/objects/index#io-openshift-operator-v1-OpenShiftControllerManagerList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`OpenShiftControllerManager`](/rest_api/operator_apis/openshiftcontrollermanager-operator-openshift-io-v1#openshiftcontrollermanager-operator-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`OpenShiftControllerManager`](/rest_api/operator_apis/openshiftcontrollermanager-operator-openshift-io-v1#openshiftcontrollermanager-operator-openshift-io-v1) schema |
| 201 - Created | [`OpenShiftControllerManager`](/rest_api/operator_apis/openshiftcontrollermanager-operator-openshift-io-v1#openshiftcontrollermanager-operator-openshift-io-v1) schema |
| 202 - Accepted | [`OpenShiftControllerManager`](/rest_api/operator_apis/openshiftcontrollermanager-operator-openshift-io-v1#openshiftcontrollermanager-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/operator.openshift.io/v1/openshiftcontrollermanagers/{{ name }} {id="_apisoperatoropenshiftiov1openshiftcontrollermanagers_name"}
...
### /apis/operator.openshift.io/v1/openshiftcontrollermanagers/{{ name }}/status {id="_apisoperatoropenshiftiov1openshiftcontrollermanagers_name_status"}
