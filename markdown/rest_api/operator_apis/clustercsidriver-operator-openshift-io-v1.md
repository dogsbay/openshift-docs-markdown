...
# ClusterCSIDriver [operator.openshift.io/v1] {id="clustercsidriver-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/operator.openshift.io/v1/clustercsidrivers {id="_apisoperatoropenshiftiov1clustercsidrivers"}
...
### /apis/operator.openshift.io/v1/clustercsidrivers/{{ name }} {id="_apisoperatoropenshiftiov1clustercsidrivers_name"}
...
### /apis/operator.openshift.io/v1/clustercsidrivers/{{ name }}/status {id="_apisoperatoropenshiftiov1clustercsidrivers_name_status"}
