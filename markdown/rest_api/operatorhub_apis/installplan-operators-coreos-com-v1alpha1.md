...
# InstallPlan [operators.coreos.com/v1alpha1] {id="installplan-operators-coreos-com-v1alpha1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/operators.coreos.com/v1alpha1/installplans {id="_apisoperatorscoreoscomv1alpha1installplans"}
...
| --- | --- |
| 200 - OK | [`InstallPlanList`](/rest_api/objects/index#com-coreos-operators-v1alpha1-InstallPlanList) schema |
| 401 - Unauthorized | Empty |

### /apis/operators.coreos.com/v1alpha1/namespaces/{{ namespace }}/installplans {id="_apisoperatorscoreoscomv1alpha1namespaces_namespace_installplans"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`InstallPlan`](/rest_api/operatorhub_apis/installplan-operators-coreos-com-v1alpha1#installplan-operators-coreos-com-v1alpha1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`InstallPlan`](/rest_api/operatorhub_apis/installplan-operators-coreos-com-v1alpha1#installplan-operators-coreos-com-v1alpha1) schema |
| 201 - Created | [`InstallPlan`](/rest_api/operatorhub_apis/installplan-operators-coreos-com-v1alpha1#installplan-operators-coreos-com-v1alpha1) schema |
| 202 - Accepted | [`InstallPlan`](/rest_api/operatorhub_apis/installplan-operators-coreos-com-v1alpha1#installplan-operators-coreos-com-v1alpha1) schema |
| 401 - Unauthorized | Empty |

### /apis/operators.coreos.com/v1alpha1/namespaces/{{ namespace }}/installplans/{{ name }} {id="_apisoperatorscoreoscomv1alpha1namespaces_namespace_installplans_name"}
...
### /apis/operators.coreos.com/v1alpha1/namespaces/{{ namespace }}/installplans/{{ name }}/status {id="_apisoperatorscoreoscomv1alpha1namespaces_namespace_installplans_name_status"}
