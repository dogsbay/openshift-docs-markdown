...
# ClusterExtension [olm.operatorframework.io/v1] {id="clusterextension-olm-operatorframework-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/olm.operatorframework.io/v1/clusterextensions {id="_apisolmoperatorframeworkiov1clusterextensions"}
...
### /apis/olm.operatorframework.io/v1/clusterextensions/{{ name }} {id="_apisolmoperatorframeworkiov1clusterextensions_name"}
...
### /apis/olm.operatorframework.io/v1/clusterextensions/{{ name }}/status {id="_apisolmoperatorframeworkiov1clusterextensions_name_status"}
