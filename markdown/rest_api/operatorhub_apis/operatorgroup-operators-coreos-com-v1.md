...
# OperatorGroup [operators.coreos.com/v1] {id="operatorgroup-operators-coreos-com-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/operators.coreos.com/v1/operatorgroups {id="_apisoperatorscoreoscomv1operatorgroups"}
...
### /apis/operators.coreos.com/v1/namespaces/{{ namespace }}/operatorgroups {id="_apisoperatorscoreoscomv1namespaces_namespace_operatorgroups"}
...
### /apis/operators.coreos.com/v1/namespaces/{{ namespace }}/operatorgroups/{{ name }} {id="_apisoperatorscoreoscomv1namespaces_namespace_operatorgroups_name"}
...
### /apis/operators.coreos.com/v1/namespaces/{{ namespace }}/operatorgroups/{{ name }}/status {id="_apisoperatorscoreoscomv1namespaces_namespace_operatorgroups_name_status"}
