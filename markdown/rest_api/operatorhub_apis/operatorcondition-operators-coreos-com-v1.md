...
# OperatorCondition [operators.coreos.com/v1] {id="operatorcondition-operators-coreos-com-v1"}
{%- if product_title %}
...
| `metadata` | [`ObjectMeta_v2 meta/v1`](/rest_api/objects/index#objectmeta_v2-meta-v1) | Standard object’s metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata |
| `spec` | `object` | OperatorConditionSpec allows a cluster admin to convey information about the state of an operator to OLM, potentially overriding state reported by the operator. |
| `status` | `object` | OperatorConditionStatus allows an operator to convey information its state to OLM. The status may trail the actual state of a system. |
...
| `overrides` | `array` |  |
| `overrides[]` | `object` | Condition contains details for one aspect of the current state of this API Resource. --- This struct is intended for direct use as an array at the field path .status.conditions.  For example, type FooStatus struct{     // Represents the observations of a foo’s current state.     // Known .status.conditions.type are: "Available", "Progressing", and "Degraded"     // +patchMergeKey=type     // +patchStrategy=merge     // +listType=map     // +listMapKey=type     Conditions []metav1.Condition `json:"conditions,omitempty" patchStrategy:"merge" patchMergeKey:"type" protobuf:"bytes,1,rep,name=conditions"`      // other fields } |
...
*   `/apis/operators.coreos.com/v1/namespaces/{{ namespace }}/operatorconditions`{minja}
    *   `DELETE`: delete collection of OperatorCondition
    *   `GET`: list objects of kind OperatorCondition
    *   `POST`: create an OperatorCondition
*   `/apis/operators.coreos.com/v1/namespaces/{{ namespace }}/operatorconditions/{{ name }}`{minja}
...
*   `/apis/operators.coreos.com/v1/namespaces/{{ namespace }}/operatorconditions/{{ name }}/status`{minja}
...
### /apis/operators.coreos.com/v1/operatorconditions {id="_apisoperatorscoreoscomv1operatorconditions"}
...
| --- | --- |
| 200 - OK | [`OperatorConditionList operators.coreos.com/v1`](/rest_api/objects/index#operatorconditionlist-operators-coreos-com-v1) |

### /apis/operators.coreos.com/v1/namespaces/{{ namespace }}/operatorconditions {id="_apisoperatorscoreoscomv1namespaces_namespace_operatorconditions"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`Status_v2 meta/v1`](/rest_api/objects/index#status_v2-meta-v1) |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`OperatorCondition operators.coreos.com/v1`](/rest_api/operatorhub_apis/operatorcondition-operators-coreos-com-v1#operatorcondition-operators-coreos-com-v1) |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`OperatorCondition operators.coreos.com/v1`](/rest_api/operatorhub_apis/operatorcondition-operators-coreos-com-v1#operatorcondition-operators-coreos-com-v1) |

### /apis/operators.coreos.com/v1/namespaces/{{ namespace }}/operatorconditions/{{ name }} {id="_apisoperatorscoreoscomv1namespaces_namespace_operatorconditions_name"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`DeleteOptions_v2 meta/v1`](/rest_api/objects/index#deleteoptions_v2-meta-v1) |  |
...
### /apis/operators.coreos.com/v1/namespaces/{{ namespace }}/operatorconditions/{{ name }}/status {id="_apisoperatorscoreoscomv1namespaces_namespace_operatorconditions_name_status"}
