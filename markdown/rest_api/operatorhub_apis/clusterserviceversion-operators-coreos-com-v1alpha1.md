...
# ClusterServiceVersion [operators.coreos.com/v1alpha1] {id="clusterserviceversion-operators-coreos-com-v1alpha1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.install.spec.deployments[].spec.template.spec.volumes[].ephemeral.volumeClaimTemplate.spec {id="_specinstallspecdeploymentsspectemplatespecvolumesephemeralvolumeclaimtemplatespec"}
...
### /apis/operators.coreos.com/v1alpha1/clusterserviceversions {id="_apisoperatorscoreoscomv1alpha1clusterserviceversions"}
...
### /apis/operators.coreos.com/v1alpha1/namespaces/{{ namespace }}/clusterserviceversions {id="_apisoperatorscoreoscomv1alpha1namespaces_namespace_clusterserviceversions"}
...
### /apis/operators.coreos.com/v1alpha1/namespaces/{{ namespace }}/clusterserviceversions/{{ name }} {id="_apisoperatorscoreoscomv1alpha1namespaces_namespace_clusterserviceversions_name"}
...
### /apis/operators.coreos.com/v1alpha1/namespaces/{{ namespace }}/clusterserviceversions/{{ name }}/status {id="_apisoperatorscoreoscomv1alpha1namespaces_namespace_clusterserviceversions_name_status"}
