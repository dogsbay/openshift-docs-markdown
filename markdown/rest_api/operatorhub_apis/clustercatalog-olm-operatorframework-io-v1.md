...
# ClusterCatalog [olm.operatorframework.io/v1] {id="clustercatalog-olm-operatorframework-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.source.image {id="_specsourceimage"}
...
### .status.resolvedSource {id="_statusresolvedsource"}
...
### .status.resolvedSource.image {id="_statusresolvedsourceimage"}
...
*   `/apis/olm.operatorframework.io/v1/clustercatalogs/{{ name }}`{minja}
...
*   `/apis/olm.operatorframework.io/v1/clustercatalogs/{{ name }}/status`{minja}
...
### /apis/olm.operatorframework.io/v1/clustercatalogs {id="_apisolmoperatorframeworkiov1clustercatalogs"}
...
### /apis/olm.operatorframework.io/v1/clustercatalogs/{{ name }} {id="_apisolmoperatorframeworkiov1clustercatalogs_name"}
...
### /apis/olm.operatorframework.io/v1/clustercatalogs/{{ name }}/status {id="_apisolmoperatorframeworkiov1clustercatalogs_name_status"}
