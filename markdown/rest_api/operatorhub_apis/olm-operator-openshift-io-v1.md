...
# OLM [operator.openshift.io/v1] {id="olm-operator-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/operator.openshift.io/v1/olms {id="_apisoperatoropenshiftiov1olms"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`OLMList`](/rest_api/objects/index#io-openshift-operator-v1-OLMList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`OLM`](/rest_api/operatorhub_apis/olm-operator-openshift-io-v1#olm-operator-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`OLM`](/rest_api/operatorhub_apis/olm-operator-openshift-io-v1#olm-operator-openshift-io-v1) schema |
| 201 - Created | [`OLM`](/rest_api/operatorhub_apis/olm-operator-openshift-io-v1#olm-operator-openshift-io-v1) schema |
| 202 - Accepted | [`OLM`](/rest_api/operatorhub_apis/olm-operator-openshift-io-v1#olm-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/operator.openshift.io/v1/olms/{{ name }} {id="_apisoperatoropenshiftiov1olms_name"}
...
### /apis/operator.openshift.io/v1/olms/{{ name }}/status {id="_apisoperatoropenshiftiov1olms_name_status"}
