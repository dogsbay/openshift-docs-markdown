...
# OperatorCondition [operators.coreos.com/v2] {id="operatorcondition-operators-coreos-com-v2"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/operators.coreos.com/v2/operatorconditions {id="_apisoperatorscoreoscomv2operatorconditions"}
...
### /apis/operators.coreos.com/v2/namespaces/{{ namespace }}/operatorconditions {id="_apisoperatorscoreoscomv2namespaces_namespace_operatorconditions"}
...
### /apis/operators.coreos.com/v2/namespaces/{{ namespace }}/operatorconditions/{{ name }} {id="_apisoperatorscoreoscomv2namespaces_namespace_operatorconditions_name"}
...
### /apis/operators.coreos.com/v2/namespaces/{{ namespace }}/operatorconditions/{{ name }}/status {id="_apisoperatorscoreoscomv2namespaces_namespace_operatorconditions_name_status"}
