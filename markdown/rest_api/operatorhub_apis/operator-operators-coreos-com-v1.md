...
# Operator [operators.coreos.com/v1] {id="operator-operators-coreos-com-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/operators.coreos.com/v1/operators {id="_apisoperatorscoreoscomv1operators"}
...
### /apis/operators.coreos.com/v1/operators/{{ name }} {id="_apisoperatorscoreoscomv1operators_name"}
...
### /apis/operators.coreos.com/v1/operators/{{ name }}/status {id="_apisoperatorscoreoscomv1operators_name_status"}
