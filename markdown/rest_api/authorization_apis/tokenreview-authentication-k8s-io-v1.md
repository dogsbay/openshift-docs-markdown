...
# TokenReview [authentication.k8s.io/v1] {id="tokenreview-authentication-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/oauth.openshift.io/v1/tokenreviews {id="_apisoauthopenshiftiov1tokenreviews"}
...
### /apis/authentication.k8s.io/v1/tokenreviews {id="_apisauthenticationk8siov1tokenreviews"}
