...
# LocalSubjectAccessReview [authorization.openshift.io/v1] {id="localsubjectaccessreview-authorization-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`LocalSubjectAccessReview`](/rest_api/authorization_apis/localsubjectaccessreview-authorization-openshift-io-v1#localsubjectaccessreview-authorization-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`LocalSubjectAccessReview`](/rest_api/authorization_apis/localsubjectaccessreview-authorization-openshift-io-v1#localsubjectaccessreview-authorization-openshift-io-v1) schema |
| 201 - Created | [`LocalSubjectAccessReview`](/rest_api/authorization_apis/localsubjectaccessreview-authorization-openshift-io-v1#localsubjectaccessreview-authorization-openshift-io-v1) schema |
| 202 - Accepted | [`LocalSubjectAccessReview`](/rest_api/authorization_apis/localsubjectaccessreview-authorization-openshift-io-v1#localsubjectaccessreview-authorization-openshift-io-v1) schema |
