...
# SelfSubjectRulesReview [authorization.k8s.io/v1] {id="selfsubjectrulesreview-authorization-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/authorization.k8s.io/v1/selfsubjectrulesreviews {id="_apisauthorizationk8siov1selfsubjectrulesreviews"}
