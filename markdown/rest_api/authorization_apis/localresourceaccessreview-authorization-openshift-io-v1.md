...
# LocalResourceAccessReview [authorization.openshift.io/v1] {id="localresourceaccessreview-authorization-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`LocalResourceAccessReview`](/rest_api/authorization_apis/localresourceaccessreview-authorization-openshift-io-v1#localresourceaccessreview-authorization-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`LocalResourceAccessReview`](/rest_api/authorization_apis/localresourceaccessreview-authorization-openshift-io-v1#localresourceaccessreview-authorization-openshift-io-v1) schema |
| 201 - Created | [`LocalResourceAccessReview`](/rest_api/authorization_apis/localresourceaccessreview-authorization-openshift-io-v1#localresourceaccessreview-authorization-openshift-io-v1) schema |
| 202 - Accepted | [`LocalResourceAccessReview`](/rest_api/authorization_apis/localresourceaccessreview-authorization-openshift-io-v1#localresourceaccessreview-authorization-openshift-io-v1) schema |
