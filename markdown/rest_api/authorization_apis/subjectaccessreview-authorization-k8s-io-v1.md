...
# SubjectAccessReview [authorization.k8s.io/v1] {id="subjectaccessreview-authorization-k8s-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/authorization.k8s.io/v1/subjectaccessreviews {id="_apisauthorizationk8siov1subjectaccessreviews"}
