...
# SubjectAccessReview [authorization.openshift.io/v1] {id="subjectaccessreview-authorization-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/authorization.openshift.io/v1/subjectaccessreviews {id="_apisauthorizationopenshiftiov1subjectaccessreviews"}
