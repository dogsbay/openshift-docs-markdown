...
# MachineHealthCheck [machine.openshift.io/v1beta1] {id="machinehealthcheck-machine-openshift-io-v1beta1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/machine.openshift.io/v1beta1/machinehealthchecks {id="_apismachineopenshiftiov1beta1machinehealthchecks"}
...
| --- | --- |
| 200 - OK | [`MachineHealthCheckList`](/rest_api/objects/index#io-openshift-machine-v1beta1-MachineHealthCheckList) schema |
| 401 - Unauthorized | Empty |

### /apis/machine.openshift.io/v1beta1/namespaces/{{ namespace }}/machinehealthchecks {id="_apismachineopenshiftiov1beta1namespaces_namespace_machinehealthchecks"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`MachineHealthCheck`](/rest_api/machine_apis/machinehealthcheck-machine-openshift-io-v1beta1#machinehealthcheck-machine-openshift-io-v1beta1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`MachineHealthCheck`](/rest_api/machine_apis/machinehealthcheck-machine-openshift-io-v1beta1#machinehealthcheck-machine-openshift-io-v1beta1) schema |
| 201 - Created | [`MachineHealthCheck`](/rest_api/machine_apis/machinehealthcheck-machine-openshift-io-v1beta1#machinehealthcheck-machine-openshift-io-v1beta1) schema |
| 202 - Accepted | [`MachineHealthCheck`](/rest_api/machine_apis/machinehealthcheck-machine-openshift-io-v1beta1#machinehealthcheck-machine-openshift-io-v1beta1) schema |
| 401 - Unauthorized | Empty |

### /apis/machine.openshift.io/v1beta1/namespaces/{{ namespace }}/machinehealthchecks/{{ name }} {id="_apismachineopenshiftiov1beta1namespaces_namespace_machinehealthchecks_name"}
...
### /apis/machine.openshift.io/v1beta1/namespaces/{{ namespace }}/machinehealthchecks/{{ name }}/status {id="_apismachineopenshiftiov1beta1namespaces_namespace_machinehealthchecks_name_status"}
