...
# MachineConfigNode [machineconfiguration.openshift.io/v1] {id="machineconfignode-machineconfiguration-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/machineconfiguration.openshift.io/v1/machineconfignodes {id="_apismachineconfigurationopenshiftiov1machineconfignodes"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`MachineConfigNodeList`](/rest_api/objects/index#io-openshift-machineconfiguration-v1-MachineConfigNodeList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`MachineConfigNode`](/rest_api/machine_apis/machineconfignode-machineconfiguration-openshift-io-v1#machineconfignode-machineconfiguration-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`MachineConfigNode`](/rest_api/machine_apis/machineconfignode-machineconfiguration-openshift-io-v1#machineconfignode-machineconfiguration-openshift-io-v1) schema |
| 201 - Created | [`MachineConfigNode`](/rest_api/machine_apis/machineconfignode-machineconfiguration-openshift-io-v1#machineconfignode-machineconfiguration-openshift-io-v1) schema |
| 202 - Accepted | [`MachineConfigNode`](/rest_api/machine_apis/machineconfignode-machineconfiguration-openshift-io-v1#machineconfignode-machineconfiguration-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/machineconfiguration.openshift.io/v1/machineconfignodes/{{ name }} {id="_apismachineconfigurationopenshiftiov1machineconfignodes_name"}
...
### /apis/machineconfiguration.openshift.io/v1/machineconfignodes/{{ name }}/status {id="_apismachineconfigurationopenshiftiov1machineconfignodes_name_status"}
