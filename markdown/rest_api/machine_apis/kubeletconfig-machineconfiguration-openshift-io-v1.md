...
# KubeletConfig [machineconfiguration.openshift.io/v1] {id="kubeletconfig-machineconfiguration-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/machineconfiguration.openshift.io/v1/kubeletconfigs {id="_apismachineconfigurationopenshiftiov1kubeletconfigs"}
...
### /apis/machineconfiguration.openshift.io/v1/kubeletconfigs/{{ name }} {id="_apismachineconfigurationopenshiftiov1kubeletconfigs_name"}
...
### /apis/machineconfiguration.openshift.io/v1/kubeletconfigs/{{ name }}/status {id="_apismachineconfigurationopenshiftiov1kubeletconfigs_name_status"}
