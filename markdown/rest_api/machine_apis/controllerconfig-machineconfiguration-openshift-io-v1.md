...
# ControllerConfig [machineconfiguration.openshift.io/v1] {id="controllerconfig-machineconfiguration-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/machineconfiguration.openshift.io/v1/controllerconfigs {id="_apismachineconfigurationopenshiftiov1controllerconfigs"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ControllerConfigList`](/rest_api/objects/index#io-openshift-machineconfiguration-v1-ControllerConfigList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`ControllerConfig`](/rest_api/machine_apis/controllerconfig-machineconfiguration-openshift-io-v1#controllerconfig-machineconfiguration-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ControllerConfig`](/rest_api/machine_apis/controllerconfig-machineconfiguration-openshift-io-v1#controllerconfig-machineconfiguration-openshift-io-v1) schema |
| 201 - Created | [`ControllerConfig`](/rest_api/machine_apis/controllerconfig-machineconfiguration-openshift-io-v1#controllerconfig-machineconfiguration-openshift-io-v1) schema |
| 202 - Accepted | [`ControllerConfig`](/rest_api/machine_apis/controllerconfig-machineconfiguration-openshift-io-v1#controllerconfig-machineconfiguration-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/machineconfiguration.openshift.io/v1/controllerconfigs/{{ name }} {id="_apismachineconfigurationopenshiftiov1controllerconfigs_name"}
...
### /apis/machineconfiguration.openshift.io/v1/controllerconfigs/{{ name }}/status {id="_apismachineconfigurationopenshiftiov1controllerconfigs_name_status"}
