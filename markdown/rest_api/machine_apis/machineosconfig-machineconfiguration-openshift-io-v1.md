...
# MachineOSConfig [machineconfiguration.openshift.io/v1] {id="machineosconfig-machineconfiguration-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/machineconfiguration.openshift.io/v1/machineosconfigs {id="_apismachineconfigurationopenshiftiov1machineosconfigs"}
...
### /apis/machineconfiguration.openshift.io/v1/machineosconfigs/{{ name }} {id="_apismachineconfigurationopenshiftiov1machineosconfigs_name"}
...
### /apis/machineconfiguration.openshift.io/v1/machineosconfigs/{{ name }}/status {id="_apismachineconfigurationopenshiftiov1machineosconfigs_name_status"}
