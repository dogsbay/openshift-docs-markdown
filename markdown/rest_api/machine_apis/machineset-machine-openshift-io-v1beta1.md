...
# MachineSet [machine.openshift.io/v1beta1] {id="machineset-machine-openshift-io-v1beta1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### .spec.template.metadata {id="_spectemplatemetadata"}
...
### .spec.template.metadata.ownerReferences {id="_spectemplatemetadataownerreferences"}
...
### .spec.template.spec.lifecycleHooks {id="_spectemplatespeclifecyclehooks"}
...
### .spec.template.spec.lifecycleHooks.preDrain {id="_spectemplatespeclifecyclehookspredrain"}
...
### .spec.template.spec.lifecycleHooks.preTerminate {id="_spectemplatespeclifecyclehookspreterminate"}
...
### .spec.template.spec.metadata {id="_spectemplatespecmetadata"}
...
### .spec.template.spec.metadata.ownerReferences {id="_spectemplatespecmetadataownerreferences"}
...
### .spec.template.spec.providerSpec {id="_spectemplatespecproviderspec"}
...
### .spec.template.spec.taints {id="_spectemplatespectaints"}
...
*   `/apis/machine.openshift.io/v1beta1/namespaces/{{ namespace }}/machinesets`{minja}
    *   `DELETE`: delete collection of MachineSet
    *   `GET`: list objects of kind MachineSet
    *   `POST`: create a MachineSet
*   `/apis/machine.openshift.io/v1beta1/namespaces/{{ namespace }}/machinesets/{{ name }}`{minja}
...
*   `/apis/machine.openshift.io/v1beta1/namespaces/{{ namespace }}/machinesets/{{ name }}/scale`{minja}
...
*   `/apis/machine.openshift.io/v1beta1/namespaces/{{ namespace }}/machinesets/{{ name }}/status`{minja}
...
### /apis/machine.openshift.io/v1beta1/machinesets {id="_apismachineopenshiftiov1beta1machinesets"}
...
| --- | --- |
| 200 - OK | [`MachineSetList`](/rest_api/objects/index#io-openshift-machine-v1beta1-MachineSetList) schema |
| 401 - Unauthorized | Empty |

### /apis/machine.openshift.io/v1beta1/namespaces/{{ namespace }}/machinesets {id="_apismachineopenshiftiov1beta1namespaces_namespace_machinesets"}
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`MachineSet`](/rest_api/machine_apis/machineset-machine-openshift-io-v1beta1#machineset-machine-openshift-io-v1beta1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`MachineSet`](/rest_api/machine_apis/machineset-machine-openshift-io-v1beta1#machineset-machine-openshift-io-v1beta1) schema |
| 201 - Created | [`MachineSet`](/rest_api/machine_apis/machineset-machine-openshift-io-v1beta1#machineset-machine-openshift-io-v1beta1) schema |
| 202 - Accepted | [`MachineSet`](/rest_api/machine_apis/machineset-machine-openshift-io-v1beta1#machineset-machine-openshift-io-v1beta1) schema |
| 401 - Unauthorized | Empty |

### /apis/machine.openshift.io/v1beta1/namespaces/{{ namespace }}/machinesets/{{ name }} {id="_apismachineopenshiftiov1beta1namespaces_namespace_machinesets_name"}
...
### /apis/machine.openshift.io/v1beta1/namespaces/{{ namespace }}/machinesets/{{ name }}/scale {id="_apismachineopenshiftiov1beta1namespaces_namespace_machinesets_name_scale"}
...
### /apis/machine.openshift.io/v1beta1/namespaces/{{ namespace }}/machinesets/{{ name }}/status {id="_apismachineopenshiftiov1beta1namespaces_namespace_machinesets_name_status"}
