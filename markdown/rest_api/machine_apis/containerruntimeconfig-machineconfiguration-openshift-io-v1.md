...
# ContainerRuntimeConfig [machineconfiguration.openshift.io/v1] {id="containerruntimeconfig-machineconfiguration-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/machineconfiguration.openshift.io/v1/containerruntimeconfigs {id="_apismachineconfigurationopenshiftiov1containerruntimeconfigs"}
...
| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ContainerRuntimeConfigList`](/rest_api/objects/index#io-openshift-machineconfiguration-v1-ContainerRuntimeConfigList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `body` | [`ContainerRuntimeConfig`](/rest_api/machine_apis/containerruntimeconfig-machineconfiguration-openshift-io-v1#containerruntimeconfig-machineconfiguration-openshift-io-v1) schema |  |

**HTTP responses**

| HTTP code | Reponse body |
| --- | --- |
| 200 - OK | [`ContainerRuntimeConfig`](/rest_api/machine_apis/containerruntimeconfig-machineconfiguration-openshift-io-v1#containerruntimeconfig-machineconfiguration-openshift-io-v1) schema |
| 201 - Created | [`ContainerRuntimeConfig`](/rest_api/machine_apis/containerruntimeconfig-machineconfiguration-openshift-io-v1#containerruntimeconfig-machineconfiguration-openshift-io-v1) schema |
| 202 - Accepted | [`ContainerRuntimeConfig`](/rest_api/machine_apis/containerruntimeconfig-machineconfiguration-openshift-io-v1#containerruntimeconfig-machineconfiguration-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |

### /apis/machineconfiguration.openshift.io/v1/containerruntimeconfigs/{{ name }} {id="_apismachineconfigurationopenshiftiov1containerruntimeconfigs_name"}
...
### /apis/machineconfiguration.openshift.io/v1/containerruntimeconfigs/{{ name }}/status {id="_apismachineconfigurationopenshiftiov1containerruntimeconfigs_name_status"}
