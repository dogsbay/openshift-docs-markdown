...
# PinnedImageSet [machineconfiguration.openshift.io/v1] {id="pinnedimageset-machineconfiguration-openshift-io-v1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/machineconfiguration.openshift.io/v1/pinnedimagesets {id="_apismachineconfigurationopenshiftiov1pinnedimagesets"}
...
### /apis/machineconfiguration.openshift.io/v1/pinnedimagesets/{{ name }} {id="_apismachineconfigurationopenshiftiov1pinnedimagesets_name"}
