...
# Machine [machine.openshift.io/v1beta1] {id="machine-machine-openshift-io-v1beta1"}
{%- set toc = "macro" -%}
{%- set toc_title = true %}
...
### /apis/machine.openshift.io/v1beta1/machines {id="_apismachineopenshiftiov1beta1machines"}
...
### /apis/machine.openshift.io/v1beta1/namespaces/{{ namespace }}/machines {id="_apismachineopenshiftiov1beta1namespaces_namespace_machines"}
...
### /apis/machine.openshift.io/v1beta1/namespaces/{{ namespace }}/machines/{{ name }} {id="_apismachineopenshiftiov1beta1namespaces_namespace_machines_name"}
...
### /apis/machine.openshift.io/v1beta1/namespaces/{{ namespace }}/machines/{{ name }}/status {id="_apismachineopenshiftiov1beta1namespaces_namespace_machines_name_status"}
