...
To enable a pod to use additional network interfaces beyond the primary cluster network in {{ product_title }}, you can attach the pod to a secondary network. Secondary networks provide additional connectivity options for your workloads. {._abstract}
