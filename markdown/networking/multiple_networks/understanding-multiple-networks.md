...
{{ product_title }} administrators and users can use user-defined networks (UDNs) or `NetworkAttachmentDefinition` (NADs) to define the networks that handle all of the ordinary network traffic of the cluster.
...
## Additional resources {id="additional-resources_understanding-multiple-networks"}
