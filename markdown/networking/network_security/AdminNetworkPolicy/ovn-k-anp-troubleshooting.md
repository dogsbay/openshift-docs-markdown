...
To troubleshoot `AdminNetworkPolicy` and `BaselineAdminNetworkPolicy` resources in {{ product_title }}, you can review status conditions with `oc describe` and inspect OVN northbound database objects with `ovn-nbctl` commands.
