...
To restrict traffic between workloads and improve application security, configure `NetworkPolicy` objects for your cluster. Network policies define the allowed ingress and egress connections for selected pods and help isolate applications within namespaces. {._abstract}
...
## Additional resources {id="about-network-policy-additional-resources" ._additional-resources}
