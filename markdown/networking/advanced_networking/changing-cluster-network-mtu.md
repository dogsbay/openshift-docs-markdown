...
As a cluster administrator, you can change the maximum transmission unit (MTU) for the cluster network after cluster installation. This change is disruptive as cluster nodes must be rebooted to finalize the MTU change. {._abstract}
...
## Additional resources {id="additional-resources-mtu-cluster-network" ._additional-resources}
