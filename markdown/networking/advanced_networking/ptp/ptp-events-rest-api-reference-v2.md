...
*   [`api/ocloudNotifications/v2/subscriptions/{{ subscription_id }}`](/networking/networking/advanced_networking/ptp/ptp-events-rest-api-reference-v2#api-ocloud-notifications-v2-subscriptions-subscription_id_{{ context }})
...
*   [`api/ocloudnotifications/v2/{{ resource_address }}/CurrentState`](/networking/networking/advanced_networking/ptp/ptp-events-rest-api-reference-v2#resource-address-current-state-v2_{{ context }})
