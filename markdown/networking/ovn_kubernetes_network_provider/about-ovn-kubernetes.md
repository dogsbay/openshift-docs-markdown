...
OVN-Kubernetes is the default networking solution for {{ product_title }} and {{ sno }} deployments.
...
{% leveloffset +1 %}{% include "./modules/nw-ovn-kubernetes-features.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/nw-ovn-kubernetes-limitations.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/nw-ovn-kubernetes-session-affinity.md" %}{% endleveloffset %}
