...
You can create an IP failover deployment configuration on {{ product_title }}. The IP failover deployment configuration specifies the set of VIP addresses, and the set of nodes on which to service them. A cluster can have multiple IP failover deployment configurations, with each managing its own set of unique VIP addresses. Each node in the IP failover configuration runs an IP failover pod, and this pod runs Keepalived.
...
{% leveloffset +1 %}{% include "./modules/nw-ipfailover-environment-variables.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/nw-ipfailover-configuration.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/nw-ipfailover-configuring-check-notify-scripts.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/nw-ipfailover-configuring-vrrp-preemption.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/nw-ipfailover-vrrp-ip-offset.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/nw-ipfailover-configuring-more-than-254.md" %}{% endleveloffset %}
...
{% leveloffset +1 %}{% include "./modules/nw-ipfailover-remove.md" %}{% endleveloffset %}