...
With the Cluster Network Operator, you can manage networking in {{ product_title }}, including how to view status, enable IP forwarding, and collect logs. 
...
## Additional resources {id="cluster-network-operator-additional-resources"}
