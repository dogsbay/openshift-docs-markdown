...
You can provision and manage {{ ibm_power_server_name }} Block storage in {{ product_title }} by using the Container Storage Interface (CSI) Driver Operator and driver, which provide dynamic volume provisioning. {._abstract}
