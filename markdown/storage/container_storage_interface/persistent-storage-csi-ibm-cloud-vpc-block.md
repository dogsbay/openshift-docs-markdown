...
You can provision and manage {{ ibm_cloud_name }} Virtual Private Cloud (VPC) Block Storage in {{ product_title }} using the {{ ibm_cloud_name }} VPC Block Container Storage Interface (CSI) Driver Operator and driver, which provide dynamic volume provisioning.
