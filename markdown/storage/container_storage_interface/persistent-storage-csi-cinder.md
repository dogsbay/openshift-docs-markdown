...
You can provision and manage OpenStack Cinder storage in {{ product_title }} using the OpenStack Cinder Container Storage Interface (CSI) Driver Operator and driver, which provide dynamic volume provisioning. {._abstract}
