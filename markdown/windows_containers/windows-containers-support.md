...
For more information, see the Red&#160;Hat {{ product_title }} Life Cycle Policy document for [{{ productwinc }}](https://access.redhat.com/support/policy/updates/openshift#windows).
