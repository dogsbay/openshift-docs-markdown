...
You can use {{ productwinc }} to run Windows compute nodes in an {{ product_title }} cluster by using the Red Hat Windows Machine Config Operator (WMCO) to install and manage Windows nodes. {._abstract}
