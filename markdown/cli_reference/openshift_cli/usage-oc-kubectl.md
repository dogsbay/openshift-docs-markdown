...
Because {{ product_title }} is a certified Kubernetes distribution, you can use the Kubernetes CLI (`kubectl`) that ships with {{ product_title }} to interact with your cluster. You can also gain extended functionality specific to {{ product_title }} by using the {{ oc_first }} binary. {._abstract}
