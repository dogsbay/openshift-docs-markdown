...
# {{ gitops_shortname }} CLI for use with {{ gitops_title }} {id="gitops-argocd-cli-tools"}
{%- set context = "gitops-argocd-cli-tools" %}
...
## Installing the {{ gitops_shortname }} CLI {id="installing-argocd-gitops-cli"}
