...
You can run your cluster in a disconnected environment if you install the cluster from a mirrored set of {{ product_title }} container images in a private registry. This registry must be running whenever your cluster is running.
