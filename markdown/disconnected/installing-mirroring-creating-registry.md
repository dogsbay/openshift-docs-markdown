...
The _mirror registry for Red&#160;Hat OpenShift_ is a small and streamlined container registry that you can use as a target for mirroring the required container images of {{ product_title }} for disconnected installations.
...
## Additional resources {id="additional-resources_installing-mirroring-creating-registry"}
