...
You can use bound service account tokens, which improve the ability to integrate with cloud provider identity access management (IAM) services such as {{ product_title }} on {{ aws_short }} IAM or {{ gcp_full }} IAM. {._abstract}
