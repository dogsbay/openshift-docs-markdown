...
You can convert a connected {{ product_title }} cluster to a disconnected cluster by mirroring required registry content and installation media for use without internet access.
