...
{% leveloffset +1 %}{% include "./modules/troubleshooting-bmn-connect-to-node.md" %}{% endleveloffset %}
...
{% leveloffset +1 %}{% include "./modules/troubleshooting-bmn-replace-dimm.md" %}{% endleveloffset %}
...
{% leveloffset +1 %}{% include "./modules/troubleshooting-bmn-replace-nw-card.md" %}{% endleveloffset %}