...
After installing {{ product_title }}, you can restrict access to cluster DNS, ingress, API server, and Azure registry storage endpoints to make core cluster services private.
