...
Review user-provided ingress certificates in {{ product_title }}, including transport layer security (TLS) secret storage, `IngressController` references, and replacing Operator-generated defaults.
