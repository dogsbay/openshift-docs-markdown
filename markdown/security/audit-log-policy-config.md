...
{% leveloffset +1 %}{% include "./modules/nodes-nodes-audit-policy.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/nodes-nodes-audit-policy-custom.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/nodes-nodes-audit-policy-disable.md" %}{% endleveloffset %}