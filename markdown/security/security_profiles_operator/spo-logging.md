...
## Benefits of the Advanced Audit Logging Framework {id="benefits-of-adv-aud-log_{{ context }}"}
...
The Security Profiles Operator supports only {{ op_system_first }} worker nodes appropriate to the version of {{ product_title }} in use.
...
## Performance considerations {id="performance-considerations_{{ context }}"}
...
## Prerequisites for the Advanced Audit Logging Framework {id="prereq-adv-audit-logging_{{ context }}"}
...
For node debugging sessions:
	...
	* To audit `oc debug` node sessions, CRI-O version 1.33 or later is required. It is available in {{ product_title }} 4.20 or later.
	* The --privileged-seccomp-profile flag must be configured in CRI-O to apply `seccompProfiles` to privileged containers.
	* The supported Linux used with the Advanced Audit Logging Framework is {{ op_system_first }} running in a container in {{ product_title }} 4.20 or later.

If you are using the CRI-O runtime, you must configure it to allow `seccompProfile` to be applied to privileged containers. Add the following flag to your CRI-O runtime configuration: `--privileged-seccomp-profile=/var/lib/kubelet/seccomp/operator/profile1.json`. This is explained in more detail in the Advanced Audit Logging installation and enablement steps. The `--privileged-seccomp-profile` flag is available starting with {{ product_title }} 4.20 and later.
...
{% leveloffset +1 %}{% include "./modules/spo-log-enrich.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/spo-log-kube-api-compare.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/spo-log-enabling.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/spo-log-json-enrich.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/spo-log-tune-rot.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/spo-log-adv-pod.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/spo-log-mon-audit.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/spo-log-debug.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/spo-log-correlate.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/spo-log-enrich-out.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/spo-log-kube-api-out.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/spo-log-corr-key.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/spo-log-corr-log.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/spo-log-webhook.md" %}{% endleveloffset %}
