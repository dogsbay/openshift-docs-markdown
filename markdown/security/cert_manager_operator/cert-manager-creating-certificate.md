...
By using the {{ cert_manager_operator }}, you can manage certificates, handling tasks such as renewal and issuance, for workloads within the cluster, as well as components interacting externally to the cluster. {._abstract}
...
## Additional resources {id="additional-resources_cert-manager-creating-certificate" ._additional-resources}
