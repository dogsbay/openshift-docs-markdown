...
Delete certificates and secrets from installed secrets management Operators using the {{ external_secrets_console_plugin }} in the {{ product_title }} web console.
