...
Track the performance of the {{ zero_trust_full }} by collecting metrics. Configure monitoring to collect metrics from the Security Production Identity Framework for Everyone (SPIRE) Server and SPIRE Agent components. {._abstract}
