...
{% leveloffset +1 %}{% include "./modules/compliance-priorityclass.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/compliance-raw-tailored.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/compliance-rescan.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/compliance-custom-storage.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/compliance-apply-remediations-from-scans.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/compliance-auto-update-remediations.md" %}{% endleveloffset %}
