...
The Compliance Operator is a "Rolling Stream" Operator, meaning updates are available asynchronously of {{ product_title }} releases. For more information, see "OpenShift Operator Life Cycles" on the Red Hat Customer Portal.
