...
Containers and virtual machines provide ways of separating applications running on a host from the operating system itself. You should understand {{ op_system }}, which is the operating system used by {{ product_title }}, to see how the host systems protect containers and hosts from each other.
