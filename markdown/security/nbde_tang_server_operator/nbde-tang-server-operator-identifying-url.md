...
# Identifying URL of a Tang server deployed with the NBDE Tang Server Operator {id="identifying-url-nbde-tang-server-operator"}
{% include "./_attributes/common-attributes.md" %}
{%- set context = "identifying-url-nbde-tang-server-operator" %}
...
{% leveloffset +1 %}{% include "./modules/nbde-tang-server-operator-identifying-url-web-console.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/nbde-tang-server-operator-identifying-url-cli.md" %}{% endleveloffset %}

## Additional resources {id="additional-resources-identifying-url-nbde-tang-server-operator"}
