...
{% leveloffset +1 %}{% include "./modules/nbde-tang-server-operator-deploying.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/nbde-tang-server-operator-rotating-keys.md" %}{% endleveloffset %}

{% leveloffset +1 %}{% include "./modules/nbde-tang-server-operator-removing-hidden-keys.md" %}{% endleveloffset %}