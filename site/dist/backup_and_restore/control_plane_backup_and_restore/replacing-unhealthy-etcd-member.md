...
- [Replacing an unhealthy etcd member whose machine is not running or whose node is not ready](/openshift-docs-markdown/backup_and_restore/control_plane_backup_and_restore/replacing-unhealthy-etcd-member#restore-replace-stopped-etcd-member_replacing-unhealthy-etcd-member)
...
- [Replacing an unhealthy stopped baremetal etcd member](/openshift-docs-markdown/backup_and_restore/control_plane_backup_and_restore/replacing-unhealthy-etcd-member#restore-replace-stopped-baremetal-etcd-member_replacing-unhealthy-etcd-member)
...
- [etcd backup](/openshift-docs-markdown/backup_and_restore/control_plane_backup_and_restore/backing-up-etcd#backing-up-etcd-data_backup-etcd)
