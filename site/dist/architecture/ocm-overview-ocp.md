...
Selecting the ![kebab](/openshift-docs-markdown/images/kebab.png "Other options") > **Edit** option opens the "Edit machine pool" dialog. In this dialog, you can change the node count per availability zone, edit node labels and taints, and view any associated AWS security groups.
