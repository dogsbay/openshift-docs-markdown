...
3. Click the Options menu ![](/openshift-docs-markdown/images/kebab.png "Options menu") for a `FileIntegrity` object.
...
7. Click the Options menu ![](/openshift-docs-markdown/images/kebab.png "Options menu") on the **File Integrity Operator** entry.
8. Select **Uninstall Operator**.
9. Go to the **Home** → **Projects** page.
10. Search for `openshift-file-integrity`.
11. Click the Options menu ![](/openshift-docs-markdown/images/kebab.png "Options menu") for the **openshift-file-integrity** project entry.
