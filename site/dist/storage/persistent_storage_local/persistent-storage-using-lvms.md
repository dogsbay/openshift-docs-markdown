...
- [Reusing a volume group from the previous LVM Storage installation](/openshift-docs-markdown/storage/persistent_storage_local/persistent-storage-using-lvms#lvms-reusing-vg-from-prev-installation_logical-volume-manager-storage)
