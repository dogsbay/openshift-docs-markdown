...
- [Sample Microsoft Azure failure domain configuration](/openshift-docs-markdown/machine_management/control_plane_machine_management/cpmso_provider_configurations/cpmso-config-options-azure#cpmso-yaml-failure-domain-azure_cpmso-config-options-azure)
...
- [Sample Red Hat OpenStack Platform (RHOSP) failure domain configuration](/openshift-docs-markdown/machine_management/control_plane_machine_management/cpmso_provider_configurations/cpmso-config-options-openstack#cpmso-yaml-failure-domain-openstack_cpmso-config-options-openstack)
- [Sample VMware vSphere failure domain configuration](/openshift-docs-markdown/machine_management/control_plane_machine_management/cpmso_provider_configurations/cpmso-config-options-vsphere#cpmso-yaml-failure-domain-vsphere_cpmso-config-options-vsphere)
