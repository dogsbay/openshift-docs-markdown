...
# About {{ VirtProductName }} {#about-virt}
...
- [Glossary of common terms for OpenShift Container Platform storage](/storage/index#openshift-storage-common-terms_storage-overview)
