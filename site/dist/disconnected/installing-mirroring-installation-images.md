...
- If you want to filter, or *prune*, an existing catalog and selectively mirror only a subset of Operators, see the following sections:
  ...
  - [Installing the opm CLI](/openshift-docs-markdown/cli_reference/opm/cli-opm-install#cli-opm-install)
...
2. Run the following command to extract and mirror the content to the mirror registry:
   ...
   `manifests-{{ index_image }}-1614211642`
...
- [Installing a cluster on AWS in a disconnected environment with user-provisioned infrastructure](/openshift-docs-markdown/installing/installing_aws/upi/installing-restricted-networks-aws#installing-restricted-networks-aws)
