...
3. Optional steps that you might need to perform in the following scenarios:
   ...
   - If you want to view logs associated with exporting an application, click  **Export application** and the **View Logs** link. ![export-application-dialog-box](/openshift-docs-markdown/images/export-application-dialog-box.png)
