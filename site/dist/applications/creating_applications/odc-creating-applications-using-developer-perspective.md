...
- [Enabling the Developer perspective in the web console](/openshift-docs-markdown/web_console/web-console-overview#enabling-developer-perspective_web-console)
- [Accessing the web console](/openshift-docs-markdown/web_console/web-console#web-console)
- [Default cluster roles](/openshift-docs-markdown/authentication/using-rbac#default-roles_using-rbac)
...
- [Installing the OpenShift Virtualization Operator](/openshift-docs-markdown/virt/install/installing-virt#virt-subscribing-cli_installing-virt)
...
- [Working with projects](/openshift-docs-markdown/applications/projects/working-with-projects#odc-providing-project-permissions-using-developer-perspective_projects)
- [Creating Helm Chart repositories](/openshift-docs-markdown/applications/working_with_helm_charts/configuring-custom-helm-chart-repositories#odc-creating-helm-releases-using-developer-perspective_configuring-custom-helm-chart-repositories)
