...
- You have the appropriate [roles and permissions](/authentication/using-rbac#default-roles_using-rbac) in a project to create applications and other workloads in OpenShift Container Platform.
