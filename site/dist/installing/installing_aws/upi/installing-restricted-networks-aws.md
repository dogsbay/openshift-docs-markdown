...
- [Requirements for a cluster with user-provisioned infrastructure on AWS](/openshift-docs-markdown/installing/installing_aws/upi/upi-aws-installation-reqs#upi-aws-installation-reqs)
...
and the pull secret for your cluster. For a restricted network installation, these files are on your mirror host.
...
## Creating networking and load balancing components in AWS {id="installation-creating-aws-dns_installing-restricted-networks-aws"}
...
### CloudFormation template for the network and load balancers {id="installation-cloudformation-dns_installing-restricted-networks-aws"}
...
## Accessing RHCOS AMIs with stream metadata {id="installation-aws-ami-stream-metadata_installing-restricted-networks-aws"}
...
## RHCOS AMIs for the AWS infrastructure {id="installation-aws-user-infra-rhcos-ami_installing-restricted-networks-aws"}
...
## Creating the bootstrap node in AWS {id="installation-creating-aws-bootstrap_installing-restricted-networks-aws"}
...
### CloudFormation template for the bootstrap machine {id="installation-cloudformation-bootstrap_installing-restricted-networks-aws"}
...
*   [RHCOS AMIs for the AWS infrastructure (AWS documentation)](/installing/installing_aws/upi/installing-aws-user-infra#installation-aws-user-infra-rhcos-ami_installing-aws-user-infra)

### Creating the control plane machines in AWS {id="installation-creating-aws-control-plane_installing-restricted-networks-aws"}
...
### CloudFormation template for control plane machines {id="installation-cloudformation-control-plane_installing-restricted-networks-aws"}
...
## Creating the worker nodes in AWS {id="installation-creating-aws-worker_installing-restricted-networks-aws"}
...
### CloudFormation template for compute machines {id="installation-cloudformation-worker_installing-restricted-networks-aws"}
...
### Creating the `CloudFormation` stack for compute machines {id="installation-aws-creating-cloudformation-stack_installing-restricted-networks-aws"}
...
## Initializing the bootstrap sequence on Amazon Web Services (AWS) with user-provisioned infrastructure {id="installation-aws-user-infra-bootstrap_installing-restricted-networks-aws"}
...
## Approving the certificate signing requests for your machines {id="installation-approve-csrs_installing-restricted-networks-aws"}
...
## Initial Operator configuration {id="installation-operators-config_installing-restricted-networks-aws"}
...
### Disabling the default software catalog sources {id="olm-restricted-networks-operatorhub_installing-restricted-networks-aws"}

To use only trusted or locally available Operator catalogs, disable the default software catalog sources that OpenShift Container Platform configures during installation.
...
### Image registry storage configuration {id="installation-registry-storage-config_installing-restricted-networks-aws"}
...
#### Configuring registry storage for AWS with user-provisioned infrastructure {id="registry-configuring-storage-aws-user-infra_installing-restricted-networks-aws"}
...
#### Configuring storage for the image registry in non-production clusters {id="installation-registry-storage-non-production_installing-restricted-networks-aws"}
...
## Deleting the bootstrap resources {id="installation-aws-user-infra-delete-bootstrap_installing-restricted-networks-aws"}
...
## Creating the Ingress DNS records {id="installation-create-ingress-dns-records_installing-restricted-networks-aws"}
...
## Completing an Amazon Web Services (AWS) installation on user-provisioned infrastructure {id="installation-aws-user-infra-installation_installing-restricted-networks-aws"}
...
## Logging in to the cluster by using the CLI {id="cli-logging-in-kubeadmin_installing-restricted-networks-aws"}
...
## Logging in to the cluster by using the web console {id="logging-in-by-using-the-web-console_installing-restricted-networks-aws"}
