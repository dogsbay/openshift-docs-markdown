...
# Installing a cluster on {{ oci_distributed_no_rt }} by using the Agent-based Installer {#installing-oci-agent-based-installer}
...
- [Internet access for OpenShift Container Platform](/installing/installing_platform_agnostic/installing-platform-agnostic#cluster-entitlements_installing-platform-agnostic)
...
- [About OpenShift Container Platform installation](/architecture/architecture-installation#installation-overview_architecture-installation)
