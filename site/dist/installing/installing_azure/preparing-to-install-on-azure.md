...
- [Installing a cluster on Azure in a restricted network](/openshift-docs-markdown/installing/installing_azure/ipi/installing-restricted-networks-azure-installer-provisioned#installing-restricted-networks-azure-installer-provisioned)
- [Installing a cluster on Azure into an existing `VNet`](/openshift-docs-markdown/installing/installing_azure/ipi/installing-azure-vnet#installing-azure-vnet)
