...
## Networking requirements for user-provisioned infrastructure {id="installation-network-user-infra_installing-restricted-networks-gcp"}
...
### Setting the cluster node hostnames through DHCP {id="installation-host-names-dhcp-user-infra_installing-restricted-networks-gcp"}
...
### Network connectivity requirements {id="installation-network-connectivity-user-infra_installing-restricted-networks-gcp"}
...
## Creating load balancers in Google Cloud {id="installation-creating-gcp-lb_installing-restricted-networks-gcp"}
...
### Infrastructure Manager template for the external load balancer {id="installation-infrastructure-manager-ext-lb_installing-restricted-networks-gcp"}
...
### Infrastructure Manager template for the internal load balancer {id="installation-infrastructure-manager-int-lb_installing-restricted-networks-gcp"}
...
## Creating a private DNS zone in Google Cloud {id="installation-creating-gcp-private-dns_installing-restricted-networks-gcp"}
...
### Infrastructure Manager template for the private DNS {id="installation-infrastructure-manager-private-dns_installing-restricted-networks-gcp"}
...
## Creating firewall rules and IAM roles in Google Cloud {id="installation-creating-gcp-firewall-rules-vpc_installing-restricted-networks-gcp"}
...
### Infrastructure Manager template for firewall rules and IAM roles {id="installation-infrastructure-manager-firewall-rules_installing-restricted-networks-gcp"}
...
## Creating IAM policy bindings in Google Cloud {id="installation-creating-gcp-iam-shared-vpc_installing-restricted-networks-gcp"}
...
## Creating the RHCOS cluster image for the Google Cloud infrastructure {id="installation-gcp-user-infra-rhcos_installing-restricted-networks-gcp"}
...
## Creating the bootstrap machine in Google Cloud {id="installation-creating-gcp-bootstrap_installing-restricted-networks-gcp"}
...
### Infrastructure Manager template for the bootstrap machine {id="installation-infrastructure-manager-bootstrap_installing-restricted-networks-gcp"}
...
## Creating the control plane machines in Google Cloud {id="installation-creating-gcp-control-plane_installing-restricted-networks-gcp"}
...
### Infrastructure Manager template for control plane machines {id="installation-infrastructure-manager-control-plane_installing-restricted-networks-gcp"}
...
## Creating additional worker machines in Google Cloud {id="installation-creating-gcp-worker_installing-restricted-networks-gcp"}
...
### Infrastructure Manager template for worker machines {id="installation-infrastructure-manager-worker_installing-restricted-networks-gcp"}
...
## Removing bootstrap resources in Google Cloud {id="installation-gcp-user-infra-wait-for-bootstrap_installing-restricted-networks-gcp"}
...
## Logging in to the cluster by using the CLI {id="cli-logging-in-kubeadmin_installing-restricted-networks-gcp"}
...
## Disabling the default software catalog sources {id="olm-restricted-networks-operatorhub_installing-restricted-networks-gcp"}
...
## Approving the certificate signing requests for your machines {id="installation-approve-csrs_installing-restricted-networks-gcp"}
...
## Optional: Adding the ingress DNS records {id="installation-gcp-user-infra-adding-ingress_installing-restricted-networks-gcp"}
...
## Completing a Google Cloud installation on user-provisioned infrastructure {id="installation-gcp-user-infra-installation_installing-restricted-networks-gcp"}
...
## Telemetry access for OpenShift Container Platform {id="cluster-telemetry_installing-restricted-networks-gcp"}
