...
- [Adding the ingress DNS records](/openshift-docs-markdown/installing/installing_gcp/installing-restricted-networks-gcp#installation-gcp-user-infra-adding-ingress_installing-restricted-networks-gcp)
...
- [Configuring image streams for the Cluster Samples Operator and the must-gather tool](/openshift-docs-markdown/post_installation_configuration/cluster-tasks#post-install-must-gather-disconnected)
