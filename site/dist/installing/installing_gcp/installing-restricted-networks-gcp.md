...
## Requirements for a cluster with user-provisioned infrastructure {#installation-requirements-user-infra_installing-restricted-networks-gcp ._additional-resources}
...
## Exporting common variables {#installation-restricted-networks-gcp-user-infra-exporting-common-variables ._additional-resources}
